...
//BA.debugLineNum = 39;BA.debugLine="pik_day1.SetLeftAndRight(0%x,15%x)"[main_layout/General script]
views.get("pik_day1").vw.setLeft((int)((0d / 100 * width)));
views.get("pik_day1").vw.setWidth((int)((15d / 100 * width) - ((0d / 100 * width))));
//BA.debugLineNum = 40;BA.debugLine="pik_day_paeen1.SetLeftAndRight(0%x,15%x)"[main_layout/General script]
views.get("pik_day_paeen1").vw.setLeft((int)((0d / 100 * width)));
views.get("pik_day_paeen1").vw.setWidth((int)((15d / 100 * width) - ((0d / 100 * width))));
//BA.debugLineNum = 43;BA.debugLine="pik_pan_hour1.SetLeftAndRight(65%x,80%x)"[main_layout/General script]
views.get("pik_pan_hour1").vw.setLeft((int)((65d / 100 * width)));
views.get("pik_pan_hour1").vw.setWidth((int)((80d / 100 * width) - ((65d / 100 * width))));
//BA.debugLineNum = 44;BA.debugLine="pik_hour_bala1.SetLeftAndRight(0%x,15%x)"[main_layout/General script]
views.get("pik_hour_bala1").vw.setLeft((int)((0d / 100 * width)));
views.get("pik_hour_bala1").vw.setWidth((int)((15d / 100 * width) - ((0d / 100 * width))));
//BA.debugLineNum = 45;BA.debugLine="pik_hour1.SetLeftAndRight(0%x,15%x)"[main_layout/General script]
views.get("pik_hour1").vw.setLeft((int)((0d / 100 * width)));
views.get("pik_hour1").vw.setWidth((int)((15d / 100 * width) - ((0d / 100 * width))));
//BA.debugLineNum = 46;BA.debugLine="pik_hour_paeen1.SetLeftAndRight(0%x,15%x)"[main_layout/General script]
...
//BA.debugLineNum = 50;BA.debugLine="pik_pan_min1.SetLeftAndRight(80%x,95%x)"[main_layout/General script]
views.get("pik_pan_min1").vw.setLeft((int)((80d / 100 * width)));
views.get("pik_pan_min1").vw.setWidth((int)((95d / 100 * width) - ((80d / 100 * width))));
//BA.debugLineNum = 51;BA.debugLine="pik_min_bala1.SetLeftAndRight(0%x,15%x)"[main_layout/General script]
views.get("pik_min_bala1").vw.setLeft((int)((0d / 100 * width)));
views.get("pik_min_bala1").vw.setWidth((int)((15d / 100 * width) - ((0d / 100 * width))));
//BA.debugLineNum = 52;BA.debugLine="pik_min1.SetLeftAndRight(0%x,15%x)"[main_layout/General script]
views.get("pik_min1").vw.setLeft((int)((0d / 100 * width)));
views.get("pik_min1").vw.setWidth((int)((15d / 100 * width) - ((0d / 100 * width))));
//BA.debugLineNum = 53;BA.debugLine="pik_min_paeen1.SetLeftAndRight(0%x,15%x)"[main_layout/General script]
views.get("pik_min_paeen1").vw.setLeft((int)((0d / 100 * width)));
views.get("pik_min_paeen1").vw.setWidth((int)((15d / 100 * width) - ((0d / 100 * width))));
//BA.debugLineNum = 58;BA.debugLine="ImageView1.SetLeftAndRight(10%x,90%x)"[main_layout/General script]
views.get("imageview1").vw.setLeft((int)((10d / 100 * width)));
views.get("imageview1").vw.setWidth((int)((90d / 100 * width) - ((10d / 100 * width))));
//BA.debugLineNum = 59;BA.debugLine="ImageView1.Height=ImageView1.Width*1.5"[main_layout/General script]
views.get("imageview1").vw.setHeight((int)((views.get("imageview1").vw.getWidth())*1.5d));
//BA.debugLineNum = 60;BA.debugLine="ImageView1.VerticalCenter=50%y"[main_layout/General script]
