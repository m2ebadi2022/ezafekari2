...
//BA.debugLineNum = 17;BA.debugLine="pan_add_mamoriat.HorizontalCenter=50%x"[home_item/General script]
views.get("pan_add_mamoriat").vw.setLeft((int)((50d / 100 * width) - (views.get("pan_add_mamoriat").vw.getWidth() / 2)));
...
//BA.debugLineNum = 19;BA.debugLine="pan_add_other.Right=pan_add_mamoriat.Left"[home_item/General script]
views.get("pan_add_other").vw.setLeft((int)((views.get("pan_add_mamoriat").vw.getLeft()) - (views.get("pan_add_other").vw.getWidth())));
//BA.debugLineNum = 21;BA.debugLine="pan_run_morakhasi.HorizontalCenter=50%x"[home_item/General script]
views.get("pan_run_morakhasi").vw.setLeft((int)((50d / 100 * width) - (views.get("pan_run_morakhasi").vw.getWidth() / 2)));
//BA.debugLineNum = 22;BA.debugLine="pan_run_hogog.Left=pan_run_morakhasi.Right"[home_item/General script]
views.get("pan_run_hogog").vw.setLeft((int)((views.get("pan_run_morakhasi").vw.getLeft() + views.get("pan_run_morakhasi").vw.getWidth())));
//BA.debugLineNum = 23;BA.debugLine="pan_fast_run.Right=pan_run_morakhasi.Left"[home_item/General script]
views.get("pan_fast_run").vw.setLeft((int)((views.get("pan_run_morakhasi").vw.getLeft()) - (views.get("pan_fast_run").vw.getWidth())));
//BA.debugLineNum = 25;BA.debugLine="pan_payankar.HorizontalCenter=50%x"[home_item/General script]
...
//BA.debugLineNum = 31;BA.debugLine="pan_ganon.Right=pan_darsad.Left"[home_item/General script]
views.get("pan_ganon").vw.setLeft((int)((views.get("pan_darsad").vw.getLeft()) - (views.get("pan_ganon").vw.getWidth())));
//BA.debugLineNum = 33;BA.debugLine="pan_bime.HorizontalCenter=50%x"[home_item/General script]
...
//BA.debugLineNum = 42;BA.debugLine="pan_help_kharid.Left=pan_setting.Left"[home_item/General script]
