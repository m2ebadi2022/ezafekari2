...
//BA.debugLineNum = 21;BA.debugLine="pan_add_other.Left=pan_add_ezafekari.Left"[home_item/General script]
views.get("pan_add_other").vw.setLeft((int)((views.get("pan_add_ezafekari").vw.getLeft())));
