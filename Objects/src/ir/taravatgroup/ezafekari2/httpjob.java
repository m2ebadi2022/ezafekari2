...
public class httpjob extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ir.taravatgroup.ezafekari2.httpjob");
            if (htSubs == null) {
...
__c.LogImpl("968419589",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("968485125",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("968222981",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("968288517",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("967960837",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("967895308",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("967633157",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("968157448","Cannot send files from the assets folder.",0);
...
__c.LogImpl("967764229",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
