...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 49;BA.debugLine="Activity.LoadLayout(\"saati_layout\")";
mostCurrent._activity.LoadLayout("saati_layout",mostCurrent.activityBA);
 //BA.debugLineNum = 53;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 54;BA.debugLine="dbCode.res= dbCode.sql.ExecQuery(\"SELECT * FROM t";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/  = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery("SELECT * FROM tb_setting")));
 //BA.debugLineNum = 56;BA.debugLine="dbCode.res.Position=0 ''--------paye------";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (0));
 //BA.debugLineNum = 58;BA.debugLine="paye=dbCode.res.GetString(\"value\")";
_paye = (int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 60;BA.debugLine="dbCode.res.Position=14 ''--------hag sanavat-----";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (14));
 //BA.debugLineNum = 61;BA.debugLine="sanavat=dbCode.res.GetString(\"value\")";
_sanavat = (int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 64;BA.debugLine="If(File.Exists(File.DirInternal,\"temp_mablagh_saa";
if ((anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"temp_mablagh_saati.txt")==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 65;BA.debugLine="et_mablagh.Tag=File.ReadString(File.DirInternal,";
mostCurrent._et_mablagh.setTag((Object)(anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"temp_mablagh_saati.txt")));
 //BA.debugLineNum = 66;BA.debugLine="et_mablagh.Text=show_num_pool(et_mablagh.Tag)";
mostCurrent._et_mablagh.setText(BA.ObjectToCharSequence(_show_num_pool((int)(BA.ObjectToNumber(mostCurrent._et_mablagh.getTag())))));
 ...
 //BA.debugLineNum = 71;BA.debugLine="et_mablagh.Tag=(paye+sanavat)/220";
mostCurrent._et_mablagh.setTag((Object)((_paye+_sanavat)/(double)220));
 //BA.debugLineNum = 72;BA.debugLine="et_mablagh.Text=show_num_pool(et_mablagh.Tag)";
mostCurrent._et_mablagh.setText(BA.ObjectToCharSequence(_show_num_pool((int)(BA.ObjectToNumber(mostCurrent._et_mablagh.getTag())))));
 };
 //BA.debugLineNum = 79;BA.debugLine="dbCode.res.Close";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .Close();
 //BA.debugLineNum = 80;BA.debugLine="dbCode.sql.Close";
mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .Close();
 //BA.debugLineNum = 83;BA.debugLine="lbl_date1.Text=myfunc.fa2en(Main.persianDate.Pers";
mostCurrent._lbl_date1.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._fa2en /*String*/ (mostCurrent.activityBA,BA.NumberToString(mostCurrent._main._persiandate /*com.b4a.manamsoftware.PersianDate.ManamPersianDate*/ .getPersianYear())+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,mostCurrent._main._persiandate /*com.b4a.manamsoftware.PersianDate.ManamPersianDate*/ .getPersianMonth())+"/01")));
 //BA.debugLineNum = 84;BA.debugLine="lbl_date2.Text=myfunc.fa2en(Main.persianDate.Pers";
mostCurrent._lbl_date2.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._fa2en /*String*/ (mostCurrent.activityBA,mostCurrent._main._persiandate /*com.b4a.manamsoftware.PersianDate.ManamPersianDate*/ .getPersianShortDate())));
 //BA.debugLineNum = 87;BA.debugLine="get_karkard(lbl_date1.Text , lbl_date2.Text)";
...
mostCurrent._moon_datapik.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"فروردین","اردیبهشت","خرداد","تیر","مرداد","شهریور","مهر","آبان","آذر","دی","بهمن","اسفند"}));
 //BA.debugLineNum = 100;BA.debugLine="lbl_date1.Color=Colors.White";
mostCurrent._lbl_date1.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 101;BA.debugLine="lbl_date2.Color=Colors.White";
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 203;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 204;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 205;BA.debugLine="If(pan_show_list.Visible=True Or pan_all_set_dat";
if ((mostCurrent._pan_show_list.getVisible()==anywheresoftware.b4a.keywords.Common.True || mostCurrent._pan_all_set_date.getVisible()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 206;BA.debugLine="pan_show_list.Visible=False";
mostCurrent._pan_show_list.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 207;BA.debugLine="pan_all_set_date.Visible=False";
mostCurrent._pan_all_set_date.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 209;BA.debugLine="lbl_back_Click";
_lbl_back_click();
 };
...
anywheresoftware.b4a.keywords.StringBuilderWrapper _str1 = null;
 //BA.debugLineNum = 222;BA.debugLine="Private Sub btn_mohasebe_Click";
 //BA.debugLineNum = 224;BA.debugLine="If(et_majmoe_hour.Text.Trim=\"\")Then";
if (((mostCurrent._et_majmoe_hour.getText().trim()).equals(""))) { 
 //BA.debugLineNum = 225;BA.debugLine="et_majmoe_hour.Text=0";
mostCurrent._et_majmoe_hour.setText(BA.ObjectToCharSequence(0));
 };
 //BA.debugLineNum = 227;BA.debugLine="If(et_majmoe_min.Text.Trim=\"\")Then";
if (((mostCurrent._et_majmoe_min.getText().trim()).equals(""))) { 
 //BA.debugLineNum = 228;BA.debugLine="et_majmoe_min.Text=0";
mostCurrent._et_majmoe_min.setText(BA.ObjectToCharSequence(0));
 };
 //BA.debugLineNum = 231;BA.debugLine="Dim sum_min As Int";
_sum_min = 0;
 //BA.debugLineNum = 232;BA.debugLine="sum_min=(et_majmoe_hour.Text * 60)+(et_majmoe_min";
_sum_min = (int) (((double)(Double.parseDouble(mostCurrent._et_majmoe_hour.getText()))*60)+(double)(Double.parseDouble((mostCurrent._et_majmoe_min.getText()))));
 //BA.debugLineNum = 236;BA.debugLine="Dim str1 As StringBuilder";
_str1 = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 237;BA.debugLine="str1.Initialize";
_str1.Initialize();
 //BA.debugLineNum = 238;BA.debugLine="str1.Append(\"<!DOCTYPE html><html dir='rtl' lang=";
_str1.Append("<!DOCTYPE html><html dir='rtl' lang='fa'><meta charset='UTF-8' />  <meta name='viewport' content='width=device-width, initial-scale=1.0' /> <body style='font-family:tahoma,Arial,sans-serif;'><br><hr>");
 //BA.debugLineNum = 241;BA.debugLine="str1.Append(\"<span style='font-size:16px; color:b";
_str1.Append("<span style='font-size:16px; color:black;' >مبلغ کل دریافتی : <span style='font-size:18px; color:green;'>"+mostCurrent._myfunc._en2fa /*String*/ (mostCurrent.activityBA,_show_num_pool((int) (((double)(BA.ObjectToNumber(mostCurrent._et_mablagh.getTag()))/(double)60)*_sum_min)))+"  </span>تومان</span>");
 //BA.debugLineNum = 246;BA.debugLine="str1.Append(\"</body></html>\")";
_str1.Append("</body></html>");
 //BA.debugLineNum = 250;BA.debugLine="wb_end_mohasebe.LoadHtml(str1.ToString)";
mostCurrent._wb_end_mohasebe.LoadHtml(_str1.ToString());
 //BA.debugLineNum = 251;BA.debugLine="File.WriteString(File.DirInternal,\"temp_mablagh_s";
...
String _n = "";
String _o = "";
 //BA.debugLineNum = 263;BA.debugLine="Sub change_formater (Old As String, New As String,";
 //BA.debugLineNum = 264;BA.debugLine="Dim D As Double				'این متغیر رو برای این ایجاد م";
_d = 0;
 //BA.debugLineNum = 265;BA.debugLine="Dim S,N,O As String";
_s = "";
_n = "";
_o = "";
 //BA.debugLineNum = 266;BA.debugLine="n=New.Replace(\",\",\"\")";
_n = _new.replace(",","");
 //BA.debugLineNum = 267;BA.debugLine="O=Old.Replace(\",\",\"\")";
_o = _old.replace(",","");
 //BA.debugLineNum = 268;BA.debugLine="If O<>N Then";
if ((_o).equals(_n) == false) { 
 //BA.debugLineNum = 269;BA.debugLine="et_name.Text=et_name.Text.Replace(\",\",\"\")";
_et_name.setText(BA.ObjectToCharSequence(_et_name.getText().replace(",","")));
 //BA.debugLineNum = 270;BA.debugLine="S=et_name.Text";
_s = _et_name.getText();
 //BA.debugLineNum = 271;BA.debugLine="If IsNumber(s) =True And S<>\"0\" Then	'برای تبدیل";
if (anywheresoftware.b4a.keywords.Common.IsNumber(_s)==anywheresoftware.b4a.keywords.Common.True && (_s).equals("0") == false) { 
 //BA.debugLineNum = 272;BA.debugLine="D=s";
_d = (double)(Double.parseDouble(_s));
 //BA.debugLineNum = 273;BA.debugLine="et_name.Text=NumberFormat(D,0,0)	'جدا کردن عدده";
_et_name.setText(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.NumberFormat(_d,(int) (0),(int) (0))));
 };
 };
 //BA.debugLineNum = 276;BA.debugLine="et_name.SelectionStart=et_name.Text.Length";
...
public static String  _et_mablagh_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 278;BA.debugLine="Private Sub et_mablagh_TextChanged (Old As String,";
 //BA.debugLineNum = 279;BA.debugLine="et_mablagh.Tag=New.Replace(\",\",\"\")";
mostCurrent._et_mablagh.setTag((Object)(_new.replace(",","")));
 //BA.debugLineNum = 280;BA.debugLine="change_formater(Old,New,et_mablagh)";
...
anywheresoftware.b4a.objects.collections.List _ls_taradod_show = null;
 //BA.debugLineNum = 110;BA.debugLine="Sub get_karkard(date1 As String , date2 As String)";
 //BA.debugLineNum = 113;BA.debugLine="Dim str1 As StringBuilder";
_str1 = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 114;BA.debugLine="str1.Initialize";
_str1.Initialize();
 //BA.debugLineNum = 116;BA.debugLine="Dim ls_tarad As List";
_ls_tarad = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 117;BA.debugLine="ls_tarad.Initialize";
...
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/  = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery("SELECT * FROM tb_taradod WHERE date_from  BETWEEN '"+_date1+"' AND '"+_date2+"' ;")));
 //BA.debugLineNum = 123;BA.debugLine="str1.Append(\"<!DOCTYPE html><html dir='rtl' lang=";
_str1.Append("<!DOCTYPE html><html dir='rtl' lang='fa'><meta charset='UTF-8' />  <meta name='viewport' content='width=device-width, initial-scale=1.0' /> <body style='font-family:tahoma,Arial,sans-serif;'>");
 //BA.debugLineNum = 124;BA.debugLine="str1.Append(\"<style>table , td {border: 1px solid";
_str1.Append("<style>table , td {border: 1px solid #707070;border-collapse: collapse; font-size:11pt;} tr:nth-child(even) { background-color: #9fd6e0; } tr:nth-child(odd) { background-color: #e8fbff; }	details {	border: 1px solid #aaa;	border-radius: 4px;	padding: .5em .5em 0;}	summary {	font-weight: bold;	margin: -.5em -.5em 0;	padding: .5em;} details[open] {	padding: .5em;	}	details[open] summary {border-bottom: 1px solid #aaa;margin-bottom: .5em;}</style>");
 //BA.debugLineNum = 125;BA.debugLine="str1.Append(\"<table style='width:100%;'><tr style";
_str1.Append("<table style='width:100%;'><tr style='text-align: center;'>");
 //BA.debugLineNum = 126;BA.debugLine="str1.Append(\"<td><b> ردیف</b></td><td><b> تاریخ<";
_str1.Append("<td><b> ردیف</b></td><td><b> تاریخ</b></td><td><b> ساعت</b></td><td><b> زمان</b></td> <td>توضیحات</td> <br></tr>");
 //BA.debugLineNum = 127;BA.debugLine="Dim majmoe_min As Int =0";
_majmoe_min = (int) (0);
 //BA.debugLineNum = 129;BA.debugLine="Do While dbCode.res.NextRow";
while (mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .NextRow()) {
 //BA.debugLineNum = 133;BA.debugLine="str1.Append(\"<tr style='text-align: center;'>\")";
...
_str1.Append("<td>").Append(mostCurrent._myfunc._en2fa /*String*/ (mostCurrent.activityBA,mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("date_from"))).Append("</td>");
 //BA.debugLineNum = 136;BA.debugLine="str1.Append(\"<td>\").Append(myfunc.en2fa(dbCode.";
_str1.Append("<td>").Append(mostCurrent._myfunc._en2fa /*String*/ (mostCurrent.activityBA,mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("time_from"))+" - "+mostCurrent._myfunc._en2fa /*String*/ (mostCurrent.activityBA,mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("time_to"))).Append("</td>");
 //BA.debugLineNum = 138;BA.debugLine="str1.Append(\"<td>\")";
_str1.Append("<td>");
 //BA.debugLineNum = 140;BA.debugLine="Dim ls_ezafe As List";
_ls_ezafe = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 141;BA.debugLine="ls_ezafe.Initialize";
_ls_ezafe.Initialize();
 //BA.debugLineNum = 143;BA.debugLine="ls_ezafe=myfunc.Min_to_saatMinRoz2_dontDay(dbCo";
_ls_ezafe = mostCurrent._myfunc._min_to_saatminroz2_dontday /*anywheresoftware.b4a.objects.collections.List*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("end_tim_m"))));
 //BA.debugLineNum = 144;BA.debugLine="majmoe_min=majmoe_min+dbCode.res.GetString(\"end";
_majmoe_min = (int) (_majmoe_min+(double)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("end_tim_m"))));
 //BA.debugLineNum = 146;BA.debugLine="str1.Append(myfunc.en2fa(ls_ezafe.Get(0)))";
_str1.Append(mostCurrent._myfunc._en2fa /*String*/ (mostCurrent.activityBA,BA.ObjectToString(_ls_ezafe.Get((int) (0)))));
 //BA.debugLineNum = 147;BA.debugLine="str1.Append(\":\")";
_str1.Append(":");
 //BA.debugLineNum = 148;BA.debugLine="str1.Append(myfunc.en2fa(ls_ezafe.Get(1)))";
_str1.Append(mostCurrent._myfunc._en2fa /*String*/ (mostCurrent.activityBA,BA.ObjectToString(_ls_ezafe.Get((int) (1)))));
 //BA.debugLineNum = 150;BA.debugLine="str1.Append(\"</td>\")";
_str1.Append("</td>");
 //BA.debugLineNum = 152;BA.debugLine="str1.Append(\"<td>\")";
_str1.Append("<td>");
 //BA.debugLineNum = 153;BA.debugLine="str1.Append(dbCode.res.GetString(\"tozihat\"))";
_str1.Append(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("tozihat"));
 //BA.debugLineNum = 154;BA.debugLine="str1.Append(\"</td>\")";
_str1.Append("</td>");
 //BA.debugLineNum = 156;BA.debugLine="str1.Append(\"</tr>\")";
_str1.Append("</tr>");
 }
;
 //BA.debugLineNum = 162;BA.debugLine="str1.Append(\"</table>\")";
_str1.Append("</table>");
 //BA.debugLineNum = 163;BA.debugLine="Dim ls_taradod_show As List";
_ls_taradod_show = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 164;BA.debugLine="ls_taradod_show.Initialize";
_ls_taradod_show.Initialize();
 //BA.debugLineNum = 165;BA.debugLine="ls_taradod_show=myfunc.Min_to_saatMinRoz2_dontDa";
_ls_taradod_show = mostCurrent._myfunc._min_to_saatminroz2_dontday /*anywheresoftware.b4a.objects.collections.List*/ (mostCurrent.activityBA,_majmoe_min);
 //BA.debugLineNum = 166;BA.debugLine="str1.Append(\"مجموع ساعت تردد :<span style='color";
_str1.Append("مجموع ساعت تردد :<span style='color:#5E35B1;'> "+mostCurrent._myfunc._en2fa /*String*/ (mostCurrent.activityBA,BA.ObjectToString(_ls_taradod_show.Get((int) (0))))+" ساعت و"+mostCurrent._myfunc._en2fa /*String*/ (mostCurrent.activityBA,BA.ObjectToString(_ls_taradod_show.Get((int) (1))))+"دقیقه </span><br></details></div><br> ");
 //BA.debugLineNum = 170;BA.debugLine="str1.Append(\"</body></html>\")";
_str1.Append("</body></html>");
 //BA.debugLineNum = 172;BA.debugLine="wb_show_taradod.LoadHtml(str1.ToString)";
mostCurrent._wb_show_taradod.LoadHtml(_str1.ToString());
 //BA.debugLineNum = 176;BA.debugLine="ls_tarad= myfunc.Min_to_saatMinRoz2_dontDay(majmo";
_ls_tarad = mostCurrent._myfunc._min_to_saatminroz2_dontday /*anywheresoftware.b4a.objects.collections.List*/ (mostCurrent.activityBA,_majmoe_min);
 //BA.debugLineNum = 180;BA.debugLine="et_majmoe_hour.Text=ls_tarad.Get(0)";
...
mostCurrent._wb_show_taradod = new anywheresoftware.b4a.objects.WebViewWrapper();
 //BA.debugLineNum = 44;BA.debugLine="Private wb_end_mohasebe As WebView";
mostCurrent._wb_end_mohasebe = new anywheresoftware.b4a.objects.WebViewWrapper();
 //BA.debugLineNum = 45;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_back_click() throws Exception{
 //BA.debugLineNum = 198;BA.debugLine="Private Sub lbl_back_Click";
...
public static String  _lbl_back_show_list_click() throws Exception{
 //BA.debugLineNum = 527;BA.debugLine="Private Sub lbl_back_show_list_Click";
 //BA.debugLineNum = 528;BA.debugLine="pan_show_list.Visible=False";
mostCurrent._pan_show_list.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 529;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_date1_click() throws Exception{
 //BA.debugLineNum = 285;BA.debugLine="Private Sub lbl_date1_Click";
 //BA.debugLineNum = 286;BA.debugLine="pan_all_set_date.Visible=True";
mostCurrent._pan_all_set_date.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 287;BA.debugLine="index_datePik=1";
_index_datepik = (int) (1);
 //BA.debugLineNum = 289;BA.debugLine="pik_year1.Text=myfunc.fa2en(lbl_date1.Text.SubStr";
mostCurrent._pik_year1.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._fa2en /*String*/ (mostCurrent.activityBA,mostCurrent._lbl_date1.getText().substring((int) (0),(int) (4)))));
 //BA.debugLineNum = 290;BA.debugLine="pik_moon1.Tag=myfunc.fa2en(lbl_date1.Text.SubStri";
mostCurrent._pik_moon1.setTag((Object)(mostCurrent._myfunc._fa2en /*String*/ (mostCurrent.activityBA,mostCurrent._lbl_date1.getText().substring((int) (5),(int) (7)))));
 //BA.debugLineNum = 291;BA.debugLine="pik_moon1.Text=moon_dataPik.Get(pik_moon1.Tag-1)";
mostCurrent._pik_moon1.setText(BA.ObjectToCharSequence(mostCurrent._moon_datapik.Get((int) ((double)(BA.ObjectToNumber(mostCurrent._pik_moon1.getTag()))-1))));
 //BA.debugLineNum = 292;BA.debugLine="pik_day1.Text=myfunc.fa2en(lbl_date1.Text.SubStri";
...
public static String  _lbl_date2_click() throws Exception{
 //BA.debugLineNum = 295;BA.debugLine="Private Sub lbl_date2_Click";
 //BA.debugLineNum = 296;BA.debugLine="pan_all_set_date.Visible=True";
mostCurrent._pan_all_set_date.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 297;BA.debugLine="index_datePik=2";
_index_datepik = (int) (2);
 //BA.debugLineNum = 299;BA.debugLine="pik_year1.Text=myfunc.fa2en(lbl_date2.Text.SubStr";
mostCurrent._pik_year1.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._fa2en /*String*/ (mostCurrent.activityBA,mostCurrent._lbl_date2.getText().substring((int) (0),(int) (4)))));
 //BA.debugLineNum = 300;BA.debugLine="pik_moon1.Tag=myfunc.fa2en(lbl_date2.Text.SubStri";
mostCurrent._pik_moon1.setTag((Object)(mostCurrent._myfunc._fa2en /*String*/ (mostCurrent.activityBA,mostCurrent._lbl_date2.getText().substring((int) (5),(int) (7)))));
 //BA.debugLineNum = 301;BA.debugLine="pik_moon1.Text=moon_dataPik.Get(pik_moon1.Tag-1)";
mostCurrent._pik_moon1.setText(BA.ObjectToCharSequence(mostCurrent._moon_datapik.Get((int) ((double)(BA.ObjectToNumber(mostCurrent._pik_moon1.getTag()))-1))));
 //BA.debugLineNum = 302;BA.debugLine="pik_day1.Text=myfunc.fa2en(lbl_date2.Text.SubStri";
...
public static String  _lbl_refresh_mablagh_click() throws Exception{
 //BA.debugLineNum = 522;BA.debugLine="Private Sub lbl_refresh_mablagh_Click";
 //BA.debugLineNum = 523;BA.debugLine="et_mablagh.Tag=(paye+sanavat)/220";
mostCurrent._et_mablagh.setTag((Object)((_paye+_sanavat)/(double)220));
 //BA.debugLineNum = 524;BA.debugLine="et_mablagh.Text=show_num_pool(et_mablagh.Tag)";
mostCurrent._et_mablagh.setText(BA.ObjectToCharSequence(_show_num_pool((int)(BA.ObjectToNumber(mostCurrent._et_mablagh.getTag())))));
 //BA.debugLineNum = 525;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_save_picker_click() throws Exception{
 //BA.debugLineNum = 305;BA.debugLine="Private Sub lbl_save_picker_Click";
 //BA.debugLineNum = 306;BA.debugLine="If(index_datePik=1) Then";
if ((_index_datepik==1)) { 
 //BA.debugLineNum = 307;BA.debugLine="lbl_date1.Text=pik_year1.Text&\"/\"&myfunc.convert";
mostCurrent._lbl_date1.setText(BA.ObjectToCharSequence(mostCurrent._pik_year1.getText()+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,(int)(BA.ObjectToNumber(mostCurrent._pik_moon1.getTag())))+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._pik_day1.getText())))));
 ...
 //BA.debugLineNum = 310;BA.debugLine="lbl_date2.Text=pik_year1.Text&\"/\"&myfunc.convert";
mostCurrent._lbl_date2.setText(BA.ObjectToCharSequence(mostCurrent._pik_year1.getText()+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,(int)(BA.ObjectToNumber(mostCurrent._pik_moon1.getTag())))+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._pik_day1.getText())))));
 ...
 //BA.debugLineNum = 312;BA.debugLine="pan_all_set_date.Visible=False";
mostCurrent._pan_all_set_date.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 313;BA.debugLine="get_karkard(lbl_date1.Text , lbl_date2.Text)";
_get_karkard(mostCurrent._lbl_date1.getText(),mostCurrent._lbl_date2.getText());
 //BA.debugLineNum = 314;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_show_list_click() throws Exception{
 //BA.debugLineNum = 531;BA.debugLine="Private Sub lbl_show_list_Click";
 //BA.debugLineNum = 532;BA.debugLine="pan_show_list.Visible=True";
...
public static String  _pan_all_set_date_click() throws Exception{
 //BA.debugLineNum = 518;BA.debugLine="Private Sub pan_all_set_date_Click";
 //BA.debugLineNum = 519;BA.debugLine="pan_all_set_date.Visible=False";
mostCurrent._pan_all_set_date.setVisible(anywheresoftware.b4a.keywords.Common.False);
...
mostCurrent._pik_day1.setText(BA.ObjectToCharSequence(30));
 ...
 //BA.debugLineNum = 493;BA.debugLine="pik_day1.Text=myfunc.convert_adad(pik_day1.Text)";
...
mostCurrent._pik_day1.setText(BA.ObjectToCharSequence(30));
 ...
 //BA.debugLineNum = 514;BA.debugLine="pik_day1.Text=myfunc.convert_adad(pik_day1.Text)";
mostCurrent._pik_day1.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._pik_day1.getText())))));
...
mostCurrent._pik_day1.setText(BA.ObjectToCharSequence(30));
 ...
 //BA.debugLineNum = 413;BA.debugLine="pik_day1.Text=myfunc.convert_adad(pik_day1.Text)";
mostCurrent._pik_day1.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._pik_day1.getText())))));
 };
...
public static String  _show_num_pool(int _num) throws Exception{
 //BA.debugLineNum = 260;BA.debugLine="Sub show_num_pool (num As Int) As String";
 //BA.debugLineNum = 261;BA.debugLine="Return NumberFormat(num,0,0)";
