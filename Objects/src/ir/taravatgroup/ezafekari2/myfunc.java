...
String _tm1 = "";
 //BA.debugLineNum = 631;BA.debugLine="Sub find_tim1_taradod (tim2 As String, ezaf_min As";
 //BA.debugLineNum = 632;BA.debugLine="Dim ls_result As List";
_ls_result = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 633;BA.debugLine="ls_result.Initialize";
_ls_result.Initialize();
 //BA.debugLineNum = 635;BA.debugLine="Dim tm1 As String=\"\"";
_tm1 = "";
 //BA.debugLineNum = 636;BA.debugLine="If (saat_toMin(tim2)-ezaf_min)>0 Then";
if ((_saat_tomin(_ba,_tim2)-_ezaf_min)>0) { 
 //BA.debugLineNum = 638;BA.debugLine="tm1=min_toSaat(saat_toMin(tim2)-ezaf_min)";
_tm1 = _min_tosaat(_ba,(int) (_saat_tomin(_ba,_tim2)-_ezaf_min));
 //BA.debugLineNum = 639;BA.debugLine="ls_result.Add(tm1)";
_ls_result.Add((Object)(_tm1));
 //BA.debugLineNum = 640;BA.debugLine="ls_result.Add(1)";
_ls_result.Add((Object)(1));
 }else {
 //BA.debugLineNum = 643;BA.debugLine="tm1=min_toSaat(1440-(ezaf_min-saat_toMin(tim2)))";
_tm1 = _min_tosaat(_ba,(int) (1440-(_ezaf_min-_saat_tomin(_ba,_tim2))));
 //BA.debugLineNum = 644;BA.debugLine="ls_result.Add(tm1)";
_ls_result.Add((Object)(_tm1));
 //BA.debugLineNum = 646;BA.debugLine="If (saat_toMin(tim2)>tm1)Then";
if ((_saat_tomin(_ba,_tim2)>(double)(Double.parseDouble(_tm1)))) { 
 //BA.debugLineNum = 647;BA.debugLine="ls_result.Add(1)";
_ls_result.Add((Object)(1));
 }else {
 //BA.debugLineNum = 649;BA.debugLine="ls_result.Add(2)";
_ls_result.Add((Object)(2));
 };
 };
 //BA.debugLineNum = 655;BA.debugLine="Return ls_result";
...
int _sat = 0;
int _dag = 0;
 //BA.debugLineNum = 669;BA.debugLine="Sub min_toSaat (min1 As Int) As String";
 //BA.debugLineNum = 670;BA.debugLine="Dim sat As Int=min1/60";
_sat = (int) (_min1/(double)60);
 //BA.debugLineNum = 671;BA.debugLine="Dim dag As Int=min1 Mod 60";
_dag = (int) (_min1%60);
 //BA.debugLineNum = 673;BA.debugLine="Return sat&\":\"&dag";
...
int _dag_tim2 = 0;
 //BA.debugLineNum = 658;BA.debugLine="Sub saat_toMin (tim As String) As Int";
 //BA.debugLineNum = 659;BA.debugLine="Dim strfun As StringFunctions";
_strfun = new adr.stringfunctions.stringfunctions();
 //BA.debugLineNum = 660;BA.debugLine="strfun.Initialize";
_strfun._initialize((_ba.processBA == null ? _ba : _ba.processBA));
 //BA.debugLineNum = 661;BA.debugLine="Dim ls_tim2 As List";
_ls_tim2 = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 662;BA.debugLine="ls_tim2.Initialize";
_ls_tim2.Initialize();
 //BA.debugLineNum = 663;BA.debugLine="ls_tim2=strfun.Split(tim,\":\")";
_ls_tim2 = _strfun._vvvvvv5(_tim,":");
 //BA.debugLineNum = 665;BA.debugLine="Dim dag_tim2 As Int =(ls_tim2.Get(0)*60)+ls_tim2.";
_dag_tim2 = (int) (((double)(BA.ObjectToNumber(_ls_tim2.Get((int) (0))))*60)+(double)(BA.ObjectToNumber(_ls_tim2.Get((int) (1)))));
 //BA.debugLineNum = 666;BA.debugLine="Return  dag_tim2";
...
public static String  _show_num_pool(anywheresoftware.b4a.BA _ba,int _num) throws Exception{
 ...
 //BA.debugLineNum = 151;BA.debugLine="Return NumberFormat(num,0,0)";
