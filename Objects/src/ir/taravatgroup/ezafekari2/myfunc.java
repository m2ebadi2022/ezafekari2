...
String _tm1 = "";
 ...
 //BA.debugLineNum = 666;BA.debugLine="Dim ls_result As List";
_ls_result = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 667;BA.debugLine="ls_result.Initialize";
_ls_result.Initialize();
 //BA.debugLineNum = 669;BA.debugLine="Dim tm1 As String=\"\"";
_tm1 = "";
 //BA.debugLineNum = 670;BA.debugLine="If (saat_toMin(tim2)-ezaf_min)>0 Then";
if ((_saat_tomin(_ba,_tim2)-_ezaf_min)>0) { 
 //BA.debugLineNum = 672;BA.debugLine="tm1=min_toSaat(saat_toMin(tim2)-ezaf_min)";
_tm1 = _min_tosaat(_ba,(int) (_saat_tomin(_ba,_tim2)-_ezaf_min));
 //BA.debugLineNum = 673;BA.debugLine="ls_result.Add(tm1)";
_ls_result.Add((Object)(_tm1));
 //BA.debugLineNum = 674;BA.debugLine="ls_result.Add(1)";
_ls_result.Add((Object)(1));
 }else {
 //BA.debugLineNum = 681;BA.debugLine="If(1440-(ezaf_min-saat_toMin(tim2))<0) Then";
if ((1440-(_ezaf_min-_saat_tomin(_ba,_tim2))<0)) { 
 //BA.debugLineNum = 684;BA.debugLine="ls_result.Add(3)";
_ls_result.Add((Object)(3));
 //BA.debugLineNum = 685;BA.debugLine="ls_result.Add(3)";
_ls_result.Add((Object)(3));
 //BA.debugLineNum = 686;BA.debugLine="Return  ls_result";
if (true) return _ls_result;
 }else {
 //BA.debugLineNum = 688;BA.debugLine="tm1=min_toSaat(1440-(ezaf_min-saat_toMin(tim2)";
_tm1 = _min_tosaat(_ba,(int) (1440-(_ezaf_min-_saat_tomin(_ba,_tim2))));
 };
 //BA.debugLineNum = 691;BA.debugLine="ls_result.Add(tm1)";
_ls_result.Add((Object)(_tm1));
 //BA.debugLineNum = 695;BA.debugLine="If (saat_toMin(tim2)>saat_toMin(tm1))Then";
if ((_saat_tomin(_ba,_tim2)>_saat_tomin(_ba,_tm1))) { 
 //BA.debugLineNum = 696;BA.debugLine="ls_result.Add(1)";
_ls_result.Add((Object)(1));
 }else {
 //BA.debugLineNum = 698;BA.debugLine="ls_result.Add(2)";
_ls_result.Add((Object)(2));
 };
 };
 //BA.debugLineNum = 704;BA.debugLine="Return ls_result";
if (true) return _ls_result;
...
int _saatkari_inweek = 0;
 //BA.debugLineNum = 733;BA.debugLine="Sub get_saatKari_inWeek (dayID As Int) As Int";
 //BA.debugLineNum = 734;BA.debugLine="Dim saatKari_InWeek As Int=0";
_saatkari_inweek = (int) (0);
 //BA.debugLineNum = 736;BA.debugLine="Select dayID";
switch (_dayid) {
case 1: {
 //BA.debugLineNum = 738;BA.debugLine="saatKari_InWeek=dbCode.get_setting_byName(\"saat";
_saatkari_inweek = (int)(Double.parseDouble(mostCurrent._dbcode._get_setting_byname /*String*/ (_ba,"saat_kar_Shanbe")));
 break; }
case 2: {
 //BA.debugLineNum = 740;BA.debugLine="saatKari_InWeek=dbCode.get_setting_byName(\"saat";
_saatkari_inweek = (int)(Double.parseDouble(mostCurrent._dbcode._get_setting_byname /*String*/ (_ba,"saat_kar_Yekshanbe")));
 break; }
case 3: {
 //BA.debugLineNum = 742;BA.debugLine="saatKari_InWeek=dbCode.get_setting_byName(\"saat";
_saatkari_inweek = (int)(Double.parseDouble(mostCurrent._dbcode._get_setting_byname /*String*/ (_ba,"saat_kar_Doshanbe")));
 break; }
case 4: {
 //BA.debugLineNum = 744;BA.debugLine="saatKari_InWeek=dbCode.get_setting_byName(\"saat";
_saatkari_inweek = (int)(Double.parseDouble(mostCurrent._dbcode._get_setting_byname /*String*/ (_ba,"saat_kar_Seshanbe")));
 break; }
case 5: {
 //BA.debugLineNum = 746;BA.debugLine="saatKari_InWeek=dbCode.get_setting_byName(\"saat";
_saatkari_inweek = (int)(Double.parseDouble(mostCurrent._dbcode._get_setting_byname /*String*/ (_ba,"saat_kar_Charshanbe")));
 break; }
case 6: {
 //BA.debugLineNum = 748;BA.debugLine="saatKari_InWeek=dbCode.get_setting_byName(\"saat";
_saatkari_inweek = (int)(Double.parseDouble(mostCurrent._dbcode._get_setting_byname /*String*/ (_ba,"saat_kar_Panjshanbe")));
 break; }
case 7: {
 //BA.debugLineNum = 750;BA.debugLine="saatKari_InWeek=Main.saat_kar_min";
_saatkari_inweek = mostCurrent._main._saat_kar_min /*int*/ ;
 break; }
}
;
 //BA.debugLineNum = 755;BA.debugLine="Return saatKari_InWeek";
...
int _sat = 0;
int _dag = 0;
 //BA.debugLineNum = 724;BA.debugLine="Sub min_toSaat (min1 As Int) As String";
 //BA.debugLineNum = 725;BA.debugLine="Dim sat As Int=min1/60";
_sat = (int) (_min1/(double)60);
 //BA.debugLineNum = 726;BA.debugLine="Dim dag As Int=min1 Mod 60";
_dag = (int) (_min1%60);
 //BA.debugLineNum = 729;BA.debugLine="Return convert_adad(sat)&\":\"&convert_adad(dag)";
if (true) return _convert_adad(_ba,_sat)+":"+_convert_adad(_ba,_dag);
...
int _sa1 = 0;
int _dag1 = 0;
 //BA.debugLineNum = 707;BA.debugLine="Sub saat_toMin (tim As String) As Int";
 //BA.debugLineNum = 709;BA.debugLine="Dim strfun As StringFunctions";
_strfun = new adr.stringfunctions.stringfunctions();
 //BA.debugLineNum = 710;BA.debugLine="strfun.Initialize";
_strfun._initialize((_ba.processBA == null ? _ba : _ba.processBA));
 //BA.debugLineNum = 711;BA.debugLine="Dim ls_tim2 As List";
_ls_tim2 = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 712;BA.debugLine="ls_tim2.Initialize";
_ls_tim2.Initialize();
 //BA.debugLineNum = 713;BA.debugLine="ls_tim2=strfun.Split(tim,\":\")";
_ls_tim2 = _strfun._vvvvvv5(_tim,":");
 //BA.debugLineNum = 715;BA.debugLine="Dim sa1 As Int =ls_tim2.Get(0)";
_sa1 = (int)(BA.ObjectToNumber(_ls_tim2.Get((int) (0))));
 //BA.debugLineNum = 716;BA.debugLine="Dim dag1 As Int =ls_tim2.Get(1)";
_dag1 = (int)(BA.ObjectToNumber(_ls_tim2.Get((int) (1))));
 //BA.debugLineNum = 721;BA.debugLine="Return  (sa1*60)+dag1";
...
if (true) return (int) (_rozha+1);
			...
			(_ba.processBA == null ? _ba : _ba.processBA).setLastException(e29); //BA.debugLineNum = 493;BA.debugLine="ToastMessageShow(\"خطا\",False)";
