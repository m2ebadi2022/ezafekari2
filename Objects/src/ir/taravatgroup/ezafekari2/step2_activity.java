...
public static anywheresoftware.b4a.objects.Timer _time_pass = null;
...
public anywheresoftware.b4a.objects.EditTextWrapper _et_pass = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 75;BA.debugLine="If(File.Exists(File.DirInternal,\"phonNum\"))Then";
if ((anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"phonNum"))) { 
 //BA.debugLineNum = 76;BA.debugLine="Activity.LoadLayout(\"step2\")";
mostCurrent._activity.LoadLayout("step2",mostCurrent.activityBA);
 //BA.debugLineNum = 78;BA.debugLine="Main.phon_num=File.ReadString(File.DirInternal,\"";
mostCurrent._main._phon_num /*String*/  = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"phonNum");
 //BA.debugLineNum = 81;BA.debugLine="If(myfunc.check_karid=False)Then";
if ((mostCurrent._myfunc._check_karid /*boolean*/ (mostCurrent.activityBA)==anywheresoftware.b4a.keywords.Common.False)) { 
 //BA.debugLineNum = 82;BA.debugLine="lbl_noske.Text=\"نسخه هدیه\"";
mostCurrent._lbl_noske.setText(BA.ObjectToCharSequence("نسخه هدیه"));
 //BA.debugLineNum = 83;BA.debugLine="type_app=0";
_type_app = (int) (0);
 }else {
 //BA.debugLineNum = 85;BA.debugLine="lbl_noske.Text=\"نسخه طلایی\"";
mostCurrent._lbl_noske.setText(BA.ObjectToCharSequence("نسخه طلایی"));
 //BA.debugLineNum = 86;BA.debugLine="type_app=1";
_type_app = (int) (1);
 };
 //BA.debugLineNum = 89;BA.debugLine="If (Main.backup_page_show=1)Then";
if ((mostCurrent._main._backup_page_show /*int*/ ==1)) { 
 //BA.debugLineNum = 90;BA.debugLine="pan_all_sendBackup.Visible=True";
mostCurrent._pan_all_sendbackup.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 91;BA.debugLine="pan_progressBar.Visible=True";
mostCurrent._pan_progressbar.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 92;BA.debugLine="ProgressBar1.Enabled=True";
mostCurrent._progressbar1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 93;BA.debugLine="ProgressDialogShow2(\"پشتیبان گیری آنلاین ...\",F";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow2(mostCurrent.activityBA,BA.ObjectToCharSequence("پشتیبان گیری آنلاین ..."),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 95;BA.debugLine="pan_all_sendBackup.Visible=False";
mostCurrent._pan_all_sendbackup.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 96;BA.debugLine="ProgressDialogShow(\"بارگذاری ...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("بارگذاری ..."));
 };
 //BA.debugLineNum = 101;BA.debugLine="CC.Initialize(\"CC\")";
_cc.Initialize("CC");
 //BA.debugLineNum = 102;BA.debugLine="Url_Php_Page=\"https://taravatgroup.ir/avatar_up1";
mostCurrent._url_php_page = "https://taravatgroup.ir/avatar_up1.php";
 //BA.debugLineNum = 104;BA.debugLine="If FirstTime Then";
if (_firsttime) { 
 //BA.debugLineNum = 105;BA.debugLine="Up.B4A_log=True";
mostCurrent._up.B4A_log = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 106;BA.debugLine="Up.Initialize(\"Up\")";
mostCurrent._up.Initialize(processBA,"Up");
 };
 //BA.debugLineNum = 110;BA.debugLine="http_initial_1(1)";
_http_initial_1((int) (1));
 //BA.debugLineNum = 111;BA.debugLine="time_pass.Initialize(\"time_pass1\", 1000)";
_time_pass.Initialize(processBA,"time_pass1",(long) (1000));
 //BA.debugLineNum = 122;BA.debugLine="Label12.Color=Main.color4";
mostCurrent._label12.setColor(mostCurrent._main._color4 /*int*/ );
 //BA.debugLineNum = 123;BA.debugLine="Panel12.Color=Main.color4";
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 129;BA.debugLine="StartActivity(step0_activity)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._step0_activity.getObject()));
 };
 //BA.debugLineNum = 136;BA.debugLine="tim_send_backup.Initialize(\"tim_send_backup\",4500";
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 531;BA.debugLine="If(pan_all_edit.Visible=True)Then";
if ((mostCurrent._pan_all_edit.getVisible()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 532;BA.debugLine="lbl_back_Click";
_lbl_back_click();
 }else if((mostCurrent._pan_all_msg.getVisible()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 534;BA.debugLine="pan_all_msg.Visible=False";
mostCurrent._pan_all_msg.setVisible(anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 536;BA.debugLine="lbl_back_Shmsg_Click";
_lbl_back_shmsg_click();
 }else {
 //BA.debugLineNum = 538;BA.debugLine="lbl_back_home_Click";
_lbl_back_home_click();
 };
 //BA.debugLineNum = 541;BA.debugLine="Return True";
if (true) return anywheresoftware.b4a.keywords.Common.True;
 }else {
 //BA.debugLineNum = 543;BA.debugLine="Return False";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 19;BA.debugLine="Private pan_all_edit As Panel";
mostCurrent._pan_all_edit = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private et_email As EditText";
mostCurrent._et_email = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Private et_nameFamili As EditText";
mostCurrent._et_namefamili = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Private lbl_noske As Label";
mostCurrent._lbl_noske = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Private lbl_nameFamili As Label";
mostCurrent._lbl_namefamili = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Private lbl_email As Label";
mostCurrent._lbl_email = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Dim my_ramz As String=\"\"";
mostCurrent._my_ramz = "";
 //BA.debugLineNum = 27;BA.debugLine="Dim http3 As HttpJob";
mostCurrent._http3 = new ir.taravatgroup.ezafekari2.httpjob();
 //BA.debugLineNum = 28;BA.debugLine="Private lbl_phoneNum As Label";
mostCurrent._lbl_phonenum = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Dim Up As UploadFilePhp";
mostCurrent._up = new com.spinter.uploadfilephp.UploadFilePhp();
 //BA.debugLineNum = 32;BA.debugLine="Dim Url_Php_Page As String";
mostCurrent._url_php_page = "";
 //BA.debugLineNum = 33;BA.debugLine="Private img_p_edit As ImageView";
mostCurrent._img_p_edit = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 34;BA.debugLine="Private img_pofil As ImageView";
mostCurrent._img_pofil = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 36;BA.debugLine="Dim Path_Phone_Image As String";
mostCurrent._path_phone_image = "";
 //BA.debugLineNum = 40;BA.debugLine="Dim picName As String=\"\"";
mostCurrent._picname = "";
 //BA.debugLineNum = 41;BA.debugLine="Dim bmp As Bitmap";
mostCurrent._bmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 42;BA.debugLine="Private lbl_image_up As Label";
mostCurrent._lbl_image_up = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 45;BA.debugLine="Dim pp As Phone";
mostCurrent._pp = new anywheresoftware.b4a.phone.Phone();
 //BA.debugLineNum = 46;BA.debugLine="Dim type_app As Int=1";
_type_app = (int) (1);
 //BA.debugLineNum = 48;BA.debugLine="Private pan_all_msg As Panel";
mostCurrent._pan_all_msg = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 49;BA.debugLine="Private et_msg As EditText";
mostCurrent._et_msg = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 50;BA.debugLine="Private lbl_icon_up As Label";
mostCurrent._lbl_icon_up = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 51;BA.debugLine="Dim tempFile As String=\"\"";
mostCurrent._tempfile = "";
 //BA.debugLineNum = 52;BA.debugLine="Dim user_key As String=\"\"";
mostCurrent._user_key = "";
 //BA.debugLineNum = 54;BA.debugLine="Private wb_show_myMsg As WebView";
mostCurrent._wb_show_mymsg = new anywheresoftware.b4a.objects.WebViewWrapper();
 //BA.debugLineNum = 55;BA.debugLine="Private pan_all_show_myMsg As Panel";
mostCurrent._pan_all_show_mymsg = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 56;BA.debugLine="Private lbl_icon_noUp As Label";
mostCurrent._lbl_icon_noup = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 57;BA.debugLine="Private Label12 As Label";
mostCurrent._label12 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 58;BA.debugLine="Private Panel12 As Panel";
mostCurrent._panel12 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 60;BA.debugLine="Private pan_all_sendBackup As Panel";
...
mostCurrent._progressbar1 = new anywheresoftware.b4a.objects.ProgressBarWrapper();
 //BA.debugLineNum = 62;BA.debugLine="Private pan_progressBar As Panel";
mostCurrent._pan_progressbar = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 63;BA.debugLine="Private lbl_progressBar1 As Label";
mostCurrent._lbl_progressbar1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 64;BA.debugLine="Private et_pass As EditText";
mostCurrent._et_pass = new anywheresoftware.b4a.objects.EditTextWrapper();
...
String _send = "";
int _exist_pic = 0;
 //BA.debugLineNum = 200;BA.debugLine="Sub http_initial_1(type1 As Int)";
 //BA.debugLineNum = 201;BA.debugLine="Try";
try { //BA.debugLineNum = 204;BA.debugLine="If (myfunc.check_internet=False)Then";
if ((mostCurrent._myfunc._check_internet /*boolean*/ (mostCurrent.activityBA)==anywheresoftware.b4a.keywords.Common.False)) { 
 //BA.debugLineNum = 205;BA.debugLine="myfunc.help_man(\"توجه\",\"اتصال اینترنت را بررسی";
mostCurrent._myfunc._help_man /*String*/ (mostCurrent.activityBA,"توجه","اتصال اینترنت را بررسی کنید !");
 }else {
 //BA.debugLineNum = 210;BA.debugLine="If(type1=1)Then";
if ((_type1==1)) { 
 //BA.debugLineNum = 212;BA.debugLine="http3.Initialize(\"ht1\",Me)";
mostCurrent._http3._initialize /*String*/ (processBA,"ht1",step2_activity.getObject());
 //BA.debugLineNum = 213;BA.debugLine="Dim send As String= \"var=3&phone=\"&Main.phon_n";
_send = "var=3&phone="+mostCurrent._main._phon_num /*String*/ +"&type_app="+BA.NumberToString(_type_app)+"&div_id="+mostCurrent._pp.GetSettings("android_id")+"&div_model="+mostCurrent._pp.getModel();
 //BA.debugLineNum = 214;BA.debugLine="http3.PostString(\"https://taravatgroup.ir/save";
mostCurrent._http3._poststring /*String*/ ("https://taravatgroup.ir/save_acc.php",_send);
 }else if((_type1==2)) { 
 //BA.debugLineNum = 218;BA.debugLine="Dim exist_pic As Int=0";
_exist_pic = (int) (0);
 //BA.debugLineNum = 219;BA.debugLine="If(File.Exists(Starter.Provider.SharedFolder,p";
if ((anywheresoftware.b4a.keywords.Common.File.Exists(mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,mostCurrent._picname))) { 
 //BA.debugLineNum = 220;BA.debugLine="upload_img(Starter.Provider.SharedFolder&\"/\"&";
_upload_img(mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ +"/"+mostCurrent._picname);
 //BA.debugLineNum = 221;BA.debugLine="exist_pic=1";
_exist_pic = (int) (1);
 };
 //BA.debugLineNum = 224;BA.debugLine="http3.Initialize(\"ht2\",Me)";
mostCurrent._http3._initialize /*String*/ (processBA,"ht2",step2_activity.getObject());
 //BA.debugLineNum = 225;BA.debugLine="Dim send As String=\"var=2&name=\"&et_nameFamili";
_send = "var=2&name="+mostCurrent._et_namefamili.getText()+"&code="+mostCurrent._et_pass.getText()+"&email="+mostCurrent._et_email.getText()+"&phone="+mostCurrent._main._phon_num /*String*/ +"&exist_pic="+BA.NumberToString(_exist_pic)+"&pic_name="+mostCurrent._picname;
 //BA.debugLineNum = 226;BA.debugLine="http3.PostString(\"https://taravatgroup.ir/save";
mostCurrent._http3._poststring /*String*/ ("https://taravatgroup.ir/save_acc.php",_send);
 }else if((_type1==3)) { 
 //BA.debugLineNum = 231;BA.debugLine="http3.Initialize(\"ht3\",Me)";
mostCurrent._http3._initialize /*String*/ (processBA,"ht3",step2_activity.getObject());
 //BA.debugLineNum = 232;BA.debugLine="Dim send As String= \"var=4&phone=\"&Main.phon_n";
_send = "var=4&phone="+mostCurrent._main._phon_num /*String*/ +"&name="+mostCurrent._lbl_namefamili.getText();
 //BA.debugLineNum = 233;BA.debugLine="http3.PostString(\"https://taravatgroup.ir/save";
mostCurrent._http3._poststring /*String*/ ("https://taravatgroup.ir/save_acc.php",_send);
 }else if((_type1==4)) { 
 //BA.debugLineNum = 236;BA.debugLine="http3.Initialize(\"ht4\",Me)";
mostCurrent._http3._initialize /*String*/ (processBA,"ht4",step2_activity.getObject());
 //BA.debugLineNum = 237;BA.debugLine="Dim send As String= \"var=5&phone=\"&Main.phon_n";
_send = "var=5&phone="+mostCurrent._main._phon_num /*String*/ +"&name="+mostCurrent._lbl_namefamili.getText();
 //BA.debugLineNum = 238;BA.debugLine="http3.PostString(\"https://taravatgroup.ir/save";
mostCurrent._http3._poststring /*String*/ ("https://taravatgroup.ir/save_acc.php",_send);
 }else if((_type1==5)) { 
 //BA.debugLineNum = 241;BA.debugLine="If(File.Exists(Starter.Provider.SharedFolder,t";
if ((anywheresoftware.b4a.keywords.Common.File.Exists(mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,mostCurrent._tempfile))) { 
 //BA.debugLineNum = 242;BA.debugLine="upload_file(Starter.Provider.SharedFolder&\"/\"";
_upload_file(mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ +"/"+mostCurrent._tempfile);
 ...
 //BA.debugLineNum = 244;BA.debugLine="tempFile=\"\"";
mostCurrent._tempfile = "";
 };
 //BA.debugLineNum = 247;BA.debugLine="If(et_msg.Text.Trim=\"\")Then";
if (((mostCurrent._et_msg.getText().trim()).equals(""))) { 
 //BA.debugLineNum = 248;BA.debugLine="ToastMessageShow(\"کادر پیام خالی است\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("کادر پیام خالی است"),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 251;BA.debugLine="http3.Initialize(\"ht5\",Me)";
mostCurrent._http3._initialize /*String*/ (processBA,"ht5",step2_activity.getObject());
 //BA.debugLineNum = 252;BA.debugLine="Dim send As String= \"var=6&phone=\"&Main.phon_";
_send = "var=6&phone="+mostCurrent._main._phon_num /*String*/ +"&msg="+mostCurrent._et_msg.getText()+"&file_name="+mostCurrent._tempfile+"&name="+mostCurrent._lbl_namefamili.getText();
 //BA.debugLineNum = 253;BA.debugLine="http3.PostString(\"https://taravatgroup.ir/sav";
mostCurrent._http3._poststring /*String*/ ("https://taravatgroup.ir/save_acc.php",_send);
 //BA.debugLineNum = 254;BA.debugLine="pan_all_msg.Visible=False";
mostCurrent._pan_all_msg.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 }else if((_type1==6)) { 
 //BA.debugLineNum = 261;BA.debugLine="http3.Initialize(\"ht7\", Me)";
mostCurrent._http3._initialize /*String*/ (processBA,"ht7",step2_activity.getObject());
 //BA.debugLineNum = 262;BA.debugLine="http3.Download(\"https://taravatgroup.ir/avatar";
mostCurrent._http3._download /*String*/ ("https://taravatgroup.ir/avatar_ezaf_users/"+mostCurrent._picname);
 }else if((_type1==7)) { 
 //BA.debugLineNum = 265;BA.debugLine="http3.Initialize(\"ht8\", Me)";
mostCurrent._http3._initialize /*String*/ (processBA,"ht8",step2_activity.getObject());
 //BA.debugLineNum = 267;BA.debugLine="Dim send As String= \"var=1&phone=\"&Main.phon_n";
_send = "var=1&phone="+mostCurrent._main._phon_num /*String*/ +"&key=mME22eBbA20aDd1401";
 //BA.debugLineNum = 268;BA.debugLine="http3.PostString(\"https://taravatgroup.ir/user";
mostCurrent._http3._poststring /*String*/ ("https://taravatgroup.ir/user_msg.php",_send);
 }else if((_type1==8)) { 
 //BA.debugLineNum = 273;BA.debugLine="http3.Initialize(\"ht9\",Me)";
mostCurrent._http3._initialize /*String*/ (processBA,"ht9",step2_activity.getObject());
 //BA.debugLineNum = 274;BA.debugLine="Dim send As String= \"var=7&phone=\"&Main.phon_n";
_send = "var=7&phone="+mostCurrent._main._phon_num /*String*/ +"&div_id="+mostCurrent._pp.GetSettings("android_id");
 //BA.debugLineNum = 275;BA.debugLine="http3.PostString(\"https://taravatgroup.ir/save";
mostCurrent._http3._poststring /*String*/ ("https://taravatgroup.ir/save_acc.php",_send);
 };
 };
 } 
       catch (Exception e54) {
			processBA.setLastException(e54); //BA.debugLineNum = 287;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("365667159",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
anywheresoftware.b4a.objects.collections.List _ls_user = null;
 //BA.debugLineNum = 296;BA.debugLine="Sub Jobdone (job As HttpJob)";
 //BA.debugLineNum = 297;BA.debugLine="Try";
try { //BA.debugLineNum = 299;BA.debugLine="If job.Success = True Then";
if (_job._success /*boolean*/ ==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 301;BA.debugLine="If job.JobName=\"ht1\" Then";
if ((_job._jobname /*String*/ ).equals("ht1")) { 
 //BA.debugLineNum = 302;BA.debugLine="If(job.GetString.Contains(\"nouser\"))Then";
if ((_job._getstring /*String*/ ().contains("nouser"))) { 
 //BA.debugLineNum = 304;BA.debugLine="File.Delete(File.DirInternal,\"userAcc\")";
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 308;BA.debugLine="StartActivity(step0_activity)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._step0_activity.getObject()));
 }else {
 //BA.debugLineNum = 312;BA.debugLine="Dim a() As String";
_a = new String[(int) (0)];
java.util.Arrays.fill(_a,"");
 //BA.debugLineNum = 313;BA.debugLine="a=Regex.Split(\"&\",job.GetString)";
_a = anywheresoftware.b4a.keywords.Common.Regex.Split("&",_job._getstring /*String*/ ());
 //BA.debugLineNum = 315;BA.debugLine="lbl_nameFamili.Text=a(0)";
mostCurrent._lbl_namefamili.setText(BA.ObjectToCharSequence(_a[(int) (0)]));
 //BA.debugLineNum = 316;BA.debugLine="lbl_email.Text=a(1)";
mostCurrent._lbl_email.setText(BA.ObjectToCharSequence(_a[(int) (1)]));
 //BA.debugLineNum = 325;BA.debugLine="lbl_phoneNum.Text=a(2)";
mostCurrent._lbl_phonenum.setText(BA.ObjectToCharSequence(_a[(int) (2)]));
 //BA.debugLineNum = 327;BA.debugLine="user_key=a(4)";
mostCurrent._user_key = _a[(int) (4)];
 //BA.debugLineNum = 328;BA.debugLine="my_ramz=a(5)";
mostCurrent._my_ramz = _a[(int) (5)];
 //BA.debugLineNum = 331;BA.debugLine="If(my_ramz=\"none2026none\")Then";
if (((mostCurrent._my_ramz).equals("none2026none"))) { 
 //BA.debugLineNum = 334;BA.debugLine="time_pass.Enabled = True";
_time_pass.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 339;BA.debugLine="If(Main.msg_page_show=1)Then";
if ((mostCurrent._main._msg_page_show /*int*/ ==1)) { 
 //BA.debugLineNum = 340;BA.debugLine="lbl_all_msg_Click";
_lbl_all_msg_click();
 }else if((mostCurrent._main._backup_page_show /*int*/ ==1)) { 
 //BA.debugLineNum = 342;BA.debugLine="tim_send_backup.Enabled=True";
_tim_send_backup.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 347;BA.debugLine="File.WriteList(File.DirInternal,\"userAcc\",a)";
...
_job._release /*String*/ ();
 //BA.debugLineNum = 351;BA.debugLine="picName=\"user-\"&Main.phon_num&\"-\"&a(4)&\".jpg\"";
mostCurrent._picname = "user-"+mostCurrent._main._phon_num /*String*/ +"-"+_a[(int) (4)]+".jpg";
 //BA.debugLineNum = 352;BA.debugLine="If(File.Exists(File.DirInternal,picName)=Fals";
if ((anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),mostCurrent._picname)==anywheresoftware.b4a.keywords.Common.False)) { 
 //BA.debugLineNum = 353;BA.debugLine="If(a(3)=\"1\")Then";
if (((_a[(int) (3)]).equals("1"))) { 
 //BA.debugLineNum = 354;BA.debugLine="job.Release";
_job._release /*String*/ ();
 //BA.debugLineNum = 355;BA.debugLine="http_initial_1(6)";
_http_initial_1((int) (6));
 };
 }else {
 //BA.debugLineNum = 358;BA.debugLine="img_pofil.Bitmap=myfunc.CircleImage( LoadBit";
mostCurrent._img_pofil.setBitmap((android.graphics.Bitmap)(mostCurrent._myfunc._circleimage /*anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper*/ (mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),mostCurrent._picname)).getObject()));
 //BA.debugLineNum = 359;BA.debugLine="img_p_edit.Bitmap=myfunc.CircleImage( LoadBi";
mostCurrent._img_p_edit.setBitmap((android.graphics.Bitmap)(mostCurrent._myfunc._circleimage /*anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper*/ (mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),mostCurrent._picname)).getObject()));
 ...
 //BA.debugLineNum = 373;BA.debugLine="If(job.GetString.Contains(\"true\"))Then";
if ((_job._getstring /*String*/ ().contains("true"))) { 
 //BA.debugLineNum = 374;BA.debugLine="job.Release";
_job._release /*String*/ ();
 //BA.debugLineNum = 375;BA.debugLine="http_initial_1(1)";
_http_initial_1((int) (1));
 //BA.debugLineNum = 376;BA.debugLine="lbl_back_Click";
_lbl_back_click();
 };
 }else if((_job._jobname /*String*/ ).equals("ht3")) { 
 //BA.debugLineNum = 381;BA.debugLine="If(job.GetString.Contains(\"ok_add\"))Then";
if ((_job._getstring /*String*/ ().contains("ok_add"))) { 
 //BA.debugLineNum = 382;BA.debugLine="MsgboxAsync(\"درخواست شما با موفقیت ثبت گردید";
anywheresoftware.b4a.keywords.Common.MsgboxAsync(BA.ObjectToCharSequence("درخواست شما با موفقیت ثبت گردید ونتیجه آن در اصرع وقت به اطلاع شما خواهد رسید. با تشکر "),BA.ObjectToCharSequence("پیام"),processBA);
 ...
 //BA.debugLineNum = 384;BA.debugLine="MsgboxAsync(\"خطا در ارسال درخواست، دوباره امت";
anywheresoftware.b4a.keywords.Common.MsgboxAsync(BA.ObjectToCharSequence("خطا در ارسال درخواست، دوباره امتحان کنید."),BA.ObjectToCharSequence("خطا"),processBA);
 ...
 //BA.debugLineNum = 389;BA.debugLine="If(job.GetString.Contains(\"ok_add\"))Then";
if ((_job._getstring /*String*/ ().contains("ok_add"))) { 
 //BA.debugLineNum = 390;BA.debugLine="MsgboxAsync(\"درخواست شما با موفقیت ثبت گردید";
anywheresoftware.b4a.keywords.Common.MsgboxAsync(BA.ObjectToCharSequence("درخواست شما با موفقیت ثبت گردید ونتیجه آن در اصرع وقت به اطلاع شما خواهد رسید. با تشکر "),BA.ObjectToCharSequence("پیام"),processBA);
 }else {
 //BA.debugLineNum = 392;BA.debugLine="MsgboxAsync(\"خطا در ارسال درخواست، دوباره امت";
anywheresoftware.b4a.keywords.Common.MsgboxAsync(BA.ObjectToCharSequence("خطا در ارسال درخواست، دوباره امتحان کنید."),BA.ObjectToCharSequence("خطا"),processBA);
 };
 }else if((_job._jobname /*String*/ ).equals("ht5")) { 
 //BA.debugLineNum = 397;BA.debugLine="If(job.GetString.Contains(\"ok_add\"))Then";
if ((_job._getstring /*String*/ ().contains("ok_add"))) { 
 //BA.debugLineNum = 398;BA.debugLine="MsgboxAsync(\"پیغام شما با موفقیت ثبت گردید ون";
anywheresoftware.b4a.keywords.Common.MsgboxAsync(BA.ObjectToCharSequence("پیغام شما با موفقیت ثبت گردید ونتیجه آن در اصرع وقت به اطلاع شما خواهد رسید. با تشکر "),BA.ObjectToCharSequence("پیام"),processBA);
 ...
 //BA.debugLineNum = 401;BA.debugLine="MsgboxAsync(\"خطا در ارسال پیغام، دوباره امتحا";
anywheresoftware.b4a.keywords.Common.MsgboxAsync(BA.ObjectToCharSequence("خطا در ارسال پیغام، دوباره امتحان کنید."),BA.ObjectToCharSequence("خطا"),processBA);
 ...
 //BA.debugLineNum = 407;BA.debugLine="Dim out As OutputStream = File.OpenOutput(File";
...
_out = anywheresoftware.b4a.keywords.Common.File.OpenOutput(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"db.db",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 408;BA.debugLine="File.Copy2(http3.GetInputStream, out)";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 411;BA.debugLine="myfunc.help_man(\"تبریک\",\"اطلاعات بازگردانده شد";
mostCurrent._myfunc._help_man /*String*/ (mostCurrent.activityBA,"تبریک","اطلاعات بازگردانده شد ، برای اعمال تغییرات یک بار از برنامه خارج و دوباره وارد شوید.");
 //BA.debugLineNum = 412;BA.debugLine="ToastMessageShow(\"اطلاعات بازگردانده شد\",False";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("اطلاعات بازگردانده شد"),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 421;BA.debugLine="Dim bmp As Bitmap = job.GetBitmap";
mostCurrent._bmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
mostCurrent._bmp = _job._getbitmap /*anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper*/ ();
 //BA.debugLineNum = 422;BA.debugLine="Dim out As OutputStream";
_out = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
 //BA.debugLineNum = 423;BA.debugLine="out = File.OpenOutput(File.DirInternal,picName";
_out = anywheresoftware.b4a.keywords.Common.File.OpenOutput(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),mostCurrent._picname,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 424;BA.debugLine="bmp.WriteToStream(out, 100, \"JPEG\")";
mostCurrent._bmp.WriteToStream((java.io.OutputStream)(_out.getObject()),(int) (100),BA.getEnumFromString(android.graphics.Bitmap.CompressFormat.class,"JPEG"));
 //BA.debugLineNum = 425;BA.debugLine="out.Close";
_out.Close();
 //BA.debugLineNum = 429;BA.debugLine="img_pofil.Bitmap=myfunc.CircleImage( LoadBitma";
mostCurrent._img_pofil.setBitmap((android.graphics.Bitmap)(mostCurrent._myfunc._circleimage /*anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper*/ (mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),mostCurrent._picname)).getObject()));
 //BA.debugLineNum = 430;BA.debugLine="img_p_edit.Bitmap=myfunc.CircleImage( LoadBitm";
mostCurrent._img_p_edit.setBitmap((android.graphics.Bitmap)(mostCurrent._myfunc._circleimage /*anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper*/ (mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),mostCurrent._picname)).getObject()));
 }else if((_job._jobname /*String*/ ).equals("ht8")) { 
 //BA.debugLineNum = 434;BA.debugLine="wb_show_myMsg.LoadHtml(job.GetString)";
mostCurrent._wb_show_mymsg.LoadHtml(_job._getstring /*String*/ ());
 }else if((_job._jobname /*String*/ ).equals("ht9")) { 
 //BA.debugLineNum = 439;BA.debugLine="Log(job.GetString)";
anywheresoftware.b4a.keywords.Common.LogImpl("365732751",_job._getstring /*String*/ (),0);
 };
 //BA.debugLineNum = 441;BA.debugLine="If (Main.backup_page_show<>1)Then";
if ((mostCurrent._main._backup_page_show /*int*/ !=1)) { 
 //BA.debugLineNum = 442;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 };
 //BA.debugLineNum = 445;BA.debugLine="job.Release";
_job._release /*String*/ ();
 }else {
 //BA.debugLineNum = 449;BA.debugLine="If(File.Exists(File.DirInternal,\"userAcc\")=True";
...
_ls_user.Initialize();
 //BA.debugLineNum = 453;BA.debugLine="ls_user=File.ReadList(File.DirInternal,\"userAc";
_ls_user = anywheresoftware.b4a.keywords.Common.File.ReadList(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"userAcc");
 //BA.debugLineNum = 455;BA.debugLine="lbl_nameFamili.Text=ls_user.Get(0)";
mostCurrent._lbl_namefamili.setText(BA.ObjectToCharSequence(_ls_user.Get((int) (0))));
 //BA.debugLineNum = 456;BA.debugLine="lbl_email.Text=ls_user.Get(1)";
mostCurrent._lbl_email.setText(BA.ObjectToCharSequence(_ls_user.Get((int) (1))));
 //BA.debugLineNum = 463;BA.debugLine="Main.phon_num=ls_user.Get(2)";
mostCurrent._main._phon_num /*String*/  = BA.ObjectToString(_ls_user.Get((int) (2)));
 //BA.debugLineNum = 464;BA.debugLine="lbl_phoneNum.Text=Main.phon_num";
mostCurrent._lbl_phonenum.setText(BA.ObjectToCharSequence(mostCurrent._main._phon_num /*String*/ ));
 //BA.debugLineNum = 466;BA.debugLine="picName=\"user-\"&Main.phon_num&\"-\"&ls_user.Get(";
mostCurrent._picname = "user-"+mostCurrent._main._phon_num /*String*/ +"-"+BA.ObjectToString(_ls_user.Get((int) (4)))+".jpg";
 //BA.debugLineNum = 468;BA.debugLine="img_pofil.Bitmap=myfunc.CircleImage( LoadBitma";
mostCurrent._img_pofil.setBitmap((android.graphics.Bitmap)(mostCurrent._myfunc._circleimage /*anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper*/ (mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),mostCurrent._picname)).getObject()));
 //BA.debugLineNum = 469;BA.debugLine="img_p_edit.Bitmap=myfunc.CircleImage( LoadBitm";
mostCurrent._img_p_edit.setBitmap((android.graphics.Bitmap)(mostCurrent._myfunc._circleimage /*anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper*/ (mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),mostCurrent._picname)).getObject()));
 };
 };
 } 
       catch (Exception e101) {
			processBA.setLastException(e101); //BA.debugLineNum = 477;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("365732789",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 //BA.debugLineNum = 478;BA.debugLine="ToastMessageShow(\"خطا در اتصال\",False)";
...
public static String  _lbl_all_msg_click() throws Exception{
 //BA.debugLineNum = 754;BA.debugLine="Private Sub lbl_all_msg_Click";
 //BA.debugLineNum = 755;BA.debugLine="ProgressDialogShow(\"بارگذاری ...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("بارگذاری ..."));
 //BA.debugLineNum = 756;BA.debugLine="http_initial_1(7)";
_http_initial_1((int) (7));
 //BA.debugLineNum = 757;BA.debugLine="pan_all_show_myMsg.Visible=True";
...
public static String  _lbl_back_click() throws Exception{
 //BA.debugLineNum = 178;BA.debugLine="Private Sub lbl_back_Click";
 //BA.debugLineNum = 179;BA.debugLine="pan_all_edit.Visible=False";
...
public static String  _lbl_back_home_click() throws Exception{
 //BA.debugLineNum = 548;BA.debugLine="Private Sub lbl_back_home_Click";
 //BA.debugLineNum = 549;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 550;BA.debugLine="StartActivity(Main)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._main.getObject()));
 //BA.debugLineNum = 552;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_back_shmsg_click() throws Exception{
 //BA.debugLineNum = 762;BA.debugLine="Private Sub lbl_back_Shmsg_Click";
 //BA.debugLineNum = 763;BA.debugLine="pan_all_show_myMsg.Visible=False";
mostCurrent._pan_all_show_mymsg.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 764;BA.debugLine="Main.msg_page_show=0";
mostCurrent._main._msg_page_show /*int*/  = (int) (0);
 //BA.debugLineNum = 765;BA.debugLine="http_initial_1(8)";
...
int _result = 0;
 //BA.debugLineNum = 656;BA.debugLine="Private Sub lbl_chek_noskhe_Click";
 //BA.debugLineNum = 657;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 658;BA.debugLine="result = Msgbox2(\"قبلا خرید کرده ام بررسی کنید\",";
...
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 660;BA.debugLine="http_initial_1(4)";
...
public static String  _lbl_edit_click() throws Exception{
 //BA.debugLineNum = 505;BA.debugLine="Private Sub lbl_edit_Click";
 //BA.debugLineNum = 508;BA.debugLine="et_nameFamili.Text=	lbl_nameFamili.Text";
mostCurrent._et_namefamili.setText(BA.ObjectToCharSequence(mostCurrent._lbl_namefamili.getText()));
 //BA.debugLineNum = 509;BA.debugLine="et_email.Text=lbl_email.Text";
mostCurrent._et_email.setText(BA.ObjectToCharSequence(mostCurrent._lbl_email.getText()));
 //BA.debugLineNum = 510;BA.debugLine="If(my_ramz=\"none2026none\")Then";
if (((mostCurrent._my_ramz).equals("none2026none"))) { 
 //BA.debugLineNum = 511;BA.debugLine="et_pass.Text=\"\"";
mostCurrent._et_pass.setText(BA.ObjectToCharSequence(""));
 }else {
 //BA.debugLineNum = 514;BA.debugLine="et_pass.Text=my_ramz";
mostCurrent._et_pass.setText(BA.ObjectToCharSequence(mostCurrent._my_ramz));
 };
 //BA.debugLineNum = 517;BA.debugLine="comp.Initialize(\"Compressor\")";
_comp.Initialize(processBA,"Compressor");
 //BA.debugLineNum = 518;BA.debugLine="comp.Quality=30";
_comp.setQuality((int) (30));
 //BA.debugLineNum = 519;BA.debugLine="lbl_image_up.Text=Chr(0xF0EE)";
mostCurrent._lbl_image_up.setText(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.Chr(((int)0xf0ee))));
 //BA.debugLineNum = 520;BA.debugLine="pan_all_edit.Visible=True";
...
public static String  _lbl_icon_noup_click() throws Exception{
 //BA.debugLineNum = 773;BA.debugLine="Private Sub lbl_icon_noUp_Click";
 //BA.debugLineNum = 775;BA.debugLine="File.Delete(Starter.Provider.SharedFolder, tempFil";
anywheresoftware.b4a.keywords.Common.File.Delete(mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,mostCurrent._tempfile);
 //BA.debugLineNum = 777;BA.debugLine="lbl_icon_up.Text=\"\"";
mostCurrent._lbl_icon_up.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 778;BA.debugLine="lbl_icon_noUp.Visible=False";
...
this.state = 4;
this.catchState = 17;
 //BA.debugLineNum = 556;BA.debugLine="CC.Show(\"image/*\", \"Choose image\")";
parent._cc.Show(processBA,"image/*","Choose image");
 //BA.debugLineNum = 558;BA.debugLine="Wait For CC_Result (Success As Boolean, Dir As S";
...
;
 //BA.debugLineNum = 559;BA.debugLine="If Success = True Then";
if (true) break;
...
this.state = 12;
this.catchState = 11;
 //BA.debugLineNum = 562;BA.debugLine="File.Copy(Dir,FileName,Starter.Provider.Shared";
anywheresoftware.b4a.keywords.Common.File.Copy(_dir,_filename,parent.mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,"temp_pic.jpg");
 //BA.debugLineNum = 563;BA.debugLine="bmp = comp.compressToBitmap(Starter.Provider.S";
parent.mostCurrent._bmp = (anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper(), (android.graphics.Bitmap)(parent._comp.compressToBitmap(parent.mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,"temp_pic.jpg")));
 //BA.debugLineNum = 564;BA.debugLine="Dim out As OutputStream = File.OpenOutput(Star";
_out = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
_out = anywheresoftware.b4a.keywords.Common.File.OpenOutput(parent.mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,parent.mostCurrent._picname,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 565;BA.debugLine="bmp.WriteToStream(out, 20, \"JPEG\")";
parent.mostCurrent._bmp.WriteToStream((java.io.OutputStream)(_out.getObject()),(int) (20),BA.getEnumFromString(android.graphics.Bitmap.CompressFormat.class,"JPEG"));
 //BA.debugLineNum = 566;BA.debugLine="out.Close";
_out.Close();
 if (true) break;
...
this.state = 12;
this.catchState = 17;
 //BA.debugLineNum = 569;BA.debugLine="File.Copy(Dir,FileName,Starter.Provider.Shared";
anywheresoftware.b4a.keywords.Common.File.Copy(_dir,_filename,parent.mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,parent.mostCurrent._picname);
 //BA.debugLineNum = 570;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("366125840",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
this.catchState = 17;
;
 //BA.debugLineNum = 573;BA.debugLine="img_p_edit.Bitmap=myfunc.CircleImage( LoadBitma";
...
//C
this.state = 15;
 //BA.debugLineNum = 576;BA.debugLine="ToastMessageShow(\"انجام نشد :(\",True)";
...
this.state = 18;
this.catchState = 0;
 //BA.debugLineNum = 580;BA.debugLine="ToastMessageShow(\"خطا در بارگزاری\",True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("خطا در بارگزاری"),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 581;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("366125851",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
int _result = 0;
 //BA.debugLineNum = 182;BA.debugLine="Private Sub lbl_logOff_Click";
 //BA.debugLineNum = 183;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 184;BA.debugLine="result = Msgbox2(\"آیا از حساب خود خارج می شوید؟\",";
...
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 186;BA.debugLine="File.Delete(File.DirInternal,\"phonNum\")";
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 189;BA.debugLine="StartActivity(Main)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._main.getObject()));
 };
...
int _result = 0;
 //BA.debugLineNum = 664;BA.debugLine="Private Sub lbl_reseve_db_Click";
 //BA.debugLineNum = 665;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 666;BA.debugLine="result = Msgbox2(\"اطلاعات من از سرور بازیابی شوند";
...
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 668;BA.debugLine="ProgressDialogShow(\"در حال دریافت ...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("در حال دریافت ..."));
 //BA.debugLineNum = 669;BA.debugLine="http3.Initialize(\"ht6\", Me)";
mostCurrent._http3._initialize /*String*/ (processBA,"ht6",step2_activity.getObject());
 //BA.debugLineNum = 670;BA.debugLine="http3.Download(\"https://taravatgroup.ir/uploads_";
...
public static String  _lbl_save_edit_click() throws Exception{
 //BA.debugLineNum = 157;BA.debugLine="Private Sub lbl_save_edit_Click";
 //BA.debugLineNum = 158;BA.debugLine="If (myfunc.check_internet=False)Then";
if ((mostCurrent._myfunc._check_internet /*boolean*/ (mostCurrent.activityBA)==anywheresoftware.b4a.keywords.Common.False)) { 
 //BA.debugLineNum = 159;BA.debugLine="myfunc.help_man(\"توجه\",\"اتصال اینترنت را بررسی ک";
mostCurrent._myfunc._help_man /*String*/ (mostCurrent.activityBA,"توجه","اتصال اینترنت را بررسی کنید !");
 }else if(((mostCurrent._et_namefamili.getText()).equals(""))) { 
 //BA.debugLineNum = 161;BA.debugLine="ToastMessageShow(\"قسمت نام خالی است \",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("قسمت نام خالی است "),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 164;BA.debugLine="ToastMessageShow(\"قسمت ایمیل خالی است \",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("قسمت ایمیل خالی است "),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 167;BA.debugLine="ToastMessageShow(\" ایمیل نامعتبر است \",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(" ایمیل نامعتبر است "),anywheresoftware.b4a.keywords.Common.False);
 }else if(((mostCurrent._et_pass.getText()).equals(""))) { 
 //BA.debugLineNum = 170;BA.debugLine="ToastMessageShow(\" رمز عبور خالی است \",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(" رمز عبور خالی است "),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 172;BA.debugLine="http_initial_1(2)";
...
int _result = 0;
 //BA.debugLineNum = 675;BA.debugLine="Private Sub lbl_send_db_Click";
 //BA.debugLineNum = 677;BA.debugLine="File.Copy(File.DirInternal,\"db.db\",Starter.Provid";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"db.db",mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,mostCurrent._main._phon_num /*String*/ +"-db-"+mostCurrent._user_key+".db");
 //BA.debugLineNum = 679;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 680;BA.debugLine="result = Msgbox2(\"اطلاعات در سرور آنلاین ذخیره شو";
_result = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("اطلاعات در سرور آنلاین ذخیره شود؟"),BA.ObjectToCharSequence("بک آپ گیری "),"باشه","","لغو",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"attention.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 681;BA.debugLine="If result = DialogResponse.Positive Then";
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 683;BA.debugLine="upload_file(Starter.Provider.SharedFolder&\"/\"&Ma";
_upload_file(mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ +"/"+mostCurrent._main._phon_num /*String*/ +"-db-"+mostCurrent._user_key+".db");
 //BA.debugLineNum = 684;BA.debugLine="pan_progressBar.Visible=True";
mostCurrent._pan_progressbar.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 685;BA.debugLine="ProgressBar1.Enabled=True";
mostCurrent._progressbar1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
...
public static String  _lbl_send_msg_click() throws Exception{
 //BA.debugLineNum = 650;BA.debugLine="Private Sub lbl_send_msg_Click";
 //BA.debugLineNum = 651;BA.debugLine="pan_all_msg.Visible=True";
...
public static String  _lbl_send_msg_end_click() throws Exception{
 //BA.debugLineNum = 739;BA.debugLine="Private Sub lbl_send_msg_end_Click";
 //BA.debugLineNum = 741;BA.debugLine="http_initial_1(5)";
_http_initial_1((int) (5));
 //BA.debugLineNum = 743;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_send_msg2_click() throws Exception{
 //BA.debugLineNum = 768;BA.debugLine="Private Sub lbl_send_msg2_Click";
 //BA.debugLineNum = 769;BA.debugLine="lbl_send_msg_Click";
_lbl_send_msg_click();
 //BA.debugLineNum = 770;BA.debugLine="lbl_back_Shmsg_Click";
_lbl_back_shmsg_click();
...
this.state = 4;
this.catchState = 17;
 //BA.debugLineNum = 696;BA.debugLine="CC.Show(\"image/*\", \"Choose image\")";
parent._cc.Show(processBA,"image/*","Choose image");
 //BA.debugLineNum = 698;BA.debugLine="Wait For CC_Result (Success As Boolean, Dir As S";
anywheresoftware.b4a.keywords.Common.WaitFor("cc_result", processBA, this, null);
this.state = 19;
return;
case 19:
...
//C
this.state = 7;
 //BA.debugLineNum = 703;BA.debugLine="tempFile=Main.phon_num&\"-\"&myfunc.random_id(10)";
...
this.state = 12;
this.catchState = 11;
 //BA.debugLineNum = 708;BA.debugLine="File.Copy(Dir,FileName,Starter.Provider.Shared";
anywheresoftware.b4a.keywords.Common.File.Copy(_dir,_filename,parent.mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,"tempimg.jpg");
 //BA.debugLineNum = 709;BA.debugLine="bmp = comp.compressToBitmap(Starter.Provider.S";
parent.mostCurrent._bmp = (anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper(), (android.graphics.Bitmap)(parent._comp.compressToBitmap(parent.mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,"tempimg.jpg")));
 //BA.debugLineNum = 710;BA.debugLine="Dim out As OutputStream = File.OpenOutput(Star";
_out = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
_out = anywheresoftware.b4a.keywords.Common.File.OpenOutput(parent.mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,parent.mostCurrent._tempfile,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 711;BA.debugLine="bmp.WriteToStream(out, 50, \"JPEG\")";
parent.mostCurrent._bmp.WriteToStream((java.io.OutputStream)(_out.getObject()),(int) (50),BA.getEnumFromString(android.graphics.Bitmap.CompressFormat.class,"JPEG"));
 //BA.debugLineNum = 712;BA.debugLine="out.Close";
_out.Close();
 if (true) break;
...
this.state = 12;
this.catchState = 17;
 //BA.debugLineNum = 717;BA.debugLine="File.Copy(Dir,FileName,Starter.Provider.Shared";
anywheresoftware.b4a.keywords.Common.File.Copy(_dir,_filename,parent.mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,parent.mostCurrent._tempfile);
 //BA.debugLineNum = 720;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("366846746",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
this.catchState = 17;
;
 //BA.debugLineNum = 725;BA.debugLine="lbl_icon_up.Text=Chr(0xF00C)";
parent.mostCurrent._lbl_icon_up.setText(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.Chr(((int)0xf00c))));
 //BA.debugLineNum = 726;BA.debugLine="lbl_icon_noUp.Visible=True";
...
//C
this.state = 15;
 //BA.debugLineNum = 728;BA.debugLine="ToastMessageShow(\"انجام نشد :(\",True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("انجام نشد :("),anywheresoftware.b4a.keywords.Common.True);
 if (true) break;
...
this.state = 18;
this.catchState = 0;
 //BA.debugLineNum = 731;BA.debugLine="ToastMessageShow(\"خطا در بارگزاری\",True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("خطا در بارگزاری"),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 732;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("366846758",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
public static String  _lbl_send_up_icon_click() throws Exception{
 //BA.debugLineNum = 750;BA.debugLine="Private Sub lbl_send_up_icon_Click";
 //BA.debugLineNum = 751;BA.debugLine="lbl_send_up_Click";
_lbl_send_up_click();
...
int _result = 0;
 //BA.debugLineNum = 641;BA.debugLine="Private Sub lbl_transfer_Click";
 //BA.debugLineNum = 643;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 644;BA.debugLine="result = Msgbox2(\"درخواست انتقال نسخه طلایی به گو";
_result = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("درخواست انتقال نسخه طلایی به گوشی جدید"),BA.ObjectToCharSequence("درخواست انتقال"),"ثبت درخواست ","","لغو",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"attention.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 645;BA.debugLine="If result = DialogResponse.Positive Then";
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 646;BA.debugLine="http_initial_1(3)";
...
public static String  _pan_all_edit_click() throws Exception{
 //BA.debugLineNum = 153;BA.debugLine="Private Sub pan_all_edit_Click";
 //BA.debugLineNum = 155;BA.debugLine="End Sub";
return "";
}
public static String  _pan_all_msg_click() throws Exception{
 //BA.debugLineNum = 690;BA.debugLine="Private Sub pan_all_msg_Click";
 //BA.debugLineNum = 691;BA.debugLine="pan_all_msg.Visible=False";
mostCurrent._pan_all_msg.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 692;BA.debugLine="End Sub";
return "";
}
public static String  _pan_all_sendbackup_click() throws Exception{
 //BA.debugLineNum = 781;BA.debugLine="Private Sub pan_all_sendBackup_Click";
 //BA.debugLineNum = 783;BA.debugLine="End Sub";
return "";
}
public static String  _panel9_click() throws Exception{
 //BA.debugLineNum = 746;BA.debugLine="Private Sub Panel9_Click";
...
_tim_send_backup = new anywheresoftware.b4a.objects.Timer();
 //BA.debugLineNum = 12;BA.debugLine="dim time_pass as Timer";
_time_pass = new anywheresoftware.b4a.objects.Timer();
 //BA.debugLineNum = 13;BA.debugLine="End Sub";
return "";
}
public static String  _send_backup_func() throws Exception{
 //BA.debugLineNum = 494;BA.debugLine="Sub send_backup_func";
 //BA.debugLineNum = 496;BA.debugLine="File.Copy(File.DirInternal,\"db.db\",Starter.Provid";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"db.db",mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,mostCurrent._main._phon_num /*String*/ +"-db-"+mostCurrent._user_key+".db");
 //BA.debugLineNum = 497;BA.debugLine="upload_file(Starter.Provider.SharedFolder&\"/\"&Mai";
_upload_file(mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ +"/"+mostCurrent._main._phon_num /*String*/ +"-db-"+mostCurrent._user_key+".db");
 //BA.debugLineNum = 498;BA.debugLine="Main.backup_page_show=0";
mostCurrent._main._backup_page_show /*int*/  = (int) (0);
 //BA.debugLineNum = 499;BA.debugLine="File.WriteString(File.DirInternal,\"chk_backup.txt";
...
public static String  _tim_send_backup_tick() throws Exception{
 //BA.debugLineNum = 483;BA.debugLine="Sub tim_send_backup_Tick";
 //BA.debugLineNum = 484;BA.debugLine="send_backup_func";
_send_backup_func();
 //BA.debugLineNum = 485;BA.debugLine="tim_send_backup.Enabled=False";
_tim_send_backup.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 488;BA.debugLine="ToastMessageShow(\" ذخیره شد\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(" ذخیره شد"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 490;BA.debugLine="lbl_back_home_Click";
_lbl_back_home_click();
...
public static String  _time_pass1_tick() throws Exception{
 //BA.debugLineNum = 140;BA.debugLine="Private Sub time_pass1_Tick";
 //BA.debugLineNum = 141;BA.debugLine="lbl_edit_Click";
_lbl_edit_click();
 //BA.debugLineNum = 142;BA.debugLine="time_pass.Enabled=False";
_time_pass.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 143;BA.debugLine="End Sub";
return "";
}
public static String  _up_sendfile(String _value) throws Exception{
 //BA.debugLineNum = 613;BA.debugLine="Sub Up_sendFile (value As String)";
 //BA.debugLineNum = 615;BA.debugLine="End Sub";
return "";
}
public static String  _up_statusupload(String _value) throws Exception{
 //BA.debugLineNum = 617;BA.debugLine="Sub Up_statusUpload (value As String)";
 //BA.debugLineNum = 619;BA.debugLine="lbl_image_up.Text=value&\" %\"";
mostCurrent._lbl_image_up.setText(BA.ObjectToCharSequence(_value+" %"));
 //BA.debugLineNum = 620;BA.debugLine="If(value>=100)Then";
if (((double)(Double.parseDouble(_value))>=100)) { 
 //BA.debugLineNum = 621;BA.debugLine="lbl_back_Click";
_lbl_back_click();
 //BA.debugLineNum = 623;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 624;BA.debugLine="pan_progressBar.Visible=False";
mostCurrent._pan_progressbar.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 625;BA.debugLine="lbl_progressBar1.Enabled=False";
mostCurrent._lbl_progressbar1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 627;BA.debugLine="ToastMessageShow(\" ذخیره شد\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(" ذخیره شد"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 631;BA.debugLine="ProgressBar1.Progress=value";
mostCurrent._progressbar1.setProgress((int)(Double.parseDouble(_value)));
 //BA.debugLineNum = 632;BA.debugLine="lbl_progressBar1.Text=value&\"%\"";
...
public static String  _upload_file(String _path) throws Exception{
 //BA.debugLineNum = 601;BA.debugLine="Sub upload_file(path As String)";
 //BA.debugLineNum = 603;BA.debugLine="If (Main.backup_page_show<>1)Then";
if ((mostCurrent._main._backup_page_show /*int*/ !=1)) { 
 };
 //BA.debugLineNum = 607;BA.debugLine="pan_progressBar.Visible=True";
mostCurrent._pan_progressbar.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 608;BA.debugLine="Up.doFileUpload( Null,Null,path,\"https://taravat";
...
public static String  _upload_img(String _path) throws Exception{
 //BA.debugLineNum = 588;BA.debugLine="Sub upload_img(path As String)";
 //BA.debugLineNum = 590;BA.debugLine="File.Copy(Starter.Provider.SharedFolder,picName,";
anywheresoftware.b4a.keywords.Common.File.Copy(mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,mostCurrent._picname,anywheresoftware.b4a.keywords.Common.File.getDirInternal(),mostCurrent._picname);
 //BA.debugLineNum = 591;BA.debugLine="Path_Phone_Image = path";
mostCurrent._path_phone_image = _path;
 //BA.debugLineNum = 592;BA.debugLine="Up.doFileUpload( Null,Null,Path_Phone_Image,Url_";
mostCurrent._up.doFileUpload(processBA,(android.widget.ProgressBar)(anywheresoftware.b4a.keywords.Common.Null),(android.widget.TextView)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent._path_phone_image,mostCurrent._url_php_page);
 //BA.debugLineNum = 594;BA.debugLine="img_pofil.Bitmap=myfunc.CircleImage( LoadBitmap(";
mostCurrent._img_pofil.setBitmap((android.graphics.Bitmap)(mostCurrent._myfunc._circleimage /*anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper*/ (mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),mostCurrent._picname)).getObject()));
 //BA.debugLineNum = 595;BA.debugLine="img_p_edit.Bitmap=myfunc.CircleImage( LoadBitmap";
mostCurrent._img_p_edit.setBitmap((android.graphics.Bitmap)(mostCurrent._myfunc._circleimage /*anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper*/ (mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),mostCurrent._picname)).getObject()));
