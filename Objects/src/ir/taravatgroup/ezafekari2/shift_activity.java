...
mostCurrent._rspop_year_tagvim.AddMenuItem((int) (1403),(int) (1403),mostCurrent._myfunc._en2fa /*String*/ (mostCurrent.activityBA,"1403"));
 //BA.debugLineNum = 418;BA.debugLine="rsPOP_moon_tagvim.Initialize(\"rsPOP_moon_tagvim\",";
mostCurrent._rspop_moon_tagvim.Initialize(mostCurrent.activityBA,"rsPOP_moon_tagvim",(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._lbl_moon_name.getObject())));
 //BA.debugLineNum = 421;BA.debugLine="rsPOP_moon_tagvim.AddMenuItem(1,1,\"فروردین\")";
mostCurrent._rspop_moon_tagvim.AddMenuItem((int) (1),(int) (1),"فروردین");
 //BA.debugLineNum = 422;BA.debugLine="rsPOP_moon_tagvim.AddMenuItem(2,2,\"اردیبهشت\")";
mostCurrent._rspop_moon_tagvim.AddMenuItem((int) (2),(int) (2),"اردیبهشت");
 //BA.debugLineNum = 423;BA.debugLine="rsPOP_moon_tagvim.AddMenuItem(3,3,\"خرداد\")";
mostCurrent._rspop_moon_tagvim.AddMenuItem((int) (3),(int) (3),"خرداد");
 //BA.debugLineNum = 424;BA.debugLine="rsPOP_moon_tagvim.AddMenuItem(4,4,\"تیر\")";
mostCurrent._rspop_moon_tagvim.AddMenuItem((int) (4),(int) (4),"تیر");
 //BA.debugLineNum = 425;BA.debugLine="rsPOP_moon_tagvim.AddMenuItem(5,5,\"مرداد\")";
mostCurrent._rspop_moon_tagvim.AddMenuItem((int) (5),(int) (5),"مرداد");
 //BA.debugLineNum = 426;BA.debugLine="rsPOP_moon_tagvim.AddMenuItem(6,6,\"شهریور\")";
mostCurrent._rspop_moon_tagvim.AddMenuItem((int) (6),(int) (6),"شهریور");
 //BA.debugLineNum = 427;BA.debugLine="rsPOP_moon_tagvim.AddMenuItem(7,7,\"مهر\")";
mostCurrent._rspop_moon_tagvim.AddMenuItem((int) (7),(int) (7),"مهر");
 //BA.debugLineNum = 428;BA.debugLine="rsPOP_moon_tagvim.AddMenuItem(8,8,\"آبان\")";
mostCurrent._rspop_moon_tagvim.AddMenuItem((int) (8),(int) (8),"آبان");
 //BA.debugLineNum = 429;BA.debugLine="rsPOP_moon_tagvim.AddMenuItem(9,9,\"آذر\")";
mostCurrent._rspop_moon_tagvim.AddMenuItem((int) (9),(int) (9),"آذر");
 //BA.debugLineNum = 430;BA.debugLine="rsPOP_moon_tagvim.AddMenuItem(10,10,\"دی\")";
mostCurrent._rspop_moon_tagvim.AddMenuItem((int) (10),(int) (10),"دی");
 //BA.debugLineNum = 431;BA.debugLine="rsPOP_moon_tagvim.AddMenuItem(11,11,\"بهمن\")";
mostCurrent._rspop_moon_tagvim.AddMenuItem((int) (11),(int) (11),"بهمن");
 //BA.debugLineNum = 432;BA.debugLine="rsPOP_moon_tagvim.AddMenuItem(12,12,\"اسفند\")";
mostCurrent._rspop_moon_tagvim.AddMenuItem((int) (12),(int) (12),"اسفند");
 //BA.debugLineNum = 440;BA.debugLine="rsPOP_year.Initialize(\"rsPOP_year\",lbl_years)";
...
mostCurrent._rspop_mah.Initialize(mostCurrent.activityBA,"rsPOP_mah",(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._lbl_mah.getObject())));
 //BA.debugLineNum = 451;BA.debugLine="lbl_mah_tagID=1";
_lbl_mah_tagid = (int) (1);
 //BA.debugLineNum = 453;BA.debugLine="rsPOP_mah.AddMenuItem(1,1,\"فروردین\")";
mostCurrent._rspop_mah.AddMenuItem((int) (1),(int) (1),"فروردین");
 //BA.debugLineNum = 454;BA.debugLine="rsPOP_mah.AddMenuItem(2,2,\"اردیبهشت\")";
mostCurrent._rspop_mah.AddMenuItem((int) (2),(int) (2),"اردیبهشت");
 //BA.debugLineNum = 455;BA.debugLine="rsPOP_mah.AddMenuItem(3,3,\"خرداد\")";
mostCurrent._rspop_mah.AddMenuItem((int) (3),(int) (3),"خرداد");
 //BA.debugLineNum = 456;BA.debugLine="rsPOP_mah.AddMenuItem(4,4,\"تیر\")";
mostCurrent._rspop_mah.AddMenuItem((int) (4),(int) (4),"تیر");
 //BA.debugLineNum = 457;BA.debugLine="rsPOP_mah.AddMenuItem(5,5,\"مرداد\")";
mostCurrent._rspop_mah.AddMenuItem((int) (5),(int) (5),"مرداد");
 //BA.debugLineNum = 458;BA.debugLine="rsPOP_mah.AddMenuItem(6,6,\"شهریور\")";
mostCurrent._rspop_mah.AddMenuItem((int) (6),(int) (6),"شهریور");
 //BA.debugLineNum = 459;BA.debugLine="rsPOP_mah.AddMenuItem(7,7,\"مهر\")";
mostCurrent._rspop_mah.AddMenuItem((int) (7),(int) (7),"مهر");
 //BA.debugLineNum = 460;BA.debugLine="rsPOP_mah.AddMenuItem(8,8,\"آبان\")";
mostCurrent._rspop_mah.AddMenuItem((int) (8),(int) (8),"آبان");
 //BA.debugLineNum = 461;BA.debugLine="rsPOP_mah.AddMenuItem(9,9,\"آذر\")";
mostCurrent._rspop_mah.AddMenuItem((int) (9),(int) (9),"آذر");
 //BA.debugLineNum = 462;BA.debugLine="rsPOP_mah.AddMenuItem(10,10,\"دی\")";
mostCurrent._rspop_mah.AddMenuItem((int) (10),(int) (10),"دی");
 //BA.debugLineNum = 463;BA.debugLine="rsPOP_mah.AddMenuItem(11,11,\"بهمن\")";
mostCurrent._rspop_mah.AddMenuItem((int) (11),(int) (11),"بهمن");
 //BA.debugLineNum = 464;BA.debugLine="rsPOP_mah.AddMenuItem(12,12,\"اسفند\")";
mostCurrent._rspop_mah.AddMenuItem((int) (12),(int) (12),"اسفند");
 //BA.debugLineNum = 467;BA.debugLine="rsPOP_roz.Initialize(\"rsPOP_roz\",lbl_roz)";
mostCurrent._rspop_roz.Initialize(mostCurrent.activityBA,"rsPOP_roz",(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._lbl_roz.getObject())));
 //BA.debugLineNum = 470;BA.debugLine="For i=1 To 31";
{
final int step76 = 1;
final int limit76 = (int) (31);
_i = (int) (1) ;
for (;_i <= limit76 ;_i = _i + step76 ) {
 //BA.debugLineNum = 472;BA.debugLine="rsPOP_roz.AddMenuItem(i,i,myfunc.en2fa(i))";
mostCurrent._rspop_roz.AddMenuItem(_i,_i,mostCurrent._myfunc._en2fa /*String*/ (mostCurrent.activityBA,BA.NumberToString(_i)));
 }
};
 //BA.debugLineNum = 476;BA.debugLine="rsPOP_year_end.Initialize(\"rsPOP_year_end\",lbl_ye";
...
mostCurrent._rspop_mah_end.Initialize(mostCurrent.activityBA,"rsPOP_mah_end",(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._lbl_mah_end.getObject())));
 //BA.debugLineNum = 488;BA.debugLine="lbl_mah_end_tagID=12";
_lbl_mah_end_tagid = (int) (12);
 //BA.debugLineNum = 490;BA.debugLine="rsPOP_mah_end.AddMenuItem(1,1,\"فروردین\")";
mostCurrent._rspop_mah_end.AddMenuItem((int) (1),(int) (1),"فروردین");
 //BA.debugLineNum = 491;BA.debugLine="rsPOP_mah_end.AddMenuItem(2,2,\"اردیبهشت\")";
mostCurrent._rspop_mah_end.AddMenuItem((int) (2),(int) (2),"اردیبهشت");
 //BA.debugLineNum = 492;BA.debugLine="rsPOP_mah_end.AddMenuItem(3,3,\"خرداد\")";
mostCurrent._rspop_mah_end.AddMenuItem((int) (3),(int) (3),"خرداد");
 //BA.debugLineNum = 493;BA.debugLine="rsPOP_mah_end.AddMenuItem(4,4,\"تیر\")";
mostCurrent._rspop_mah_end.AddMenuItem((int) (4),(int) (4),"تیر");
 //BA.debugLineNum = 494;BA.debugLine="rsPOP_mah_end.AddMenuItem(5,5,\"مرداد\")";
mostCurrent._rspop_mah_end.AddMenuItem((int) (5),(int) (5),"مرداد");
 //BA.debugLineNum = 495;BA.debugLine="rsPOP_mah_end.AddMenuItem(6,6,\"شهریور\")";
mostCurrent._rspop_mah_end.AddMenuItem((int) (6),(int) (6),"شهریور");
 //BA.debugLineNum = 496;BA.debugLine="rsPOP_mah_end.AddMenuItem(7,7,\"مهر\")";
mostCurrent._rspop_mah_end.AddMenuItem((int) (7),(int) (7),"مهر");
 //BA.debugLineNum = 497;BA.debugLine="rsPOP_mah_end.AddMenuItem(8,8,\"آبان\")";
mostCurrent._rspop_mah_end.AddMenuItem((int) (8),(int) (8),"آبان");
 //BA.debugLineNum = 498;BA.debugLine="rsPOP_mah_end.AddMenuItem(9,9,\"آذر\")";
mostCurrent._rspop_mah_end.AddMenuItem((int) (9),(int) (9),"آذر");
 //BA.debugLineNum = 499;BA.debugLine="rsPOP_mah_end.AddMenuItem(10,10,\"دی\")";
mostCurrent._rspop_mah_end.AddMenuItem((int) (10),(int) (10),"دی");
 //BA.debugLineNum = 500;BA.debugLine="rsPOP_mah_end.AddMenuItem(11,11,\"بهمن\")";
mostCurrent._rspop_mah_end.AddMenuItem((int) (11),(int) (11),"بهمن");
 //BA.debugLineNum = 501;BA.debugLine="rsPOP_mah_end.AddMenuItem(12,12,\"اسفند\")";
mostCurrent._rspop_mah_end.AddMenuItem((int) (12),(int) (12),"اسفند");
 //BA.debugLineNum = 503;BA.debugLine="rsPOP_roz_end.Initialize(\"rsPOP_roz_end\",lbl_roz_";
mostCurrent._rspop_roz_end.Initialize(mostCurrent.activityBA,"rsPOP_roz_end",(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._lbl_roz_end.getObject())));
 //BA.debugLineNum = 504;BA.debugLine="For i=1 To 31";
{
final int step101 = 1;
final int limit101 = (int) (31);
_i = (int) (1) ;
for (;_i <= limit101 ;_i = _i + step101 ) {
 //BA.debugLineNum = 505;BA.debugLine="rsPOP_roz_end.AddMenuItem(i,i,myfunc.en2fa(i))";
mostCurrent._rspop_roz_end.AddMenuItem(_i,_i,mostCurrent._myfunc._en2fa /*String*/ (mostCurrent.activityBA,BA.NumberToString(_i)));
 ...
 //BA.debugLineNum = 511;BA.debugLine="lbl_go_today_Click";
_lbl_go_today_click();
 //BA.debugLineNum = 513;BA.debugLine="myfunc.set_font(Activity)";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 //BA.debugLineNum = 730;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
 //BA.debugLineNum = 732;BA.debugLine="End Sub";
return "";
}
public static String  _activity_resume() throws Exception{
 //BA.debugLineNum = 726;BA.debugLine="Sub Activity_Resume";
...
public static String  _checkbox_tatil_garardadi_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 1546;BA.debugLine="Private Sub CheckBox_tatil_garardadi_CheckedChange";
 //BA.debugLineNum = 1547;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 1548;BA.debugLine="If(Checked=True)Then";
if ((_checked==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 1550;BA.debugLine="dbCode.sql.ExecNonQuery(\"UPDATE 'my_calander' se";
mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery("UPDATE 'my_calander' set state='tatil1' WHERE id="+BA.NumberToString(_selectedday_id));
 ...
 //BA.debugLineNum = 1554;BA.debugLine="dbCode.sql.ExecNonQuery(\"UPDATE 'my_calander' se";
mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery("UPDATE 'my_calander' set state='' WHERE id="+BA.NumberToString(_selectedday_id));
 ...
 //BA.debugLineNum = 1557;BA.debugLine="generat_taghvim(lbl_year_tagvim.Text,lbl_moon_nam";
_generat_taghvim((int)(Double.parseDouble(mostCurrent._lbl_year_tagvim.getText())),(int)(BA.ObjectToNumber(mostCurrent._lbl_moon_name.getTag())));
 //BA.debugLineNum = 1559;BA.debugLine="pan_all_menu_day_Click";
_pan_all_menu_day_click();
 //BA.debugLineNum = 1560;BA.debugLine="ToastMessageShow(\" ذخیره شد\",True)";
...
public static String  _checkbox_tatil_rasmi_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 1578;BA.debugLine="Private Sub CheckBox_tatil_rasmi_CheckedChange(Che";
 //BA.debugLineNum = 1580;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 1581;BA.debugLine="If(Checked=True)Then";
if ((_checked==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 1583;BA.debugLine="dbCode.sql.ExecNonQuery(\"UPDATE 'my_calander' se";
mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery("UPDATE 'my_calander' set state='tatil' WHERE id="+BA.NumberToString(_selectedday_id));
 ...
 //BA.debugLineNum = 1587;BA.debugLine="dbCode.sql.ExecNonQuery(\"UPDATE 'my_calander' se";
mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery("UPDATE 'my_calander' set state='' WHERE id="+BA.NumberToString(_selectedday_id));
 };
 //BA.debugLineNum = 1590;BA.debugLine="generat_taghvim(lbl_year_tagvim.Text,lbl_moon_nam";
_generat_taghvim((int)(Double.parseDouble(mostCurrent._lbl_year_tagvim.getText())),(int)(BA.ObjectToNumber(mostCurrent._lbl_moon_name.getTag())));
 //BA.debugLineNum = 1592;BA.debugLine="pan_all_menu_day_Click";
_pan_all_menu_day_click();
 //BA.debugLineNum = 1593;BA.debugLine="ToastMessageShow(\" ذخیره شد\",True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(" ذخیره شد"),anywheresoftware.b4a.keywords.Common.True);
...
int _counter = 0;
int _f = 0;
 //BA.debugLineNum = 938;BA.debugLine="Sub generat_taghvim(year As Int , moon As Int)";
 //BA.debugLineNum = 939;BA.debugLine="Try";
try { //BA.debugLineNum = 942;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 946;BA.debugLine="For d=0 To PA.Length-1";
{
final int step3 = 1;
final int limit3 = (int) (mostCurrent._pa.length-1);
_d = (int) (0) ;
for (;_d <= limit3 ;_d = _d + step3 ) {
 //BA.debugLineNum = 947;BA.debugLine="PA(d).Visible=True";
mostCurrent._pa[_d].setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 948;BA.debugLine="PA(d).Color=0xFFEFEFEF";
mostCurrent._pa[_d].setColor(((int)0xffefefef));
 //BA.debugLineNum = 951;BA.debugLine="EZ(d).Text=\"\"";
mostCurrent._ez[_d].setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 952;BA.debugLine="NO(d).Text=\"\"";
mostCurrent._no[_d].setText(BA.ObjectToCharSequence(""));
 }
};
 //BA.debugLineNum = 956;BA.debugLine="ls_shift_moon.Clear";
mostCurrent._ls_shift_moon.Clear();
 //BA.debugLineNum = 957;BA.debugLine="ls_tatili_moon.Clear";
mostCurrent._ls_tatili_moon.Clear();
 //BA.debugLineNum = 958;BA.debugLine="ls_tatili_custom_moon.Clear";
mostCurrent._ls_tatili_custom_moon.Clear();
 //BA.debugLineNum = 959;BA.debugLine="ls_note_moon.Clear";
mostCurrent._ls_note_moon.Clear();
 //BA.debugLineNum = 961;BA.debugLine="Dim count_day_moon As Int";
_count_day_moon = 0;
 //BA.debugLineNum = 963;BA.debugLine="current_moon=moon";
_current_moon = _moon;
 //BA.debugLineNum = 964;BA.debugLine="lbl_moon_name.Tag=moon";
mostCurrent._lbl_moon_name.setTag((Object)(_moon));
 //BA.debugLineNum = 965;BA.debugLine="lbl_year_tagvim.Text=year";
mostCurrent._lbl_year_tagvim.setText(BA.ObjectToCharSequence(_year));
 //BA.debugLineNum = 967;BA.debugLine="Select moon";
switch (_moon) {
case 1: {
 //BA.debugLineNum = 969;BA.debugLine="lbl_moon_name.Text=\"فروردین\"";
mostCurrent._lbl_moon_name.setText(BA.ObjectToCharSequence("فروردین"));
 break; }
case 2: {
 //BA.debugLineNum = 971;BA.debugLine="lbl_moon_name.Text=\"اردیبهشت\"";
mostCurrent._lbl_moon_name.setText(BA.ObjectToCharSequence("اردیبهشت"));
 break; }
case 3: {
 //BA.debugLineNum = 973;BA.debugLine="lbl_moon_name.Text=\"خرداد\"";
mostCurrent._lbl_moon_name.setText(BA.ObjectToCharSequence("خرداد"));
 break; }
case 4: {
 //BA.debugLineNum = 975;BA.debugLine="lbl_moon_name.Text=\"تیر\"";
mostCurrent._lbl_moon_name.setText(BA.ObjectToCharSequence("تیر"));
 break; }
case 5: {
 //BA.debugLineNum = 977;BA.debugLine="lbl_moon_name.Text=\"مرداد\"";
mostCurrent._lbl_moon_name.setText(BA.ObjectToCharSequence("مرداد"));
 break; }
case 6: {
 //BA.debugLineNum = 979;BA.debugLine="lbl_moon_name.Text=\"شهریور\"";
mostCurrent._lbl_moon_name.setText(BA.ObjectToCharSequence("شهریور"));
 break; }
case 7: {
 //BA.debugLineNum = 981;BA.debugLine="lbl_moon_name.Text=\"مهر\"";
mostCurrent._lbl_moon_name.setText(BA.ObjectToCharSequence("مهر"));
 break; }
case 8: {
 //BA.debugLineNum = 983;BA.debugLine="lbl_moon_name.Text=\"آبان\"";
mostCurrent._lbl_moon_name.setText(BA.ObjectToCharSequence("آبان"));
 break; }
case 9: {
 //BA.debugLineNum = 985;BA.debugLine="lbl_moon_name.Text=\"آذر\"";
mostCurrent._lbl_moon_name.setText(BA.ObjectToCharSequence("آذر"));
 break; }
case 10: {
 //BA.debugLineNum = 987;BA.debugLine="lbl_moon_name.Text=\"دی\"";
mostCurrent._lbl_moon_name.setText(BA.ObjectToCharSequence("دی"));
 break; }
case 11: {
 //BA.debugLineNum = 989;BA.debugLine="lbl_moon_name.Text=\"بهمن\"";
mostCurrent._lbl_moon_name.setText(BA.ObjectToCharSequence("بهمن"));
 break; }
case 12: {
 //BA.debugLineNum = 991;BA.debugLine="lbl_moon_name.Text=\"اسفند\"";
mostCurrent._lbl_moon_name.setText(BA.ObjectToCharSequence("اسفند"));
 break; }
}
;
 //BA.debugLineNum = 997;BA.debugLine="dbCode.res =  dbCode.sql.ExecQuery(\"SELECT * FROM";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/  = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery("SELECT * FROM 'my_calander' WHERE year="+BA.NumberToString(_year)+" AND moon="+BA.NumberToString(_moon)+" ;")));
 //BA.debugLineNum = 1001;BA.debugLine="If (dbCode.res.RowCount>0)Then";
if ((mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .getRowCount()>0)) { 
 //BA.debugLineNum = 1003;BA.debugLine="count_day_moon=dbCode.res.RowCount";
_count_day_moon = mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .getRowCount();
 //BA.debugLineNum = 1004;BA.debugLine="dbCode.res.Position =0";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (0));
 //BA.debugLineNum = 1005;BA.debugLine="start_day=dbCode.res.Getint(\"day_h\")";
_start_day = mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetInt("day_h");
 //BA.debugLineNum = 1008;BA.debugLine="For i=0 To dbCode.res.RowCount-1";
{
final int step48 = 1;
...
for (;_i <= limit48 ;_i = _i + step48 ) {
 //BA.debugLineNum = 1009;BA.debugLine="dbCode.res.Position =i";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition(_i);
 //BA.debugLineNum = 1011;BA.debugLine="If (dbCode.res.GetString(\"shift\") = Null)Then";
if ((mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("shift")== null)) { 
 //BA.debugLineNum = 1012;BA.debugLine="ls_shift_moon.Add(\"\")";
mostCurrent._ls_shift_moon.Add((Object)(""));
 }else {
 //BA.debugLineNum = 1014;BA.debugLine="ls_shift_moon.Add(dbCode.res.GetString(\"shift";
...
if ((mostCurrent._dbcode._isexist_ezafekari_by_date /*boolean*/ (mostCurrent.activityBA,BA.NumberToString(_year)+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,_moon)+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,_counter))==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 1110;BA.debugLine="EZ(i).Text=\"*\"";
mostCurrent._ez[_i].setText(BA.ObjectToCharSequence("*"));
 //BA.debugLineNum = 1111;BA.debugLine="EZ(i).TextColor=0xFF00941C";
...
mostCurrent._ez[_i].setText(BA.ObjectToCharSequence("*"));
 //BA.debugLineNum = 1114;BA.debugLine="EZ(i).TextColor=0xFFFF5200";
...
mostCurrent._ez[_i].setTextColor(((int)0xffff5200));
 ...
 //BA.debugLineNum = 1126;BA.debugLine="If(counter=this_day And moon=date.PersianMonth A";
if ((_counter==_this_day && _moon==mostCurrent._date.getPersianMonth() && _year==_this_year)) { 
 //BA.debugLineNum = 1129;BA.debugLine="Lb(i).TextColor=0xFFFF9000";
mostCurrent._lb[_i].setTextColor(((int)0xffff9000));
 //BA.debugLineNum = 1130;BA.debugLine="index_i_today=i";
_index_i_today = _i;
 };
 //BA.debugLineNum = 1133;BA.debugLine="If(counter>=count_day_moon)Then";
if ((_counter>=_count_day_moon)) { 
 //BA.debugLineNum = 1135;BA.debugLine="For f=i+1 To Lb.Length-1";
{
final int step126 = 1;
final int limit126 = (int) (mostCurrent._lb.length-1);
_f = (int) (_i+1) ;
for (;_f <= limit126 ;_f = _f + step126 ) {
 //BA.debugLineNum = 1136;BA.debugLine="PA(f).Visible=False";
mostCurrent._pa[_f].setVisible(anywheresoftware.b4a.keywords.Common.False);
 }
};
 };
 //BA.debugLineNum = 1142;BA.debugLine="counter=counter+1";
_counter = (int) (_counter+1);
 }
};
 } 
       catch (Exception e133) {
			processBA.setLastException(e133); //BA.debugLineNum = 1146;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("19175248",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
int _i = 0;
 //BA.debugLineNum = 864;BA.debugLine="Sub get_ezafekari(date1 As String)";
 //BA.debugLineNum = 865;BA.debugLine="lbl_ezafekari_day.Text=\"\"";
mostCurrent._lbl_ezafekari_day.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 866;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 867;BA.debugLine="Dim ezList As List";
_ezlist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 868;BA.debugLine="ezList.Initialize";
_ezlist.Initialize();
 //BA.debugLineNum = 869;BA.debugLine="Dim newLine As String=\"\"";
_newline = "";
 //BA.debugLineNum = 871;BA.debugLine="dbCode.res =  dbCode.sql.ExecQuery(\"SELECT * FROM";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/  = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery("SELECT * FROM tb_ezafekari WHERE date_from LIKE '"+_date1+"';")));
 //BA.debugLineNum = 873;BA.debugLine="If (dbCode.res.RowCount>0)Then";
if ((mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .getRowCount()>0)) { 
 //BA.debugLineNum = 874;BA.debugLine="For K=0 To dbCode.res.RowCount-1";
{
final int step8 = 1;
...
for (;_k <= limit8 ;_k = _k + step8 ) {
 //BA.debugLineNum = 875;BA.debugLine="dbCode.res.Position=K";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition(_k);
 //BA.debugLineNum = 878;BA.debugLine="Dim ls_time_conv As List";
_ls_time_conv = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 879;BA.debugLine="ls_time_conv.Initialize";
_ls_time_conv.Initialize();
 //BA.debugLineNum = 880;BA.debugLine="ls_time_conv=myfunc.Min_to_saatMinRoz2_dontDay(";
_ls_time_conv = mostCurrent._myfunc._min_to_saatminroz2_dontday /*anywheresoftware.b4a.objects.collections.List*/ (mostCurrent.activityBA,mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetInt("end_tim_m"));
 //BA.debugLineNum = 883;BA.debugLine="ezList.Add(newLine&\"از \"&dbCode.res.GetString(\"";
_ezlist.Add((Object)(_newline+"از "+mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("time_from")+" تا "+mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("time_to")+"  ( "+BA.ObjectToString(_ls_time_conv.Get((int) (0)))+":"+BA.ObjectToString(_ls_time_conv.Get((int) (1)))+")"));
 //BA.debugLineNum = 884;BA.debugLine="newLine=CRLF";
_newline = anywheresoftware.b4a.keywords.Common.CRLF;
 }
};
 }else {
 //BA.debugLineNum = 890;BA.debugLine="ezList.Add(\"-\")";
_ezlist.Add((Object)("-"));
 };
 //BA.debugLineNum = 893;BA.debugLine="For i=0 To ezList.Size-1";
{
final int step19 = 1;
final int limit19 = (int) (_ezlist.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit19 ;_i = _i + step19 ) {
 //BA.debugLineNum = 894;BA.debugLine="lbl_ezafekari_day.Text=lbl_ezafekari_day.Text &";
...
String _str_sh = "";
 //BA.debugLineNum = 765;BA.debugLine="Sub get_monasebat ( id As Int)";
 //BA.debugLineNum = 766;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 767;BA.debugLine="lbl_today_monasebat.Text=\"\"";
mostCurrent._lbl_today_monasebat.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 768;BA.debugLine="lbl_today.Text=\"\"";
mostCurrent._lbl_today.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 770;BA.debugLine="dbCode.res =  dbCode.sql.ExecQuery(\"SELECT * FROM";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/  = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery("SELECT * FROM 'my_calander' WHERE id="+BA.NumberToString(_id))));
 //BA.debugLineNum = 773;BA.debugLine="dbCode.res.Position = 0";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (0));
 //BA.debugLineNum = 777;BA.debugLine="If(dbCode.res.GetString(\"monasebat\")<> \"\")Then";
if (((mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("monasebat")).equals("") == false)) { 
 //BA.debugLineNum = 778;BA.debugLine="lbl_today_monasebat.Text=dbCode.res.GetString(\"m";
mostCurrent._lbl_today_monasebat.setText(BA.ObjectToCharSequence(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("monasebat")));
 ...
 //BA.debugLineNum = 782;BA.debugLine="lbl_today.Text=lbl_year_tagvim.Text&\"/\"&dbCode.re";
mostCurrent._lbl_today.setText(BA.ObjectToCharSequence(mostCurrent._lbl_year_tagvim.getText()+"/"+mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("moon")+"/"+BA.NumberToString(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetInt("day_c"))));
 //BA.debugLineNum = 785;BA.debugLine="If (dbCode.res.GetString(\"state\") = \"tatil\")Then";
if (((mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("state")).equals("tatil"))) { 
 //BA.debugLineNum = 786;BA.debugLine="lbl_today.Text=lbl_today.Text&\" (تعطیل) \"";
mostCurrent._lbl_today.setText(BA.ObjectToCharSequence(mostCurrent._lbl_today.getText()+" (تعطیل) "));
 };
 //BA.debugLineNum = 789;BA.debugLine="If (dbCode.res.GetString(\"state\") = \"tatil1\")Then";
if (((mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("state")).equals("tatil1"))) { 
 //BA.debugLineNum = 790;BA.debugLine="lbl_today.Text=lbl_today.Text&\" ( تعطیل قراردادی";
mostCurrent._lbl_today.setText(BA.ObjectToCharSequence(mostCurrent._lbl_today.getText()+" ( تعطیل قراردادی) "));
 };
 //BA.debugLineNum = 793;BA.debugLine="If (dbCode.res.GetString(\"shift\") <> \"\")Then";
if (((mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("shift")).equals("") == false)) { 
 //BA.debugLineNum = 794;BA.debugLine="Dim str_sh As String";
_str_sh = "";
 //BA.debugLineNum = 795;BA.debugLine="Select dbCode.res.GetString(\"shift\")";
...
case 0: {
 //BA.debugLineNum = 797;BA.debugLine="str_sh=\"روزکار\"";
_str_sh = "روزکار";
 break; }
case 1: {
 //BA.debugLineNum = 799;BA.debugLine="str_sh=\"شبکار\"";
_str_sh = "شبکار";
 break; }
case 2: {
 //BA.debugLineNum = 801;BA.debugLine="str_sh=\"عصرکار\"";
_str_sh = "عصرکار";
 break; }
case 3: {
 //BA.debugLineNum = 803;BA.debugLine="str_sh=\"استراحت\"";
_str_sh = "استراحت";
 break; }
case 4: {
 //BA.debugLineNum = 805;BA.debugLine="str_sh=\"صبح-عصر\"";
_str_sh = "صبح-عصر";
 break; }
case 5: {
 //BA.debugLineNum = 807;BA.debugLine="str_sh=\"عصر-شب\"";
_str_sh = "عصر-شب";
 break; }
case 6: {
 //BA.debugLineNum = 809;BA.debugLine="str_sh=\"صبح-شب\"";
_str_sh = "صبح-شب";
 break; }
}
;
 //BA.debugLineNum = 812;BA.debugLine="lbl_today.Text=lbl_today.Text&\"- (( شیفت : \"&str";
...
anywheresoftware.b4a.objects.collections.List _ls_time_conv = null;
int _i = 0;
 //BA.debugLineNum = 899;BA.debugLine="Sub get_morakhasi(date1 As String)";
 //BA.debugLineNum = 900;BA.debugLine="lbl_morakhasi_day.Text=\"\"";
mostCurrent._lbl_morakhasi_day.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 901;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 902;BA.debugLine="Dim ezList As List";
_ezlist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 903;BA.debugLine="ezList.Initialize";
_ezlist.Initialize();
 //BA.debugLineNum = 904;BA.debugLine="Dim newLine As String=\"\"";
_newline = "";
 //BA.debugLineNum = 906;BA.debugLine="dbCode.res =  dbCode.sql.ExecQuery(\"SELECT * FROM";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/  = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery("SELECT * FROM tb_morakhasi WHERE date_from LIKE '"+_date1+"';")));
 //BA.debugLineNum = 908;BA.debugLine="If (dbCode.res.RowCount>0)Then";
if ((mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .getRowCount()>0)) { 
 //BA.debugLineNum = 909;BA.debugLine="For K=0 To dbCode.res.RowCount-1";
{
final int step8 = 1;
final int limit8 = (int) (mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .getRowCount()-1);
_k = (int) (0) ;
for (;_k <= limit8 ;_k = _k + step8 ) {
 //BA.debugLineNum = 910;BA.debugLine="dbCode.res.Position=K";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition(_k);
 //BA.debugLineNum = 912;BA.debugLine="Dim ls_time_conv As List";
_ls_time_conv = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 913;BA.debugLine="ls_time_conv.Initialize";
_ls_time_conv.Initialize();
 //BA.debugLineNum = 914;BA.debugLine="ls_time_conv=myfunc.Min_to_saatMinRoz(dbCode.re";
_ls_time_conv = mostCurrent._myfunc._min_to_saatminroz /*anywheresoftware.b4a.objects.collections.List*/ (mostCurrent.activityBA,mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetInt("end_tim_m"));
 //BA.debugLineNum = 917;BA.debugLine="ezList.Add(newLine&\"از \"&dbCode.res.GetString(\"";
_ezlist.Add((Object)(_newline+"از "+mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("time_from")+" تا "+mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("time_to")+"  ( "+BA.ObjectToString(_ls_time_conv.Get((int) (2)))+":"+BA.ObjectToString(_ls_time_conv.Get((int) (0)))+":"+BA.ObjectToString(_ls_time_conv.Get((int) (1)))+")"));
 //BA.debugLineNum = 918;BA.debugLine="newLine=CRLF";
_newline = anywheresoftware.b4a.keywords.Common.CRLF;
 }
};
 }else {
 //BA.debugLineNum = 924;BA.debugLine="ezList.Add(\"-\")";
_ezlist.Add((Object)("-"));
 };
 //BA.debugLineNum = 927;BA.debugLine="For i=0 To ezList.Size-1";
{
final int step19 = 1;
final int limit19 = (int) (_ezlist.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit19 ;_i = _i + step19 ) {
 //BA.debugLineNum = 928;BA.debugLine="lbl_morakhasi_day.Text=lbl_morakhasi_day.Text &";
...
public static String  _get_note(int _id) throws Exception{
 //BA.debugLineNum = 819;BA.debugLine="Sub get_note ( id As Int)";
 //BA.debugLineNum = 820;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 821;BA.debugLine="lbl_note_day.Text=\"\"";
mostCurrent._lbl_note_day.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 824;BA.debugLine="dbCode.res =  dbCode.sql.ExecQuery(\"SELECT * FROM";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/  = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery("SELECT * FROM 'my_calander' WHERE id="+BA.NumberToString(_id))));
 //BA.debugLineNum = 825;BA.debugLine="dbCode.res.Position = 0";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (0));
 //BA.debugLineNum = 827;BA.debugLine="If(dbCode.res.GetString(\"note\")<> \"\")Then";
if (((mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("note")).equals("") == false)) { 
 //BA.debugLineNum = 828;BA.debugLine="lbl_note_day.Text=dbCode.res.GetString(\"note\")";
...
int _k = 0;
int _i = 0;
 //BA.debugLineNum = 835;BA.debugLine="Sub get_taradod(date1 As String)";
 //BA.debugLineNum = 836;BA.debugLine="lbl_taradod_day.Text=\"\"";
mostCurrent._lbl_taradod_day.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 837;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 838;BA.debugLine="Dim ezList As List";
_ezlist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 839;BA.debugLine="ezList.Initialize";
_ezlist.Initialize();
 //BA.debugLineNum = 840;BA.debugLine="Dim newLine As String=\"\"";
_newline = "";
 //BA.debugLineNum = 842;BA.debugLine="dbCode.res =  dbCode.sql.ExecQuery(\"SELECT * FROM";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/  = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery("SELECT * FROM tb_taradod WHERE date_from LIKE '"+_date1+"';")));
 //BA.debugLineNum = 844;BA.debugLine="If (dbCode.res.RowCount>0)Then";
if ((mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .getRowCount()>0)) { 
 //BA.debugLineNum = 845;BA.debugLine="For K=0 To dbCode.res.RowCount-1";
{
final int step8 = 1;
final int limit8 = (int) (mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .getRowCount()-1);
_k = (int) (0) ;
for (;_k <= limit8 ;_k = _k + step8 ) {
 //BA.debugLineNum = 846;BA.debugLine="dbCode.res.Position=K";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition(_k);
 //BA.debugLineNum = 848;BA.debugLine="ezList.Add(newLine&\"از \"&dbCode.res.GetString(\"";
_ezlist.Add((Object)(_newline+"از "+mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("time_from")+" تا "+mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("time_to")));
 //BA.debugLineNum = 849;BA.debugLine="newLine=CRLF";
_newline = anywheresoftware.b4a.keywords.Common.CRLF;
 }
};
 }else {
 //BA.debugLineNum = 853;BA.debugLine="ezList.Add(\"-\")";
_ezlist.Add((Object)("-"));
 };
 //BA.debugLineNum = 856;BA.debugLine="For i=0 To ezList.Size-1";
{
final int step16 = 1;
final int limit16 = (int) (_ezlist.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit16 ;_i = _i + step16 ) {
 //BA.debugLineNum = 857;BA.debugLine="lbl_taradod_day.Text=lbl_taradod_day.Text & ezLi";
...
public static String  _lbl_back_2_click() throws Exception{
 //BA.debugLineNum = 1403;BA.debugLine="Private Sub lbl_back_2_Click";
 //BA.debugLineNum = 1404;BA.debugLine="pan_all_setSift.Visible=False";
mostCurrent._pan_all_setsift.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1405;BA.debugLine="lbl_delete_lis_olgo_Click";
_lbl_delete_lis_olgo_click();
 //BA.debugLineNum = 1406;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_back_click() throws Exception{
 //BA.debugLineNum = 736;BA.debugLine="Private Sub lbl_back_Click";
...
public static String  _lbl_checkbox_tatil_garardadi_click() throws Exception{
 //BA.debugLineNum = 1536;BA.debugLine="Private Sub lbl_CheckBox_tatil_garardadi_Click";
 //BA.debugLineNum = 1538;BA.debugLine="If(CheckBox_tatil_garardadi.Checked=True)Then";
if ((mostCurrent._checkbox_tatil_garardadi.getChecked()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 1539;BA.debugLine="CheckBox_tatil_garardadi.Checked=False";
mostCurrent._checkbox_tatil_garardadi.setChecked(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 1541;BA.debugLine="CheckBox_tatil_garardadi.Checked=True";
...
public static String  _lbl_checkbox_tatil_rasmi_click() throws Exception{
 //BA.debugLineNum = 1567;BA.debugLine="Private Sub lbl_CheckBox_tatil_rasmi_Click";
 //BA.debugLineNum = 1568;BA.debugLine="If(CheckBox_tatil_rasmi.Checked=True)Then";
if ((mostCurrent._checkbox_tatil_rasmi.getChecked()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 1569;BA.debugLine="CheckBox_tatil_rasmi.Checked=False";
mostCurrent._checkbox_tatil_rasmi.setChecked(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 1571;BA.debugLine="CheckBox_tatil_rasmi.Checked=True";
...
public static String  _lbl_del_shiftha_click() throws Exception{
 //BA.debugLineNum = 1414;BA.debugLine="Private Sub lbl_del_shiftha_Click";
 //BA.debugLineNum = 1415;BA.debugLine="shift_rest";
_shift_rest();
 //BA.debugLineNum = 1416;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_delete_lis_olgo_click() throws Exception{
 //BA.debugLineNum = 1408;BA.debugLine="Private Sub lbl_delete_lis_olgo_Click";
 //BA.debugLineNum = 1409;BA.debugLine="ls_set_shift.Clear";
mostCurrent._ls_set_shift.Clear();
 //BA.debugLineNum = 1410;BA.debugLine="list_sift_olgo.Clear";
...
public static String  _lbl_edit_note_click() throws Exception{
 //BA.debugLineNum = 1435;BA.debugLine="Private Sub lbl_edit_note_Click";
 //BA.debugLineNum = 1436;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 1437;BA.debugLine="dbCode.res =  dbCode.sql.ExecQuery(\"SELECT * FROM";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/  = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery("SELECT * FROM 'my_calander' WHERE id="+BA.NumberToString(_selectedday_id))));
 //BA.debugLineNum = 1438;BA.debugLine="dbCode.res.Position=0";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (0));
 //BA.debugLineNum = 1441;BA.debugLine="et_note.Text=dbCode.res.GetString(\"note\")";
mostCurrent._et_note.setText(BA.ObjectToCharSequence(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("note")));
 //BA.debugLineNum = 1443;BA.debugLine="lbl_date_in_note.Text=lbl_year_tagvim.Text&\"/\"&db";
mostCurrent._lbl_date_in_note.setText(BA.ObjectToCharSequence(mostCurrent._lbl_year_tagvim.getText()+"/"+mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("moon")+"/"+BA.NumberToString(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetInt("day_c"))));
 //BA.debugLineNum = 1446;BA.debugLine="pan_all_note.Visible=True";
...
public static String  _lbl_go_today_click() throws Exception{
 //BA.debugLineNum = 519;BA.debugLine="Private Sub lbl_go_today_Click";
 //BA.debugLineNum = 521;BA.debugLine="selectedDay_id=dbCode.get_day_id(this_year,this_m";
_selectedday_id = mostCurrent._dbcode._get_day_id /*int*/ (mostCurrent.activityBA,_this_year,_this_moon,_this_day);
 //BA.debugLineNum = 525;BA.debugLine="generat_taghvim(this_year,this_moon)";
_generat_taghvim(_this_year,_this_moon);
 //BA.debugLineNum = 527;BA.debugLine="get_monasebat( selectedDay_id )";
_get_monasebat(_selectedday_id);
 //BA.debugLineNum = 528;BA.debugLine="get_note(selectedDay_id)";
_get_note(_selectedday_id);
 //BA.debugLineNum = 530;BA.debugLine="get_ezafekari(this_year&\"/\"&myfunc.convert_adad(t";
_get_ezafekari(BA.NumberToString(_this_year)+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,_this_moon)+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,_this_day));
 //BA.debugLineNum = 531;BA.debugLine="get_morakhasi(this_year&\"/\"&myfunc.convert_adad(t";
_get_morakhasi(BA.NumberToString(_this_year)+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,_this_moon)+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,_this_day));
 //BA.debugLineNum = 532;BA.debugLine="get_taradod(this_year&\"/\"&myfunc.convert_adad(thi";
...
public static String  _lbl_help_shift_click() throws Exception{
 //BA.debugLineNum = 1563;BA.debugLine="Private Sub lbl_help_shift_Click";
 //BA.debugLineNum = 1564;BA.debugLine="myfunc.help_man(\"راهنما\",\"1- با نگهداشتن انگشت رو";
...
public static String  _lbl_mah_click() throws Exception{
 //BA.debugLineNum = 648;BA.debugLine="Private Sub lbl_mah_Click";
 //BA.debugLineNum = 649;BA.debugLine="rsPOP_mah.Show";
...
public static String  _lbl_mah_end_click() throws Exception{
 //BA.debugLineNum = 711;BA.debugLine="Private Sub lbl_mah_end_Click";
 //BA.debugLineNum = 712;BA.debugLine="rsPOP_mah_end.Show";
...
public static String  _lbl_moon_name_click() throws Exception{
 //BA.debugLineNum = 554;BA.debugLine="Private Sub lbl_moon_name_Click";
 //BA.debugLineNum = 555;BA.debugLine="rsPOP_moon_tagvim.Show";
...
int _i = 0;
 //BA.debugLineNum = 1262;BA.debugLine="Private Sub lbl_new_line_Click";
 //BA.debugLineNum = 1265;BA.debugLine="ls_set_shift.AddSingleLine(et_num_roz.Text&\" \"&sp";
mostCurrent._ls_set_shift.AddSingleLine(BA.ObjectToCharSequence(mostCurrent._et_num_roz.getText()+" "+mostCurrent._sp_noe_shift.getSelectedItem()));
 //BA.debugLineNum = 1266;BA.debugLine="For i=1 To et_num_roz.Text";
{
final int step2 = 1;
final int limit2 = (int)(Double.parseDouble(mostCurrent._et_num_roz.getText()));
_i = (int) (1) ;
for (;_i <= limit2 ;_i = _i + step2 ) {
 //BA.debugLineNum = 1268;BA.debugLine="Select sp_noe_shift.SelectedIndex";
switch (BA.switchObjectToInt(mostCurrent._sp_noe_shift.getSelectedIndex(),(int) (0),(int) (1),(int) (2),(int) (3),(int) (4),(int) (5),(int) (6))) {
case 0: {
 //BA.debugLineNum = 1271;BA.debugLine="list_sift_olgo.Add(\"ر\")";
mostCurrent._list_sift_olgo.Add((Object)("ر"));
 break; }
case 1: {
 //BA.debugLineNum = 1273;BA.debugLine="list_sift_olgo.Add(\"ع\")";
mostCurrent._list_sift_olgo.Add((Object)("ع"));
 break; }
case 2: {
 //BA.debugLineNum = 1275;BA.debugLine="list_sift_olgo.Add(\"ش\")";
mostCurrent._list_sift_olgo.Add((Object)("ش"));
 break; }
case 3: {
 //BA.debugLineNum = 1277;BA.debugLine="list_sift_olgo.Add(\"ا\")";
mostCurrent._list_sift_olgo.Add((Object)("ا"));
 break; }
case 4: {
 //BA.debugLineNum = 1279;BA.debugLine="list_sift_olgo.Add(\"ص/ع\")";
mostCurrent._list_sift_olgo.Add((Object)("ص/ع"));
 break; }
case 5: {
 //BA.debugLineNum = 1281;BA.debugLine="list_sift_olgo.Add(\"ع/ش\")";
mostCurrent._list_sift_olgo.Add((Object)("ع/ش"));
 break; }
case 6: {
 //BA.debugLineNum = 1283;BA.debugLine="list_sift_olgo.Add(\"ص/ش\")";
...
int _adad = 0;
 //BA.debugLineNum = 1212;BA.debugLine="Private Sub lbl_next_Click";
 //BA.debugLineNum = 1214;BA.debugLine="If (current_moon>=12)Then";
if ((_current_moon>=12)) { 
 //BA.debugLineNum = 1216;BA.debugLine="If(lbl_year_tagvim.Text<1403)Then";
if (((double)(Double.parseDouble(mostCurrent._lbl_year_tagvim.getText()))<1403)) { 
 //BA.debugLineNum = 1217;BA.debugLine="Dim adad As Int=lbl_year_tagvim.Text";
_adad = (int)(Double.parseDouble(mostCurrent._lbl_year_tagvim.getText()));
 //BA.debugLineNum = 1218;BA.debugLine="lbl_year_tagvim.Text=adad+1";
mostCurrent._lbl_year_tagvim.setText(BA.ObjectToCharSequence(_adad+1));
 //BA.debugLineNum = 1219;BA.debugLine="current_moon=1";
_current_moon = (int) (1);
 }else {
 //BA.debugLineNum = 1221;BA.debugLine="current_moon=12";
_current_moon = (int) (12);
 };
 }else {
 //BA.debugLineNum = 1227;BA.debugLine="current_moon=current_moon+1";
_current_moon = (int) (_current_moon+1);
 };
 //BA.debugLineNum = 1229;BA.debugLine="generat_taghvim(lbl_year_tagvim.Text,current_moon";
...
public static String  _lbl_note_day_menu_click() throws Exception{
 //BA.debugLineNum = 1531;BA.debugLine="Private Sub lbl_note_day_menu_Click";
 //BA.debugLineNum = 1532;BA.debugLine="lbl_edit_note_Click";
_lbl_edit_note_click();
 //BA.debugLineNum = 1533;BA.debugLine="pan_all_menu_day_Click";
_pan_all_menu_day_click();
...
int _adad = 0;
 //BA.debugLineNum = 1233;BA.debugLine="Private Sub lbl_prev_Click";
 //BA.debugLineNum = 1235;BA.debugLine="If (current_moon<=1)Then";
if ((_current_moon<=1)) { 
 //BA.debugLineNum = 1238;BA.debugLine="If(lbl_year_tagvim.Text>1398)Then";
if (((double)(Double.parseDouble(mostCurrent._lbl_year_tagvim.getText()))>1398)) { 
 //BA.debugLineNum = 1239;BA.debugLine="Dim adad As Int=lbl_year_tagvim.Text";
_adad = (int)(Double.parseDouble(mostCurrent._lbl_year_tagvim.getText()));
 //BA.debugLineNum = 1240;BA.debugLine="lbl_year_tagvim.Text=adad-1";
mostCurrent._lbl_year_tagvim.setText(BA.ObjectToCharSequence(_adad-1));
 //BA.debugLineNum = 1241;BA.debugLine="current_moon=12";
_current_moon = (int) (12);
 }else {
 //BA.debugLineNum = 1243;BA.debugLine="current_moon=1";
_current_moon = (int) (1);
 };
 }else {
 //BA.debugLineNum = 1248;BA.debugLine="current_moon=current_moon-1";
_current_moon = (int) (_current_moon-1);
 };
 //BA.debugLineNum = 1250;BA.debugLine="generat_taghvim(lbl_year_tagvim.Text,current_moon";
_generat_taghvim((int)(Double.parseDouble(mostCurrent._lbl_year_tagvim.getText())),_current_moon);
 //BA.debugLineNum = 1252;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_roz_click() throws Exception{
 //BA.debugLineNum = 652;BA.debugLine="Private Sub lbl_roz_Click";
 //BA.debugLineNum = 653;BA.debugLine="rsPOP_roz.Show";
...
public static String  _lbl_roz_end_click() throws Exception{
 //BA.debugLineNum = 715;BA.debugLine="Private Sub lbl_roz_end_Click";
 //BA.debugLineNum = 716;BA.debugLine="rsPOP_roz_end.Show";
...
public static String  _lbl_save_note_click() throws Exception{
 //BA.debugLineNum = 1503;BA.debugLine="Private Sub lbl_save_note_Click";
 //BA.debugLineNum = 1505;BA.debugLine="set_note(selectedDay_id,et_note.Text)";
_set_note(_selectedday_id,mostCurrent._et_note.getText());
 //BA.debugLineNum = 1506;BA.debugLine="generat_taghvim(lbl_year_tagvim.Text,lbl_moon_nam";
_generat_taghvim((int)(Double.parseDouble(mostCurrent._lbl_year_tagvim.getText())),(int)(BA.ObjectToNumber(mostCurrent._lbl_moon_name.getTag())));
 //BA.debugLineNum = 1507;BA.debugLine="pan_all_note.Visible=False";
mostCurrent._pan_all_note.setVisible(anywheresoftware.b4a.keywords.Common.False);
...
int _p = 0;
 //BA.debugLineNum = 1295;BA.debugLine="Private Sub lbl_save_shift_Click";
 //BA.debugLineNum = 1298;BA.debugLine="If(ls_set_shift.Size<1)Then";
if ((mostCurrent._ls_set_shift.getSize()<1)) { 
 //BA.debugLineNum = 1299;BA.debugLine="ToastMessageShow(\"الگو باید حداقل یک مورد باشد\",";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("الگو باید حداقل یک مورد باشد"),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 1304;BA.debugLine="set_shift(list_sift_olgo)";
_set_shift(mostCurrent._list_sift_olgo);
 //BA.debugLineNum = 1307;BA.debugLine="Dim ls_toSave As List";
_ls_tosave = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 1308;BA.debugLine="ls_toSave.Initialize";
_ls_tosave.Initialize();
 //BA.debugLineNum = 1310;BA.debugLine="For p=0 To ls_set_shift.Size-1";
{
final int step7 = 1;
final int limit7 = (int) (mostCurrent._ls_set_shift.getSize()-1);
_p = (int) (0) ;
for (;_p <= limit7 ;_p = _p + step7 ) {
 //BA.debugLineNum = 1311;BA.debugLine="ls_toSave.Add(ls_set_shift.GetItem(p))";
_ls_tosave.Add(mostCurrent._ls_set_shift.GetItem(_p));
 }
};
 //BA.debugLineNum = 1314;BA.debugLine="File.WriteList(File.DirInternal,\"shift_olgo\",ls_";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"shift_olgo",_ls_tosave);
 //BA.debugLineNum = 1315;BA.debugLine="File.WriteList(File.DirInternal,\"shift_olgo_cod\"";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"shift_olgo_cod",mostCurrent._list_sift_olgo);
 //BA.debugLineNum = 1318;BA.debugLine="pan_all_setSift.Visible=False";
mostCurrent._pan_all_setsift.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1322;BA.debugLine="lbl_delete_lis_olgo_Click";
_lbl_delete_lis_olgo_click();
 //BA.debugLineNum = 1323;BA.debugLine="generat_taghvim(this_year,this_moon)";
_generat_taghvim(_this_year,_this_moon);
 };
...
int _i = 0;
 //BA.debugLineNum = 1330;BA.debugLine="Private Sub lbl_show_panShift_Click";
 //BA.debugLineNum = 1332;BA.debugLine="If(File.Exists(File.DirInternal,\"shift_olgo\")=Tru";
if ((anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"shift_olgo")==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 1334;BA.debugLine="Dim ls_toLoad As List";
_ls_toload = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 1335;BA.debugLine="ls_toLoad.Initialize";
_ls_toload.Initialize();
 //BA.debugLineNum = 1337;BA.debugLine="ls_toLoad=File.ReadList(File.DirInternal,\"shift_";
_ls_toload = anywheresoftware.b4a.keywords.Common.File.ReadList(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"shift_olgo");
 //BA.debugLineNum = 1339;BA.debugLine="For i=0 To ls_toLoad.Size-1";
{
final int step5 = 1;
final int limit5 = (int) (_ls_toload.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit5 ;_i = _i + step5 ) {
 //BA.debugLineNum = 1340;BA.debugLine="ls_set_shift.AddSingleLine(ls_toLoad.Get(i))";
mostCurrent._ls_set_shift.AddSingleLine(BA.ObjectToCharSequence(_ls_toload.Get(_i)));
 }
};
 //BA.debugLineNum = 1343;BA.debugLine="list_sift_olgo=File.ReadList(File.DirInternal,\"s";
mostCurrent._list_sift_olgo = anywheresoftware.b4a.keywords.Common.File.ReadList(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"shift_olgo_cod");
 ...
 //BA.debugLineNum = 1347;BA.debugLine="pan_all_setSift.Visible=True";
...
public static String  _lbl_year_tagvim_click() throws Exception{
 //BA.debugLineNum = 550;BA.debugLine="Private Sub lbl_year_tagvim_Click";
 //BA.debugLineNum = 551;BA.debugLine="rsPOP_year_tagvim.Show";
mostCurrent._rspop_year_tagvim.Show();
 //BA.debugLineNum = 552;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_years_click() throws Exception{
 //BA.debugLineNum = 644;BA.debugLine="Private Sub lbl_years_Click";
 //BA.debugLineNum = 645;BA.debugLine="rsPOP_year.Show";
...
public static String  _lbl_years_end_click() throws Exception{
 //BA.debugLineNum = 707;BA.debugLine="Private Sub lbl_years_end_Click";
 //BA.debugLineNum = 708;BA.debugLine="rsPOP_year_end.Show";
...
public static String  _mod_tatil_garardadi(int _id) throws Exception{
 //BA.debugLineNum = 1465;BA.debugLine="Sub mod_tatil_garardadi (id As Int)";
 //BA.debugLineNum = 1466;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 1467;BA.debugLine="dbCode.res =  dbCode.sql.ExecQuery(\"SELECT * FROM";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/  = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery("SELECT * FROM 'my_calander' WHERE id="+BA.NumberToString(_id))));
 //BA.debugLineNum = 1468;BA.debugLine="dbCode.res.Position=0";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (0));
 //BA.debugLineNum = 1471;BA.debugLine="If(dbCode.res.GetString(\"state\")=\"tatil\") Then";
if (((mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("state")).equals("tatil"))) { 
 //BA.debugLineNum = 1474;BA.debugLine="CheckBox_tatil_garardadi.Checked=False";
mostCurrent._checkbox_tatil_garardadi.setChecked(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1475;BA.debugLine="CheckBox_tatil_rasmi.Checked=True";
mostCurrent._checkbox_tatil_rasmi.setChecked(anywheresoftware.b4a.keywords.Common.True);
 }else if(((mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("state")).equals("tatil1"))) { 
 //BA.debugLineNum = 1480;BA.debugLine="CheckBox_tatil_garardadi.Checked=True";
mostCurrent._checkbox_tatil_garardadi.setChecked(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1481;BA.debugLine="CheckBox_tatil_rasmi.Checked=False";
mostCurrent._checkbox_tatil_rasmi.setChecked(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 1485;BA.debugLine="CheckBox_tatil_garardadi.Checked=False";
mostCurrent._checkbox_tatil_garardadi.setChecked(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1486;BA.debugLine="CheckBox_tatil_rasmi.Checked=False";
mostCurrent._checkbox_tatil_rasmi.setChecked(anywheresoftware.b4a.keywords.Common.False);
 };
...
int _d = 0;
int _moon_tag = 0;
 //BA.debugLineNum = 1156;BA.debugLine="Private Sub PA_Click";
 //BA.debugLineNum = 1157;BA.debugLine="Dim str_t As String";
_str_t = "";
 //BA.debugLineNum = 1158;BA.debugLine="Dim B As Panel = Sender";
...
_b = (anywheresoftware.b4a.objects.PanelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.PanelWrapper(), (android.view.ViewGroup)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 1159;BA.debugLine="selectedDay_id=dbCode.get_day_id(lbl_year_tagvim.";
_selectedday_id = mostCurrent._dbcode._get_day_id /*int*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._lbl_year_tagvim.getText())),(int)(BA.ObjectToNumber(mostCurrent._lbl_moon_name.getTag())),(int)(BA.ObjectToNumber(_b.getTag())));
 //BA.debugLineNum = 1161;BA.debugLine="For d=0 To PA.Length-1";
{
final int step4 = 1;
final int limit4 = (int) (mostCurrent._pa.length-1);
_d = (int) (0) ;
for (;_d <= limit4 ;_d = _d + step4 ) {
 //BA.debugLineNum = 1162;BA.debugLine="str_t=PA(d).Tag";
_str_t = BA.ObjectToString(mostCurrent._pa[_d].getTag());
 //BA.debugLineNum = 1163;BA.debugLine="If ( str_t = last_selected_itemTag )Then";
if (((_str_t).equals(BA.NumberToString(_last_selected_itemtag)))) { 
 //BA.debugLineNum = 1167;BA.debugLine="If(last_selected_itemTag<>0)Then";
if ((_last_selected_itemtag!=0)) { 
 //BA.debugLineNum = 1169;BA.debugLine="If(ls_tatili_moon.Get(last_selected_itemTag-1)";
if (((mostCurrent._ls_tatili_moon.Get((int) (_last_selected_itemtag-1))).equals((Object)(anywheresoftware.b4a.keywords.Common.True)))) { 
 //BA.debugLineNum = 1170;BA.debugLine="PA(d).Color=0xFFFF5252";
mostCurrent._pa[_d].setColor(((int)0xffff5252));
 ...
 //BA.debugLineNum = 1173;BA.debugLine="PA(d).Color=0xFF00BB8B";
mostCurrent._pa[_d].setColor(((int)0xff00bb8b));
 }else {
 //BA.debugLineNum = 1176;BA.debugLine="PA(d).Color=0xFFEFEFEF";
mostCurrent._pa[_d].setColor(((int)0xffefefef));
 };
 };
 };
 ...
 //BA.debugLineNum = 1189;BA.debugLine="Dim moon_tag As Int=lbl_moon_name.Tag";
_moon_tag = (int)(BA.ObjectToNumber(mostCurrent._lbl_moon_name.getTag()));
 //BA.debugLineNum = 1190;BA.debugLine="If( moon_tag=this_moon)Then";
if ((_moon_tag==_this_moon)) { 
 //BA.debugLineNum = 1192;BA.debugLine="Lb(index_i_today).TextColor=0xFFFF9000";
mostCurrent._lb[_index_i_today].setTextColor(((int)0xffff9000));
 };
 //BA.debugLineNum = 1197;BA.debugLine="B.Color=Colors.Gray";
_b.setColor(anywheresoftware.b4a.keywords.Common.Colors.Gray);
 //BA.debugLineNum = 1198;BA.debugLine="get_monasebat(selectedDay_id)";
_get_monasebat(_selectedday_id);
 //BA.debugLineNum = 1199;BA.debugLine="get_note(selectedDay_id)";
_get_note(_selectedday_id);
 //BA.debugLineNum = 1201;BA.debugLine="get_ezafekari(lbl_year_tagvim.Text&\"/\"&myfunc.con";
_get_ezafekari(mostCurrent._lbl_year_tagvim.getText()+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,(int)(BA.ObjectToNumber(mostCurrent._lbl_moon_name.getTag())))+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,(int)(BA.ObjectToNumber(_b.getTag()))));
 //BA.debugLineNum = 1202;BA.debugLine="get_morakhasi(lbl_year_tagvim.Text&\"/\"&myfunc.con";
_get_morakhasi(mostCurrent._lbl_year_tagvim.getText()+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,(int)(BA.ObjectToNumber(mostCurrent._lbl_moon_name.getTag())))+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,(int)(BA.ObjectToNumber(_b.getTag()))));
 //BA.debugLineNum = 1203;BA.debugLine="get_taradod(lbl_year_tagvim.Text&\"/\"&myfunc.conve";
_get_taradod(mostCurrent._lbl_year_tagvim.getText()+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,(int)(BA.ObjectToNumber(mostCurrent._lbl_moon_name.getTag())))+"/"+mostCurrent._myfunc._convert_adad /*String*/ (mostCurrent.activityBA,(int)(BA.ObjectToNumber(_b.getTag()))));
 //BA.debugLineNum = 1205;BA.debugLine="last_selected_itemTag=B.Tag";
...
anywheresoftware.b4a.objects.PanelWrapper _b = null;
 //BA.debugLineNum = 1449;BA.debugLine="Private Sub PA_LongClick";
 //BA.debugLineNum = 1450;BA.debugLine="Dim B As Panel = Sender";
_b = new anywheresoftware.b4a.objects.PanelWrapper();
_b = (anywheresoftware.b4a.objects.PanelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.PanelWrapper(), (android.view.ViewGroup)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 1453;BA.debugLine="selectedDay_id=dbCode.get_day_id(lbl_year_tagvim.";
_selectedday_id = mostCurrent._dbcode._get_day_id /*int*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._lbl_year_tagvim.getText())),(int)(BA.ObjectToNumber(mostCurrent._lbl_moon_name.getTag())),(int)(BA.ObjectToNumber(_b.getTag())));
 //BA.debugLineNum = 1460;BA.debugLine="lbl_title_day_menu.Text=lbl_year_tagvim.Text&\"/\"&";
mostCurrent._lbl_title_day_menu.setText(BA.ObjectToCharSequence(mostCurrent._lbl_year_tagvim.getText()+"/"+BA.ObjectToString(mostCurrent._lbl_moon_name.getTag())+"/"+BA.ObjectToString(_b.getTag())));
 //BA.debugLineNum = 1461;BA.debugLine="mod_tatil_garardadi(selectedDay_id)";
_mod_tatil_garardadi(_selectedday_id);
 //BA.debugLineNum = 1462;BA.debugLine="pan_all_menu_day.Visible=True";
...
public static String  _pan_all_menu_day_click() throws Exception{
 //BA.debugLineNum = 1523;BA.debugLine="Private Sub pan_all_menu_day_Click";
 //BA.debugLineNum = 1524;BA.debugLine="pan_all_menu_day.Visible=False";
...
public static String  _pan_all_note_click() throws Exception{
 //BA.debugLineNum = 1495;BA.debugLine="Private Sub pan_all_note_Click";
 //BA.debugLineNum = 1496;BA.debugLine="pan_all_note.Visible=False";
mostCurrent._pan_all_note.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1497;BA.debugLine="End Sub";
return "";
}
public static String  _pan_all_setsift_click() throws Exception{
 //BA.debugLineNum = 1258;BA.debugLine="Private Sub pan_all_setSift_Click";
 //BA.debugLineNum = 1260;BA.debugLine="End Sub";
return "";
}
public static String  _panel12_click() throws Exception{
 //BA.debugLineNum = 1499;BA.debugLine="Private Sub Panel12_Click";
 //BA.debugLineNum = 1501;BA.debugLine="End Sub";
return "";
}
public static String  _panel8_click() throws Exception{
 //BA.debugLineNum = 1527;BA.debugLine="Private Sub Panel8_Click";
...
String _mmah = "";
 //BA.debugLineNum = 663;BA.debugLine="Sub rsPOP_mah_end_MenuItemClick (ItemId As Int) As";
 //BA.debugLineNum = 664;BA.debugLine="Dim mmah As String";
_mmah = "";
 //BA.debugLineNum = 665;BA.debugLine="Select ItemId";
switch (_itemid) {
case 1: {
 //BA.debugLineNum = 667;BA.debugLine="mmah=\"فروردین\"";
_mmah = "فروردین";
 break; }
case 2: {
 //BA.debugLineNum = 669;BA.debugLine="mmah=\"اردیبهشت\"";
_mmah = "اردیبهشت";
 break; }
case 3: {
 //BA.debugLineNum = 671;BA.debugLine="mmah=\"خرداد\"";
_mmah = "خرداد";
 break; }
case 4: {
 //BA.debugLineNum = 673;BA.debugLine="mmah=\"تیر\"";
_mmah = "تیر";
 break; }
case 5: {
 //BA.debugLineNum = 675;BA.debugLine="mmah=\"مرداد\"";
_mmah = "مرداد";
 break; }
case 6: {
 //BA.debugLineNum = 677;BA.debugLine="mmah=\"شهریور\"";
_mmah = "شهریور";
 break; }
case 7: {
 //BA.debugLineNum = 679;BA.debugLine="mmah=\"مهر\"";
_mmah = "مهر";
 break; }
case 8: {
 //BA.debugLineNum = 681;BA.debugLine="mmah=\"آبان\"";
_mmah = "آبان";
 break; }
case 9: {
 //BA.debugLineNum = 683;BA.debugLine="mmah=\"آذر\"";
_mmah = "آذر";
 break; }
case 10: {
 //BA.debugLineNum = 685;BA.debugLine="mmah=\"دی\"";
_mmah = "دی";
 break; }
case 11: {
 //BA.debugLineNum = 687;BA.debugLine="mmah=\"بهمن\"";
_mmah = "بهمن";
 break; }
case 12: {
 //BA.debugLineNum = 689;BA.debugLine="mmah=\"اسفند\"";
_mmah = "اسفند";
 break; }
}
;
 //BA.debugLineNum = 695;BA.debugLine="lbl_mah_end.Text=mmah";
mostCurrent._lbl_mah_end.setText(BA.ObjectToCharSequence(_mmah));
 //BA.debugLineNum = 696;BA.debugLine="lbl_mah_end_tagID=ItemId";
_lbl_mah_end_tagid = _itemid;
 //BA.debugLineNum = 698;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
...
String _mmah = "";
 //BA.debugLineNum = 603;BA.debugLine="Sub rsPOP_mah_MenuItemClick (ItemId As Int) As Boo";
 //BA.debugLineNum = 604;BA.debugLine="Dim mmah As String";
_mmah = "";
 //BA.debugLineNum = 605;BA.debugLine="Select ItemId";
switch (_itemid) {
case 1: {
 //BA.debugLineNum = 607;BA.debugLine="mmah=\"فروردین\"";
_mmah = "فروردین";
 break; }
case 2: {
 //BA.debugLineNum = 609;BA.debugLine="mmah=\"اردیبهشت\"";
_mmah = "اردیبهشت";
 break; }
case 3: {
 //BA.debugLineNum = 611;BA.debugLine="mmah=\"خرداد\"";
_mmah = "خرداد";
 break; }
case 4: {
 //BA.debugLineNum = 613;BA.debugLine="mmah=\"تیر\"";
_mmah = "تیر";
 break; }
case 5: {
 //BA.debugLineNum = 615;BA.debugLine="mmah=\"مرداد\"";
_mmah = "مرداد";
 break; }
case 6: {
 //BA.debugLineNum = 617;BA.debugLine="mmah=\"شهریور\"";
_mmah = "شهریور";
 break; }
case 7: {
 //BA.debugLineNum = 619;BA.debugLine="mmah=\"مهر\"";
_mmah = "مهر";
 break; }
case 8: {
 //BA.debugLineNum = 621;BA.debugLine="mmah=\"آبان\"";
_mmah = "آبان";
 break; }
case 9: {
 //BA.debugLineNum = 623;BA.debugLine="mmah=\"آذر\"";
_mmah = "آذر";
 break; }
case 10: {
 //BA.debugLineNum = 625;BA.debugLine="mmah=\"دی\"";
_mmah = "دی";
 break; }
case 11: {
 //BA.debugLineNum = 627;BA.debugLine="mmah=\"بهمن\"";
_mmah = "بهمن";
 break; }
case 12: {
 //BA.debugLineNum = 629;BA.debugLine="mmah=\"اسفند\"";
_mmah = "اسفند";
 break; }
}
;
 //BA.debugLineNum = 633;BA.debugLine="lbl_mah.Text=mmah";
mostCurrent._lbl_mah.setText(BA.ObjectToCharSequence(_mmah));
 //BA.debugLineNum = 634;BA.debugLine="lbl_mah_tagID=ItemId";
...
String _mmah = "";
 //BA.debugLineNum = 560;BA.debugLine="Sub rsPOP_moon_tagvim_MenuItemClick (ItemId As Int";
 //BA.debugLineNum = 561;BA.debugLine="Dim mmah As String";
_mmah = "";
 //BA.debugLineNum = 562;BA.debugLine="Select ItemId";
switch (_itemid) {
case 1: {
 //BA.debugLineNum = 564;BA.debugLine="mmah=\"فروردین\"";
_mmah = "فروردین";
 break; }
case 2: {
 //BA.debugLineNum = 566;BA.debugLine="mmah=\"اردیبهشت\"";
_mmah = "اردیبهشت";
 break; }
case 3: {
 //BA.debugLineNum = 568;BA.debugLine="mmah=\"خرداد\"";
_mmah = "خرداد";
 break; }
case 4: {
 //BA.debugLineNum = 570;BA.debugLine="mmah=\"تیر\"";
_mmah = "تیر";
 break; }
case 5: {
 //BA.debugLineNum = 572;BA.debugLine="mmah=\"مرداد\"";
_mmah = "مرداد";
 break; }
case 6: {
 //BA.debugLineNum = 574;BA.debugLine="mmah=\"شهریور\"";
_mmah = "شهریور";
 break; }
case 7: {
 //BA.debugLineNum = 576;BA.debugLine="mmah=\"مهر\"";
_mmah = "مهر";
 break; }
case 8: {
 //BA.debugLineNum = 578;BA.debugLine="mmah=\"آبان\"";
_mmah = "آبان";
 break; }
case 9: {
 //BA.debugLineNum = 580;BA.debugLine="mmah=\"آذر\"";
_mmah = "آذر";
 break; }
case 10: {
 //BA.debugLineNum = 582;BA.debugLine="mmah=\"دی\"";
_mmah = "دی";
 break; }
case 11: {
 //BA.debugLineNum = 584;BA.debugLine="mmah=\"بهمن\"";
_mmah = "بهمن";
 break; }
case 12: {
 //BA.debugLineNum = 586;BA.debugLine="mmah=\"اسفند\"";
_mmah = "اسفند";
 break; }
}
;
 //BA.debugLineNum = 590;BA.debugLine="lbl_moon_name.Text=mmah";
mostCurrent._lbl_moon_name.setText(BA.ObjectToCharSequence(_mmah));
 //BA.debugLineNum = 592;BA.debugLine="generat_taghvim(lbl_year_tagvim.Text,ItemId)";
_generat_taghvim((int)(Double.parseDouble(mostCurrent._lbl_year_tagvim.getText())),_itemid);
 //BA.debugLineNum = 593;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 594;BA.debugLine="End Sub";
return false;
}
public static boolean  _rspop_roz_end_menuitemclick(int _itemid) throws Exception{
 //BA.debugLineNum = 700;BA.debugLine="Sub rsPOP_roz_end_MenuItemClick (ItemId As Int) As";
 //BA.debugLineNum = 702;BA.debugLine="lbl_roz_end.Text=ItemId";
...
public static boolean  _rspop_roz_menuitemclick(int _itemid) throws Exception{
 //BA.debugLineNum = 638;BA.debugLine="Sub rsPOP_roz_MenuItemClick (ItemId As Int) As Boo";
 //BA.debugLineNum = 640;BA.debugLine="lbl_roz.Text=ItemId";
...
public static boolean  _rspop_year_end_menuitemclick(int _itemid) throws Exception{
 //BA.debugLineNum = 659;BA.debugLine="Sub rsPOP_year_end_MenuItemClick (ItemId As Int) A";
 //BA.debugLineNum = 660;BA.debugLine="lbl_years_end.Text=ItemId";
...
public static boolean  _rspop_year_menuitemclick(int _itemid) throws Exception{
 //BA.debugLineNum = 599;BA.debugLine="Sub rsPOP_year_MenuItemClick (ItemId As Int) As Bo";
 //BA.debugLineNum = 600;BA.debugLine="lbl_years.Text=ItemId";
...
public static boolean  _rspop_year_tagvim_menuitemclick(int _itemid) throws Exception{
 //BA.debugLineNum = 544;BA.debugLine="Sub rsPOP_year_tagvim_MenuItemClick (ItemId As Int";
 //BA.debugLineNum = 545;BA.debugLine="lbl_year_tagvim.Text=ItemId";
mostCurrent._lbl_year_tagvim.setText(BA.ObjectToCharSequence(_itemid));
 //BA.debugLineNum = 546;BA.debugLine="generat_taghvim(lbl_year_tagvim.Text,current_moon";
_generat_taghvim((int)(Double.parseDouble(mostCurrent._lbl_year_tagvim.getText())),_current_moon);
 //BA.debugLineNum = 547;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 548;BA.debugLine="End Sub";
return false;
}
public static String  _set_note(int _id,String _matn) throws Exception{
 //BA.debugLineNum = 1512;BA.debugLine="Sub set_note(id As Int , matn As String)";
 //BA.debugLineNum = 1513;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 1514;BA.debugLine="dbCode.sql.ExecNonQuery(\"UPDATE 'my_calander' set";
mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery("UPDATE 'my_calander' set note='"+_matn+"' WHERE id="+BA.NumberToString(_id));
 //BA.debugLineNum = 1516;BA.debugLine="ToastMessageShow(\"یادداشت ذخیره شد\",True)";
...
int _i = 0;
 //BA.debugLineNum = 1353;BA.debugLine="Sub set_shift(ol As List )";
 //BA.debugLineNum = 1355;BA.debugLine="Try";
try { //BA.debugLineNum = 1356;BA.debugLine="ProgressDialogShow(\"در حال تنظیم شیفت ها\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("در حال تنظیم شیفت ها"));
 //BA.debugLineNum = 1358;BA.debugLine="Dim start_shift As Int";
_start_shift = 0;
 //BA.debugLineNum = 1359;BA.debugLine="Dim end_shift As Int";
_end_shift = 0;
 //BA.debugLineNum = 1361;BA.debugLine="Dim index_curent_shift As Int=0";
_index_curent_shift = (int) (0);
 //BA.debugLineNum = 1362;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 1364;BA.debugLine="dbCode.sql.ExecNonQuery(\"UPDATE 'my_calander' se";
mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery("UPDATE 'my_calander' set shift=''");
 //BA.debugLineNum = 1367;BA.debugLine="start_shift=dbCode.get_day_id(lbl_years.Text,lbl";
_start_shift = mostCurrent._dbcode._get_day_id /*int*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._lbl_years.getText())),_lbl_mah_tagid,(int)(Double.parseDouble(mostCurrent._lbl_roz.getText())));
 //BA.debugLineNum = 1368;BA.debugLine="end_shift=dbCode.get_day_id(lbl_years_end.Text,l";
_end_shift = mostCurrent._dbcode._get_day_id /*int*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._lbl_years_end.getText())),_lbl_mah_end_tagid,(int)(Double.parseDouble(mostCurrent._lbl_roz_end.getText())));
 //BA.debugLineNum = 1371;BA.debugLine="For i=start_shift To end_shift";
{
final int step10 = 1;
final int limit10 = _end_shift;
_i = _start_shift ;
for (;_i <= limit10 ;_i = _i + step10 ) {
 //BA.debugLineNum = 1373;BA.debugLine="dbCode.sql.ExecNonQuery2(\"UPDATE 'my_calander'";
mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery2("UPDATE 'my_calander' set shift=? WHERE id=?",anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{mostCurrent._list_sift_olgo.Get(_index_curent_shift),(Object)(_i)}));
 //BA.debugLineNum = 1376;BA.debugLine="If(index_curent_shift=list_sift_olgo.Size-1)The";
if ((_index_curent_shift==mostCurrent._list_sift_olgo.getSize()-1)) { 
 //BA.debugLineNum = 1377;BA.debugLine="index_curent_shift=0";
_index_curent_shift = (int) (0);
 }else {
 //BA.debugLineNum = 1379;BA.debugLine="index_curent_shift=index_curent_shift+1";
_index_curent_shift = (int) (_index_curent_shift+1);
 };
 }
};
 //BA.debugLineNum = 1384;BA.debugLine="dbCode.sql.Close";
mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .Close();
 //BA.debugLineNum = 1385;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 } 
       catch (Exception e21) {
			processBA.setLastException(e21); //BA.debugLineNum = 1388;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("19699363",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 //BA.debugLineNum = 1389;BA.debugLine="ToastMessageShow(\"خطا در تاریخ\",False)";
...
public static String  _shift_rest() throws Exception{
 //BA.debugLineNum = 1418;BA.debugLine="Sub shift_rest";
 //BA.debugLineNum = 1419;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 1420;BA.debugLine="dbCode.sql.ExecNonQuery(\"UPDATE 'my_calander' set";
mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery("UPDATE 'my_calander' set shift='' ");
 //BA.debugLineNum = 1421;BA.debugLine="If(File.Exists(File.DirInternal,\"shift_olgo\"))The";
if ((anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"shift_olgo"))) { 
 //BA.debugLineNum = 1422;BA.debugLine="File.Delete(File.DirInternal,\"shift_olgo\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"shift_olgo");
 //BA.debugLineNum = 1423;BA.debugLine="File.Delete(File.DirInternal,\"shift_olgo_cod\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"shift_olgo_cod");
 };
 //BA.debugLineNum = 1427;BA.debugLine="pan_all_setSift.Visible=False";
mostCurrent._pan_all_setsift.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1428;BA.debugLine="lbl_delete_lis_olgo_Click";
_lbl_delete_lis_olgo_click();
 //BA.debugLineNum = 1429;BA.debugLine="generat_taghvim(this_year,this_moon)";
_generat_taghvim(_this_year,_this_moon);
 //BA.debugLineNum = 1430;BA.debugLine="ToastMessageShow(\"همه شیفت ها حذف شدند\",True)";
...
public static String  _sql_nonquerycomplete(boolean _success) throws Exception{
 //BA.debugLineNum = 1397;BA.debugLine="Sub sql_NonQueryComplete (Success As Boolean)";
