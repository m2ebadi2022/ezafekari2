...
anywheresoftware.b4a.keywords.Common.LogImpl("651380330","nooop data",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("651380426",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
public static String  _lbl_mah_click() throws Exception{
 //BA.debugLineNum = 647;BA.debugLine="Private Sub lbl_mah_Click";
 //BA.debugLineNum = 648;BA.debugLine="rsPOP_mah.Show";
...
;
 //BA.debugLineNum = 632;BA.debugLine="lbl_mah.Text=mmah";
...
anywheresoftware.b4a.keywords.Common.LogImpl("651904547",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
