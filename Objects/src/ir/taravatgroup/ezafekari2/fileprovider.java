...
RDebugUtils.currentLine=63635456;
 //BA.debugLineNum = 63635456;BA.debugLine="Public Sub GetFileUri (FileName As String) As Obje";
RDebugUtils.currentLine=63635458;
 //BA.debugLineNum = 63635458;BA.debugLine="If UseFileProvider = False Then";
if (__ref._usefileprovider /*boolean*/ ==__c.False) { 
RDebugUtils.currentLine=63635459;
 //BA.debugLineNum = 63635459;BA.debugLine="Dim uri As JavaObject";
_uri = new anywheresoftware.b4j.object.JavaObject();
RDebugUtils.currentLine=63635460;
 //BA.debugLineNum = 63635460;BA.debugLine="Return uri.InitializeStatic(\"android.net.Uri\").R";
...
RDebugUtils.currentLine=63635462;
 //BA.debugLineNum = 63635462;BA.debugLine="Dim f As JavaObject";
_f = new anywheresoftware.b4j.object.JavaObject();
RDebugUtils.currentLine=63635463;
 //BA.debugLineNum = 63635463;BA.debugLine="f.InitializeNewInstance(\"java.io.File\", Array(Sh";
...
RDebugUtils.currentLine=63635464;
 //BA.debugLineNum = 63635464;BA.debugLine="Dim fp As JavaObject";
_fp = new anywheresoftware.b4j.object.JavaObject();
RDebugUtils.currentLine=63635465;
 //BA.debugLineNum = 63635465;BA.debugLine="Dim context As JavaObject";
_context = new anywheresoftware.b4j.object.JavaObject();
RDebugUtils.currentLine=63635466;
 //BA.debugLineNum = 63635466;BA.debugLine="context.InitializeContext";
_context.InitializeContext(ba);
RDebugUtils.currentLine=63635467;
 //BA.debugLineNum = 63635467;BA.debugLine="fp.InitializeStatic(\"android.support.v4.content.";
_fp.InitializeStatic("androidx.core.content.FileProvider");
RDebugUtils.currentLine=63635468;
 //BA.debugLineNum = 63635468;BA.debugLine="Return fp.RunMethod(\"getUriForFile\", Array(conte";
...
RDebugUtils.currentLine=63635470;
 //BA.debugLineNum = 63635470;BA.debugLine="End Sub";
return null;
}
...
RDebugUtils.currentLine=63569920;
 //BA.debugLineNum = 63569920;BA.debugLine="Public Sub Initialize";
RDebugUtils.currentLine=63569921;
 //BA.debugLineNum = 63569921;BA.debugLine="Dim p As Phone";
_p = new anywheresoftware.b4a.phone.Phone();
RDebugUtils.currentLine=63569922;
 //BA.debugLineNum = 63569922;BA.debugLine="If p.SdkVersion >= 24 Or File.ExternalWritable =";
if (_p.getSdkVersion()>=24 || __c.File.getExternalWritable()==__c.False) { 
RDebugUtils.currentLine=63569923;
 //BA.debugLineNum = 63569923;BA.debugLine="UseFileProvider = True";
__ref._usefileprovider /*boolean*/  = __c.True;
RDebugUtils.currentLine=63569924;
 //BA.debugLineNum = 63569924;BA.debugLine="SharedFolder = File.Combine(File.DirInternal, \"s";
__ref._sharedfolder /*String*/  = __c.File.Combine(__c.File.getDirInternal(),"shared");
RDebugUtils.currentLine=63569925;
 //BA.debugLineNum = 63569925;BA.debugLine="File.MakeDir(\"\", SharedFolder)";
__c.File.MakeDir("",__ref._sharedfolder /*String*/ );
 }else {
RDebugUtils.currentLine=63569927;
 //BA.debugLineNum = 63569927;BA.debugLine="UseFileProvider = False";
__ref._usefileprovider /*boolean*/  = __c.False;
RDebugUtils.currentLine=63569928;
 //BA.debugLineNum = 63569928;BA.debugLine="SharedFolder = rp.GetSafeDirDefaultExternal(\"sha";
...
RDebugUtils.currentLine=63569930;
 //BA.debugLineNum = 63569930;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=63504385;
 //BA.debugLineNum = 63504385;BA.debugLine="Public SharedFolder As String";
_sharedfolder = "";
RDebugUtils.currentLine=63504386;
 //BA.debugLineNum = 63504386;BA.debugLine="Public UseFileProvider As Boolean";
_usefileprovider = false;
RDebugUtils.currentLine=63504387;
 //BA.debugLineNum = 63504387;BA.debugLine="Private rp As RuntimePermissions";
...
RDebugUtils.currentLine=63700992;
 //BA.debugLineNum = 63700992;BA.debugLine="Public Sub SetFileUriAsIntentData (Intent As Inten";
RDebugUtils.currentLine=63700993;
 //BA.debugLineNum = 63700993;BA.debugLine="Dim jo As JavaObject = Intent";
...
RDebugUtils.currentLine=63700994;
 //BA.debugLineNum = 63700994;BA.debugLine="jo.RunMethod(\"setData\", Array(GetFileUri(FileName";
_jo.RunMethod("setData",new Object[]{__ref._getfileuri /*Object*/ (null,_filename)});
RDebugUtils.currentLine=63700995;
 //BA.debugLineNum = 63700995;BA.debugLine="Intent.Flags = Bit.Or(Intent.Flags, 1) 'FLAG_GRAN";
