...
mostCurrent._myfunc._set_font /*String*/ (mostCurrent.activityBA,mostCurrent._activity);
 //BA.debugLineNum = 108;BA.debugLine="olad_vahed=716618    ' sal 1403";
_olad_vahed = (int) (716618);
 //BA.debugLineNum = 113;BA.debugLine="sp_ganon_kar.Add(\"سال 1403\")";
mostCurrent._sp_ganon_kar.Add("سال 1403");
 //BA.debugLineNum = 114;BA.debugLine="sp_ganon_kar.Add(\"سال 1402\")";
mostCurrent._sp_ganon_kar.Add("سال 1402");
 //BA.debugLineNum = 115;BA.debugLine="sp_ganon_kar.Add(\"سال 1401\")";
mostCurrent._sp_ganon_kar.Add("سال 1401");
 //BA.debugLineNum = 116;BA.debugLine="sp_ganon_kar.Add(\"سال 1400\")";
mostCurrent._sp_ganon_kar.Add("سال 1400");
 //BA.debugLineNum = 117;BA.debugLine="sp_ganon_kar.Add(\"سال 1399\")";
mostCurrent._sp_ganon_kar.Add("سال 1399");
 //BA.debugLineNum = 118;BA.debugLine="sp_ganon_kar.Add(\"سفارشی شده\")";
mostCurrent._sp_ganon_kar.Add("سفارشی شده");
 //BA.debugLineNum = 123;BA.debugLine="sp_olad.AddAll(Array As String(0,1,2,3,4,5,6,7,8,";
mostCurrent._sp_olad.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{BA.NumberToString(0),BA.NumberToString(1),BA.NumberToString(2),BA.NumberToString(3),BA.NumberToString(4),BA.NumberToString(5),BA.NumberToString(6),BA.NumberToString(7),BA.NumberToString(8),BA.NumberToString(9),BA.NumberToString(10)}));
 //BA.debugLineNum = 128;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 129;BA.debugLine="dbCode.res= dbCode.sql.ExecQuery(\"SELECT * FROM t";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/  = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery("SELECT * FROM tb_setting")));
 //BA.debugLineNum = 131;BA.debugLine="dbCode.res.Position=0 ''--------paye------";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (0));
 //BA.debugLineNum = 132;BA.debugLine="et_paye.Text=myfunc.show_num_pool(dbCode.res.GetS";
mostCurrent._et_paye.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._show_num_pool /*String*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value"))))));
 //BA.debugLineNum = 133;BA.debugLine="et_paye.Tag=dbCode.res.GetString(\"value\")";
mostCurrent._et_paye.setTag((Object)(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 137;BA.debugLine="dbCode.res.Position=1 ''--------mashan------";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (1));
 //BA.debugLineNum = 138;BA.debugLine="et_maskan.Tag=dbCode.res.GetString(\"value\")";
mostCurrent._et_maskan.setTag((Object)(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 139;BA.debugLine="et_maskan.Text=myfunc.show_num_pool(dbCode.res.Ge";
mostCurrent._et_maskan.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._show_num_pool /*String*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value"))))));
 //BA.debugLineNum = 141;BA.debugLine="dbCode.res.Position=3 ''--------olad------";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (3));
 //BA.debugLineNum = 142;BA.debugLine="et_olad.Tag=dbCode.res.GetString(\"value\")";
mostCurrent._et_olad.setTag((Object)(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 143;BA.debugLine="et_olad.Text=myfunc.show_num_pool(dbCode.res.GetS";
mostCurrent._et_olad.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._show_num_pool /*String*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value"))))));
 //BA.debugLineNum = 147;BA.debugLine="dbCode.res.Position=4 ''--------fani------";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (4));
 //BA.debugLineNum = 148;BA.debugLine="et_fani.Tag=dbCode.res.GetString(\"value\")";
mostCurrent._et_fani.setTag((Object)(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 149;BA.debugLine="et_fani.Text=myfunc.show_num_pool(dbCode.res.GetS";
mostCurrent._et_fani.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._show_num_pool /*String*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value"))))));
 //BA.debugLineNum = 151;BA.debugLine="dbCode.res.Position=5 ''--------masoliat------";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (5));
 //BA.debugLineNum = 152;BA.debugLine="et_masoliat.tag=dbCode.res.GetString(\"value\")";
mostCurrent._et_masoliat.setTag((Object)(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 153;BA.debugLine="et_masoliat.Text=myfunc.show_num_pool(dbCode.res.";
mostCurrent._et_masoliat.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._show_num_pool /*String*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value"))))));
 //BA.debugLineNum = 155;BA.debugLine="dbCode.res.Position=2 ''--------bon------";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (2));
 //BA.debugLineNum = 156;BA.debugLine="et_bon.Tag=dbCode.res.GetString(\"value\")";
mostCurrent._et_bon.setTag((Object)(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 157;BA.debugLine="et_bon.Text=myfunc.show_num_pool(dbCode.res.GetSt";
mostCurrent._et_bon.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._show_num_pool /*String*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value"))))));
 //BA.debugLineNum = 162;BA.debugLine="dbCode.res.Position=6 ''--------bime_tamin------";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (6));
 //BA.debugLineNum = 163;BA.debugLine="et_bime_tamin.Text=dbCode.res.GetString(\"value\")";
mostCurrent._et_bime_tamin.setText(BA.ObjectToCharSequence(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 165;BA.debugLine="dbCode.res.Position=11 ''--------bime_takmili----";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (11));
 //BA.debugLineNum = 166;BA.debugLine="et_bime_takmil.Tag=dbCode.res.GetString(\"value\")";
mostCurrent._et_bime_takmil.setTag((Object)(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 167;BA.debugLine="et_bime_takmil.Text=myfunc.show_num_pool(dbCode.r";
mostCurrent._et_bime_takmil.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._show_num_pool /*String*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value"))))));
 //BA.debugLineNum = 169;BA.debugLine="dbCode.res.Position=13 ''--------hag shift------";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (13));
 //BA.debugLineNum = 170;BA.debugLine="et_shift.Text=dbCode.res.GetString(\"value\")";
mostCurrent._et_shift.setText(BA.ObjectToCharSequence(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 172;BA.debugLine="dbCode.res.Position=14 ''--------hag sanavat-----";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (14));
 //BA.debugLineNum = 173;BA.debugLine="et_sanavat.Tag=dbCode.res.GetString(\"value\")";
mostCurrent._et_sanavat.setTag((Object)(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 174;BA.debugLine="et_sanavat.Text=myfunc.show_num_pool(dbCode.res.G";
mostCurrent._et_sanavat.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._show_num_pool /*String*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value"))))));
 //BA.debugLineNum = 176;BA.debugLine="dbCode.res.Position=15 ''--------hag sarparasti--";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (15));
 //BA.debugLineNum = 177;BA.debugLine="et_sarparast.Tag=dbCode.res.GetString(\"value\")";
mostCurrent._et_sarparast.setTag((Object)(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 178;BA.debugLine="et_sarparast.Text=myfunc.show_num_pool(dbCode.res";
mostCurrent._et_sarparast.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._show_num_pool /*String*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value"))))));
 //BA.debugLineNum = 180;BA.debugLine="dbCode.res.Position=16 ''--------mazaya------";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (16));
 //BA.debugLineNum = 181;BA.debugLine="et_mazaya.Tag=dbCode.res.GetString(\"value\")";
mostCurrent._et_mazaya.setTag((Object)(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 182;BA.debugLine="et_mazaya.Text=myfunc.show_num_pool(dbCode.res.Ge";
mostCurrent._et_mazaya.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._show_num_pool /*String*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value"))))));
 //BA.debugLineNum = 184;BA.debugLine="dbCode.res.Position=19 ''--------ksorat------";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (19));
 //BA.debugLineNum = 185;BA.debugLine="et_ksorat.Tag=dbCode.res.GetString(\"value\")";
mostCurrent._et_ksorat.setTag((Object)(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 186;BA.debugLine="et_ksorat.Text=myfunc.show_num_pool(dbCode.res.Ge";
mostCurrent._et_ksorat.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._show_num_pool /*String*/ (mostCurrent.activityBA,(int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value"))))));
 //BA.debugLineNum = 194;BA.debugLine="dbCode.res.Position=18 ''--------number olad-----";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (18));
 //BA.debugLineNum = 195;BA.debugLine="sp_olad.SelectedIndex=dbCode.res.GetString(\"value";
mostCurrent._sp_olad.setSelectedIndex((int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value"))));
 //BA.debugLineNum = 197;BA.debugLine="dbCode.res.Position=26 ''--------saat  kari dar r";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (26));
 //BA.debugLineNum = 198;BA.debugLine="min_saat_kari=dbCode.res.GetString(\"value\")";
_min_saat_kari = (int)(Double.parseDouble(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("value")));
 //BA.debugLineNum = 200;BA.debugLine="Dim sat1 As Int= min_saat_kari/60";
_sat1 = (int) (_min_saat_kari/(double)60);
 //BA.debugLineNum = 201;BA.debugLine="Dim dag1 As Int= min_saat_kari Mod 60";
_dag1 = (int) (_min_saat_kari%60);
 //BA.debugLineNum = 203;BA.debugLine="et_saat_kari.Text=sat1";
mostCurrent._et_saat_kari.setText(BA.ObjectToCharSequence(_sat1));
 //BA.debugLineNum = 204;BA.debugLine="et_min_kari.Text=dag1";
mostCurrent._et_min_kari.setText(BA.ObjectToCharSequence(_dag1));
 //BA.debugLineNum = 212;BA.debugLine="lbl_vahed.Text=\"واحد : تومان\"";
mostCurrent._lbl_vahed.setText(BA.ObjectToCharSequence("واحد : تومان"));
 //BA.debugLineNum = 214;BA.debugLine="dbCode.res.Close";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .Close();
 //BA.debugLineNum = 215;BA.debugLine="dbCode.sql.Close";
mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .Close();
 //BA.debugLineNum = 220;BA.debugLine="et_hamsar.Tag=dbCode.get_setting_byName(\"hag_hams";
mostCurrent._et_hamsar.setTag((Object)(mostCurrent._dbcode._get_setting_byname /*String*/ (mostCurrent.activityBA,"hag_hamsar")));
 //BA.debugLineNum = 221;BA.debugLine="et_hamsar.Text=myfunc.show_num_pool(et_hamsar.Tag";
mostCurrent._et_hamsar.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._show_num_pool /*String*/ (mostCurrent.activityBA,(int)(BA.ObjectToNumber(mostCurrent._et_hamsar.getTag())))));
 //BA.debugLineNum = 222;BA.debugLine="If(et_hamsar.Tag > 0)Then";
if (((double)(BA.ObjectToNumber(mostCurrent._et_hamsar.getTag()))>0)) { 
 //BA.debugLineNum = 223;BA.debugLine="chek_hamsar.Checked=True";
mostCurrent._chek_hamsar.setChecked(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 225;BA.debugLine="chek_hamsar.Checked=False";
mostCurrent._chek_hamsar.setChecked(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 231;BA.debugLine="Dim pay_ch As Int=et_paye.tag";
_pay_ch = (int)(BA.ObjectToNumber(mostCurrent._et_paye.getTag()));
 //BA.debugLineNum = 233;BA.debugLine="If (pay_ch=7166184)Then   '' sal 1403";
if ((_pay_ch==7166184)) { 
 //BA.debugLineNum = 234;BA.debugLine="sp_ganon_kar.SelectedIndex=0";
mostCurrent._sp_ganon_kar.setSelectedIndex((int) (0));
 }else if((_pay_ch==5308284)) { 
 //BA.debugLineNum = 237;BA.debugLine="sp_ganon_kar.SelectedIndex=1";
mostCurrent._sp_ganon_kar.setSelectedIndex((int) (1));
 }else if((_pay_ch==4179755)) { 
 //BA.debugLineNum = 240;BA.debugLine="sp_ganon_kar.SelectedIndex=2";
mostCurrent._sp_ganon_kar.setSelectedIndex((int) (2));
 }else if((_pay_ch==2655492)) { 
 //BA.debugLineNum = 243;BA.debugLine="sp_ganon_kar.SelectedIndex=3";
mostCurrent._sp_ganon_kar.setSelectedIndex((int) (3));
 }else if((_pay_ch==1910427)) { 
 //BA.debugLineNum = 246;BA.debugLine="sp_ganon_kar.SelectedIndex=4";
mostCurrent._sp_ganon_kar.setSelectedIndex((int) (4));
 }else {
 //BA.debugLineNum = 248;BA.debugLine="sp_ganon_kar.SelectedIndex=5";
mostCurrent._sp_ganon_kar.setSelectedIndex((int) (5));
 };
 //BA.debugLineNum = 253;BA.debugLine="If (File.Exists(File.DirInternal,\"help_set_hogog\"";
if ((anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"help_set_hogog")==anywheresoftware.b4a.keywords.Common.False)) { 
 //BA.debugLineNum = 254;BA.debugLine="show_help";
_show_help();
 //BA.debugLineNum = 255;BA.debugLine="File.WriteString(File.DirInternal,\"help_set_hogo";
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 420;BA.debugLine="lbl_back_Click";
_lbl_back_click();
...
public static String  _chek_hamsar_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 727;BA.debugLine="Private Sub chek_hamsar_CheckedChange(Checked As B";
 //BA.debugLineNum = 728;BA.debugLine="If(Checked)Then";
if ((_checked)) { 
 //BA.debugLineNum = 729;BA.debugLine="et_hamsar.Tag=hamsar_int";
mostCurrent._et_hamsar.setTag((Object)(_hamsar_int));
 //BA.debugLineNum = 730;BA.debugLine="et_hamsar.Text=myfunc.show_num_pool(hamsar_int)";
mostCurrent._et_hamsar.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._show_num_pool /*String*/ (mostCurrent.activityBA,_hamsar_int)));
 ...
 //BA.debugLineNum = 733;BA.debugLine="et_hamsar.Tag=0";
mostCurrent._et_hamsar.setTag((Object)(0));
 //BA.debugLineNum = 734;BA.debugLine="et_hamsar.Text=myfunc.show_num_pool(0)";
...
public static boolean  _empty_fild(anywheresoftware.b4a.objects.EditTextWrapper _et) throws Exception{
 //BA.debugLineNum = 637;BA.debugLine="Sub empty_fild(et As EditText) As Boolean";
 //BA.debugLineNum = 638;BA.debugLine="If(et.Text.Trim=\"\")Then";
if (((_et.getText().trim()).equals(""))) { 
 //BA.debugLineNum = 639;BA.debugLine="ToastMessageShow(\"فیلد خالی است\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("فیلد خالی است"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 640;BA.debugLine="et.Color=0x9FFF4E4E";
_et.setColor(((int)0x9fff4e4e));
 //BA.debugLineNum = 641;BA.debugLine="Return True";
if (true) return anywheresoftware.b4a.keywords.Common.True;
 };
...
public static String  _et_bime_takmil_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 586;BA.debugLine="Private Sub et_bime_takmil_TextChanged (Old As Str";
 //BA.debugLineNum = 587;BA.debugLine="et_bime_takmil.Tag=New.Replace(\",\",\"\")";
mostCurrent._et_bime_takmil.setTag((Object)(_new.replace(",","")));
 //BA.debugLineNum = 588;BA.debugLine="myfunc.change_formater(Old,New,et_bime_takmil)";
...
public static String  _et_bon_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 591;BA.debugLine="Private Sub et_bon_TextChanged (Old As String, New";
 //BA.debugLineNum = 592;BA.debugLine="et_bon.Tag=New.Replace(\",\",\"\")";
mostCurrent._et_bon.setTag((Object)(_new.replace(",","")));
 //BA.debugLineNum = 593;BA.debugLine="myfunc.change_formater(Old,New,et_bon)";
...
public static String  _et_fani_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 615;BA.debugLine="Private Sub et_fani_TextChanged (Old As String, Ne";
 //BA.debugLineNum = 616;BA.debugLine="et_fani.Tag=New.Replace(\",\",\"\")";
mostCurrent._et_fani.setTag((Object)(_new.replace(",","")));
 //BA.debugLineNum = 617;BA.debugLine="myfunc.change_formater(Old,New,et_fani)";
...
public static String  _et_hamsar_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 596;BA.debugLine="Private Sub et_hamsar_TextChanged (Old As String,";
 //BA.debugLineNum = 597;BA.debugLine="et_hamsar.Tag=New.Replace(\",\",\"\")";
mostCurrent._et_hamsar.setTag((Object)(_new.replace(",","")));
 //BA.debugLineNum = 598;BA.debugLine="myfunc.change_formater(Old,New,et_hamsar)";
...
public static String  _et_ksorat_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 581;BA.debugLine="Private Sub et_ksorat_TextChanged (Old As String,";
 //BA.debugLineNum = 582;BA.debugLine="et_ksorat.Tag=New.Replace(\",\",\"\")";
mostCurrent._et_ksorat.setTag((Object)(_new.replace(",","")));
 //BA.debugLineNum = 583;BA.debugLine="myfunc.change_formater(Old,New,et_ksorat)";
...
public static String  _et_maskan_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 625;BA.debugLine="Private Sub et_maskan_TextChanged (Old As String,";
 //BA.debugLineNum = 626;BA.debugLine="et_maskan.Tag=New.Replace(\",\",\"\")";
mostCurrent._et_maskan.setTag((Object)(_new.replace(",","")));
 //BA.debugLineNum = 627;BA.debugLine="myfunc.change_formater(Old,New,et_maskan)";
...
public static String  _et_masoliat_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 610;BA.debugLine="Private Sub et_masoliat_TextChanged (Old As String";
 //BA.debugLineNum = 611;BA.debugLine="et_masoliat.Tag=New.Replace(\",\",\"\")";
mostCurrent._et_masoliat.setTag((Object)(_new.replace(",","")));
 //BA.debugLineNum = 612;BA.debugLine="myfunc.change_formater(Old,New,et_masoliat)";
...
public static String  _et_mazaya_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 576;BA.debugLine="Private Sub et_mazaya_TextChanged (Old As String,";
 //BA.debugLineNum = 577;BA.debugLine="et_mazaya.Tag=New.Replace(\",\",\"\")";
mostCurrent._et_mazaya.setTag((Object)(_new.replace(",","")));
 //BA.debugLineNum = 578;BA.debugLine="myfunc.change_formater(Old,New,et_mazaya)";
...
public static String  _et_olad_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 620;BA.debugLine="Private Sub et_olad_TextChanged (Old As String, Ne";
 //BA.debugLineNum = 621;BA.debugLine="et_olad.Tag=New.Replace(\",\",\"\")";
mostCurrent._et_olad.setTag((Object)(_new.replace(",","")));
 //BA.debugLineNum = 622;BA.debugLine="myfunc.change_formater(Old,New,et_olad)";
...
public static String  _et_paye_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 570;BA.debugLine="Private Sub et_paye_TextChanged (Old As String, Ne";
 //BA.debugLineNum = 571;BA.debugLine="et_paye.Tag=New.Replace(\",\",\"\")";
mostCurrent._et_paye.setTag((Object)(_new.replace(",","")));
 //BA.debugLineNum = 572;BA.debugLine="myfunc.change_formater(Old,New,et_paye)";
...
public static String  _et_sanavat_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 630;BA.debugLine="Private Sub et_sanavat_TextChanged (Old As String,";
 //BA.debugLineNum = 631;BA.debugLine="et_sanavat.Tag=New.Replace(\",\",\"\")";
mostCurrent._et_sanavat.setTag((Object)(_new.replace(",","")));
 //BA.debugLineNum = 632;BA.debugLine="myfunc.change_formater(Old,New,et_sanavat)";
...
public static String  _et_sarparast_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 605;BA.debugLine="Private Sub et_sarparast_TextChanged (Old As Strin";
 //BA.debugLineNum = 606;BA.debugLine="et_sarparast.Tag=New.Replace(\",\",\"\")";
mostCurrent._et_sarparast.setTag((Object)(_new.replace(",","")));
 //BA.debugLineNum = 607;BA.debugLine="myfunc.change_formater(Old,New,et_sarparast)";
...
anywheresoftware.b4a.objects.LabelWrapper _this_onv = null;
 //BA.debugLineNum = 682;BA.debugLine="Private Sub EV_onv_LongClick";
 //BA.debugLineNum = 683;BA.debugLine="Dim this_onv As Label";
_this_onv = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 684;BA.debugLine="this_onv=Sender";
_this_onv = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 687;BA.debugLine="current_index_onvan=this_onv.Tag";
_current_index_onvan = (int)(BA.ObjectToNumber(_this_onv.getTag()));
 //BA.debugLineNum = 689;BA.debugLine="lbl_onv_def.Text=get_onvan_byId(this_onv.Tag).Get";
mostCurrent._lbl_onv_def.setText(BA.ObjectToCharSequence(_get_onvan_byid((int)(BA.ObjectToNumber(_this_onv.getTag()))).Get((int) (0))));
 //BA.debugLineNum = 690;BA.debugLine="et_onv_new.Text=get_onvan_byId(this_onv.Tag).Get(";
mostCurrent._et_onv_new.setText(BA.ObjectToCharSequence(_get_onvan_byid((int)(BA.ObjectToNumber(_this_onv.getTag()))).Get((int) (1))));
 //BA.debugLineNum = 693;BA.debugLine="pan_all_onvanHa.Visible=True";
...
anywheresoftware.b4a.objects.collections.List _ls_result = null;
 //BA.debugLineNum = 704;BA.debugLine="Sub get_onvan_byId (id1 As Int) As List";
 //BA.debugLineNum = 705;BA.debugLine="Dim ls_result As List";
_ls_result = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 706;BA.debugLine="ls_result.Initialize";
_ls_result.Initialize();
 //BA.debugLineNum = 707;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 708;BA.debugLine="dbCode.res= dbCode.sql.ExecQuery(\"SELECT * FROM t";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/  = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery("SELECT * FROM tbl_onvanha WHERE id="+BA.NumberToString(_id1))));
 //BA.debugLineNum = 709;BA.debugLine="dbCode.res.Position=0";
mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .setPosition((int) (0));
 //BA.debugLineNum = 710;BA.debugLine="ls_result.Add(dbCode.res.GetString(\"def_name\"))";
_ls_result.Add((Object)(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("def_name")));
 //BA.debugLineNum = 711;BA.debugLine="ls_result.Add(dbCode.res.GetString(\"custom_name\")";
_ls_result.Add((Object)(mostCurrent._dbcode._res /*anywheresoftware.b4a.sql.SQL.ResultSetWrapper*/ .GetString("custom_name")));
 //BA.debugLineNum = 712;BA.debugLine="Return ls_result";
...
public static String  _lbl_back_click() throws Exception{
 //BA.debugLineNum = 274;BA.debugLine="Private Sub lbl_back_Click";
 //BA.debugLineNum = 276;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 277;BA.debugLine="StartActivity(Main)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._main.getObject()));
 //BA.debugLineNum = 280;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_help_onv_click() throws Exception{
 //BA.debugLineNum = 721;BA.debugLine="Private Sub lbl_help_onv_Click";
 //BA.debugLineNum = 722;BA.debugLine="myfunc.help_man(\"راهنما\",\"با نگه داشتن انگشت روی";
...
public static String  _lbl_onv_def_click() throws Exception{
 //BA.debugLineNum = 716;BA.debugLine="Private Sub lbl_onv_def_Click";
 //BA.debugLineNum = 717;BA.debugLine="et_onv_new.Text=lbl_onv_def.Text";
...
anywheresoftware.b4a.objects.collections.List _data = null;
 //BA.debugLineNum = 282;BA.debugLine="Private Sub lbl_save_Click";
 //BA.debugLineNum = 283;BA.debugLine="Dim exep As Boolean=True";
_exep = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 285;BA.debugLine="et_paye.Color=Colors.White";
mostCurrent._et_paye.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 286;BA.debugLine="et_maskan.Color=Colors.White";
mostCurrent._et_maskan.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 287;BA.debugLine="et_fani.Color=Colors.White";
mostCurrent._et_fani.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 288;BA.debugLine="et_masoliat.Color=Colors.White";
mostCurrent._et_masoliat.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 289;BA.debugLine="et_olad.Color=Colors.White";
mostCurrent._et_olad.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 290;BA.debugLine="et_bon.Color=Colors.White";
mostCurrent._et_bon.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 291;BA.debugLine="et_hamsar.Color=Colors.White";
mostCurrent._et_hamsar.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 293;BA.debugLine="et_bime_takmil.Color=Colors.White";
mostCurrent._et_bime_takmil.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 296;BA.debugLine="et_shift.Color=Colors.White";
mostCurrent._et_shift.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 297;BA.debugLine="et_sanavat.Color=Colors.White";
mostCurrent._et_sanavat.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 298;BA.debugLine="et_sarparast.Color=Colors.White";
mostCurrent._et_sarparast.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 299;BA.debugLine="et_mazaya.Color=Colors.White";
mostCurrent._et_mazaya.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 300;BA.debugLine="et_ksorat.Color=Colors.White";
mostCurrent._et_ksorat.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 301;BA.debugLine="et_saat_kari.Color=Colors.White";
mostCurrent._et_saat_kari.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 302;BA.debugLine="et_min_kari.Color=Colors.White";
mostCurrent._et_min_kari.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 317;BA.debugLine="et_maliat.TextColor=Colors.Black";
mostCurrent._et_maliat.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 320;BA.debugLine="If(et_shift.Text=\"\")Then";
if (((mostCurrent._et_shift.getText()).equals(""))) { 
 //BA.debugLineNum = 321;BA.debugLine="et_shift.Text=0";
mostCurrent._et_shift.setText(BA.ObjectToCharSequence(0));
 };
 //BA.debugLineNum = 323;BA.debugLine="If(et_saat_kari.Text=\"\")Then";
if (((mostCurrent._et_saat_kari.getText()).equals(""))) { 
 //BA.debugLineNum = 324;BA.debugLine="et_saat_kari.Text=8";
mostCurrent._et_saat_kari.setText(BA.ObjectToCharSequence(8));
 };
 //BA.debugLineNum = 326;BA.debugLine="If(et_min_kari.Text=\"\")Then";
if (((mostCurrent._et_min_kari.getText()).equals(""))) { 
 //BA.debugLineNum = 327;BA.debugLine="et_min_kari.Text=0";
mostCurrent._et_min_kari.setText(BA.ObjectToCharSequence(0));
 };
 //BA.debugLineNum = 331;BA.debugLine="If(et_shift.Text>100 Or et_shift.Text<0 Or  et_sh";
if (((double)(Double.parseDouble(mostCurrent._et_shift.getText()))>100 || (double)(Double.parseDouble(mostCurrent._et_shift.getText()))<0 || (mostCurrent._et_shift.getText()).equals(""))) { 
 //BA.debugLineNum = 332;BA.debugLine="ToastMessageShow(\"خطا درصد-(0 تا 100)\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("خطا درصد-(0 تا 100)"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 333;BA.debugLine="et_shift.TextColor=Colors.Red";
mostCurrent._et_shift.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 334;BA.debugLine="exep=False";
_exep = anywheresoftware.b4a.keywords.Common.False;
 }else {
 //BA.debugLineNum = 336;BA.debugLine="et_shift.TextColor=Colors.Black";
mostCurrent._et_shift.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 };
 //BA.debugLineNum = 339;BA.debugLine="If(et_saat_kari.Text>24 Or et_saat_kari.Text<0 )T";
if (((double)(Double.parseDouble(mostCurrent._et_saat_kari.getText()))>24 || (double)(Double.parseDouble(mostCurrent._et_saat_kari.getText()))<0)) { 
 //BA.debugLineNum = 340;BA.debugLine="ToastMessageShow(\"ساعت کاری را اصلاح نمائید\",Fal";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("ساعت کاری را اصلاح نمائید"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 341;BA.debugLine="et_saat_kari.TextColor=Colors.Red";
...
_exep = anywheresoftware.b4a.keywords.Common.False;
 ...
 //BA.debugLineNum = 344;BA.debugLine="et_saat_kari.TextColor=Colors.Black";
mostCurrent._et_saat_kari.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 };
 //BA.debugLineNum = 347;BA.debugLine="If(et_min_kari.Text>59 Or et_min_kari.Text<0 )The";
...
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("ساعت کاری را اصلاح نمائید"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 349;BA.debugLine="et_min_kari.TextColor=Colors.Red";
...
_exep = anywheresoftware.b4a.keywords.Common.False;
 ...
 //BA.debugLineNum = 352;BA.debugLine="et_min_kari.TextColor=Colors.Black";
mostCurrent._et_min_kari.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 };
 //BA.debugLineNum = 358;BA.debugLine="If(empty_fild(et_paye)=True)Then";
if ((_empty_fild(mostCurrent._et_paye)==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 359;BA.debugLine="exep=False";
_exep = anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 361;BA.debugLine="If(empty_fild(et_maskan)=True)Then";
if ((_empty_fild(mostCurrent._et_maskan)==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 362;BA.debugLine="exep=False";
_exep = anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 364;BA.debugLine="If(empty_fild(et_bon)=True)Then";
if ((_empty_fild(mostCurrent._et_bon)==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 365;BA.debugLine="exep=False";
_exep = anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 367;BA.debugLine="If(empty_fild(et_hamsar)=True)Then";
if ((_empty_fild(mostCurrent._et_hamsar)==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 368;BA.debugLine="exep=False";
_exep = anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 371;BA.debugLine="If(et_sanavat.Text=\"\")Then";
if (((mostCurrent._et_sanavat.getText()).equals(""))) { 
 //BA.debugLineNum = 372;BA.debugLine="et_sanavat.Text=0";
mostCurrent._et_sanavat.setText(BA.ObjectToCharSequence(0));
 };
 //BA.debugLineNum = 374;BA.debugLine="If(et_olad.Text=\"\")Then";
if (((mostCurrent._et_olad.getText()).equals(""))) { 
 //BA.debugLineNum = 375;BA.debugLine="et_olad.Text=0";
mostCurrent._et_olad.setText(BA.ObjectToCharSequence(0));
 };
 //BA.debugLineNum = 377;BA.debugLine="If(et_fani.Text=\"\")Then";
if (((mostCurrent._et_fani.getText()).equals(""))) { 
 //BA.debugLineNum = 378;BA.debugLine="et_fani.Text=0";
mostCurrent._et_fani.setText(BA.ObjectToCharSequence(0));
 };
 //BA.debugLineNum = 380;BA.debugLine="If(et_masoliat.Text=\"\")Then";
if (((mostCurrent._et_masoliat.getText()).equals(""))) { 
 //BA.debugLineNum = 381;BA.debugLine="et_masoliat.Text=0";
mostCurrent._et_masoliat.setText(BA.ObjectToCharSequence(0));
 };
 //BA.debugLineNum = 383;BA.debugLine="If(et_sarparast.Text=\"\")Then";
if (((mostCurrent._et_sarparast.getText()).equals(""))) { 
 //BA.debugLineNum = 384;BA.debugLine="et_sarparast.Text=0";
mostCurrent._et_sarparast.setText(BA.ObjectToCharSequence(0));
 };
 //BA.debugLineNum = 386;BA.debugLine="If(et_bime_takmil.Text=\"\")Then";
if (((mostCurrent._et_bime_takmil.getText()).equals(""))) { 
 //BA.debugLineNum = 387;BA.debugLine="et_bime_takmil.Text=0";
mostCurrent._et_bime_takmil.setText(BA.ObjectToCharSequence(0));
 };
 //BA.debugLineNum = 389;BA.debugLine="If(et_mazaya.Text=\"\")Then";
if (((mostCurrent._et_mazaya.getText()).equals(""))) { 
 //BA.debugLineNum = 390;BA.debugLine="et_mazaya.Text=0";
mostCurrent._et_mazaya.setText(BA.ObjectToCharSequence(0));
 };
 //BA.debugLineNum = 392;BA.debugLine="If(et_ksorat.Text=\"\")Then";
if (((mostCurrent._et_ksorat.getText()).equals(""))) { 
 //BA.debugLineNum = 393;BA.debugLine="et_ksorat.Text=0";
mostCurrent._et_ksorat.setText(BA.ObjectToCharSequence(0));
 };
 //BA.debugLineNum = 397;BA.debugLine="Dim min_sat_kar As Int=(et_saat_kari.Text*60)+et_";
_min_sat_kar = (int) (((double)(Double.parseDouble(mostCurrent._et_saat_kari.getText()))*60)+(double)(Double.parseDouble(mostCurrent._et_min_kari.getText())));
 //BA.debugLineNum = 399;BA.debugLine="If(exep=True)Then";
if ((_exep==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 400;BA.debugLine="Dim data As List";
_data = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 401;BA.debugLine="data.Initialize";
_data.Initialize();
 //BA.debugLineNum = 402;BA.debugLine="data.AddAll(Array As String(et_paye.Tag,et_maska";
_data.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{BA.ObjectToString(mostCurrent._et_paye.getTag()),BA.ObjectToString(mostCurrent._et_maskan.getTag()),BA.ObjectToString(mostCurrent._et_olad.getTag()),BA.ObjectToString(mostCurrent._et_fani.getTag()),BA.ObjectToString(mostCurrent._et_masoliat.getTag()),BA.ObjectToString(mostCurrent._et_bon.getTag()),mostCurrent._et_bime_tamin.getText(),BA.ObjectToString(mostCurrent._et_bime_takmil.getTag()),BA.NumberToString(10),mostCurrent._et_shift.getText(),BA.ObjectToString(mostCurrent._et_sanavat.getTag()),BA.ObjectToString(mostCurrent._et_sarparast.getTag()),BA.ObjectToString(mostCurrent._et_mazaya.getTag()),mostCurrent._sp_olad.getSelectedItem(),BA.ObjectToString(mostCurrent._et_ksorat.getTag()),BA.NumberToString(_min_sat_kar),BA.ObjectToString(mostCurrent._et_hamsar.getTag())}));
 //BA.debugLineNum = 405;BA.debugLine="If (dbCode.add_setting_hogog(data)) Then";
if ((mostCurrent._dbcode._add_setting_hogog /*boolean*/ (mostCurrent.activityBA,_data))) { 
 //BA.debugLineNum = 406;BA.debugLine="ToastMessageShow (\"ذخیره شد\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("ذخیره شد"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 408;BA.debugLine="Main.saat_kar_min=min_sat_kar";
mostCurrent._main._saat_kar_min /*int*/  = _min_sat_kar;
 //BA.debugLineNum = 409;BA.debugLine="lbl_back_Click";
_lbl_back_click();
 };
 };
...
public static String  _lbl_save_onvan_click() throws Exception{
 //BA.debugLineNum = 696;BA.debugLine="Private Sub lbl_save_onvan_Click";
 //BA.debugLineNum = 697;BA.debugLine="dbCode.connect_db";
mostCurrent._dbcode._connect_db /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 698;BA.debugLine="dbCode.sql.ExecNonQuery(\"UPDATE tbl_onvanha SET '";
mostCurrent._dbcode._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery("UPDATE tbl_onvanha SET 'custom_name' ='"+mostCurrent._et_onv_new.getText()+"'  WHERE id="+BA.NumberToString(_current_index_onvan));
 //BA.debugLineNum = 700;BA.debugLine="read_onvan";
_read_onvan();
 //BA.debugLineNum = 701;BA.debugLine="pan_all_onvanHa.Visible=False";
...
public static String  _pan_all_onvanha_click() throws Exception{
 //BA.debugLineNum = 673;BA.debugLine="Private Sub pan_all_onvanHa_Click";
 //BA.debugLineNum = 675;BA.debugLine="pan_all_onvanHa.Visible=False";
mostCurrent._pan_all_onvanha.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 676;BA.debugLine="End Sub";
return "";
}
public static String  _panel15_click() throws Exception{
 //BA.debugLineNum = 678;BA.debugLine="Private Sub Panel15_Click";
...
public static String  _show_help() throws Exception{
 //BA.debugLineNum = 262;BA.debugLine="Sub show_help";
 //BA.debugLineNum = 263;BA.debugLine="Msgbox(\"همه قیمت ها به تومان می باشد\",\"هشدار مهم\"";
...
public static String  _sp_ganon_kar_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 427;BA.debugLine="Private Sub sp_ganon_kar_ItemClick (Position As In";
 //BA.debugLineNum = 430;BA.debugLine="Select Value";
switch (BA.switchObjectToInt(_value,(Object)("سال 1403"),(Object)("سال 1402"),(Object)("سال 1401"),(Object)("سال 1400"),(Object)("سال 1399"))) {
case 0: {
 //BA.debugLineNum = 432;BA.debugLine="et_paye.Text=7166184";
mostCurrent._et_paye.setText(BA.ObjectToCharSequence(7166184));
 //BA.debugLineNum = 433;BA.debugLine="et_maskan.Text=900000";
mostCurrent._et_maskan.setText(BA.ObjectToCharSequence(900000));
 //BA.debugLineNum = 434;BA.debugLine="et_bon.Text=1400000";
mostCurrent._et_bon.setText(BA.ObjectToCharSequence(1400000));
 //BA.debugLineNum = 436;BA.debugLine="hamsar_int=500000";
_hamsar_int = (int) (500000);
...
mostCurrent._et_mazaya.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 447;BA.debugLine="olad_vahed=716618";
_olad_vahed = (int) (716618);
...
mostCurrent._et_sanavat.setText(BA.ObjectToCharSequence(0));
 break; }
case 1: {
 //BA.debugLineNum = 458;BA.debugLine="et_paye.Text=5308284";
mostCurrent._et_paye.setText(BA.ObjectToCharSequence(5308284));
 //BA.debugLineNum = 459;BA.debugLine="et_maskan.Text=900000";
mostCurrent._et_maskan.setText(BA.ObjectToCharSequence(900000));
 //BA.debugLineNum = 460;BA.debugLine="et_bon.Text=1100000";
mostCurrent._et_bon.setText(BA.ObjectToCharSequence(1100000));
 //BA.debugLineNum = 461;BA.debugLine="hamsar_int=0";
_hamsar_int = (int) (0);
 //BA.debugLineNum = 462;BA.debugLine="et_bime_tamin.Text=7";
mostCurrent._et_bime_tamin.setText(BA.ObjectToCharSequence(7));
 //BA.debugLineNum = 465;BA.debugLine="et_fani.Text=0";
mostCurrent._et_fani.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 466;BA.debugLine="et_masoliat.Text=0";
mostCurrent._et_masoliat.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 467;BA.debugLine="et_sarparast.Text=0";
mostCurrent._et_sarparast.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 468;BA.debugLine="et_mazaya.Text=0";
mostCurrent._et_mazaya.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 471;BA.debugLine="olad_vahed=530828";
_olad_vahed = (int) (530828);
 //BA.debugLineNum = 472;BA.debugLine="et_olad.Text=0";
mostCurrent._et_olad.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 476;BA.debugLine="et_sanavat.Text=0";
mostCurrent._et_sanavat.setText(BA.ObjectToCharSequence(0));
 break; }
case 2: {
 //BA.debugLineNum = 479;BA.debugLine="et_paye.Text=4179755";
mostCurrent._et_paye.setText(BA.ObjectToCharSequence(4179755));
 //BA.debugLineNum = 480;BA.debugLine="et_maskan.Text=650000";
mostCurrent._et_maskan.setText(BA.ObjectToCharSequence(650000));
 //BA.debugLineNum = 481;BA.debugLine="et_bon.Text=850000";
mostCurrent._et_bon.setText(BA.ObjectToCharSequence(850000));
 //BA.debugLineNum = 482;BA.debugLine="hamsar_int=0";
_hamsar_int = (int) (0);
 //BA.debugLineNum = 483;BA.debugLine="et_bime_tamin.Text=7";
mostCurrent._et_bime_tamin.setText(BA.ObjectToCharSequence(7));
 //BA.debugLineNum = 486;BA.debugLine="et_fani.Text=0";
mostCurrent._et_fani.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 487;BA.debugLine="et_masoliat.Text=0";
mostCurrent._et_masoliat.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 488;BA.debugLine="et_sarparast.Text=0";
mostCurrent._et_sarparast.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 489;BA.debugLine="et_mazaya.Text=0";
mostCurrent._et_mazaya.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 492;BA.debugLine="olad_vahed=417975";
_olad_vahed = (int) (417975);
 //BA.debugLineNum = 493;BA.debugLine="et_olad.Text=0";
mostCurrent._et_olad.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 497;BA.debugLine="et_sanavat.Text=0";
mostCurrent._et_sanavat.setText(BA.ObjectToCharSequence(0));
 break; }
case 3: {
 //BA.debugLineNum = 500;BA.debugLine="et_paye.Text=2655492";
mostCurrent._et_paye.setText(BA.ObjectToCharSequence(2655492));
 //BA.debugLineNum = 501;BA.debugLine="et_maskan.Text=450000";
mostCurrent._et_maskan.setText(BA.ObjectToCharSequence(450000));
 //BA.debugLineNum = 502;BA.debugLine="et_bon.Text=600000";
mostCurrent._et_bon.setText(BA.ObjectToCharSequence(600000));
 //BA.debugLineNum = 503;BA.debugLine="hamsar_int=0";
_hamsar_int = (int) (0);
 //BA.debugLineNum = 504;BA.debugLine="et_bime_tamin.Text=7";
mostCurrent._et_bime_tamin.setText(BA.ObjectToCharSequence(7));
 //BA.debugLineNum = 507;BA.debugLine="et_fani.Text=0";
mostCurrent._et_fani.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 508;BA.debugLine="et_masoliat.Text=0";
mostCurrent._et_masoliat.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 509;BA.debugLine="et_sarparast.Text=0";
mostCurrent._et_sarparast.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 510;BA.debugLine="et_mazaya.Text=0";
mostCurrent._et_mazaya.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 513;BA.debugLine="olad_vahed=265549";
_olad_vahed = (int) (265549);
 //BA.debugLineNum = 514;BA.debugLine="et_olad.Text=0";
mostCurrent._et_olad.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 518;BA.debugLine="et_sanavat.Text=0";
mostCurrent._et_sanavat.setText(BA.ObjectToCharSequence(0));
 break; }
case 4: {
 //BA.debugLineNum = 521;BA.debugLine="et_paye.Text=1910427";
mostCurrent._et_paye.setText(BA.ObjectToCharSequence(1910427));
 //BA.debugLineNum = 522;BA.debugLine="et_maskan.Text=300000";
mostCurrent._et_maskan.setText(BA.ObjectToCharSequence(300000));
 //BA.debugLineNum = 523;BA.debugLine="et_bon.Text=400000";
mostCurrent._et_bon.setText(BA.ObjectToCharSequence(400000));
 //BA.debugLineNum = 524;BA.debugLine="hamsar_int=0";
_hamsar_int = (int) (0);
 //BA.debugLineNum = 525;BA.debugLine="et_bime_tamin.Text=7";
mostCurrent._et_bime_tamin.setText(BA.ObjectToCharSequence(7));
 //BA.debugLineNum = 528;BA.debugLine="et_fani.Text=0";
mostCurrent._et_fani.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 529;BA.debugLine="et_masoliat.Text=0";
mostCurrent._et_masoliat.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 530;BA.debugLine="et_sarparast.Text=0";
mostCurrent._et_sarparast.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 531;BA.debugLine="et_mazaya.Text=0";
mostCurrent._et_mazaya.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 534;BA.debugLine="olad_vahed=191127";
_olad_vahed = (int) (191127);
 //BA.debugLineNum = 535;BA.debugLine="et_olad.Text=0";
mostCurrent._et_olad.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 539;BA.debugLine="et_sanavat.Text=0";
mostCurrent._et_sanavat.setText(BA.ObjectToCharSequence(0));
 break; }
default: {
 //BA.debugLineNum = 542;BA.debugLine="et_paye.Text=0";
mostCurrent._et_paye.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 543;BA.debugLine="et_maskan.Text=0";
mostCurrent._et_maskan.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 544;BA.debugLine="et_bon.Text=0";
mostCurrent._et_bon.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 545;BA.debugLine="hamsar_int=500000";
_hamsar_int = (int) (500000);
 //BA.debugLineNum = 546;BA.debugLine="et_bime_tamin.Text=7";
mostCurrent._et_bime_tamin.setText(BA.ObjectToCharSequence(7));
 //BA.debugLineNum = 549;BA.debugLine="et_fani.Text=0";
mostCurrent._et_fani.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 550;BA.debugLine="et_masoliat.Text=0";
mostCurrent._et_masoliat.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 551;BA.debugLine="et_sarparast.Text=0";
mostCurrent._et_sarparast.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 552;BA.debugLine="et_mazaya.Text=0";
mostCurrent._et_mazaya.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 554;BA.debugLine="olad_vahed=0";
_olad_vahed = (int) (0);
 //BA.debugLineNum = 555;BA.debugLine="et_olad.Text=0";
mostCurrent._et_olad.setText(BA.ObjectToCharSequence(0));
 //BA.debugLineNum = 557;BA.debugLine="et_sanavat.Text=0";
mostCurrent._et_sanavat.setText(BA.ObjectToCharSequence(0));
 break; }
}
;
...
int _num = 0;
 //BA.debugLineNum = 564;BA.debugLine="Private Sub sp_olad_ItemClick (Position As Int, Va";
 //BA.debugLineNum = 565;BA.debugLine="Dim num As Int=Value";
_num = (int)(BA.ObjectToNumber(_value));
 //BA.debugLineNum = 566;BA.debugLine="et_olad.Text=olad_vahed*num";
