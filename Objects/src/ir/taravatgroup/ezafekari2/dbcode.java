...
anywheresoftware.b4a.keywords.Common.LogImpl("3786506","error",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("3720908",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("35177359",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("3524293","tbl savabeg exist",0);
 } 
       catch (Exception e6) {
...
anywheresoftware.b4a.keywords.Common.LogImpl("3524298","tbl savabeg created",0);
 };
...
_res = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(_sql.ExecQuery("SELECT * FROM 'my_calander' WHERE year=1405 And moon=12 ")));
...
anywheresoftware.b4a.keywords.Common.LogImpl("3589831","tbl my_calander1404 exist---"+_aaa,0);
 } 
       catch (Exception e8) {
...
anywheresoftware.b4a.keywords.Common.LogImpl("3589833","tbl my_calander1404 not exist---",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("3655364","tbl tbl_onvanha exist",0);
 } 
       catch (Exception e6) {
...
anywheresoftware.b4a.keywords.Common.LogImpl("3655386","tbl tbl_onvanha created",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458757","tbl taradod exist",0);
 } 
       catch (Exception e6) {
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458762","tbl taradod created",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458769","tbl mamoriat exist",0);
 } 
       catch (Exception e13) {
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458774","tbl mamoriat created",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458780","tbl mosaedeh exist",0);
 } 
       catch (Exception e20) {
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458785","tbl mosaedeh created",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458791","tbl food exist",0);
 } 
       catch (Exception e27) {
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458796","tbl food created",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458803","tbl tb_padash exist",0);
 } 
       catch (Exception e34) {
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458808","tbl tb_padash created",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458813","tbl sayer exist",0);
 } 
       catch (Exception e41) {
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458818","tbl sayer created",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458825","tbl tb_ayabzahab exist",0);
 } 
       catch (Exception e48) {
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458830","tbl tb_ayabzahab created",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458837","tbl tb_vam exist",0);
 } 
       catch (Exception e55) {
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458842","tbl tb_vam created",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458848","tbl tb_gestha exist",0);
 } 
       catch (Exception e62) {
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458853","tbl tb_gestha created",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("34849676",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("35046284",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("34915212",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("34980748",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("35111823",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
