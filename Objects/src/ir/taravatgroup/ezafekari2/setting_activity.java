...
public static String  _et_pass_lock_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 577;BA.debugLine="Private Sub et_pass_lock_TextChanged (Old As Strin";
 //BA.debugLineNum = 578;BA.debugLine="If(New.Length>4)Then";
if ((_new.length()>4)) { 
 //BA.debugLineNum = 579;BA.debugLine="ToastMessageShow(\"رمز فقط 4 رقم باشد\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("رمز فقط 4 رقم باشد"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 580;BA.debugLine="et_pass_lock.Text=Old";
...
anywheresoftware.b4a.objects.IntentWrapper _in = null;
 //BA.debugLineNum = 215;BA.debugLine="Private Sub lbl_backup_Click";
 //BA.debugLineNum = 217;BA.debugLine="Dim FileName As String = \"db.db\"";
_filename = "db.db";
 //BA.debugLineNum = 220;BA.debugLine="File.Copy(File.DirInternal, FileName, Starter.Pro";
...
_email = new anywheresoftware.b4a.phone.Phone.Email();
 //BA.debugLineNum = 223;BA.debugLine="email.To.Add(\"aaa@bbb.com\")";
_email.To.Add((Object)("aaa@bbb.com"));
 //BA.debugLineNum = 224;BA.debugLine="email.Subject = \"subject\"";
_email.Subject = "subject";
 //BA.debugLineNum = 225;BA.debugLine="email.Body = \"backup-\"&DateTime.Date(DateTime.Now";
_email.Body = "backup-"+anywheresoftware.b4a.keywords.Common.DateTime.Date(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 226;BA.debugLine="email.Attachments.Add(Starter.Provider.GetFileUri";
_email.Attachments.Add(mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._getfileuri /*Object*/ (_filename));
 //BA.debugLineNum = 228;BA.debugLine="Dim in As Intent = email.GetIntent";
...
_in = (anywheresoftware.b4a.objects.IntentWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.IntentWrapper(), (android.content.Intent)(_email.GetIntent()));
 //BA.debugLineNum = 231;BA.debugLine="in.Flags = 1 'FLAG_GRANT_READ_URI_PERMISSION";
_in.setFlags((int) (1));
 //BA.debugLineNum = 232;BA.debugLine="StartActivity(in)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(_in.getObject()));
 //BA.debugLineNum = 234;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_close_help_font_click() throws Exception{
 //BA.debugLineNum = 483;BA.debugLine="Private Sub lbl_close_help_font_Click";
 //BA.debugLineNum = 484;BA.debugLine="pan_all_help.Visible=False";
mostCurrent._pan_all_help.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 485;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_color_home_click() throws Exception{
 //BA.debugLineNum = 406;BA.debugLine="Private Sub lbl_color_home_Click";
 //BA.debugLineNum = 407;BA.debugLine="lbl_color1_Click";
_lbl_color1_click();
 //BA.debugLineNum = 408;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_color1_click() throws Exception{
 //BA.debugLineNum = 261;BA.debugLine="Private Sub lbl_color1_Click";
 //BA.debugLineNum = 262;BA.debugLine="pan_all.Visible=True";
mostCurrent._pan_all.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 264;BA.debugLine="color_index=Main.color_index";
_color_index = mostCurrent._main._color_index /*int*/ ;
 //BA.debugLineNum = 266;BA.debugLine="Select color_index";
switch (_color_index) {
case 1: {
 //BA.debugLineNum = 268;BA.debugLine="pan_color1_Click";
_pan_color1_click();
 break; }
case 2: {
 //BA.debugLineNum = 270;BA.debugLine="pan_color2_Click";
_pan_color2_click();
 break; }
case 3: {
 //BA.debugLineNum = 272;BA.debugLine="pan_color3_Click";
_pan_color3_click();
 break; }
case 4: {
 //BA.debugLineNum = 274;BA.debugLine="pan_color4_Click";
_pan_color4_click();
 break; }
case 5: {
 //BA.debugLineNum = 276;BA.debugLine="pan_color5_Click";
_pan_color5_click();
 break; }
case 6: {
 //BA.debugLineNum = 278;BA.debugLine="pan_color6_Click";
_pan_color6_click();
 break; }
}
;
...
public static String  _lbl_font_pan_click() throws Exception{
 //BA.debugLineNum = 414;BA.debugLine="Private Sub lbl_font_pan_Click";
 //BA.debugLineNum = 415;BA.debugLine="pan_all2.Visible=True";
...
public static String  _lbl_help_font_click() throws Exception{
 //BA.debugLineNum = 439;BA.debugLine="Private Sub lbl_help_font_Click";
 //BA.debugLineNum = 444;BA.debugLine="pan_all_help.Visible=True";
...
anywheresoftware.b4a.objects.collections.List _ls_lock3 = null;
 //BA.debugLineNum = 487;BA.debugLine="Private Sub lbl_lock_app_Click";
 //BA.debugLineNum = 489;BA.debugLine="If(File.Exists(File.DirInternal,\"ls_lock\")=True)T";
if ((anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"ls_lock")==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 490;BA.debugLine="Dim ls_lock0 As List";
_ls_lock0 = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 491;BA.debugLine="ls_lock0.Initialize";
_ls_lock0.Initialize();
 //BA.debugLineNum = 493;BA.debugLine="ls_lock0=File.ReadList(File.DirInternal,\"ls_lock";
...
mostCurrent._togglebtn_finger.setChecked(anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 513;BA.debugLine="et_hint_lock.Text=ls_lock0.Get(3)";
mostCurrent._et_hint_lock.setText(BA.ObjectToCharSequence(_ls_lock0.Get((int) (3))));
 }else {
 //BA.debugLineNum = 516;BA.debugLine="Dim ls_lock3 As List";
_ls_lock3 = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 517;BA.debugLine="ls_lock3.Initialize";
_ls_lock3.Initialize();
 //BA.debugLineNum = 519;BA.debugLine="ls_lock3.Add(\"false\")";
_ls_lock3.Add((Object)("false"));
 //BA.debugLineNum = 520;BA.debugLine="ls_lock3.Add(\"false\")";
_ls_lock3.Add((Object)("false"));
 //BA.debugLineNum = 521;BA.debugLine="ls_lock3.Add(\"\")";
_ls_lock3.Add((Object)(""));
 //BA.debugLineNum = 522;BA.debugLine="ls_lock3.Add(\"\")";
_ls_lock3.Add((Object)(""));
 //BA.debugLineNum = 525;BA.debugLine="File.WriteList(File.DirInternal,\"ls_lock\",ls_loc";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"ls_lock",_ls_lock3);
 //BA.debugLineNum = 528;BA.debugLine="ToggleBtn_OffOn_lock.Checked=False";
mostCurrent._togglebtn_offon_lock.setChecked(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 529;BA.debugLine="ToggleBtn_finger.Enabled=False";
mostCurrent._togglebtn_finger.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 530;BA.debugLine="ToggleBtn_finger.Checked=False";
mostCurrent._togglebtn_finger.setChecked(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 531;BA.debugLine="et_pass_lock.Enabled=False";
mostCurrent._et_pass_lock.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 532;BA.debugLine="et_hint_lock.Enabled=False";
mostCurrent._et_hint_lock.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 539;BA.debugLine="pan_all_lock.Visible=True";
...
public static String  _lbl_rest_font_click() throws Exception{
 //BA.debugLineNum = 423;BA.debugLine="Private Sub lbl_rest_font_Click";
 //BA.debugLineNum = 424;BA.debugLine="sp_font.SelectedIndex=0";
mostCurrent._sp_font.setSelectedIndex((int) (0));
 //BA.debugLineNum = 426;BA.debugLine="skb_f1.Value=17";
mostCurrent._skb_f1.setValue((int) (17));
 //BA.debugLineNum = 427;BA.debugLine="skb_f2.Value=15";
mostCurrent._skb_f2.setValue((int) (15));
 //BA.debugLineNum = 428;BA.debugLine="skb_f3.Value=13";
mostCurrent._skb_f3.setValue((int) (13));
 //BA.debugLineNum = 430;BA.debugLine="lbl_skb_f1.Text=17";
mostCurrent._lbl_skb_f1.setText(BA.ObjectToCharSequence(17));
 //BA.debugLineNum = 431;BA.debugLine="lbl_skb_f2.Text=15";
mostCurrent._lbl_skb_f2.setText(BA.ObjectToCharSequence(15));
 //BA.debugLineNum = 432;BA.debugLine="lbl_skb_f3.Text=13";
...
//C
this.state = 1;
 //BA.debugLineNum = 237;BA.debugLine="cc.Initialize(\"CC\")";
parent._cc.Initialize("CC");
 //BA.debugLineNum = 238;BA.debugLine="cc.Show(\"*/*\", \"انتخاب فایل دیتابیس\")";
parent._cc.Show(processBA,"*/*","انتخاب فایل دیتابیس");
 //BA.debugLineNum = 239;BA.debugLine="Wait For CC_Result (Success As Boolean, Dir As St";
...
//C
this.state = 4;
 //BA.debugLineNum = 241;BA.debugLine="File.Copy(Dir,FileName,Starter.Provider.SharedFo";
anywheresoftware.b4a.keywords.Common.File.Copy(_dir,_filename,parent.mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,"db2.db");
 //BA.debugLineNum = 243;BA.debugLine="Log( Dir)";
anywheresoftware.b4a.keywords.Common.LogImpl("650200583",_dir,0);
 //BA.debugLineNum = 244;BA.debugLine="Log(FileName)";
anywheresoftware.b4a.keywords.Common.LogImpl("650200584",_filename,0);
 //BA.debugLineNum = 245;BA.debugLine="Log(File.Exists(Starter.Provider.SharedFolder,\"d";
anywheresoftware.b4a.keywords.Common.LogImpl("650200585",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.File.Exists(parent.mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,"db2.db")),0);
 //BA.debugLineNum = 247;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 249;BA.debugLine="result = Msgbox2(\"دیتای قبلی حذف و دیتای جدید جا";
...
//C
this.state = 7;
 //BA.debugLineNum = 251;BA.debugLine="File.Copy(Starter.Provider.SharedFolder,\"db2.db";
anywheresoftware.b4a.keywords.Common.File.Copy(parent.mostCurrent._starter._provider /*ir.taravatgroup.ezafekari2.fileprovider*/ ._sharedfolder /*String*/ ,"db2.db",anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"db.db");
 //BA.debugLineNum = 252;BA.debugLine="StartActivity(Main)";
...
public static String  _lbl_save_color_click() throws Exception{
 //BA.debugLineNum = 380;BA.debugLine="Private Sub lbl_save_color_Click";
 //BA.debugLineNum = 381;BA.debugLine="Main.color1=color1";
mostCurrent._main._color1 /*int*/  = _color1;
 //BA.debugLineNum = 382;BA.debugLine="Main.color2=color2";
mostCurrent._main._color2 /*int*/  = _color2;
 //BA.debugLineNum = 383;BA.debugLine="Main.color3=color3";
mostCurrent._main._color3 /*int*/  = _color3;
 //BA.debugLineNum = 384;BA.debugLine="Main.color4=color4";
mostCurrent._main._color4 /*int*/  = _color4;
 //BA.debugLineNum = 385;BA.debugLine="Main.color5=color5";
mostCurrent._main._color5 /*int*/  = _color5;
 //BA.debugLineNum = 386;BA.debugLine="Main.color_index=color_index";
mostCurrent._main._color_index /*int*/  = _color_index;
 //BA.debugLineNum = 388;BA.debugLine="File.WriteString(File.DirInternal,\"setcolor.txt\",";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"setcolor.txt",BA.NumberToString(mostCurrent._main._color1 /*int*/ )+","+BA.NumberToString(mostCurrent._main._color2 /*int*/ )+","+BA.NumberToString(mostCurrent._main._color_index /*int*/ )+","+BA.NumberToString(mostCurrent._main._color3 /*int*/ )+","+BA.NumberToString(mostCurrent._main._color4 /*int*/ )+","+BA.NumberToString(mostCurrent._main._color5 /*int*/ )+anywheresoftware.b4a.keywords.Common.CRLF+mostCurrent._main._main_font /*String*/ +","+BA.NumberToString(mostCurrent._main._size_f1 /*int*/ )+","+BA.NumberToString(mostCurrent._main._size_f2 /*int*/ )+","+BA.NumberToString(mostCurrent._main._size_f3 /*int*/ ));
 //BA.debugLineNum = 390;BA.debugLine="pan_all.Visible=False";
mostCurrent._pan_all.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 391;BA.debugLine="ToastMessageShow(\"تغییرات ذخیره شد\",False)";
...
public static String  _lbl_save_font_click() throws Exception{
 //BA.debugLineNum = 447;BA.debugLine="Private Sub lbl_save_font_Click";
 //BA.debugLineNum = 451;BA.debugLine="File.WriteString(File.DirInternal,\"setcolor.txt\",";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"setcolor.txt",BA.NumberToString(mostCurrent._main._color1 /*int*/ )+","+BA.NumberToString(mostCurrent._main._color2 /*int*/ )+","+BA.NumberToString(_color_index)+","+BA.NumberToString(mostCurrent._main._color3 /*int*/ )+","+BA.NumberToString(mostCurrent._main._color4 /*int*/ )+","+BA.NumberToString(mostCurrent._main._color5 /*int*/ )+anywheresoftware.b4a.keywords.Common.CRLF+mostCurrent._sp_font.getSelectedItem()+","+BA.NumberToString(mostCurrent._skb_f1.getValue())+","+BA.NumberToString(mostCurrent._skb_f2.getValue())+","+BA.NumberToString(mostCurrent._skb_f3.getValue()));
 //BA.debugLineNum = 455;BA.debugLine="pan_all2_Click";
_pan_all2_click();
 //BA.debugLineNum = 456;BA.debugLine="ToastMessageShow(\"تغییرات ذخیره شد\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("تغییرات ذخیره شد"),anywheresoftware.b4a.keywords.Common.False);
...
anywheresoftware.b4a.objects.collections.List _ls_lock = null;
 //BA.debugLineNum = 542;BA.debugLine="Private Sub lbl_save_lock_Click";
 //BA.debugLineNum = 543;BA.debugLine="Dim ls_lock As List";
_ls_lock = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 544;BA.debugLine="ls_lock.Initialize";
_ls_lock.Initialize();
 //BA.debugLineNum = 548;BA.debugLine="If (ToggleBtn_OffOn_lock.Checked=True)Then";
if ((mostCurrent._togglebtn_offon_lock.getChecked()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 549;BA.debugLine="If(et_pass_lock.Text.Length <> 4)Then";
if ((mostCurrent._et_pass_lock.getText().length()!=4)) { 
 //BA.debugLineNum = 550;BA.debugLine="ToastMessageShow(\"تعیین رمز\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("تعیین رمز"),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 554;BA.debugLine="ls_lock.Add(\"true\")";
_ls_lock.Add((Object)("true"));
 //BA.debugLineNum = 555;BA.debugLine="ls_lock.Add(ToggleBtn_finger.Checked)";
_ls_lock.Add((Object)(mostCurrent._togglebtn_finger.getChecked()));
 //BA.debugLineNum = 556;BA.debugLine="ls_lock.Add(et_pass_lock.Text)";
_ls_lock.Add((Object)(mostCurrent._et_pass_lock.getText()));
 //BA.debugLineNum = 557;BA.debugLine="ls_lock.Add(et_hint_lock.Text)";
_ls_lock.Add((Object)(mostCurrent._et_hint_lock.getText()));
 //BA.debugLineNum = 560;BA.debugLine="File.WriteList(File.DirInternal,\"ls_lock\",ls_lo";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"ls_lock",_ls_lock);
 //BA.debugLineNum = 562;BA.debugLine="pan_all_lock_Click";
_pan_all_lock_click();
 };
 }else {
 //BA.debugLineNum = 566;BA.debugLine="ls_lock.Add(\"false\")";
_ls_lock.Add((Object)("false"));
 //BA.debugLineNum = 567;BA.debugLine="ls_lock.Add(ToggleBtn_finger.Checked)";
_ls_lock.Add((Object)(mostCurrent._togglebtn_finger.getChecked()));
 //BA.debugLineNum = 568;BA.debugLine="ls_lock.Add(\"\")";
_ls_lock.Add((Object)(""));
 //BA.debugLineNum = 569;BA.debugLine="ls_lock.Add(\"\")";
_ls_lock.Add((Object)(""));
 //BA.debugLineNum = 570;BA.debugLine="File.WriteList(File.DirInternal,\"ls_lock\",ls_loc";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"ls_lock",_ls_lock);
 //BA.debugLineNum = 571;BA.debugLine="pan_all_lock_Click";
_pan_all_lock_click();
 };
...
public static String  _pan_all_click() throws Exception{
 //BA.debugLineNum = 287;BA.debugLine="Private Sub pan_all_Click";
 //BA.debugLineNum = 288;BA.debugLine="pan_all.Visible=False";
mostCurrent._pan_all.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 290;BA.debugLine="End Sub";
return "";
}
public static String  _pan_all_lock_click() throws Exception{
 //BA.debugLineNum = 605;BA.debugLine="Private Sub pan_all_lock_Click";
 //BA.debugLineNum = 606;BA.debugLine="pan_all_lock.Visible=False";
mostCurrent._pan_all_lock.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 607;BA.debugLine="End Sub";
return "";
}
public static String  _pan_all2_click() throws Exception{
 //BA.debugLineNum = 474;BA.debugLine="Private Sub pan_all2_Click";
 //BA.debugLineNum = 475;BA.debugLine="pan_all2.Visible=False";
mostCurrent._pan_all2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 476;BA.debugLine="End Sub";
return "";
}
public static String  _pan_color1_click() throws Exception{
 //BA.debugLineNum = 366;BA.debugLine="Private Sub pan_color1_Click";
 //BA.debugLineNum = 367;BA.debugLine="tik_all_dis";
_tik_all_dis();
 //BA.debugLineNum = 368;BA.debugLine="color1=0XFF69AC00";
_color1 = ((int)0xff69ac00);
 //BA.debugLineNum = 369;BA.debugLine="color2=0xFF00C7C7";
_color2 = ((int)0xff00c7c7);
 //BA.debugLineNum = 370;BA.debugLine="color3=0XFFFFFFFF";
_color3 = ((int)0xffffffff);
 //BA.debugLineNum = 371;BA.debugLine="color4=0XFF69AC00";
_color4 = ((int)0xff69ac00);
 //BA.debugLineNum = 372;BA.debugLine="color5=0xFF00C7C7";
_color5 = ((int)0xff00c7c7);
 //BA.debugLineNum = 375;BA.debugLine="color_index=1";
_color_index = (int) (1);
 //BA.debugLineNum = 376;BA.debugLine="tik1.Visible=True";
...
public static String  _pan_color2_click() throws Exception{
 //BA.debugLineNum = 351;BA.debugLine="Private Sub pan_color2_Click";
 //BA.debugLineNum = 352;BA.debugLine="tik_all_dis";
_tik_all_dis();
 //BA.debugLineNum = 353;BA.debugLine="color1 = 0xFF7F19EE";
_color1 = ((int)0xff7f19ee);
 //BA.debugLineNum = 354;BA.debugLine="color2 = 0xFF567BFF";
_color2 = ((int)0xff567bff);
 //BA.debugLineNum = 355;BA.debugLine="color3=0XFFFFFFFF";
_color3 = ((int)0xffffffff);
 //BA.debugLineNum = 356;BA.debugLine="color4=0xFF567BFF";
_color4 = ((int)0xff567bff);
 //BA.debugLineNum = 357;BA.debugLine="color5=0xFF567BFF";
_color5 = ((int)0xff567bff);
 //BA.debugLineNum = 361;BA.debugLine="color_index=2";
_color_index = (int) (2);
 //BA.debugLineNum = 362;BA.debugLine="tik2.Visible=True";
...
public static String  _pan_color3_click() throws Exception{
 //BA.debugLineNum = 336;BA.debugLine="Private Sub pan_color3_Click";
 //BA.debugLineNum = 337;BA.debugLine="tik_all_dis";
_tik_all_dis();
 //BA.debugLineNum = 338;BA.debugLine="color1 = 0xFF2BC1F6";
_color1 = ((int)0xff2bc1f6);
 //BA.debugLineNum = 339;BA.debugLine="color2 = 0xFF1E45D1";
_color2 = ((int)0xff1e45d1);
 //BA.debugLineNum = 340;BA.debugLine="color3=0XFFFFFFFF";
_color3 = ((int)0xffffffff);
 //BA.debugLineNum = 341;BA.debugLine="color4=0xFF2BC1F6";
_color4 = ((int)0xff2bc1f6);
 //BA.debugLineNum = 342;BA.debugLine="color5=0xFF1E45D1";
_color5 = ((int)0xff1e45d1);
 //BA.debugLineNum = 347;BA.debugLine="color_index=3";
_color_index = (int) (3);
 //BA.debugLineNum = 348;BA.debugLine="tik3.Visible=True";
...
public static String  _pan_color4_click() throws Exception{
 //BA.debugLineNum = 321;BA.debugLine="Private Sub pan_color4_Click";
 //BA.debugLineNum = 322;BA.debugLine="tik_all_dis";
_tik_all_dis();
 //BA.debugLineNum = 323;BA.debugLine="color1 = 0xFFDD00FF";
_color1 = ((int)0xffdd00ff);
 //BA.debugLineNum = 324;BA.debugLine="color2 = 0xFF0090FF";
_color2 = ((int)0xff0090ff);
 //BA.debugLineNum = 325;BA.debugLine="color3=0XFFFFFFFF";
_color3 = ((int)0xffffffff);
 //BA.debugLineNum = 326;BA.debugLine="color4=0xFFDD00FF";
_color4 = ((int)0xffdd00ff);
 //BA.debugLineNum = 327;BA.debugLine="color5=0xFF24EB9D";
_color5 = ((int)0xff24eb9d);
 //BA.debugLineNum = 332;BA.debugLine="color_index=4";
_color_index = (int) (4);
 //BA.debugLineNum = 333;BA.debugLine="tik4.Visible=True";
...
public static String  _pan_color5_click() throws Exception{
 //BA.debugLineNum = 307;BA.debugLine="Private Sub pan_color5_Click";
 //BA.debugLineNum = 308;BA.debugLine="tik_all_dis";
_tik_all_dis();
 //BA.debugLineNum = 309;BA.debugLine="color1 = 0xFFCF5263";
_color1 = ((int)0xffcf5263);
 //BA.debugLineNum = 310;BA.debugLine="color2 = 0xFFABC01A";
_color2 = ((int)0xffabc01a);
 //BA.debugLineNum = 311;BA.debugLine="color3=0XFFFFFFFF";
_color3 = ((int)0xffffffff);
 //BA.debugLineNum = 312;BA.debugLine="color4=0xFFCF5263";
_color4 = ((int)0xffcf5263);
 //BA.debugLineNum = 313;BA.debugLine="color5=0xFFABC01A";
_color5 = ((int)0xffabc01a);
 //BA.debugLineNum = 317;BA.debugLine="color_index=5";
_color_index = (int) (5);
 //BA.debugLineNum = 318;BA.debugLine="tik5.Visible=True";
...
public static String  _pan_color6_click() throws Exception{
 //BA.debugLineNum = 292;BA.debugLine="Private Sub pan_color6_Click";
 //BA.debugLineNum = 293;BA.debugLine="tik_all_dis";
_tik_all_dis();
 //BA.debugLineNum = 294;BA.debugLine="color1= 0xFF5289CF";
_color1 = ((int)0xff5289cf);
 //BA.debugLineNum = 295;BA.debugLine="color2= 0xFFABC01A";
_color2 = ((int)0xffabc01a);
 //BA.debugLineNum = 296;BA.debugLine="color3=0XFFFFFFFF";
_color3 = ((int)0xffffffff);
 //BA.debugLineNum = 297;BA.debugLine="color4=0xFF5289CF";
_color4 = ((int)0xff5289cf);
 //BA.debugLineNum = 298;BA.debugLine="color5=0xFFABC01A";
_color5 = ((int)0xffabc01a);
 //BA.debugLineNum = 303;BA.debugLine="color_index=6";
_color_index = (int) (6);
 //BA.debugLineNum = 304;BA.debugLine="tik6.Visible=True";
...
public static String  _pan_colors_click() throws Exception{
 //BA.debugLineNum = 410;BA.debugLine="Private Sub pan_colors_Click";
 //BA.debugLineNum = 412;BA.debugLine="End Sub";
return "";
}
public static String  _pan_font_click() throws Exception{
 //BA.debugLineNum = 478;BA.debugLine="Private Sub pan_font_Click";
 //BA.debugLineNum = 480;BA.debugLine="End Sub";
return "";
}
public static String  _pan_lock_click() throws Exception{
 //BA.debugLineNum = 609;BA.debugLine="Private Sub pan_lock_Click";
...
public static String  _skb_f1_valuechanged(int _value,boolean _userchanged) throws Exception{
 //BA.debugLineNum = 470;BA.debugLine="Private Sub skb_f1_ValueChanged (Value As Int, Use";
 //BA.debugLineNum = 471;BA.debugLine="lbl_skb_f1.Text=Value";
...
public static String  _skb_f2_valuechanged(int _value,boolean _userchanged) throws Exception{
 //BA.debugLineNum = 466;BA.debugLine="Private Sub skb_f2_ValueChanged (Value As Int, Use";
 //BA.debugLineNum = 467;BA.debugLine="lbl_skb_f2.Text=Value";
...
public static String  _skb_f3_valuechanged(int _value,boolean _userchanged) throws Exception{
 //BA.debugLineNum = 462;BA.debugLine="Private Sub skb_f3_ValueChanged (Value As Int, Use";
 //BA.debugLineNum = 463;BA.debugLine="lbl_skb_f3.Text=Value";
...
public static String  _sp_backup_online_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 773;BA.debugLine="Private Sub sp_backup_online_ItemClick (Position A";
 //BA.debugLineNum = 774;BA.debugLine="dbCode.update_setting_byname(\"backup_online\",Posi";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"backup_online",BA.NumberToString(_position));
 //BA.debugLineNum = 775;BA.debugLine="Main.backup_page_show=0";
mostCurrent._main._backup_page_show /*int*/  = (int) (0);
 //BA.debugLineNum = 776;BA.debugLine="File.WriteString(File.DirInternal,\"chk_backup.txt";
...
public static String  _tog_ayab_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 707;BA.debugLine="Private Sub tog_ayab_CheckedChange(Checked As Bool";
 //BA.debugLineNum = 708;BA.debugLine="If(tog_ayab.Checked=True)Then";
if ((mostCurrent._tog_ayab.getChecked()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 709;BA.debugLine="dbCode.update_setting_byname(\"tog_ayab\",\"1\")";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_ayab","1");
 }else {
 //BA.debugLineNum = 711;BA.debugLine="dbCode.update_setting_byname(\"tog_ayab\",\"0\")";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_ayab","0");
 };
 //BA.debugLineNum = 714;BA.debugLine="chek_togel";
_chek_togel();
 //BA.debugLineNum = 715;BA.debugLine="End Sub";
return "";
}
public static String  _tog_bime_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 739;BA.debugLine="Private Sub tog_bime_CheckedChange(Checked As Bool";
 //BA.debugLineNum = 741;BA.debugLine="If(tog_bime.Checked=True)Then";
if ((mostCurrent._tog_bime.getChecked()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 742;BA.debugLine="dbCode.update_setting_byname(\"tog_bime\",1)";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_bime",BA.NumberToString(1));
 }else {
 //BA.debugLineNum = 744;BA.debugLine="dbCode.update_setting_byname(\"tog_bime\",0)";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_bime",BA.NumberToString(0));
 };
 //BA.debugLineNum = 747;BA.debugLine="chek_togel";
_chek_togel();
 //BA.debugLineNum = 748;BA.debugLine="End Sub";
return "";
}
public static String  _tog_food_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 728;BA.debugLine="Private Sub tog_food_CheckedChange(Checked As Bool";
 //BA.debugLineNum = 730;BA.debugLine="If(tog_food.Checked=True)Then";
if ((mostCurrent._tog_food.getChecked()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 731;BA.debugLine="dbCode.update_setting_byname(\"tog_food\",\"1\")";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_food","1");
 }else {
 //BA.debugLineNum = 733;BA.debugLine="dbCode.update_setting_byname(\"tog_food\",\"0\")";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_food","0");
 };
 //BA.debugLineNum = 736;BA.debugLine="chek_togel";
_chek_togel();
 //BA.debugLineNum = 737;BA.debugLine="End Sub";
return "";
}
public static String  _tog_maliat_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 750;BA.debugLine="Private Sub tog_maliat_CheckedChange(Checked As Bo";
 //BA.debugLineNum = 752;BA.debugLine="If(tog_maliat.Checked=True)Then";
if ((mostCurrent._tog_maliat.getChecked()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 753;BA.debugLine="dbCode.update_setting_byname(\"tog_maliat\",1)";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_maliat",BA.NumberToString(1));
 }else {
 //BA.debugLineNum = 755;BA.debugLine="dbCode.update_setting_byname(\"tog_maliat\",0)";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_maliat",BA.NumberToString(0));
 };
 //BA.debugLineNum = 758;BA.debugLine="chek_togel";
_chek_togel();
...
public static String  _tog_mosaede_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 761;BA.debugLine="Private Sub tog_mosaede_CheckedChange(Checked As B";
 //BA.debugLineNum = 763;BA.debugLine="If(tog_mosaede.Checked=True)Then";
if ((mostCurrent._tog_mosaede.getChecked()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 764;BA.debugLine="dbCode.update_setting_byname(\"tog_mosaede\",1)";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_mosaede",BA.NumberToString(1));
 }else {
 //BA.debugLineNum = 766;BA.debugLine="dbCode.update_setting_byname(\"tog_mosaede\",0)";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_mosaede",BA.NumberToString(0));
 };
 //BA.debugLineNum = 769;BA.debugLine="chek_togel";
_chek_togel();
 //BA.debugLineNum = 771;BA.debugLine="End Sub";
return "";
}
public static String  _tog_padash_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 697;BA.debugLine="Private Sub tog_padash_CheckedChange(Checked As Bo";
 //BA.debugLineNum = 698;BA.debugLine="If(tog_padash.Checked=True)Then";
if ((mostCurrent._tog_padash.getChecked()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 699;BA.debugLine="dbCode.update_setting_byname(\"tog_padash\",\"1\")";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_padash","1");
 }else {
 //BA.debugLineNum = 701;BA.debugLine="dbCode.update_setting_byname(\"tog_padash\",\"0\")";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_padash","0");
 };
 //BA.debugLineNum = 704;BA.debugLine="chek_togel";
_chek_togel();
 //BA.debugLineNum = 705;BA.debugLine="End Sub";
return "";
}
public static String  _tog_sayer_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 687;BA.debugLine="Private Sub tog_sayer_CheckedChange(Checked As Boo";
 //BA.debugLineNum = 688;BA.debugLine="If(tog_sayer.Checked=True)Then";
if ((mostCurrent._tog_sayer.getChecked()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 689;BA.debugLine="dbCode.update_setting_byname(\"tog_sayer\",\"1\")";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_sayer","1");
 }else {
 //BA.debugLineNum = 691;BA.debugLine="dbCode.update_setting_byname(\"tog_sayer\",\"0\")";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_sayer","0");
 };
 //BA.debugLineNum = 694;BA.debugLine="chek_togel";
_chek_togel();
 //BA.debugLineNum = 695;BA.debugLine="End Sub";
return "";
}
public static String  _tog_vam_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 717;BA.debugLine="Private Sub tog_vam_CheckedChange(Checked As Boole";
 //BA.debugLineNum = 719;BA.debugLine="If(tog_vam.Checked=True)Then";
if ((mostCurrent._tog_vam.getChecked()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 720;BA.debugLine="dbCode.update_setting_byname(\"tog_vam\",\"1\")";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_vam","1");
 }else {
 //BA.debugLineNum = 722;BA.debugLine="dbCode.update_setting_byname(\"tog_vam\",\"0\")";
mostCurrent._dbcode._update_setting_byname /*String*/ (mostCurrent.activityBA,"tog_vam","0");
 };
 //BA.debugLineNum = 725;BA.debugLine="chek_togel";
_chek_togel();
...
public static String  _togglebtn_finger_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 613;BA.debugLine="Private Sub ToggleBtn_finger_CheckedChange(Checked";
 //BA.debugLineNum = 614;BA.debugLine="Try";
try { //BA.debugLineNum = 615;BA.debugLine="fingerprint1.Initialize (Me, \"auth\")";
mostCurrent._fingerprint1._initialize /*String*/ (processBA,setting_activity.getObject(),"auth");
 //BA.debugLineNum = 616;BA.debugLine="If fingerprint1.HardwareDetected = False Then";
if (mostCurrent._fingerprint1._gethardwaredetected /*boolean*/ ()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 617;BA.debugLine="ToastMessageShow(\"سنسور اثر انگشت موجود نیست\",";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("سنسور اثر انگشت موجود نیست"),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 618;BA.debugLine="ToggleBtn_finger.Checked=False";
mostCurrent._togglebtn_finger.setChecked(anywheresoftware.b4a.keywords.Common.False);
 }else if(mostCurrent._fingerprint1._gethasenrolledfingerprints /*boolean*/ ()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 620;BA.debugLine="ToastMessageShow(\"اثر انگشت تعریف نشده است\", Fa";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("اثر انگشت تعریف نشده است"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 621;BA.debugLine="ToggleBtn_finger.Checked=False";
mostCurrent._togglebtn_finger.setChecked(anywheresoftware.b4a.keywords.Common.False);
 };
 } 
       catch (Exception e11) {
			processBA.setLastException(e11); //BA.debugLineNum = 625;BA.debugLine="ToastMessageShow(\"سنسور اثر انگشت موجود نیست\", T";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("سنسور اثر انگشت موجود نیست"),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 626;BA.debugLine="ToggleBtn_finger.Checked=False";
mostCurrent._togglebtn_finger.setChecked(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 627;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("652101134",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
public static String  _togglebtn_offon_lock_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 584;BA.debugLine="Private Sub ToggleBtn_OffOn_lock_CheckedChange(Che";
 //BA.debugLineNum = 585;BA.debugLine="Try";
try { //BA.debugLineNum = 586;BA.debugLine="If(ToggleBtn_OffOn_lock.Checked=False)Then";
if ((mostCurrent._togglebtn_offon_lock.getChecked()==anywheresoftware.b4a.keywords.Common.False)) { 
 //BA.debugLineNum = 587;BA.debugLine="et_pass_lock.Enabled=False";
mostCurrent._et_pass_lock.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 588;BA.debugLine="ToggleBtn_finger.Enabled=False";
mostCurrent._togglebtn_finger.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 589;BA.debugLine="et_hint_lock.Enabled=False";
mostCurrent._et_hint_lock.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 591;BA.debugLine="et_pass_lock.Enabled=True";
mostCurrent._et_pass_lock.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 592;BA.debugLine="ToggleBtn_finger.Enabled=True";
mostCurrent._togglebtn_finger.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 593;BA.debugLine="et_hint_lock.Enabled=True";
mostCurrent._et_hint_lock.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 } 
       catch (Exception e12) {
			processBA.setLastException(e12); //BA.debugLineNum = 597;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("651904525",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
