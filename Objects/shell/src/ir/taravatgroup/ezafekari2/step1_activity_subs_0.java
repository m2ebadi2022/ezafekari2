...
try {
		Debug.PushSubsStack("Activity_Create (step1_activity) ","step1_activity",30,step1_activity.mostCurrent.activityBA,step1_activity.mostCurrent,24);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (step1_activity) ","step1_activity",30,step1_activity.mostCurrent.activityBA,step1_activity.mostCurrent,112);
...
try {
		Debug.PushSubsStack("Activity_Pause (step1_activity) ","step1_activity",30,step1_activity.mostCurrent.activityBA,step1_activity.mostCurrent,41);
...
try {
		Debug.PushSubsStack("Activity_Resume (step1_activity) ","step1_activity",30,step1_activity.mostCurrent.activityBA,step1_activity.mostCurrent,37);
...
try {
		Debug.PushSubsStack("http_initial_1 (step1_activity) ","step1_activity",30,step1_activity.mostCurrent.activityBA,step1_activity.mostCurrent,67);
...
try {
		Debug.PushSubsStack("Jobdone (step1_activity) ","step1_activity",30,step1_activity.mostCurrent.activityBA,step1_activity.mostCurrent,84);
...
Debug.ShouldStop(256);
step1_activity.mostCurrent.__c.runVoidMethod ("LogImpl","257344021",BA.ObjectToString(step1_activity.mostCurrent.__c.runMethod(false,"LastException",step1_activity.mostCurrent.activityBA)),0);
...
try {
		Debug.PushSubsStack("lbl_run_step1_Click (step1_activity) ","step1_activity",30,step1_activity.mostCurrent.activityBA,step1_activity.mostCurrent,45);
