...
try {
		Debug.PushSubsStack("Activity_Create (step1_activity) ","step1_activity",31,step1_activity.mostCurrent.activityBA,step1_activity.mostCurrent,24);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (step1_activity) ","step1_activity",31,step1_activity.mostCurrent.activityBA,step1_activity.mostCurrent,115);
...
try {
		Debug.PushSubsStack("Activity_Pause (step1_activity) ","step1_activity",31,step1_activity.mostCurrent.activityBA,step1_activity.mostCurrent,41);
...
try {
		Debug.PushSubsStack("Activity_Resume (step1_activity) ","step1_activity",31,step1_activity.mostCurrent.activityBA,step1_activity.mostCurrent,37);
...
try {
		Debug.PushSubsStack("http_initial_1 (step1_activity) ","step1_activity",31,step1_activity.mostCurrent.activityBA,step1_activity.mostCurrent,67);
...
try {
		Debug.PushSubsStack("Jobdone (step1_activity) ","step1_activity",31,step1_activity.mostCurrent.activityBA,step1_activity.mostCurrent,84);
...
Debug.ShouldStop(33554432);
step1_activity.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteString",(Object)(step1_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("phonNum")),(Object)(step1_activity.mostCurrent._main._phon_num /*RemoteObject*/ ));
...
Debug.ShouldStop(134217728);
step1_activity.mostCurrent._activity.runVoidMethod ("Finish");
 BA.debugLineNum = 93;BA.debugLine="StartActivity(step2_activity)";
Debug.ShouldStop(268435456);
step1_activity.mostCurrent.__c.runVoidMethod ("StartActivity",step1_activity.processBA,(Object)((step1_activity.mostCurrent._step2_activity.getObject())));
 BA.debugLineNum = 95;BA.debugLine="ToastMessageShow(\"تبریک\",False)";
Debug.ShouldStop(1073741824);
step1_activity.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("تبریک")),(Object)(step1_activity.mostCurrent.__c.getField(true,"False")));
 ...
 BA.debugLineNum = 97;BA.debugLine="ToastMessageShow(job.GetString,False)";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("lbl_run_step1_Click (step1_activity) ","step1_activity",31,step1_activity.mostCurrent.activityBA,step1_activity.mostCurrent,45);
