...
try {
		Debug.PushSubsStack("Activity_Create (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,64);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,175);
...
try {
		Debug.PushSubsStack("Activity_Pause (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,94);
...
try {
		Debug.PushSubsStack("Activity_Resume (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,90);
...
try {
		Debug.PushSubsStack("et_mablagh_vam_TextChanged (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,239);
...
try {
		Debug.PushSubsStack("et_nerkh_vam_TextChanged (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,485);
...
Debug.locals.put("Old", _old);
Debug.locals.put("New", _new);
 BA.debugLineNum = 485;BA.debugLine="Private Sub et_nerkh_vam_TextChanged (Old As Strin";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("et_tedad_gest_TextChanged (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,489);
...
Debug.locals.put("Old", _old);
Debug.locals.put("New", _new);
 BA.debugLineNum = 489;BA.debugLine="Private Sub et_tedad_gest_TextChanged (Old As Stri";
Debug.ShouldStop(256);
 BA.debugLineNum = 490;BA.debugLine="mohasebe";
...
try {
		Debug.PushSubsStack("fill_list_vam (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,100);
...
try {
		Debug.PushSubsStack("lbl_add_vam_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,371);
...
try {
		Debug.PushSubsStack("lbl_agsat_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,509);
if (RapidSub.canDelegate("lbl_agsat_click")) { return ir.taravatgroup.ezafekari2.vam_activity.remoteMe.runUserSub(false, "vam_activity","lbl_agsat_click");}
 BA.debugLineNum = 509;BA.debugLine="Private Sub lbl_agsat_Click";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 510;BA.debugLine="pan_all_show_info.Visible=False";
Debug.ShouldStop(536870912);
vam_activity.mostCurrent._pan_all_show_info.runMethod(true,"setVisible",vam_activity.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 512;BA.debugLine="StartActivity(gestha_activity)";
Debug.ShouldStop(-2147483648);
...
try {
		Debug.PushSubsStack("lbl_back_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,171);
...
try {
		Debug.PushSubsStack("lbl_close_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,515);
if (RapidSub.canDelegate("lbl_close_click")) { return ir.taravatgroup.ezafekari2.vam_activity.remoteMe.runUserSub(false, "vam_activity","lbl_close_click");}
 BA.debugLineNum = 515;BA.debugLine="Private Sub lbl_close_Click";
Debug.ShouldStop(4);
 BA.debugLineNum = 516;BA.debugLine="pan_all_show_info.Visible=False";
Debug.ShouldStop(8);
vam_activity.mostCurrent._pan_all_show_info.runMethod(true,"setVisible",vam_activity.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("lbl_date_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,386);
...
try {
		Debug.PushSubsStack("lbl_go_agsatPage_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,493);
...
RemoteObject _b = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
 BA.debugLineNum = 493;BA.debugLine="Private Sub lbl_go_agsatPage_Click";
Debug.ShouldStop(4096);
 BA.debugLineNum = 494;BA.debugLine="Dim b As Label";
Debug.ShouldStop(8192);
_b = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");Debug.locals.put("b", _b);
 BA.debugLineNum = 495;BA.debugLine="b = Sender";
Debug.ShouldStop(16384);
_b = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.LabelWrapper"), vam_activity.mostCurrent.__c.runMethod(false,"Sender",vam_activity.mostCurrent.activityBA));Debug.locals.put("b", _b);
 BA.debugLineNum = 496;BA.debugLine="Main.current_idvam=b.Tag";
Debug.ShouldStop(32768);
vam_activity.mostCurrent._main._current_idvam /*RemoteObject*/  = BA.ObjectToString(_b.runMethod(false,"getTag"));
 BA.debugLineNum = 497;BA.debugLine="StartActivity(gestha_activity)";
Debug.ShouldStop(65536);
vam_activity.mostCurrent.__c.runVoidMethod ("StartActivity",vam_activity.processBA,(Object)((vam_activity.mostCurrent._gestha_activity.getObject())));
...
try {
		Debug.PushSubsStack("lbl_info_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,520);
...
RemoteObject _str_show = RemoteObject.declareNull("anywheresoftware.b4a.keywords.StringBuilderWrapper");
 BA.debugLineNum = 520;BA.debugLine="Private Sub lbl_info_Click";
Debug.ShouldStop(128);
 BA.debugLineNum = 522;BA.debugLine="Dim b As Label";
Debug.ShouldStop(512);
_b = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");Debug.locals.put("b", _b);
 BA.debugLineNum = 523;BA.debugLine="b = Sender";
Debug.ShouldStop(1024);
_b = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.LabelWrapper"), vam_activity.mostCurrent.__c.runMethod(false,"Sender",vam_activity.mostCurrent.activityBA));Debug.locals.put("b", _b);
...
vam_activity.mostCurrent._dbcode.runVoidMethod ("_connect_db" /*RemoteObject*/ ,vam_activity.mostCurrent.activityBA);
 BA.debugLineNum = 526;BA.debugLine="dbCode.res= dbCode.sql.ExecQuery(\"SELECT * FROM t";
Debug.ShouldStop(8192);
vam_activity.mostCurrent._dbcode._res /*RemoteObject*/  = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.sql.SQL.ResultSetWrapper"), vam_activity.mostCurrent._dbcode._sql /*RemoteObject*/ .runMethod(false,"ExecQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("SELECT * FROM tb_vam WHERE id="),_b.runMethod(false,"getTag")))));
 BA.debugLineNum = 527;BA.debugLine="dbCode.res.Position=0";
Debug.ShouldStop(16384);
vam_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"setPosition",BA.numberCast(int.class, 0));
 BA.debugLineNum = 528;BA.debugLine="Main.current_idvam= dbCode.res.GetString(\"idvam\")";
Debug.ShouldStop(32768);
...
_str_show.runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("<html dir='rtl'><meta charset='UTF-8' />  <meta name='viewport' content='width=device-width, initial-scale=1.0' /><body>")));
 BA.debugLineNum = 540;BA.debugLine="str_show.Append(\"<h5 align='center'>عنوان وام <br";
Debug.ShouldStop(134217728);
_str_show.runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("<h5 align='center'>عنوان وام <br>")));
 BA.debugLineNum = 541;BA.debugLine="str_show.Append(dbCode.res.GetString(\"onvan\"))";
Debug.ShouldStop(268435456);
_str_show.runVoidMethod ("Append",(Object)(vam_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("onvan")))));
 BA.debugLineNum = 542;BA.debugLine="str_show.Append(\"</h5>\")";
Debug.ShouldStop(536870912);
_str_show.runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("</h5>")));
 BA.debugLineNum = 544;BA.debugLine="str_show.Append(\"<div style=' border: 2px solid g";
Debug.ShouldStop(-2147483648);
_str_show.runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("<div style=' border: 2px solid gray;  padding: 10px; border-radius: 20px;'>")));
 BA.debugLineNum = 545;BA.debugLine="str_show.Append(\" مبلغ وام : \"&myfunc.show_num_po";
Debug.ShouldStop(1);
_str_show.runMethod(false,"Append",(Object)(RemoteObject.concat(RemoteObject.createImmutable(" مبلغ وام : "),vam_activity.mostCurrent._myfunc.runMethod(true,"_show_num_pool" /*RemoteObject*/ ,vam_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, vam_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("mablag"))))))))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("<br>")));
 BA.debugLineNum = 546;BA.debugLine="str_show.Append(\"نرخ وام % : \"&(dbCode.res.GetStr";
Debug.ShouldStop(2);
_str_show.runMethod(false,"Append",(Object)(RemoteObject.concat(RemoteObject.createImmutable("نرخ وام % : "),(vam_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("rate"))))))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("<br>")));
 BA.debugLineNum = 547;BA.debugLine="str_show.Append(\" تعداد اقساط : \"&(dbCode.res.Get";
Debug.ShouldStop(4);
_str_show.runMethod(false,"Append",(Object)(RemoteObject.concat(RemoteObject.createImmutable(" تعداد اقساط : "),(vam_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("count"))))))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("<br>")));
 BA.debugLineNum = 548;BA.debugLine="str_show.Append(\" ماه شروع : \"&(dbCode.res.GetStr";
Debug.ShouldStop(8);
_str_show.runMethod(false,"Append",(Object)(RemoteObject.concat(RemoteObject.createImmutable(" ماه شروع : "),(vam_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("date"))))))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("<br>")));
 BA.debugLineNum = 549;BA.debugLine="str_show.Append(\" توضیحات : \"&(dbCode.res.GetStri";
Debug.ShouldStop(16);
_str_show.runMethod(false,"Append",(Object)(RemoteObject.concat(RemoteObject.createImmutable(" توضیحات : "),(vam_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("tozihat"))))))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("<br>")));
 BA.debugLineNum = 550;BA.debugLine="str_show.Append(\"</div>\").Append(\"<br>\")";
Debug.ShouldStop(32);
_str_show.runMethod(false,"Append",(Object)(RemoteObject.createImmutable("</div>"))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("<br>")));
 BA.debugLineNum = 552;BA.debugLine="str_show.Append(\"<div style=' border: 3px solid g";
Debug.ShouldStop(128);
_str_show.runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("<div style=' border: 3px solid green;  padding: 10px; border-radius: 20px;'>")));
 BA.debugLineNum = 553;BA.debugLine="str_show.Append(\" کل مبلغ بازپرداخت  : \"&myfunc.s";
Debug.ShouldStop(256);
_str_show.runMethod(false,"Append",(Object)(RemoteObject.concat(RemoteObject.createImmutable(" کل مبلغ بازپرداخت  : "),vam_activity.mostCurrent._myfunc.runMethod(true,"_show_num_pool" /*RemoteObject*/ ,vam_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, vam_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("bazpardakht"))))))))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("<br>")));
 BA.debugLineNum = 554;BA.debugLine="str_show.Append(\" مبلغ هر قسط : <mark> \"&myfunc.s";
Debug.ShouldStop(512);
_str_show.runVoidMethod ("Append",(Object)(RemoteObject.concat(RemoteObject.createImmutable(" مبلغ هر قسط : <mark> "),vam_activity.mostCurrent._myfunc.runMethod(true,"_show_num_pool" /*RemoteObject*/ ,vam_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, vam_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("harghest")))))),RemoteObject.createImmutable("</mark>"))));
 BA.debugLineNum = 555;BA.debugLine="str_show.Append(\"</div>\")";
Debug.ShouldStop(1024);
_str_show.runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("</div>")));
 BA.debugLineNum = 557;BA.debugLine="str_show.Append(\"</body></html>\")";
Debug.ShouldStop(4096);
_str_show.runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("</body></html>")));
 BA.debugLineNum = 560;BA.debugLine="wb_show_result.LoadHtml(str_show.ToString)";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("lbl_remove_from_list2_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,194);
...
public static RemoteObject  _lbl_restall_click() throws Exception{
try {
		Debug.PushSubsStack("lbl_restAll_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,567);
if (RapidSub.canDelegate("lbl_restall_click")) { return ir.taravatgroup.ezafekari2.vam_activity.remoteMe.runUserSub(false, "vam_activity","lbl_restall_click");}
RemoteObject _result = RemoteObject.createImmutable(0);
...
Debug.ShouldStop(16777216);
_result = vam_activity.mostCurrent.__c.runMethodAndSync(true,"Msgbox2",(Object)(BA.ObjectToCharSequence("با این گزینه همه وام ها و قسط ها حذف میشوند!")),(Object)(BA.ObjectToCharSequence("بازنشانی")),(Object)(BA.ObjectToString("بازنشانی همه")),(Object)(BA.ObjectToString("")),(Object)(BA.ObjectToString("بستن")),(Object)((vam_activity.mostCurrent.__c.getField(false,"Null"))),vam_activity.mostCurrent.activityBA);Debug.locals.put("result", _result);
...
Debug.ShouldStop(134217728);
vam_activity.mostCurrent._dbcode.runVoidMethod ("_delete_all_vam" /*RemoteObject*/ ,vam_activity.mostCurrent.activityBA);
 BA.debugLineNum = 573;BA.debugLine="ToastMessageShow(\"انجام شد.\",False)";
Debug.ShouldStop(268435456);
vam_activity.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("انجام شد.")),(Object)(vam_activity.mostCurrent.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("lbl_save_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,398);
...
{ BA.debugLineNum = 405;BA.debugLine="else If(et_nerkh_vam.Text=\"\" )Then";
Debug.ShouldStop(1048576);
if ((RemoteObject.solveBoolean("=",vam_activity.mostCurrent._et_nerkh_vam.runMethod(true,"getText"),RemoteObject.createImmutable("")))) { 
...
try {
		Debug.PushSubsStack("lbl_save_picker_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,247);
...
try {
		Debug.PushSubsStack("mohasebe (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,444);
...
{ BA.debugLineNum = 447;BA.debugLine="Else If (et_mablagh_vam.Text<>\"\" And et_nerkh_vam";
Debug.ShouldStop(1073741824);
if ((RemoteObject.solveBoolean("!",vam_activity.mostCurrent._et_mablagh_vam.runMethod(true,"getText"),BA.ObjectToString("")) && RemoteObject.solveBoolean("=",vam_activity.mostCurrent._et_nerkh_vam.runMethod(true,"getText"),BA.NumberToString(0)) && RemoteObject.solveBoolean("!",vam_activity.mostCurrent._et_tedad_gest.runMethod(true,"getText"),RemoteObject.createImmutable("")))) { 
 BA.debugLineNum = 451;BA.debugLine="lbl_harGest.Tag=Round(et_mablagh_vam.Tag/et_teda";
Debug.ShouldStop(4);
vam_activity.mostCurrent._lbl_hargest.runMethod(false,"setTag",(vam_activity.mostCurrent.__c.runMethod(true,"Round",(Object)(RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, vam_activity.mostCurrent._et_mablagh_vam.runMethod(false,"getTag")),BA.numberCast(double.class, vam_activity.mostCurrent._et_tedad_gest.runMethod(true,"getText"))}, "/",0, 0)))));
 BA.debugLineNum = 452;BA.debugLine="lbl_kol_bazPardakht.Tag=Round(et_mablagh_vam.Tag";
Debug.ShouldStop(8);
vam_activity.mostCurrent._lbl_kol_bazpardakht.runMethod(false,"setTag",(vam_activity.mostCurrent.__c.runMethod(true,"Round",(Object)(BA.numberCast(double.class, vam_activity.mostCurrent._et_mablagh_vam.runMethod(false,"getTag"))))));
 BA.debugLineNum = 454;BA.debugLine="lbl_harGest.Text=myfunc.show_num_pool(lbl_harGes";
Debug.ShouldStop(32);
vam_activity.mostCurrent._lbl_hargest.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(vam_activity.mostCurrent._myfunc.runMethod(true,"_show_num_pool" /*RemoteObject*/ ,vam_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, vam_activity.mostCurrent._lbl_hargest.runMethod(false,"getTag")))),RemoteObject.createImmutable(" تومان "))));
 BA.debugLineNum = 455;BA.debugLine="lbl_kol_bazPardakht.Text=myfunc.show_num_pool(lb";
Debug.ShouldStop(64);
vam_activity.mostCurrent._lbl_kol_bazpardakht.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(vam_activity.mostCurrent._myfunc.runMethod(true,"_show_num_pool" /*RemoteObject*/ ,vam_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, vam_activity.mostCurrent._lbl_kol_bazpardakht.runMethod(false,"getTag")))),RemoteObject.createImmutable(" تومان "))));
 }else {
 BA.debugLineNum = 463;BA.debugLine="Dim eb1 As Double=Power( (1+(et_nerkh_vam.Text/1";
Debug.ShouldStop(16384);
_eb1 = vam_activity.mostCurrent.__c.runMethod(true,"Power",(Object)((RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(1),(RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, vam_activity.mostCurrent._et_nerkh_vam.runMethod(true,"getText")),RemoteObject.createImmutable(1200)}, "/",0, 0))}, "+",1, 0))),(Object)(BA.numberCast(double.class, vam_activity.mostCurrent._et_tedad_gest.runMethod(true,"getText"))));Debug.locals.put("eb1", _eb1);Debug.locals.put("eb1", _eb1);
 BA.debugLineNum = 464;BA.debugLine="Dim sorat As Double=et_mablagh_vam.Tag*(et_nerkh";
Debug.ShouldStop(32768);
_sorat = RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, vam_activity.mostCurrent._et_mablagh_vam.runMethod(false,"getTag")),(RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, vam_activity.mostCurrent._et_nerkh_vam.runMethod(true,"getText")),RemoteObject.createImmutable(1200)}, "/",0, 0)),_eb1}, "**",0, 0);Debug.locals.put("sorat", _sorat);Debug.locals.put("sorat", _sorat);
 BA.debugLineNum = 465;BA.debugLine="Dim makhraj As Double=eb1-1";
Debug.ShouldStop(65536);
_makhraj = RemoteObject.solve(new RemoteObject[] {_eb1,RemoteObject.createImmutable(1)}, "-",1, 0);Debug.locals.put("makhraj", _makhraj);Debug.locals.put("makhraj", _makhraj);
 BA.debugLineNum = 467;BA.debugLine="Dim gest As Double=sorat/makhraj";
Debug.ShouldStop(262144);
_gest = RemoteObject.solve(new RemoteObject[] {_sorat,_makhraj}, "/",0, 0);Debug.locals.put("gest", _gest);Debug.locals.put("gest", _gest);
 BA.debugLineNum = 469;BA.debugLine="Dim sod As Double=(gest*et_tedad_gest.Text)-et_m";
Debug.ShouldStop(1048576);
_sod = RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_gest,BA.numberCast(double.class, vam_activity.mostCurrent._et_tedad_gest.runMethod(true,"getText"))}, "*",0, 0)),BA.numberCast(double.class, vam_activity.mostCurrent._et_mablagh_vam.runMethod(false,"getTag"))}, "-",1, 0);Debug.locals.put("sod", _sod);Debug.locals.put("sod", _sod);
 BA.debugLineNum = 472;BA.debugLine="lbl_harGest.Tag=Round(gest)";
Debug.ShouldStop(8388608);
vam_activity.mostCurrent._lbl_hargest.runMethod(false,"setTag",(vam_activity.mostCurrent.__c.runMethod(true,"Round",(Object)(_gest))));
 BA.debugLineNum = 473;BA.debugLine="lbl_kol_bazPardakht.Tag=Round(et_mablagh_vam.Tag";
Debug.ShouldStop(16777216);
vam_activity.mostCurrent._lbl_kol_bazpardakht.runMethod(false,"setTag",(vam_activity.mostCurrent.__c.runMethod(true,"Round",(Object)(RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, vam_activity.mostCurrent._et_mablagh_vam.runMethod(false,"getTag")),_sod}, "+",1, 0)))));
 BA.debugLineNum = 475;BA.debugLine="lbl_harGest.Text=myfunc.show_num_pool(lbl_harGes";
Debug.ShouldStop(67108864);
vam_activity.mostCurrent._lbl_hargest.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(vam_activity.mostCurrent._myfunc.runMethod(true,"_show_num_pool" /*RemoteObject*/ ,vam_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, vam_activity.mostCurrent._lbl_hargest.runMethod(false,"getTag")))),RemoteObject.createImmutable(" تومان "))));
 BA.debugLineNum = 476;BA.debugLine="lbl_kol_bazPardakht.Text=myfunc.show_num_pool(lb";
Debug.ShouldStop(134217728);
vam_activity.mostCurrent._lbl_kol_bazpardakht.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(vam_activity.mostCurrent._myfunc.runMethod(true,"_show_num_pool" /*RemoteObject*/ ,vam_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, vam_activity.mostCurrent._lbl_kol_bazpardakht.runMethod(false,"getTag")))),RemoteObject.createImmutable(" تومان "))));
 }}
;
...
try {
		Debug.PushSubsStack("pan_all_add_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,382);
...
try {
		Debug.PushSubsStack("pan_all_set_date_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,232);
...
try {
		Debug.PushSubsStack("pan_all_show_info_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,501);
if (RapidSub.canDelegate("pan_all_show_info_click")) { return ir.taravatgroup.ezafekari2.vam_activity.remoteMe.runUserSub(false, "vam_activity","pan_all_show_info_click");}
 BA.debugLineNum = 501;BA.debugLine="Private Sub pan_all_show_info_Click";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 502;BA.debugLine="pan_all_show_info.Visible=False";
Debug.ShouldStop(2097152);
vam_activity.mostCurrent._pan_all_show_info.runMethod(true,"setVisible",vam_activity.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("Panel2_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,505);
if (RapidSub.canDelegate("panel2_click")) { return ir.taravatgroup.ezafekari2.vam_activity.remoteMe.runUserSub(false, "vam_activity","panel2_click");}
 BA.debugLineNum = 505;BA.debugLine="Private Sub Panel2_Click";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("Panel4_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,228);
...
try {
		Debug.PushSubsStack("pik_moon_bala1_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,315);
...
try {
		Debug.PushSubsStack("pik_moon_paeen1_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,329);
...
try {
		Debug.PushSubsStack("pik_pan_moon1_Touch (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,254);
...
try {
		Debug.PushSubsStack("pik_pan_year1_Touch (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,284);
...
try {
		Debug.PushSubsStack("pik_year_bala1_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,343);
...
try {
		Debug.PushSubsStack("pik_year_paeen1_Click (vam_activity) ","vam_activity",33,vam_activity.mostCurrent.activityBA,vam_activity.mostCurrent,356);
