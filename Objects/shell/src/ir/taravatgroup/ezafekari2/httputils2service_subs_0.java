...
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","337289990",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service: job completed multiple times - "),_taskid),0);
...
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","337224455",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseError): job completed multiple times - "),_taskid),0);
...
Debug.ShouldStop(1073741824);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","337093379",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "),_taskid),0);
...
if (RapidSub.canDelegate("receiver_receive")) { return ir.taravatgroup.ezafekari2.httputils2service.remoteMe.runUserSub(false, "httputils2service","receiver_receive", _firsttime, _startingintent);}
...
Debug.ShouldStop(2);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","336765703",BA.ObjectToString(httputils2service.mostCurrent.__c.runMethod(false,"LastException",httputils2service.processBA)),0);
 BA.debugLineNum = 35;BA.debugLine="Log(\"Switching to File.DirInternal\")";
Debug.ShouldStop(4);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","336765704",RemoteObject.createImmutable("Switching to File.DirInternal"),0);
