...
try {
		Debug.PushSubsStack("Activity_Create (step0_activity) ","step0_activity",30,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,31);
...
Debug.ShouldStop(64);
if ((step0_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"Exists",(Object)(step0_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("phonNum_step0")))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 40;BA.debugLine="Main.phon_num=File.ReadString(File.DirInternal,\"";
Debug.ShouldStop(128);
step0_activity.mostCurrent._main._phon_num /*RemoteObject*/  = step0_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"ReadString",(Object)(step0_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("phonNum_step0")));
 };
...
try {
		Debug.PushSubsStack("Activity_KeyPress (step0_activity) ","step0_activity",30,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,262);
...
try {
		Debug.PushSubsStack("Activity_Pause (step0_activity) ","step0_activity",30,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,51);
...
try {
		Debug.PushSubsStack("Activity_Resume (step0_activity) ","step0_activity",30,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,47);
...
try {
		Debug.PushSubsStack("et_code_num_TextChanged (step0_activity) ","step0_activity",30,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,171);
...
try {
		Debug.PushSubsStack("et_phonNum_TextChanged (step0_activity) ","step0_activity",30,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,254);
...
try {
		Debug.PushSubsStack("http_initial_1 (step0_activity) ","step0_activity",30,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,182);
...
Debug.ShouldStop(536870912);
step0_activity.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteString",(Object)(step0_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("phonNum_step0")),(Object)(step0_activity.mostCurrent._main._phon_num /*RemoteObject*/ ));
...
try {
		Debug.PushSubsStack("Jobdone (step0_activity) ","step0_activity",30,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,210);
...
Debug.ShouldStop(1048576);
step0_activity.mostCurrent.__c.runVoidMethod ("LogImpl","658064899",_job.runClassMethod (ir.taravatgroup.ezafekari2.httpjob.class, "_getstring" /*RemoteObject*/ ),0);
...
{ BA.debugLineNum = 227;BA.debugLine="Else if (job.GetString.Contains(\"nouser\")=True";
Debug.ShouldStop(4);
...
Debug.ShouldStop(16);
step0_activity.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteString",(Object)(step0_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("phonNum_step1")),(Object)(step0_activity.mostCurrent._main._phon_num /*RemoteObject*/ ));
...
_job.runClassMethod (ir.taravatgroup.ezafekari2.httpjob.class, "_release" /*RemoteObject*/ );
 ...
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",step0_activity.processBA, e24.toString()); BA.debugLineNum = 245;BA.debugLine="Log(LastException)";
Debug.ShouldStop(1048576);
step0_activity.mostCurrent.__c.runVoidMethod ("LogImpl","658064931",BA.ObjectToString(step0_activity.mostCurrent.__c.runMethod(false,"LastException",step0_activity.mostCurrent.activityBA)),0);
...
try {
		Debug.PushSubsStack("lbl_back_Click (step0_activity) ","step0_activity",30,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,276);
...
try {
		Debug.PushSubsStack("lbl_back_run1_Click (step0_activity) ","step0_activity",30,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,166);
...
try {
		Debug.PushSubsStack("lbl_code_recived_Click (step0_activity) ","step0_activity",30,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,281);
...
try {
		Debug.PushSubsStack("lbl_run1_step0_Click (step0_activity) ","step0_activity",30,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,122);
...
Debug.ShouldStop(1073741824);
step0_activity.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("شماره موبایل معتبر وارد کنید")),(Object)(step0_activity.mostCurrent.__c.getField(true,"False")));
 }else {
...
try {
		Debug.PushSubsStack("lbl_run2_step0_Click (step0_activity) ","step0_activity",30,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,149);
...
try {
		Debug.PushSubsStack("pan_all_send_Click (step0_activity) ","step0_activity",30,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,162);
...
try {
		Debug.PushSubsStack("time_remind_Tick (step0_activity) ","step0_activity",30,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,55);
