...
try {
		Debug.PushSubsStack("Activity_Create (step0_activity) ","step0_activity",29,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,31);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (step0_activity) ","step0_activity",29,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,258);
...
try {
		Debug.PushSubsStack("Activity_Pause (step0_activity) ","step0_activity",29,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,51);
...
try {
		Debug.PushSubsStack("Activity_Resume (step0_activity) ","step0_activity",29,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,47);
...
try {
		Debug.PushSubsStack("et_code_num_TextChanged (step0_activity) ","step0_activity",29,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,171);
...
try {
		Debug.PushSubsStack("et_phonNum_TextChanged (step0_activity) ","step0_activity",29,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,250);
...
try {
		Debug.PushSubsStack("http_initial_1 (step0_activity) ","step0_activity",29,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,182);
...
try {
		Debug.PushSubsStack("Jobdone (step0_activity) ","step0_activity",29,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,210);
...
Debug.ShouldStop(1048576);
step0_activity.mostCurrent.__c.runVoidMethod ("LogImpl","256557571",_job.runClassMethod (ir.taravatgroup.ezafekari2.httpjob.class, "_getstring" /*RemoteObject*/ ),0);
...
Debug.ShouldStop(65536);
step0_activity.mostCurrent.__c.runVoidMethod ("LogImpl","256557599",BA.ObjectToString(step0_activity.mostCurrent.__c.runMethod(false,"LastException",step0_activity.mostCurrent.activityBA)),0);
...
try {
		Debug.PushSubsStack("lbl_back_Click (step0_activity) ","step0_activity",29,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,272);
...
try {
		Debug.PushSubsStack("lbl_back_run1_Click (step0_activity) ","step0_activity",29,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,166);
...
try {
		Debug.PushSubsStack("lbl_code_recived_Click (step0_activity) ","step0_activity",29,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,277);
...
try {
		Debug.PushSubsStack("lbl_run1_step0_Click (step0_activity) ","step0_activity",29,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,122);
...
try {
		Debug.PushSubsStack("lbl_run2_step0_Click (step0_activity) ","step0_activity",29,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,149);
...
try {
		Debug.PushSubsStack("pan_all_send_Click (step0_activity) ","step0_activity",29,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,162);
...
try {
		Debug.PushSubsStack("time_remind_Tick (step0_activity) ","step0_activity",29,step0_activity.mostCurrent.activityBA,step0_activity.mostCurrent,55);
