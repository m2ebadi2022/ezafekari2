...
try {
		Debug.PushSubsStack("Activity_Create (comment_activity) ","comment_activity",9,comment_activity.mostCurrent.activityBA,comment_activity.mostCurrent,18);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (comment_activity) ","comment_activity",9,comment_activity.mostCurrent.activityBA,comment_activity.mostCurrent,41);
...
try {
		Debug.PushSubsStack("Activity_Pause (comment_activity) ","comment_activity",9,comment_activity.mostCurrent.activityBA,comment_activity.mostCurrent,28);
...
try {
		Debug.PushSubsStack("Activity_Resume (comment_activity) ","comment_activity",9,comment_activity.mostCurrent.activityBA,comment_activity.mostCurrent,24);
...
try {
		Debug.PushSubsStack("lbl_back_Click (comment_activity) ","comment_activity",9,comment_activity.mostCurrent.activityBA,comment_activity.mostCurrent,33);
