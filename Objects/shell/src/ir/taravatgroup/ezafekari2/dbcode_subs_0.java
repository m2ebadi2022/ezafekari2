...
try {
		Debug.PushSubsStack("add_ezafekari (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,171);
...
try {
		Debug.PushSubsStack("add_gozaresh (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,238);
...
try {
		Debug.PushSubsStack("add_mamoriat (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,194);
...
try {
		Debug.PushSubsStack("add_morakhasi (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,179);
...
try {
		Debug.PushSubsStack("add_setting_hogog (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,278);
...
try {
		Debug.PushSubsStack("add_setting_run (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,316);
...
try {
		Debug.PushSubsStack("add_taradod (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,186);
...
try {
		Debug.PushSubsStack("all_ezafekari_mah (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,325);
...
try {
		Debug.PushSubsStack("all_mamoriat_mah (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,480);
...
try {
		Debug.PushSubsStack("all_morakhasi_mah (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,386);
...
try {
		Debug.PushSubsStack("all_taradod_mah (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,440);
...
try {
		Debug.PushSubsStack("cheng_tagvim (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,98);
...
dbcode._res.runVoidMethod ("Close");
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba), e22.toString()); BA.debugLineNum = 133;BA.debugLine="Log(\"error\")";
Debug.ShouldStop(16);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","610420259",RemoteObject.createImmutable("error"),0);
 };
...
try {
		Debug.PushSubsStack("delete_ezafekari (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,245);
...
try {
		Debug.PushSubsStack("delete_gozaresh (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,263);
...
try {
		Debug.PushSubsStack("delete_mamoriat (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,271);
...
try {
		Debug.PushSubsStack("delete_morakhasi (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,251);
...
try {
		Debug.PushSubsStack("delete_taradod (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,257);
...
try {
		Debug.PushSubsStack("edit_ezafekari (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,204);
...
try {
		Debug.PushSubsStack("edit_mamoriat (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,227);
...
try {
		Debug.PushSubsStack("edit_morakhasi (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,212);
...
try {
		Debug.PushSubsStack("edit_taradod (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,219);
...
try {
		Debug.PushSubsStack("get_day_id (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,626);
...
Debug.CheckDeviceExceptions();if (true) return dbcode._res.runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("id")));
 ...
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba), e9.toString()); BA.debugLineNum = 641;BA.debugLine="Log(LastException)";
Debug.ShouldStop(1);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","611993103",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
try {
		Debug.PushSubsStack("get_setting_byName (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,306);
...
try {
		Debug.PushSubsStack("init_notfound (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,161);
...
try {
		Debug.PushSubsStack("insert_calander_exl (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,139);
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba), e9.toString()); BA.debugLineNum = 150;BA.debugLine="ToastMessageShow(\"error date loading\",True)";
Debug.ShouldStop(2097152);
...
try {
		Debug.PushSubsStack("install_db_tbl_myCalander (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,51);
...
Debug.ShouldStop(4194304);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","610289156",RemoteObject.createImmutable("tbl my_calander exist"),0);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
			BA.rdebugUtils.runVoidMethod("setLastException",BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba), e6.toString()); BA.debugLineNum = 57;BA.debugLine="sql.ExecNonQuery(\"CREATE TABLE 'my_calander' ('i";
Debug.ShouldStop(16777216);
...
Debug.ShouldStop(134217728);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","610289161",RemoteObject.createImmutable("tbl myCalander created"),0);
 };
...
try {
		Debug.PushSubsStack("install_db_tbl_onvanha (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,65);
...
Debug.ShouldStop(16);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","610354692",RemoteObject.createImmutable("tbl tbl_onvanha exist"),0);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
			BA.rdebugUtils.runVoidMethod("setLastException",BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba), e6.toString()); BA.debugLineNum = 71;BA.debugLine="sql.ExecNonQuery(\"CREATE TABLE 'tbl_onvanha' ('i";
Debug.ShouldStop(64);
...
Debug.ShouldStop(33554432);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","610354713",RemoteObject.createImmutable("tbl tbl_onvanha created"),0);
 };
...
Debug.ShouldStop(33554432);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","610223621",RemoteObject.createImmutable("tbl taradod exist"),0);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
...
Debug.ShouldStop(1073741824);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","610223626",RemoteObject.createImmutable("tbl taradod created"),0);
 };
...
Debug.ShouldStop(32);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","610223633",RemoteObject.createImmutable("tbl mamoriat exist"),0);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e13) {
			BA.rdebugUtils.runVoidMethod("setLastException",BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba), e13.toString()); BA.debugLineNum = 41;BA.debugLine="sql.ExecNonQuery(\"CREATE TABLE 'tb_mamoriat' ( '";
Debug.ShouldStop(256);
...
Debug.ShouldStop(1024);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","610223638",RemoteObject.createImmutable("tbl mamoriat created"),0);
 };
...
try {
		Debug.PushSubsStack("isexist_ezafekari_by_date (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,520);
...
dbcode._res.runVoidMethod ("Close");
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba), e12.toString()); BA.debugLineNum = 532;BA.debugLine="Log(LastException)";
Debug.ShouldStop(524288);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","611730956",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
try {
		Debug.PushSubsStack("isexist_mamoriat_by_date (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,579);
...
dbcode._res.runVoidMethod ("Close");
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba), e12.toString()); BA.debugLineNum = 591;BA.debugLine="Log(LastException)";
Debug.ShouldStop(16384);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","642926092",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
try {
		Debug.PushSubsStack("isexist_morakhasi_by_date (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,540);
...
dbcode._res.runVoidMethod ("Close");
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba), e12.toString()); BA.debugLineNum = 552;BA.debugLine="Log(LastException)";
Debug.ShouldStop(128);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","611796492",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
try {
		Debug.PushSubsStack("isexist_taradod_by_date (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,558);
...
dbcode._res.runVoidMethod ("Close");
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba), e12.toString()); BA.debugLineNum = 570;BA.debugLine="Log(LastException)";
Debug.ShouldStop(33554432);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","611862028",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
try {
		Debug.PushSubsStack("istatil_by_date (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,600);
...
dbcode._res.runVoidMethod ("Close");
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba), e13.toString()); BA.debugLineNum = 615;BA.debugLine="Log(LastException)";
Debug.ShouldStop(64);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","611927567",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
try {
		Debug.PushSubsStack("read_onvan_db (dbcode) ","dbcode",2,_ba,dbcode.mostCurrent,650);
