...
Debug.ShouldStop(2097152);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","48585251",RemoteObject.createImmutable("error"),0);
 };
...
Debug.ShouldStop(8);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","410158095",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
Debug.ShouldStop(128);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","48454148",RemoteObject.createImmutable("tbl my_calander exist"),0);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
...
Debug.ShouldStop(4096);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","48454153",RemoteObject.createImmutable("tbl myCalander created"),0);
 };
...
Debug.ShouldStop(2097152);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","48519684",RemoteObject.createImmutable("tbl tbl_onvanha exist"),0);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
...
Debug.ShouldStop(1024);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","48519705",RemoteObject.createImmutable("tbl tbl_onvanha created"),0);
 };
...
Debug.ShouldStop(33554432);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","48388613",RemoteObject.createImmutable("tbl taradod exist"),0);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
...
Debug.ShouldStop(1073741824);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","48388618",RemoteObject.createImmutable("tbl taradod created"),0);
 };
...
Debug.ShouldStop(1024);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","49895948",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
Debug.ShouldStop(1073741824);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","49961484",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
Debug.ShouldStop(65536);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","410027020",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
Debug.ShouldStop(512);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","410092559",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
