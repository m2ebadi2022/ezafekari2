...
Debug.ShouldStop(2097152);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","710354723",RemoteObject.createImmutable("error"),0);
 };
...
Debug.ShouldStop(8);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","711927567",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
Debug.ShouldStop(128);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","710223620",RemoteObject.createImmutable("tbl my_calander exist"),0);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
...
Debug.ShouldStop(4096);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","710223625",RemoteObject.createImmutable("tbl myCalander created"),0);
 };
...
Debug.ShouldStop(2097152);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","710289156",RemoteObject.createImmutable("tbl tbl_onvanha exist"),0);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
...
Debug.ShouldStop(1024);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","710289177",RemoteObject.createImmutable("tbl tbl_onvanha created"),0);
 };
...
Debug.ShouldStop(33554432);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","710158085",RemoteObject.createImmutable("tbl taradod exist"),0);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
...
Debug.ShouldStop(1073741824);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","710158090",RemoteObject.createImmutable("tbl taradod created"),0);
 };
...
Debug.ShouldStop(1024);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","711665420",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
Debug.ShouldStop(1073741824);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","711730956",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
Debug.ShouldStop(65536);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","711796492",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
Debug.ShouldStop(512);
dbcode.mostCurrent.__c.runVoidMethod ("LogImpl","711862031",BA.ObjectToString(dbcode.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
