...
try {
		Debug.PushSubsStack("Activity_KeyPress (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1993);
...
Debug.locals.put("KeyCode", _keycode);
 BA.debugLineNum = 1993;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
Debug.ShouldStop(256);
 BA.debugLineNum = 1994;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
...
if (RemoteObject.solveBoolean("=",_keycode,BA.numberCast(double.class, main.mostCurrent.__c.getField(false,"KeyCodes").getField(true,"KEYCODE_BACK")))) { 
 BA.debugLineNum = 1995;BA.debugLine="If (pan_all_msgNewYear.Visible=True)Then";
Debug.ShouldStop(1024);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._pan_all_msgnewyear.runMethod(true,"getVisible"),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 1996;BA.debugLine="pan_all_msgNewYear.Visible=False";
Debug.ShouldStop(2048);
main.mostCurrent._pan_all_msgnewyear.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 }else 
{ BA.debugLineNum = 1998;BA.debugLine="else If (pan_help.Visible=True)Then";
Debug.ShouldStop(8192);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._pan_help.runMethod(true,"getVisible"),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 1999;BA.debugLine="lbl_close_help_Click";
Debug.ShouldStop(16384);
_lbl_close_help_click();
 }else 
{ BA.debugLineNum = 2001;BA.debugLine="Else If (pan_all.Visible=True )Then";
Debug.ShouldStop(65536);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._pan_all.runMethod(true,"getVisible"),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 2003;BA.debugLine="If(pan_all2.Visible=True)Then";
Debug.ShouldStop(262144);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._pan_all2.runMethod(true,"getVisible"),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 2004;BA.debugLine="pan_all2.Visible=False";
Debug.ShouldStop(524288);
main.mostCurrent._pan_all2.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 }else {
 BA.debugLineNum = 2006;BA.debugLine="pan_all.Visible=False";
Debug.ShouldStop(2097152);
main.mostCurrent._pan_all.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 };
 }else 
{ BA.debugLineNum = 2009;BA.debugLine="Else if(pan_notifi_all.Visible==True) Then";
Debug.ShouldStop(16777216);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._pan_notifi_all.runMethod(true,"getVisible"),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 2010;BA.debugLine="lbl_close_notif_Click";
Debug.ShouldStop(33554432);
_lbl_close_notif_click();
 }else 
{ BA.debugLineNum = 2011;BA.debugLine="Else If(index_page=2 Or index_page=3)Then";
Debug.ShouldStop(67108864);
if ((RemoteObject.solveBoolean("=",main._index_page,BA.numberCast(double.class, 2)) || RemoteObject.solveBoolean("=",main._index_page,BA.numberCast(double.class, 3)))) { 
 BA.debugLineNum = 2012;BA.debugLine="btn_menu_home_Click";
Debug.ShouldStop(134217728);
_btn_menu_home_click();
 }else 
{ BA.debugLineNum = 2013;BA.debugLine="Else If(pan_all_noskhe.Visible==True)Then";
Debug.ShouldStop(268435456);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._pan_all_noskhe.runMethod(true,"getVisible"),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 2014;BA.debugLine="pan_all_noskhe_Click";
Debug.ShouldStop(536870912);
_pan_all_noskhe_click();
 }else 
{ BA.debugLineNum = 2015;BA.debugLine="Else If(pan_all_liteMenu.Visible==True)Then";
Debug.ShouldStop(1073741824);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._pan_all_litemenu.runMethod(true,"getVisible"),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 2016;BA.debugLine="pan_all_liteMenu.Visible=False";
Debug.ShouldStop(-2147483648);
main.mostCurrent._pan_all_litemenu.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 }else 
{ BA.debugLineNum = 2017;BA.debugLine="Else If (pan_all_chekUpdate.Visible==True)Then";
Debug.ShouldStop(1);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._pan_all_chekupdate.runMethod(true,"getVisible"),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 2018;BA.debugLine="pan_all_chekUpdate.Visible=False";
Debug.ShouldStop(2);
main.mostCurrent._pan_all_chekupdate.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 }else 
{ BA.debugLineNum = 2019;BA.debugLine="Else If(pan_all_FT.Visible=True)Then";
Debug.ShouldStop(4);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._pan_all_ft.runMethod(true,"getVisible"),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 2020;BA.debugLine="pan_all_FT.Visible=False";
Debug.ShouldStop(8);
main.mostCurrent._pan_all_ft.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 }else {
 BA.debugLineNum = 2024;BA.debugLine="Dim result As Int";
Debug.ShouldStop(128);
_result = RemoteObject.createImmutable(0);Debug.locals.put("result", _result);
 BA.debugLineNum = 2025;BA.debugLine="result = Msgbox2(\"آیا قصد خروج دارید؟\", \"خروج\",";
Debug.ShouldStop(256);
_result = main.mostCurrent.__c.runMethodAndSync(true,"Msgbox2",(Object)(BA.ObjectToCharSequence("آیا قصد خروج دارید؟")),(Object)(BA.ObjectToCharSequence("خروج")),(Object)(BA.ObjectToString("بله")),(Object)(BA.ObjectToString("")),(Object)(BA.ObjectToString("خیر")),(Object)((main.mostCurrent.__c.getField(false,"Null"))),main.mostCurrent.activityBA);Debug.locals.put("result", _result);
 BA.debugLineNum = 2026;BA.debugLine="If result = DialogResponse.Positive Then";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean("=",_result,BA.numberCast(double.class, main.mostCurrent.__c.getField(false,"DialogResponse").getField(true,"POSITIVE")))) { 
 BA.debugLineNum = 2027;BA.debugLine="ExitApplication";
Debug.ShouldStop(1024);
main.mostCurrent.__c.runVoidMethod ("ExitApplication");
 };
 }}}}}}}}}
;
 BA.debugLineNum = 2033;BA.debugLine="Return True";
Debug.ShouldStop(65536);
if (true) return main.mostCurrent.__c.getField(true,"True");
 }else {
 BA.debugLineNum = 2035;BA.debugLine="Return False";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("add_end (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1746);
...
RemoteObject _alist = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
 BA.debugLineNum = 1746;BA.debugLine="Sub add_end";
Debug.ShouldStop(131072);
 BA.debugLineNum = 1747;BA.debugLine="Dim chek As Boolean";
Debug.ShouldStop(262144);
_chek = RemoteObject.createImmutable(false);Debug.locals.put("chek", _chek);
 BA.debugLineNum = 1748;BA.debugLine="chek=myfunc.check_karid";
Debug.ShouldStop(524288);
_chek = main.mostCurrent._myfunc.runMethod(true,"_check_karid" /*RemoteObject*/ ,main.mostCurrent.activityBA);Debug.locals.put("chek", _chek);
 BA.debugLineNum = 1749;BA.debugLine="Dim alist As List";
Debug.ShouldStop(1048576);
_alist = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("alist", _alist);
 BA.debugLineNum = 1750;BA.debugLine="alist.Initialize";
Debug.ShouldStop(2097152);
_alist.runVoidMethod ("Initialize");
 BA.debugLineNum = 1752;BA.debugLine="Dim moon_num As String=myfunc.convert_adad(myfunc";
Debug.ShouldStop(8388608);
main._moon_num = main.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.NumberToString(main._persiandate.runMethod(true,"getPersianMonth")))))));
 BA.debugLineNum = 1755;BA.debugLine="alist=myfunc.num_list(myfunc.fa2en(persianDate.Pe";
Debug.ShouldStop(67108864);
_alist = main.mostCurrent._myfunc.runMethod(false,"_num_list" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.NumberToString(main._persiandate.runMethod(true,"getPersianYear"))))),(Object)(main._moon_num));Debug.locals.put("alist", _alist);
 BA.debugLineNum = 1758;BA.debugLine="If(index_box=1) Then";
Debug.ShouldStop(536870912);
...
if ((RemoteObject.solveBoolean("=",_chek,main.mostCurrent.__c.getField(true,"False")))) { 
 BA.debugLineNum = 1760;BA.debugLine="If(alist.Get(0)<5)Then";
Debug.ShouldStop(-2147483648);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, _alist.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)))),BA.numberCast(double.class, 5)))) { 
 BA.debugLineNum = 1761;BA.debugLine="add_ezafe_sub";
Debug.ShouldStop(1);
_add_ezafe_sub();
 }else {
...
_lbl_vip_click();
 ...
 BA.debugLineNum = 1767;BA.debugLine="add_ezafe_sub";
Debug.ShouldStop(64);
_add_ezafe_sub();
 };
 }else 
{ BA.debugLineNum = 1770;BA.debugLine="Else If (index_box=2) Then";
Debug.ShouldStop(512);
if ((RemoteObject.solveBoolean("=",main._index_box,BA.numberCast(double.class, 2)))) { 
 BA.debugLineNum = 1772;BA.debugLine="If(chek=False)Then";
Debug.ShouldStop(2048);
if ((RemoteObject.solveBoolean("=",_chek,main.mostCurrent.__c.getField(true,"False")))) { 
 BA.debugLineNum = 1773;BA.debugLine="If(alist.Get(1)<5)Then";
...
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, _alist.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1)))),BA.numberCast(double.class, 5)))) { 
 BA.debugLineNum = 1774;BA.debugLine="add_morakhasi_sub";
Debug.ShouldStop(8192);
_add_morakhasi_sub();
 }else {
 BA.debugLineNum = 1776;BA.debugLine="lbl_vip_Click";
Debug.ShouldStop(32768);
_lbl_vip_click();
 };
 }else {
 BA.debugLineNum = 1779;BA.debugLine="add_morakhasi_sub";
Debug.ShouldStop(262144);
_add_morakhasi_sub();
 };
 }else 
{ BA.debugLineNum = 1782;BA.debugLine="Else If (index_box=3) Then";
Debug.ShouldStop(2097152);
if ((RemoteObject.solveBoolean("=",main._index_box,BA.numberCast(double.class, 3)))) { 
 BA.debugLineNum = 1784;BA.debugLine="If(chek=False)Then";
Debug.ShouldStop(8388608);
if ((RemoteObject.solveBoolean("=",_chek,main.mostCurrent.__c.getField(true,"False")))) { 
 BA.debugLineNum = 1785;BA.debugLine="If(alist.Get(3)<5)Then";
Debug.ShouldStop(16777216);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, _alist.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 3)))),BA.numberCast(double.class, 5)))) { 
 BA.debugLineNum = 1786;BA.debugLine="add_taradod_sub";
Debug.ShouldStop(33554432);
_add_taradod_sub();
 }else {
 BA.debugLineNum = 1788;BA.debugLine="lbl_vip_Click";
Debug.ShouldStop(134217728);
_lbl_vip_click();
 };
 }else {
 BA.debugLineNum = 1791;BA.debugLine="add_taradod_sub";
Debug.ShouldStop(1073741824);
_add_taradod_sub();
 };
 }else 
{ BA.debugLineNum = 1795;BA.debugLine="Else If (index_box=4) Then";
Debug.ShouldStop(4);
if ((RemoteObject.solveBoolean("=",main._index_box,BA.numberCast(double.class, 4)))) { 
 BA.debugLineNum = 1797;BA.debugLine="If(chek=False)Then";
Debug.ShouldStop(16);
if ((RemoteObject.solveBoolean("=",_chek,main.mostCurrent.__c.getField(true,"False")))) { 
 BA.debugLineNum = 1798;BA.debugLine="If(alist.Get(3)<5)Then";
Debug.ShouldStop(32);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, _alist.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 3)))),BA.numberCast(double.class, 5)))) { 
 BA.debugLineNum = 1799;BA.debugLine="add_taradod_fast";
Debug.ShouldStop(64);
_add_taradod_fast();
 }else {
 BA.debugLineNum = 1801;BA.debugLine="lbl_vip_Click";
Debug.ShouldStop(256);
_lbl_vip_click();
 BA.debugLineNum = 1802;BA.debugLine="lbl_tim_vorod_FT.Text=\"00:00\"";
Debug.ShouldStop(512);
main.mostCurrent._lbl_tim_vorod_ft.runMethod(true,"setText",BA.ObjectToCharSequence("00:00"));
 BA.debugLineNum = 1803;BA.debugLine="code_fast_taradod=1";
Debug.ShouldStop(1024);
main._code_fast_taradod = BA.numberCast(int.class, 1);
 BA.debugLineNum = 1804;BA.debugLine="pan_all_FT_Click";
Debug.ShouldStop(2048);
_pan_all_ft_click();
 };
 }else {
 BA.debugLineNum = 1807;BA.debugLine="add_taradod_fast";
Debug.ShouldStop(16384);
_add_taradod_fast();
 };
 }}}}
...
try {
		Debug.PushSubsStack("add_ezafe_sub (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1813);
...
RemoteObject _ls_temp_time1 = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
 BA.debugLineNum = 1813;BA.debugLine="Sub add_ezafe_sub";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 1814;BA.debugLine="Dim state_mod As Int=0";
Debug.ShouldStop(2097152);
_state_mod = BA.numberCast(int.class, 0);Debug.locals.put("state_mod", _state_mod);Debug.locals.put("state_mod", _state_mod);
 BA.debugLineNum = 1815;BA.debugLine="Dim str_mod As String=\"\"";
Debug.ShouldStop(4194304);
_str_mod = BA.ObjectToString("");Debug.locals.put("str_mod", _str_mod);Debug.locals.put("str_mod", _str_mod);
 BA.debugLineNum = 1816;BA.debugLine="If(ckb_ezaf_taradod.Checked=True)Then";
Debug.ShouldStop(8388608);
...
if ((RemoteObject.solveBoolean("<",main._hour_bt,BA.numberCast(double.class, 0)) || RemoteObject.solveBoolean("<",main._min_bt,BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 1827;BA.debugLine="ToastMessageShow(\"خطا! زمان منفی نمی شود\",True)";
Debug.ShouldStop(4);
...
{ BA.debugLineNum = 1829;BA.debugLine="Else If (moon_bt<>0 Or year_bt<>0 Or day_bt<>0)T";
Debug.ShouldStop(16);
if ((RemoteObject.solveBoolean("!",main._moon_bt,BA.numberCast(double.class, 0)) || RemoteObject.solveBoolean("!",main._year_bt,BA.numberCast(double.class, 0)) || RemoteObject.solveBoolean("!",main._day_bt,BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 1830;BA.debugLine="ToastMessageShow(\"خطا! زمان نادرست است\",True)";
Debug.ShouldStop(32);
...
{ BA.debugLineNum = 1831;BA.debugLine="Else If (hour_bt=0 And min_bt=0 )Then";
Debug.ShouldStop(64);
if ((RemoteObject.solveBoolean("=",main._hour_bt,BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean("=",main._min_bt,BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 1832;BA.debugLine="ToastMessageShow(\"خطا! انتخاب زمان  \",True)";
Debug.ShouldStop(128);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("خطا! انتخاب زمان  ")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 ...
 BA.debugLineNum = 1836;BA.debugLine="If(is_for_edit=False)Then";
Debug.ShouldStop(2048);
if ((RemoteObject.solveBoolean("=",main._is_for_edit,main.mostCurrent.__c.getField(true,"False")))) { 
 BA.debugLineNum = 1837;BA.debugLine="If(dbCode.isexist_ezafekari_by_date(date1)=Tru";
Debug.ShouldStop(4096);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._dbcode.runMethod(true,"_isexist_ezafekari_by_date" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._date1)),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 1838;BA.debugLine="myfunc.help_man(\"توجه\",\"برای این تاریخ اضافه";
Debug.ShouldStop(8192);
main.mostCurrent._myfunc.runVoidMethod ("_help_man" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.ObjectToString("توجه")),(Object)(RemoteObject.createImmutable("برای این تاریخ اضافه کاری وجود دارد میتوانید در صفحه لیست آن را ویرایش نمائید")));
 ...
 BA.debugLineNum = 1840;BA.debugLine="dbCode.add_ezafekari(date1,date2,lbl_tim1.Tex";
Debug.ShouldStop(32768);
main.mostCurrent._dbcode.runVoidMethod ("_add_ezafekari" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._date1),(Object)(main.mostCurrent._date2),(Object)(main.mostCurrent._lbl_tim1.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_tim2.runMethod(true,"getText")),(Object)(main._day_bt),(Object)(main._hour_bt),(Object)(main._min_bt),(Object)(RemoteObject.concat(_str_mod,main.mostCurrent._et_tozihat.runMethod(true,"getText"))),(Object)(_state_mod));
 BA.debugLineNum = 1842;BA.debugLine="Dim ls_temp_time1 As List";
Debug.ShouldStop(131072);
_ls_temp_time1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("ls_temp_time1", _ls_temp_time1);
 BA.debugLineNum = 1843;BA.debugLine="ls_temp_time1.Initialize";
Debug.ShouldStop(262144);
_ls_temp_time1.runVoidMethod ("Initialize");
 BA.debugLineNum = 1845;BA.debugLine="ls_temp_time1.Add(lbl_tim1.Text)";
Debug.ShouldStop(1048576);
_ls_temp_time1.runVoidMethod ("Add",(Object)((main.mostCurrent._lbl_tim1.runMethod(true,"getText"))));
 BA.debugLineNum = 1846;BA.debugLine="ls_temp_time1.Add(lbl_tim2.Text)";
Debug.ShouldStop(2097152);
_ls_temp_time1.runVoidMethod ("Add",(Object)((main.mostCurrent._lbl_tim2.runMethod(true,"getText"))));
 BA.debugLineNum = 1848;BA.debugLine="File.WriteList(File.DirInternal,\"temp_time1.t";
Debug.ShouldStop(8388608);
main.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteList",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("temp_time1.txt")),(Object)(_ls_temp_time1));
 BA.debugLineNum = 1850;BA.debugLine="ToastMessageShow (\"اضافه شد\",False)";
Debug.ShouldStop(33554432);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("اضافه شد")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 1851;BA.debugLine="btn_menu_home_Click";
Debug.ShouldStop(67108864);
_btn_menu_home_click();
 };
 }else {
 BA.debugLineNum = 1855;BA.debugLine="dbCode.edit_ezafekari(current_id_edit,date1,da";
Debug.ShouldStop(1073741824);
main.mostCurrent._dbcode.runVoidMethod ("_edit_ezafekari" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main._current_id_edit),(Object)(main.mostCurrent._date1),(Object)(main.mostCurrent._date2),(Object)(main.mostCurrent._lbl_tim1.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_tim2.runMethod(true,"getText")),(Object)(main._day_bt),(Object)(main._hour_bt),(Object)(main._min_bt),(Object)(main.mostCurrent._et_tozihat.runMethod(true,"getText")),(Object)(_state_mod));
 BA.debugLineNum = 1856;BA.debugLine="ToastMessageShow (\"ویرایش شد\",False)";
Debug.ShouldStop(-2147483648);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("ویرایش شد")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 1859;BA.debugLine="fill_lists(sp_year.SelectedItem,myfunc.convert";
Debug.ShouldStop(4);
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e38.toString()); BA.debugLineNum = 1870;BA.debugLine="ToastMessageShow(\"خطا\",False)";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("add_morakhasi_sub (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1877);
...
RemoteObject _str_noe2 = RemoteObject.createImmutable("");
 BA.debugLineNum = 1877;BA.debugLine="Sub add_morakhasi_sub";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 1878;BA.debugLine="Dim str_noe2 As String";
Debug.ShouldStop(2097152);
_str_noe2 = RemoteObject.createImmutable("");Debug.locals.put("str_noe2", _str_noe2);
 BA.debugLineNum = 1879;BA.debugLine="str_noe2=\"(\"&str_noe&\")- \"";
Debug.ShouldStop(4194304);
_str_noe2 = RemoteObject.concat(RemoteObject.createImmutable("("),main.mostCurrent._str_noe,RemoteObject.createImmutable(")- "));Debug.locals.put("str_noe2", _str_noe2);
 BA.debugLineNum = 1881;BA.debugLine="Try";
Debug.ShouldStop(16777216);
try { BA.debugLineNum = 1882;BA.debugLine="If(day_bt<0 Or hour_bt<0 Or min_bt<0)Then";
Debug.ShouldStop(33554432);
...
{ BA.debugLineNum = 1884;BA.debugLine="Else If (moon_bt<>0 Or year_bt<>0)Then";
Debug.ShouldStop(134217728);
...
{ BA.debugLineNum = 1886;BA.debugLine="Else If (hour_bt=0 And min_bt=0 And day_bt=0 )Th";
Debug.ShouldStop(536870912);
...
Debug.ShouldStop(8);
if ((RemoteObject.solveBoolean("=",main._is_for_edit,main.mostCurrent.__c.getField(true,"False")))) { 
 BA.debugLineNum = 1893;BA.debugLine="If(dbCode.isexist_morakhasi_by_date(date1)=Tru";
Debug.ShouldStop(16);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._dbcode.runMethod(true,"_isexist_morakhasi_by_date" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._date1)),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 1894;BA.debugLine="myfunc.help_man(\"توجه\",\"برای این تاریخ مرخصی";
Debug.ShouldStop(32);
main.mostCurrent._myfunc.runVoidMethod ("_help_man" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.ObjectToString("توجه")),(Object)(RemoteObject.createImmutable("برای این تاریخ مرخصی وجود دارد میتوانید در صفحه لیست آن را ویرایش نمائید")));
 ...
 BA.debugLineNum = 1896;BA.debugLine="dbCode.add_morakhasi(date1,date2,lbl_tim1.Tex";
Debug.ShouldStop(128);
main.mostCurrent._dbcode.runVoidMethod ("_add_morakhasi" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._date1),(Object)(main.mostCurrent._date2),(Object)(main.mostCurrent._lbl_tim1.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_tim2.runMethod(true,"getText")),(Object)(main._day_bt),(Object)(main._hour_bt),(Object)(main._min_bt),(Object)(RemoteObject.concat(_str_noe2,main.mostCurrent._et_tozihat.runMethod(true,"getText"))),(Object)(main._index_noe_morakhasi));
 BA.debugLineNum = 1897;BA.debugLine="ToastMessageShow (\"اضافه شد\",False)";
Debug.ShouldStop(256);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("اضافه شد")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 1898;BA.debugLine="btn_menu_home_Click";
Debug.ShouldStop(512);
_btn_menu_home_click();
 };
 }else {
 BA.debugLineNum = 1901;BA.debugLine="dbCode.edit_morakhasi(current_id_edit,date1,da";
Debug.ShouldStop(4096);
main.mostCurrent._dbcode.runVoidMethod ("_edit_morakhasi" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main._current_id_edit),(Object)(main.mostCurrent._date1),(Object)(main.mostCurrent._date2),(Object)(main.mostCurrent._lbl_tim1.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_tim2.runMethod(true,"getText")),(Object)(main._day_bt),(Object)(main._hour_bt),(Object)(main._min_bt),(Object)(main.mostCurrent._et_tozihat.runMethod(true,"getText")),(Object)(main._index_noe_morakhasi));
 BA.debugLineNum = 1903;BA.debugLine="ToastMessageShow (\"ویرایش شد\",False)";
Debug.ShouldStop(16384);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("ویرایش شد")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 1904;BA.debugLine="fill_lists(sp_year.SelectedItem,myfunc.convert";
Debug.ShouldStop(32768);
_fill_lists(main.mostCurrent._sp_year.runMethod(true,"getSelectedItem"),main.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(RemoteObject.solve(new RemoteObject[] {main.mostCurrent._sp_moon.runMethod(true,"getSelectedIndex"),RemoteObject.createImmutable(1)}, "+",1, 1))));
 };
 BA.debugLineNum = 1911;BA.debugLine="pan_all_Click";
Debug.ShouldStop(4194304);
_pan_all_click();
 }}}
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e27.toString()); BA.debugLineNum = 1917;BA.debugLine="ToastMessageShow(\"خطا\",False)";
Debug.ShouldStop(268435456);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("خطا")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 };
...
try {
		Debug.PushSubsStack("add_taradod_fast (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3504);
...
RemoteObject _str_ft3 = RemoteObject.createImmutable("");
 BA.debugLineNum = 3504;BA.debugLine="Sub add_taradod_fast";
Debug.ShouldStop(32768);
 BA.debugLineNum = 3506;BA.debugLine="Try";
Debug.ShouldStop(131072);
try { BA.debugLineNum = 3508;BA.debugLine="If(dbCode.isexist_taradod_by_date(lbl_date_FT.Te";
Debug.ShouldStop(524288);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._dbcode.runMethod(true,"_isexist_taradod_by_date" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._lbl_date_ft.runMethod(true,"getText"))),main.mostCurrent.__c.getField(true,"False")))) { 
 BA.debugLineNum = 3510;BA.debugLine="Dim str_Ft1 As String=et_tozihat_FT.Text";
Debug.ShouldStop(2097152);
_str_ft1 = main.mostCurrent._et_tozihat_ft.runMethod(true,"getText");Debug.locals.put("str_Ft1", _str_ft1);Debug.locals.put("str_Ft1", _str_ft1);
 BA.debugLineNum = 3511;BA.debugLine="If (ckb_ezaf_taradod_FT.Checked=True)Then";
Debug.ShouldStop(4194304);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._ckb_ezaf_taradod_ft.runMethod(true,"getChecked"),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 3514;BA.debugLine="dbCode.add_taradod(lbl_date_FT.Text,lbl_date_F";
Debug.ShouldStop(33554432);
main.mostCurrent._dbcode.runVoidMethod ("_add_taradod" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._lbl_date_ft.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_date_ft.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_tim_vorod_ft.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_tim_khoroj_ft.runMethod(true,"getText")),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(_str_ft1),(Object)(BA.numberCast(int.class, 20)));
 ...
 BA.debugLineNum = 3518;BA.debugLine="dbCode.add_taradod(lbl_date_FT.Text,lbl_date_F";
Debug.ShouldStop(536870912);
main.mostCurrent._dbcode.runVoidMethod ("_add_taradod" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._lbl_date_ft.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_date_ft.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_tim_vorod_ft.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_tim_khoroj_ft.runMethod(true,"getText")),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(_str_ft1),(Object)(BA.numberCast(int.class, 10)));
 ...
 BA.debugLineNum = 3521;BA.debugLine="Log(\"is frest\")";
Debug.ShouldStop(1);
main.mostCurrent.__c.runVoidMethod ("LogImpl","17995409",RemoteObject.createImmutable("is frest"),0);
 BA.debugLineNum = 3522;BA.debugLine="ToastMessageShow(\"ورود ثبت شد\",False)";
Debug.ShouldStop(2);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("ورود ثبت شد")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 3525;BA.debugLine="lbl_vorod_FT.TextColor=Colors.Green";
Debug.ShouldStop(16);
main.mostCurrent._lbl_vorod_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"));
 BA.debugLineNum = 3526;BA.debugLine="ckb_ezaf_taradod_FT.Enabled=False";
Debug.ShouldStop(32);
main.mostCurrent._ckb_ezaf_taradod_ft.runMethod(true,"setEnabled",main.mostCurrent.__c.getField(true,"False"));
 }else {
 BA.debugLineNum = 3532;BA.debugLine="time_show2(lbl_date_FT.Text,lbl_date_FT.Text,lb";
Debug.ShouldStop(2048);
_time_show2(main.mostCurrent._lbl_date_ft.runMethod(true,"getText"),main.mostCurrent._lbl_date_ft.runMethod(true,"getText"),main.mostCurrent._lbl_tim_vorod_ft.runMethod(true,"getText"),main.mostCurrent._lbl_tim_khoroj_ft.runMethod(true,"getText"));
 BA.debugLineNum = 3534;BA.debugLine="If (ckb_ezaf_taradod_FT.Checked=True)Then";
Debug.ShouldStop(8192);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._ckb_ezaf_taradod_ft.runMethod(true,"getChecked"),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 3536;BA.debugLine="Dim tim_min2 As Int=(hour_bt*60)+min_bt";
Debug.ShouldStop(32768);
_tim_min2 = RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {main._hour_bt,RemoteObject.createImmutable(60)}, "*",0, 1)),main._min_bt}, "+",1, 1);Debug.locals.put("tim_min2", _tim_min2);Debug.locals.put("tim_min2", _tim_min2);
 BA.debugLineNum = 3539;BA.debugLine="If(tim_min2>saat_kar_min) Then";
Debug.ShouldStop(262144);
if ((RemoteObject.solveBoolean(">",_tim_min2,BA.numberCast(double.class, main._saat_kar_min)))) { 
 BA.debugLineNum = 3541;BA.debugLine="Dim dagige_fixed As Int = tim_vorod_conv_ezaf";
Debug.ShouldStop(1048576);
_dagige_fixed = _tim_vorod_conv_ezaf(main.mostCurrent._lbl_tim_vorod_ft.runMethod(true,"getText"));Debug.locals.put("dagige_fixed", _dagige_fixed);Debug.locals.put("dagige_fixed", _dagige_fixed);
 BA.debugLineNum = 3542;BA.debugLine="Dim saat_fixed As String = (myfunc.Min_to_saa";
Debug.ShouldStop(2097152);
_saat_fixed = RemoteObject.concat((main.mostCurrent._myfunc.runMethod(false,"_min_to_saatminroz2_dontday" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(_dagige_fixed)).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)))),RemoteObject.createImmutable(":"),(main.mostCurrent._myfunc.runMethod(false,"_min_to_saatminroz2_dontday" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(_dagige_fixed)).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1)))));Debug.locals.put("saat_fixed", _saat_fixed);Debug.locals.put("saat_fixed", _saat_fixed);
 BA.debugLineNum = 3544;BA.debugLine="dbCode.add_ezafekari(lbl_date_FT.Text,lbl_dat";
Debug.ShouldStop(8388608);
main.mostCurrent._dbcode.runVoidMethod ("_add_ezafekari" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._lbl_date_ft.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_date_ft.runMethod(true,"getText")),(Object)(_saat_fixed),(Object)(main.mostCurrent._lbl_tim_khoroj_ft.runMethod(true,"getText")),(Object)(main._day_bt),(Object)(BA.numberCast(int.class, (main.mostCurrent._myfunc.runMethod(false,"_min_to_saatminroz" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(RemoteObject.solve(new RemoteObject[] {_tim_min2,main._saat_kar_min}, "-",1, 1))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)))))),(Object)(BA.numberCast(int.class, (main.mostCurrent._myfunc.runMethod(false,"_min_to_saatminroz" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(RemoteObject.solve(new RemoteObject[] {_tim_min2,main._saat_kar_min}, "-",1, 1))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1)))))),(Object)(BA.ObjectToString(" (ثبت سریع-تردد دارد)- ")),(Object)(BA.numberCast(int.class, 0)));
 ...
 BA.debugLineNum = 3547;BA.debugLine="Dim str_Ft2 As String=\"(ثبت سریع-اضافه کاری)-\"";
Debug.ShouldStop(67108864);
_str_ft2 = RemoteObject.concat(RemoteObject.createImmutable("(ثبت سریع-اضافه کاری)-"),main.mostCurrent._et_tozihat_ft.runMethod(true,"getText"));Debug.locals.put("str_Ft2", _str_ft2);Debug.locals.put("str_Ft2", _str_ft2);
 BA.debugLineNum = 3548;BA.debugLine="dbCode.edit_taradod(current_id_edit,lbl_date_F";
Debug.ShouldStop(134217728);
main.mostCurrent._dbcode.runVoidMethod ("_edit_taradod" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main._current_id_edit),(Object)(main.mostCurrent._lbl_date_ft.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_date_ft.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_tim_vorod_ft.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_tim_khoroj_ft.runMethod(true,"getText")),(Object)(main._day_bt),(Object)(main._hour_bt),(Object)(main._min_bt),(Object)(_str_ft2),(Object)(BA.numberCast(int.class, 21)));
 ...
 BA.debugLineNum = 3550;BA.debugLine="Dim str_Ft3 As String=\"(ثبت سریع)-\"&et_tozihat";
Debug.ShouldStop(536870912);
_str_ft3 = RemoteObject.concat(RemoteObject.createImmutable("(ثبت سریع)-"),main.mostCurrent._et_tozihat_ft.runMethod(true,"getText"));Debug.locals.put("str_Ft3", _str_ft3);Debug.locals.put("str_Ft3", _str_ft3);
 BA.debugLineNum = 3551;BA.debugLine="dbCode.edit_taradod(current_id_edit,lbl_date_F";
Debug.ShouldStop(1073741824);
main.mostCurrent._dbcode.runVoidMethod ("_edit_taradod" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main._current_id_edit),(Object)(main.mostCurrent._lbl_date_ft.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_date_ft.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_tim_vorod_ft.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_tim_khoroj_ft.runMethod(true,"getText")),(Object)(main._day_bt),(Object)(main._hour_bt),(Object)(main._min_bt),(Object)(_str_ft3),(Object)(BA.numberCast(int.class, 11)));
 };
 BA.debugLineNum = 3554;BA.debugLine="Log(\"is secend\")";
Debug.ShouldStop(2);
main.mostCurrent.__c.runVoidMethod ("LogImpl","17995442",RemoteObject.createImmutable("is secend"),0);
 BA.debugLineNum = 3555;BA.debugLine="ToastMessageShow(\"خروج ثبت شد\",False)";
Debug.ShouldStop(4);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("خروج ثبت شد")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 3558;BA.debugLine="lbl_khoroj_FT.TextColor=Colors.Green";
Debug.ShouldStop(32);
main.mostCurrent._lbl_khoroj_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"));
 ...
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e33.toString()); BA.debugLineNum = 3567;BA.debugLine="ToastMessageShow(\"خطا\",False)";
Debug.ShouldStop(16384);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("خطا")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 };
...
try {
		Debug.PushSubsStack("add_taradod_sub (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1925);
...
RemoteObject _ls_temp_time2 = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
 BA.debugLineNum = 1925;BA.debugLine="Sub add_taradod_sub";
Debug.ShouldStop(16);
 BA.debugLineNum = 1926;BA.debugLine="Try";
Debug.ShouldStop(32);
try { BA.debugLineNum = 1928;BA.debugLine="If(hour_bt<0 Or min_bt<0 )Then";
Debug.ShouldStop(128);
if ((RemoteObject.solveBoolean("<",main._hour_bt,BA.numberCast(double.class, 0)) || RemoteObject.solveBoolean("<",main._min_bt,BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 1929;BA.debugLine="ToastMessageShow(\"خطا! زمان منفی نمی شود\",True)";
Debug.ShouldStop(256);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("خطا! زمان منفی نمی شود")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 }else 
{ BA.debugLineNum = 1931;BA.debugLine="Else If (moon_bt<>0 Or year_bt<>0 Or day_bt<>0)T";
Debug.ShouldStop(1024);
if ((RemoteObject.solveBoolean("!",main._moon_bt,BA.numberCast(double.class, 0)) || RemoteObject.solveBoolean("!",main._year_bt,BA.numberCast(double.class, 0)) || RemoteObject.solveBoolean("!",main._day_bt,BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 1932;BA.debugLine="ToastMessageShow(\"خطا! زمان نادرست است\",True)";
Debug.ShouldStop(2048);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("خطا! زمان نادرست است")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 }else 
{ BA.debugLineNum = 1933;BA.debugLine="Else If (hour_bt=0 And min_bt=0 )Then";
Debug.ShouldStop(4096);
if ((RemoteObject.solveBoolean("=",main._hour_bt,BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean("=",main._min_bt,BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 1934;BA.debugLine="ToastMessageShow(\"خطا! انتخاب زمان  \",True)";
Debug.ShouldStop(8192);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("خطا! انتخاب زمان  ")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 }else {
 BA.debugLineNum = 1939;BA.debugLine="If(is_for_edit=False)Then";
Debug.ShouldStop(262144);
if ((RemoteObject.solveBoolean("=",main._is_for_edit,main.mostCurrent.__c.getField(true,"False")))) { 
 BA.debugLineNum = 1940;BA.debugLine="If(dbCode.isexist_taradod_by_date(date1)=True)";
Debug.ShouldStop(524288);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._dbcode.runMethod(true,"_isexist_taradod_by_date" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._date1)),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 1941;BA.debugLine="myfunc.help_man(\"توجه\",\"برای این تاریخ تردد و";
Debug.ShouldStop(1048576);
main.mostCurrent._myfunc.runVoidMethod ("_help_man" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.ObjectToString("توجه")),(Object)(RemoteObject.createImmutable("برای این تاریخ تردد وجود دارد میتوانید در صفحه لیست آن را ویرایش نمائید")));
 ...
 BA.debugLineNum = 1944;BA.debugLine="If (ckb_ezaf_taradod.Checked==True And ckb_ez";
Debug.ShouldStop(8388608);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._ckb_ezaf_taradod.runMethod(true,"getChecked"),main.mostCurrent.__c.getField(true,"True")) && RemoteObject.solveBoolean("=",main.mostCurrent._ckb_ezaf_taradod.runMethod(true,"getEnabled"),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 1946;BA.debugLine="Dim dagige_fixed As Int = tim_vorod_conv_eza";
Debug.ShouldStop(33554432);
_dagige_fixed = _tim_vorod_conv_ezaf(main.mostCurrent._lbl_tim1.runMethod(true,"getText"));Debug.locals.put("dagige_fixed", _dagige_fixed);Debug.locals.put("dagige_fixed", _dagige_fixed);
 BA.debugLineNum = 1947;BA.debugLine="Dim saat_fixed As String = (myfunc.Min_to_sa";
Debug.ShouldStop(67108864);
_saat_fixed = RemoteObject.concat((main.mostCurrent._myfunc.runMethod(false,"_min_to_saatminroz2_dontday" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(_dagige_fixed)).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)))),RemoteObject.createImmutable(":"),(main.mostCurrent._myfunc.runMethod(false,"_min_to_saatminroz2_dontday" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(_dagige_fixed)).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1)))));Debug.locals.put("saat_fixed", _saat_fixed);Debug.locals.put("saat_fixed", _saat_fixed);
 BA.debugLineNum = 1949;BA.debugLine="Dim str_tozih1 As String=\"(تردد دارد)-\"&et_t";
Debug.ShouldStop(268435456);
_str_tozih1 = RemoteObject.concat(RemoteObject.createImmutable("(تردد دارد)-"),main.mostCurrent._et_tozihat.runMethod(true,"getText"));Debug.locals.put("str_tozih1", _str_tozih1);Debug.locals.put("str_tozih1", _str_tozih1);
 BA.debugLineNum = 1950;BA.debugLine="Dim str_tozih2 As String=\"(اضافه کاری دارد)-";
Debug.ShouldStop(536870912);
_str_tozih2 = RemoteObject.concat(RemoteObject.createImmutable("(اضافه کاری دارد)-"),main.mostCurrent._et_tozihat.runMethod(true,"getText"));Debug.locals.put("str_tozih2", _str_tozih2);Debug.locals.put("str_tozih2", _str_tozih2);
 BA.debugLineNum = 1952;BA.debugLine="dbCode.add_ezafekari(date1,date2,saat_fixed,";
Debug.ShouldStop(-2147483648);
main.mostCurrent._dbcode.runVoidMethod ("_add_ezafekari" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._date1),(Object)(main.mostCurrent._date2),(Object)(_saat_fixed),(Object)(main.mostCurrent._lbl_tim2.runMethod(true,"getText")),(Object)(main._day_bt),(Object)(BA.numberCast(int.class, (main.mostCurrent._myfunc.runMethod(false,"_min_to_saatminroz" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(RemoteObject.solve(new RemoteObject[] {main._tim_min,main._saat_kar_min}, "-",1, 1))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)))))),(Object)(BA.numberCast(int.class, (main.mostCurrent._myfunc.runMethod(false,"_min_to_saatminroz" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(RemoteObject.solve(new RemoteObject[] {main._tim_min,main._saat_kar_min}, "-",1, 1))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1)))))),(Object)(_str_tozih1),(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 1954;BA.debugLine="dbCode.add_taradod(date1,date2,lbl_tim1.Text";
Debug.ShouldStop(2);
main.mostCurrent._dbcode.runVoidMethod ("_add_taradod" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._date1),(Object)(main.mostCurrent._date2),(Object)(main.mostCurrent._lbl_tim1.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_tim2.runMethod(true,"getText")),(Object)(main._day_bt),(Object)(main._hour_bt),(Object)(main._min_bt),(Object)(_str_tozih2),(Object)(BA.numberCast(int.class, 0)));
 ...
 BA.debugLineNum = 1956;BA.debugLine="dbCode.add_taradod(date1,date2,lbl_tim1.Text";
Debug.ShouldStop(8);
main.mostCurrent._dbcode.runVoidMethod ("_add_taradod" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._date1),(Object)(main.mostCurrent._date2),(Object)(main.mostCurrent._lbl_tim1.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_tim2.runMethod(true,"getText")),(Object)(main._day_bt),(Object)(main._hour_bt),(Object)(main._min_bt),(Object)(main.mostCurrent._et_tozihat.runMethod(true,"getText")),(Object)(BA.numberCast(int.class, 0)));
 ...
 BA.debugLineNum = 1959;BA.debugLine="Dim ls_temp_time2 As List";
Debug.ShouldStop(64);
_ls_temp_time2 = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("ls_temp_time2", _ls_temp_time2);
 BA.debugLineNum = 1960;BA.debugLine="ls_temp_time2.Initialize";
Debug.ShouldStop(128);
_ls_temp_time2.runVoidMethod ("Initialize");
 BA.debugLineNum = 1962;BA.debugLine="ls_temp_time2.Add(lbl_tim1.Text)";
Debug.ShouldStop(512);
_ls_temp_time2.runVoidMethod ("Add",(Object)((main.mostCurrent._lbl_tim1.runMethod(true,"getText"))));
 BA.debugLineNum = 1963;BA.debugLine="ls_temp_time2.Add(lbl_tim2.Text)";
Debug.ShouldStop(1024);
_ls_temp_time2.runVoidMethod ("Add",(Object)((main.mostCurrent._lbl_tim2.runMethod(true,"getText"))));
 BA.debugLineNum = 1965;BA.debugLine="File.WriteList(File.DirInternal,\"temp_time2.t";
Debug.ShouldStop(4096);
main.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteList",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("temp_time2.txt")),(Object)(_ls_temp_time2));
 BA.debugLineNum = 1967;BA.debugLine="ToastMessageShow (\"اضافه شد\",False)";
Debug.ShouldStop(16384);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("اضافه شد")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 1968;BA.debugLine="btn_menu_home_Click";
Debug.ShouldStop(32768);
_btn_menu_home_click();
 };
 }else {
 BA.debugLineNum = 1971;BA.debugLine="dbCode.edit_taradod(current_id_edit,date1,date";
Debug.ShouldStop(262144);
main.mostCurrent._dbcode.runVoidMethod ("_edit_taradod" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main._current_id_edit),(Object)(main.mostCurrent._date1),(Object)(main.mostCurrent._date2),(Object)(main.mostCurrent._lbl_tim1.runMethod(true,"getText")),(Object)(main.mostCurrent._lbl_tim2.runMethod(true,"getText")),(Object)(main._day_bt),(Object)(main._hour_bt),(Object)(main._min_bt),(Object)(main.mostCurrent._et_tozihat.runMethod(true,"getText")),(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 1973;BA.debugLine="ToastMessageShow (\"ویرایش شد\",False)";
Debug.ShouldStop(1048576);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("ویرایش شد")),(Object)(main.mostCurrent.__c.getField(true,"False")));
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e39.toString()); BA.debugLineNum = 1985;BA.debugLine="ToastMessageShow(\"خطا\",False)";
Debug.ShouldStop(1);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("خطا")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 };
...
Debug.ShouldStop(8192);
main.mostCurrent.__c.runVoidMethod ("LogImpl","11048582",_errormessage,0);
 };
...
try {
		Debug.PushSubsStack("cust_LV_taradod_ItemClick (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3307);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 3307;BA.debugLine="Private Sub cust_LV_taradod_ItemClick (Index As In";
Debug.ShouldStop(1024);
...
Debug.ShouldStop(32);
main.mostCurrent.__c.runVoidMethod ("LogImpl","12424852",main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("id"))),0);
 }
;
...
try {
		Debug.PushSubsStack("get_dataEdit_byId (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3101);
...
Debug.locals.put("id1", _id1);
 BA.debugLineNum = 3101;BA.debugLine="Sub get_dataEdit_byId(id1 As Int)";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 3102;BA.debugLine="dbCode.connect_db";
Debug.ShouldStop(536870912);
main.mostCurrent._dbcode.runVoidMethod ("_connect_db" /*RemoteObject*/ ,main.mostCurrent.activityBA);
 BA.debugLineNum = 3103;BA.debugLine="If(index_box=1)Then";
Debug.ShouldStop(1073741824);
if ((RemoteObject.solveBoolean("=",main._index_box,BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 3104;BA.debugLine="dbCode.res=dbCode.sql.ExecQuery(\"SELECT * FROM t";
Debug.ShouldStop(-2147483648);
main.mostCurrent._dbcode._res /*RemoteObject*/  = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.sql.SQL.ResultSetWrapper"), main.mostCurrent._dbcode._sql /*RemoteObject*/ .runMethod(false,"ExecQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("SELECT * FROM tb_ezafekari WHERE id="),_id1))));
 BA.debugLineNum = 3105;BA.debugLine="dbCode.res.Position=0";
Debug.ShouldStop(1);
main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"setPosition",BA.numberCast(int.class, 0));
 BA.debugLineNum = 3107;BA.debugLine="If(dbCode.res.GetInt(\"state\")=0)Then";
Debug.ShouldStop(4);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("state"))),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 3108;BA.debugLine="ckb_ezaf_taradod.Checked=False";
Debug.ShouldStop(8);
main.mostCurrent._ckb_ezaf_taradod.runMethodAndSync(true,"setChecked",main.mostCurrent.__c.getField(true,"False"));
 }else {
 BA.debugLineNum = 3110;BA.debugLine="ckb_ezaf_taradod.Checked=True";
Debug.ShouldStop(32);
main.mostCurrent._ckb_ezaf_taradod.runMethodAndSync(true,"setChecked",main.mostCurrent.__c.getField(true,"True"));
 };
 }else 
{ BA.debugLineNum = 3115;BA.debugLine="Else If(index_box=2)Then";
Debug.ShouldStop(1024);
if ((RemoteObject.solveBoolean("=",main._index_box,BA.numberCast(double.class, 2)))) { 
 BA.debugLineNum = 3116;BA.debugLine="dbCode.res=dbCode.sql.ExecQuery(\"SELECT * FROM t";
Debug.ShouldStop(2048);
main.mostCurrent._dbcode._res /*RemoteObject*/  = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.sql.SQL.ResultSetWrapper"), main.mostCurrent._dbcode._sql /*RemoteObject*/ .runMethod(false,"ExecQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("SELECT * FROM tb_morakhasi WHERE id="),_id1))));
 BA.debugLineNum = 3117;BA.debugLine="dbCode.res.Position=0";
Debug.ShouldStop(4096);
main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"setPosition",BA.numberCast(int.class, 0));
 BA.debugLineNum = 3120;BA.debugLine="Select dbCode.res.GetInt(\"state\")";
Debug.ShouldStop(32768);
...
case 0: {
 BA.debugLineNum = 3122;BA.debugLine="str_noe=\"استحقاقی-ساعتی/روزانه\"";
Debug.ShouldStop(131072);
main.mostCurrent._str_noe = BA.ObjectToString("استحقاقی-ساعتی/روزانه");
 break; }
case 1: {
 BA.debugLineNum = 3124;BA.debugLine="str_noe=\"استعلاجی\"";
Debug.ShouldStop(524288);
main.mostCurrent._str_noe = BA.ObjectToString("استعلاجی");
 break; }
case 2: {
 BA.debugLineNum = 3126;BA.debugLine="str_noe=\"سایر (با حقوق)\"";
Debug.ShouldStop(2097152);
main.mostCurrent._str_noe = BA.ObjectToString("سایر (با حقوق)");
 break; }
case 3: {
 BA.debugLineNum = 3128;BA.debugLine="str_noe=\"سایر (بدون حقوق)\"";
Debug.ShouldStop(8388608);
main.mostCurrent._str_noe = BA.ObjectToString("سایر (بدون حقوق)");
 break; }
}
;
 BA.debugLineNum = 3132;BA.debugLine="lbl_ezaf_taradod.Text=\"نوع مرخصی : \"&str_noe";
Debug.ShouldStop(134217728);
main.mostCurrent._lbl_ezaf_taradod.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("نوع مرخصی : "),main.mostCurrent._str_noe)));
 BA.debugLineNum = 3133;BA.debugLine="index_noe_morakhasi=dbCode.res.GetInt(\"state\")";
Debug.ShouldStop(268435456);
...
{ BA.debugLineNum = 3137;BA.debugLine="Else If(index_box=3)Then";
Debug.ShouldStop(1);
if ((RemoteObject.solveBoolean("=",main._index_box,BA.numberCast(double.class, 3)))) { 
 BA.debugLineNum = 3138;BA.debugLine="dbCode.res=dbCode.sql.ExecQuery(\"SELECT * FROM t";
Debug.ShouldStop(2);
main.mostCurrent._dbcode._res /*RemoteObject*/  = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.sql.SQL.ResultSetWrapper"), main.mostCurrent._dbcode._sql /*RemoteObject*/ .runMethod(false,"ExecQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("SELECT * FROM tb_taradod WHERE id="),_id1))));
 BA.debugLineNum = 3139;BA.debugLine="dbCode.res.Position=0";
Debug.ShouldStop(4);
main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"setPosition",BA.numberCast(int.class, 0));
 }}}
;
 BA.debugLineNum = 3146;BA.debugLine="lbl_tim1.Text=dbCode.res.GetString(\"time_from\")";
Debug.ShouldStop(512);
main.mostCurrent._lbl_tim1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("time_from")))));
 BA.debugLineNum = 3147;BA.debugLine="lbl_tim2.Text=dbCode.res.GetString(\"time_to\")";
Debug.ShouldStop(1024);
main.mostCurrent._lbl_tim2.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("time_to")))));
 BA.debugLineNum = 3149;BA.debugLine="lbl_date1.Text=myfunc.fa2en(dbCode.res.GetString(";
Debug.ShouldStop(4096);
main.mostCurrent._lbl_date1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("date_from")))))));
 BA.debugLineNum = 3150;BA.debugLine="lbl_date2.Text=myfunc.fa2en(dbCode.res.GetString(";
Debug.ShouldStop(8192);
main.mostCurrent._lbl_date2.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("date_to")))))));
 BA.debugLineNum = 3152;BA.debugLine="et_tozihat.Text=dbCode.res.GetString(\"tozihat\")";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("img_slider (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3042);
...
Debug.locals.put("index1", _index1);
 BA.debugLineNum = 3042;BA.debugLine="Sub img_slider (index1 As Int)";
Debug.ShouldStop(2);
 BA.debugLineNum = 3043;BA.debugLine="Select index1";
Debug.ShouldStop(4);
...
Debug.ShouldStop(64);
main.mostCurrent.__c.runVoidMethod ("LogImpl","1393347",BA.ObjectToString(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA)),0);
...
try {
		Debug.PushSubsStack("lbl_account_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3630);
if (RapidSub.canDelegate("lbl_account_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_account_click");}
 BA.debugLineNum = 3630;BA.debugLine="Private Sub lbl_account_Click";
Debug.ShouldStop(8192);
 BA.debugLineNum = 3634;BA.debugLine="If (File.Exists(File.DirInternal,\"userAcc\")=True";
Debug.ShouldStop(131072);
if ((RemoteObject.solveBoolean("=",main.mostCurrent.__c.getField(false,"File").runMethod(true,"Exists",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("userAcc"))),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 3635;BA.debugLine="StartActivity(step2_activity)";
Debug.ShouldStop(262144);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((main.mostCurrent._step2_activity.getObject())));
 BA.debugLineNum = 3636;BA.debugLine="Activity.Finish";
Debug.ShouldStop(524288);
main.mostCurrent._activity.runVoidMethod ("Finish");
 }else {
 BA.debugLineNum = 3639;BA.debugLine="If (myfunc.check_internet)Then";
Debug.ShouldStop(4194304);
if ((main.mostCurrent._myfunc.runMethod(true,"_check_internet" /*RemoteObject*/ ,main.mostCurrent.activityBA)).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 3640;BA.debugLine="StartActivity(step0_activity)";
Debug.ShouldStop(8388608);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((main.mostCurrent._step0_activity.getObject())));
 }else {
 BA.debugLineNum = 3642;BA.debugLine="myfunc.help_man(\"توجه\",\"اتصال اینترنت را بررسی";
Debug.ShouldStop(33554432);
main.mostCurrent._myfunc.runVoidMethod ("_help_man" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.ObjectToString("توجه")),(Object)(RemoteObject.createImmutable("اتصال اینترنت را بررسی کنید !")));
 ...
 BA.debugLineNum = 3648;BA.debugLine="pan_all_liteMenu_Click";
Debug.ShouldStop(-2147483648);
...
try {
		Debug.PushSubsStack("lbl_chk_update_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3614);
...
RemoteObject _send2 = RemoteObject.createImmutable("");
 BA.debugLineNum = 3614;BA.debugLine="Private Sub lbl_chk_update_Click";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 3616;BA.debugLine="If (myfunc.check_internet)Then";
Debug.ShouldStop(-2147483648);
if ((main.mostCurrent._myfunc.runMethod(true,"_check_internet" /*RemoteObject*/ ,main.mostCurrent.activityBA)).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 3617;BA.debugLine="ProgressDialogShow(\"بررسی بروزرسانی ...\")";
Debug.ShouldStop(1);
main.mostCurrent.__c.runVoidMethod ("ProgressDialogShow",main.mostCurrent.activityBA,(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("بررسی بروزرسانی ..."))));
 BA.debugLineNum = 3618;BA.debugLine="ht.Initialize(\"chkupdate\",Me)";
Debug.ShouldStop(2);
main.mostCurrent._ht.runClassMethod (ir.taravatgroup.ezafekari2.httpjob.class, "_initialize" /*RemoteObject*/ ,main.processBA,(Object)(BA.ObjectToString("chkupdate")),(Object)(main.getObject()));
 BA.debugLineNum = 3619;BA.debugLine="Dim send2 As String";
Debug.ShouldStop(4);
_send2 = RemoteObject.createImmutable("");Debug.locals.put("send2", _send2);
 BA.debugLineNum = 3620;BA.debugLine="send2 = \"var=checkupdate\"";
Debug.ShouldStop(8);
_send2 = BA.ObjectToString("var=checkupdate");Debug.locals.put("send2", _send2);
 BA.debugLineNum = 3621;BA.debugLine="ht.PostString(\"https://taravatgroup.ir/chek_upda";
Debug.ShouldStop(16);
main.mostCurrent._ht.runClassMethod (ir.taravatgroup.ezafekari2.httpjob.class, "_poststring" /*RemoteObject*/ ,(Object)(BA.ObjectToString("https://taravatgroup.ir/chek_update.php")),(Object)(_send2));
 ...
 BA.debugLineNum = 3623;BA.debugLine="myfunc.help_man(\"توجه\",\"اتصال اینترنت را بررسی ک";
Debug.ShouldStop(64);
main.mostCurrent._myfunc.runVoidMethod ("_help_man" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.ObjectToString("توجه")),(Object)(RemoteObject.createImmutable("اتصال اینترنت را بررسی کنید !")));
 };
 BA.debugLineNum = 3627;BA.debugLine="pan_all_liteMenu_Click";
Debug.ShouldStop(1024);
_pan_all_litemenu_click();
...
try {
		Debug.PushSubsStack("lbl_chk_update_ok_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3659);
...
RemoteObject _op = RemoteObject.declareNull("anywheresoftware.b4a.objects.IntentWrapper");
 BA.debugLineNum = 3659;BA.debugLine="Private Sub lbl_chk_update_ok_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 3660;BA.debugLine="If (lbl_chk_update_ok.Tag==1)Then";
Debug.ShouldStop(2048);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._lbl_chk_update_ok.runMethod(false,"getTag"),RemoteObject.createImmutable((1))))) { 
 BA.debugLineNum = 3661;BA.debugLine="Try";
Debug.ShouldStop(4096);
try { BA.debugLineNum = 3662;BA.debugLine="Dim op As Intent";
Debug.ShouldStop(8192);
_op = RemoteObject.createNew ("anywheresoftware.b4a.objects.IntentWrapper");Debug.locals.put("op", _op);
 BA.debugLineNum = 3663;BA.debugLine="op.Initialize(op.ACTION_VIEW,\"bazaar://details?";
Debug.ShouldStop(16384);
_op.runVoidMethod ("Initialize",(Object)(_op.getField(true,"ACTION_VIEW")),(Object)(RemoteObject.createImmutable("bazaar://details?id=ir.taravatgroup.ezafekari2")));
 BA.debugLineNum = 3664;BA.debugLine="op.SetPackage(\"com.farsitel.bazaar\")";
Debug.ShouldStop(32768);
_op.runVoidMethod ("SetPackage",(Object)(RemoteObject.createImmutable("com.farsitel.bazaar")));
 BA.debugLineNum = 3665;BA.debugLine="StartActivity(op)";
Debug.ShouldStop(65536);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((_op.getObject())));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e8) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e8.toString()); BA.debugLineNum = 3667;BA.debugLine="myfunc.help_man(\"توجه\",\"برنامه بازار را نصب کنی";
Debug.ShouldStop(262144);
main.mostCurrent._myfunc.runVoidMethod ("_help_man" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.ObjectToString("توجه")),(Object)(RemoteObject.createImmutable("برنامه بازار را نصب کنید !")));
 BA.debugLineNum = 3669;BA.debugLine="Log(LastException)";
Debug.ShouldStop(1048576);
main.mostCurrent.__c.runVoidMethod ("LogImpl","18716298",BA.ObjectToString(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA)),0);
 };
 };
 BA.debugLineNum = 3676;BA.debugLine="pan_all_chekUpdate_Click";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("lbl_close_FT_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3428);
...
RemoteObject _result = RemoteObject.createImmutable(0);
 BA.debugLineNum = 3428;BA.debugLine="Private Sub lbl_close_FT_Click";
Debug.ShouldStop(8);
 BA.debugLineNum = 3430;BA.debugLine="If(dbCode.isexist_taradod_by_date(myfunc.fa2en(pe";
Debug.ShouldStop(32);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._dbcode.runMethod(true,"_isexist_taradod_by_date" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main._persiandate.runMethod(true,"getPersianShortDate"))))),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 3431;BA.debugLine="Dim result As Int";
Debug.ShouldStop(64);
_result = RemoteObject.createImmutable(0);Debug.locals.put("result", _result);
 BA.debugLineNum = 3432;BA.debugLine="result = Msgbox2(\"تردد و اضافه کاری امروز پاک شو";
Debug.ShouldStop(128);
_result = main.mostCurrent.__c.runMethodAndSync(true,"Msgbox2",(Object)(BA.ObjectToCharSequence("تردد و اضافه کاری امروز پاک شود؟")),(Object)(BA.ObjectToCharSequence("توجه")),(Object)(BA.ObjectToString("بله")),(Object)(BA.ObjectToString("")),(Object)(BA.ObjectToString("خیر")),(Object)((main.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("attention.png"))).getObject())),main.mostCurrent.activityBA);Debug.locals.put("result", _result);
 BA.debugLineNum = 3433;BA.debugLine="If result = DialogResponse.Positive Then";
Debug.ShouldStop(256);
if (RemoteObject.solveBoolean("=",_result,BA.numberCast(double.class, main.mostCurrent.__c.getField(false,"DialogResponse").getField(true,"POSITIVE")))) { 
 BA.debugLineNum = 3435;BA.debugLine="dbCode.connect_db";
Debug.ShouldStop(1024);
main.mostCurrent._dbcode.runVoidMethod ("_connect_db" /*RemoteObject*/ ,main.mostCurrent.activityBA);
 BA.debugLineNum = 3437;BA.debugLine="dbCode.sql.ExecNonQuery(\"DELETE FROM tb_taradod";
Debug.ShouldStop(4096);
main.mostCurrent._dbcode._sql /*RemoteObject*/ .runVoidMethod ("ExecNonQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("DELETE FROM tb_taradod WHERE date_from LIKE '%"),main.mostCurrent._lbl_date_ft.runMethod(true,"getText"),RemoteObject.createImmutable("%'; "))));
 BA.debugLineNum = 3439;BA.debugLine="dbCode.sql.ExecNonQuery(\"DELETE FROM tb_ezafeka";
Debug.ShouldStop(16384);
main.mostCurrent._dbcode._sql /*RemoteObject*/ .runVoidMethod ("ExecNonQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("DELETE FROM tb_ezafekari WHERE date_from LIKE '%"),main.mostCurrent._lbl_date_ft.runMethod(true,"getText"),RemoteObject.createImmutable("%'; "))));
 BA.debugLineNum = 3440;BA.debugLine="lbl_vorod_FT.TextColor=Colors.Gray";
Debug.ShouldStop(32768);
...
main.mostCurrent._myfunc.runVoidMethod ("_help_man" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.ObjectToString("توجه")),(Object)(RemoteObject.createImmutable("برای امروز هنوز ترددی ثبت نشده است")));
 BA.debugLineNum = 3455;BA.debugLine="code_fast_taradod=1";
Debug.ShouldStop(1073741824);
main._code_fast_taradod = BA.numberCast(int.class, 1);
 };
 BA.debugLineNum = 3458;BA.debugLine="End Sub";
Debug.ShouldStop(2);
return RemoteObject.createImmutable("");
}
catch (Exception e) {
...
try {
		Debug.PushSubsStack("lbl_close_help_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2986);
if (RapidSub.canDelegate("lbl_close_help_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_close_help_click");}
 BA.debugLineNum = 2986;BA.debugLine="Private Sub lbl_close_help_Click";
Debug.ShouldStop(512);
 BA.debugLineNum = 2987;BA.debugLine="pan_help.Visible=False";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("lbl_date1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2736);
if (RapidSub.canDelegate("lbl_date1_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_date1_click");}
 BA.debugLineNum = 2736;BA.debugLine="Private Sub lbl_date1_Click";
Debug.ShouldStop(32768);
 BA.debugLineNum = 2737;BA.debugLine="lbl_tim1_Click";
Debug.ShouldStop(65536);
_lbl_tim1_click();
...
try {
		Debug.PushSubsStack("lbl_date2_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2731);
if (RapidSub.canDelegate("lbl_date2_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_date2_click");}
 BA.debugLineNum = 2731;BA.debugLine="Private Sub lbl_date2_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 2732;BA.debugLine="lbl_tim2_Click";
Debug.ShouldStop(2048);
_lbl_tim2_click();
...
try {
		Debug.PushSubsStack("lbl_edit_from_list_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3065);
...
RemoteObject _b = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
 BA.debugLineNum = 3065;BA.debugLine="Private Sub lbl_edit_from_list_Click";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 3066;BA.debugLine="Dim b As Label";
Debug.ShouldStop(33554432);
_b = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");Debug.locals.put("b", _b);
 BA.debugLineNum = 3067;BA.debugLine="b = Sender";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("lbl_help_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2970);
if (RapidSub.canDelegate("lbl_help_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_help_click");}
 BA.debugLineNum = 2970;BA.debugLine="Private Sub lbl_help_Click";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 2973;BA.debugLine="bit_img0.Initialize(File.DirAssets,\"home-h0.jpg\")";
Debug.ShouldStop(268435456);
main.mostCurrent._bit_img0.runVoidMethod ("Initialize",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("home-h0.jpg")));
 BA.debugLineNum = 2974;BA.debugLine="bit_img1.Initialize(File.DirAssets,\"home-h1.jpg\")";
Debug.ShouldStop(536870912);
main.mostCurrent._bit_img1.runVoidMethod ("Initialize",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("home-h1.jpg")));
 BA.debugLineNum = 2975;BA.debugLine="bit_img2.Initialize(File.DirAssets,\"home-h2.jpg\")";
Debug.ShouldStop(1073741824);
main.mostCurrent._bit_img2.runVoidMethod ("Initialize",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("home-h2.jpg")));
 BA.debugLineNum = 2976;BA.debugLine="bit_img3.Initialize(File.DirAssets,\"home-h3.jpg\")";
Debug.ShouldStop(-2147483648);
main.mostCurrent._bit_img3.runVoidMethod ("Initialize",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("home-h3.jpg")));
 BA.debugLineNum = 2977;BA.debugLine="bit_img4.Initialize(File.DirAssets,\"home-h4.jpg\")";
Debug.ShouldStop(1);
main.mostCurrent._bit_img4.runVoidMethod ("Initialize",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("home-h4.jpg")));
 BA.debugLineNum = 2980;BA.debugLine="index_curent_img=0";
Debug.ShouldStop(8);
...
_img_slider(main._index_curent_img);
 BA.debugLineNum = 2982;BA.debugLine="pan_help.Visible=True";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("lbl_help_FT_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3589);
if (RapidSub.canDelegate("lbl_help_ft_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_help_ft_click");}
 BA.debugLineNum = 3589;BA.debugLine="Private Sub lbl_help_FT_Click";
Debug.ShouldStop(16);
 BA.debugLineNum = 3590;BA.debugLine="myfunc.help_man(\"راهنما\",\"برای ثبت ورود یا خروج ا";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("lbl_help_piker_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3283);
if (RapidSub.canDelegate("lbl_help_piker_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_help_piker_click");}
 BA.debugLineNum = 3283;BA.debugLine="Private Sub lbl_help_piker_Click";
Debug.ShouldStop(262144);
 BA.debugLineNum = 3285;BA.debugLine="index_curent_img=4";
Debug.ShouldStop(1048576);
main._index_curent_img = BA.numberCast(int.class, 4);
 BA.debugLineNum = 3287;BA.debugLine="img_help.Bitmap=bit_img4";
Debug.ShouldStop(4194304);
main.mostCurrent._img_help.runMethod(false,"setBitmap",(main.mostCurrent._bit_img4.getObject()));
 BA.debugLineNum = 3288;BA.debugLine="lbl_close_help.Visible=False";
Debug.ShouldStop(8388608);
main.mostCurrent._lbl_close_help.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 3289;BA.debugLine="pan_help.Visible=True";
Debug.ShouldStop(16777216);
main.mostCurrent._pan_help.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"True"));
...
try {
		Debug.PushSubsStack("lbl_help2_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3233);
if (RapidSub.canDelegate("lbl_help2_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_help2_click");}
 BA.debugLineNum = 3233;BA.debugLine="Private Sub lbl_help2_Click";
Debug.ShouldStop(1);
 BA.debugLineNum = 3234;BA.debugLine="lbl_help_Click";
Debug.ShouldStop(2);
_lbl_help_click();
...
try {
		Debug.PushSubsStack("lbl_khoroj_FT_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3467);
if (RapidSub.canDelegate("lbl_khoroj_ft_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_khoroj_ft_click");}
 BA.debugLineNum = 3467;BA.debugLine="Private Sub lbl_khoroj_FT_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 3468;BA.debugLine="ToastMessageShow(\"انگشت خود را 3 ثانیه نگه دارید\"";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("lbl_khoroj_FT_LongClick (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3488);
if (RapidSub.canDelegate("lbl_khoroj_ft_longclick")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_khoroj_ft_longclick");}
 BA.debugLineNum = 3488;BA.debugLine="Private Sub lbl_khoroj_FT_LongClick";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 3489;BA.debugLine="If(code_fast_taradod=10 Or code_fast_taradod=20)T";
Debug.ShouldStop(1);
if ((RemoteObject.solveBoolean("=",main._code_fast_taradod,BA.numberCast(double.class, 10)) || RemoteObject.solveBoolean("=",main._code_fast_taradod,BA.numberCast(double.class, 20)))) { 
 BA.debugLineNum = 3490;BA.debugLine="index_box=4";
Debug.ShouldStop(2);
main._index_box = BA.numberCast(int.class, 4);
 BA.debugLineNum = 3491;BA.debugLine="lbl_tim_khoroj_FT.Text=DateTime.Time(DateTime.No";
Debug.ShouldStop(4);
main.mostCurrent._lbl_tim_khoroj_ft.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"Time",(Object)(main.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"getNow")))));
 BA.debugLineNum = 3492;BA.debugLine="add_taradod_fast";
Debug.ShouldStop(8);
_add_taradod_fast();
 BA.debugLineNum = 3493;BA.debugLine="code_fast_taradod=11";
Debug.ShouldStop(16);
main._code_fast_taradod = BA.numberCast(int.class, 11);
 }else 
{ BA.debugLineNum = 3494;BA.debugLine="Else If(code_fast_taradod=0)Then";
Debug.ShouldStop(32);
if ((RemoteObject.solveBoolean("=",main._code_fast_taradod,BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 3495;BA.debugLine="ToastMessageShow(\"تردد امروز دستی ثبت شده است\",F";
Debug.ShouldStop(64);
...
{ BA.debugLineNum = 3496;BA.debugLine="Else If(code_fast_taradod=1)Then";
Debug.ShouldStop(128);
if ((RemoteObject.solveBoolean("=",main._code_fast_taradod,BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 3497;BA.debugLine="ToastMessageShow(\"ابتدا قسمت ورود را بزنید\",Fals";
Debug.ShouldStop(256);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("ابتدا قسمت ورود را بزنید")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 ...
 BA.debugLineNum = 3499;BA.debugLine="ToastMessageShow(\"زمان خروج ثبت شده است\",False)";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("lbl_lite_menu_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3323);
if (RapidSub.canDelegate("lbl_lite_menu_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_lite_menu_click");}
 BA.debugLineNum = 3323;BA.debugLine="Private Sub lbl_lite_menu_Click";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 3324;BA.debugLine="pan_all_liteMenu.Visible=True";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("lbl_remove_from_list_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3157);
...
RemoteObject _b = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
RemoteObject _result = RemoteObject.createImmutable(0);
 BA.debugLineNum = 3157;BA.debugLine="Private Sub lbl_remove_from_list_Click";
Debug.ShouldStop(1048576);
...
Debug.ShouldStop(67108864);
_result = RemoteObject.createImmutable(0);Debug.locals.put("result", _result);
 BA.debugLineNum = 3164;BA.debugLine="result = Msgbox2(\"آیا این مورد حذف شود؟\", \"حذف\",";
Debug.ShouldStop(134217728);
...
Debug.ShouldStop(268435456);
if (RemoteObject.solveBoolean("=",_result,BA.numberCast(double.class, main.mostCurrent.__c.getField(false,"DialogResponse").getField(true,"POSITIVE")))) { 
 BA.debugLineNum = 3167;BA.debugLine="If (dbCode.delete_ezafekari(b.Tag))Then";
Debug.ShouldStop(1073741824);
...
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("حذف شد.")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 3170;BA.debugLine="curent_tab_list=TabHost1.CurrentTab";
Debug.ShouldStop(2);
main._curent_tab_list = main.mostCurrent._tabhost1.runMethod(true,"getCurrentTab");
 BA.debugLineNum = 3173;BA.debugLine="fill_lists(sp_year.SelectedItem,myfunc.convert";
Debug.ShouldStop(16);
_fill_lists(main.mostCurrent._sp_year.runMethod(true,"getSelectedItem"),main.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(RemoteObject.solve(new RemoteObject[] {main.mostCurrent._sp_moon.runMethod(true,"getSelectedIndex"),RemoteObject.createImmutable(1)}, "+",1, 1))));
 };
 };
 }else 
{ BA.debugLineNum = 3176;BA.debugLine="Else if (TabHost1.CurrentTab=1)Then";
Debug.ShouldStop(128);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._tabhost1.runMethod(true,"getCurrentTab"),BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 3178;BA.debugLine="Dim result As Int";
Debug.ShouldStop(512);
_result = RemoteObject.createImmutable(0);Debug.locals.put("result", _result);
 BA.debugLineNum = 3179;BA.debugLine="result = Msgbox2(\"آیا این مورد حذف شود؟\", \"حذف\",";
Debug.ShouldStop(1024);
_result = main.mostCurrent.__c.runMethodAndSync(true,"Msgbox2",(Object)(BA.ObjectToCharSequence("آیا این مورد حذف شود؟")),(Object)(BA.ObjectToCharSequence("حذف")),(Object)(BA.ObjectToString("بله")),(Object)(BA.ObjectToString("")),(Object)(BA.ObjectToString("خیر")),(Object)((main.mostCurrent.__c.getField(false,"Null"))),main.mostCurrent.activityBA);Debug.locals.put("result", _result);
 BA.debugLineNum = 3180;BA.debugLine="If result = DialogResponse.Positive Then";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean("=",_result,BA.numberCast(double.class, main.mostCurrent.__c.getField(false,"DialogResponse").getField(true,"POSITIVE")))) { 
 BA.debugLineNum = 3182;BA.debugLine="If (dbCode.delete_morakhasi(b.Tag))Then";
Debug.ShouldStop(8192);
if ((main.mostCurrent._dbcode.runMethod(true,"_delete_morakhasi" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, _b.runMethod(false,"getTag"))))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 3183;BA.debugLine="ToastMessageShow(\"حذف شد.\",False)";
Debug.ShouldStop(16384);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("حذف شد.")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 3184;BA.debugLine="curent_tab_list=TabHost1.CurrentTab";
Debug.ShouldStop(32768);
main._curent_tab_list = main.mostCurrent._tabhost1.runMethod(true,"getCurrentTab");
 BA.debugLineNum = 3185;BA.debugLine="fill_lists(sp_year.SelectedItem,myfunc.convert";
Debug.ShouldStop(65536);
_fill_lists(main.mostCurrent._sp_year.runMethod(true,"getSelectedItem"),main.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(RemoteObject.solve(new RemoteObject[] {main.mostCurrent._sp_moon.runMethod(true,"getSelectedIndex"),RemoteObject.createImmutable(1)}, "+",1, 1))));
 };
 };
 }else 
{ BA.debugLineNum = 3189;BA.debugLine="Else if (TabHost1.CurrentTab=2)Then";
Debug.ShouldStop(1048576);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._tabhost1.runMethod(true,"getCurrentTab"),BA.numberCast(double.class, 2)))) { 
 BA.debugLineNum = 3190;BA.debugLine="Dim result As Int";
Debug.ShouldStop(2097152);
_result = RemoteObject.createImmutable(0);Debug.locals.put("result", _result);
 BA.debugLineNum = 3191;BA.debugLine="result = Msgbox2(\"آیا این مورد حذف شود؟\", \"حذف\",";
Debug.ShouldStop(4194304);
_result = main.mostCurrent.__c.runMethodAndSync(true,"Msgbox2",(Object)(BA.ObjectToCharSequence("آیا این مورد حذف شود؟")),(Object)(BA.ObjectToCharSequence("حذف")),(Object)(BA.ObjectToString("بله")),(Object)(BA.ObjectToString("")),(Object)(BA.ObjectToString("خیر")),(Object)((main.mostCurrent.__c.getField(false,"Null"))),main.mostCurrent.activityBA);Debug.locals.put("result", _result);
 BA.debugLineNum = 3192;BA.debugLine="If result = DialogResponse.Positive Then";
Debug.ShouldStop(8388608);
if (RemoteObject.solveBoolean("=",_result,BA.numberCast(double.class, main.mostCurrent.__c.getField(false,"DialogResponse").getField(true,"POSITIVE")))) { 
 BA.debugLineNum = 3194;BA.debugLine="If (dbCode.delete_taradod(b.Tag))Then";
Debug.ShouldStop(33554432);
if ((main.mostCurrent._dbcode.runMethod(true,"_delete_taradod" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, _b.runMethod(false,"getTag"))))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 3195;BA.debugLine="ToastMessageShow(\"حذف شد.\",False)";
Debug.ShouldStop(67108864);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("حذف شد.")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 3197;BA.debugLine="curent_tab_list=TabHost1.CurrentTab";
Debug.ShouldStop(268435456);
main._curent_tab_list = main.mostCurrent._tabhost1.runMethod(true,"getCurrentTab");
...
try {
		Debug.PushSubsStack("lbl_remove_from_list2_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3212);
...
RemoteObject _b = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
RemoteObject _result = RemoteObject.createImmutable(0);
 BA.debugLineNum = 3212;BA.debugLine="Private Sub lbl_remove_from_list2_Click";
Debug.ShouldStop(2048);
 BA.debugLineNum = 3213;BA.debugLine="Dim b As Label";
Debug.ShouldStop(4096);
_b = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");Debug.locals.put("b", _b);
 BA.debugLineNum = 3214;BA.debugLine="b = Sender";
Debug.ShouldStop(8192);
_b = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.LabelWrapper"), main.mostCurrent.__c.runMethod(false,"Sender",main.mostCurrent.activityBA));Debug.locals.put("b", _b);
 BA.debugLineNum = 3217;BA.debugLine="Dim result As Int";
Debug.ShouldStop(65536);
_result = RemoteObject.createImmutable(0);Debug.locals.put("result", _result);
 BA.debugLineNum = 3218;BA.debugLine="result = Msgbox2(\"آیا این گزارش حذف شود؟\", \"حذف\",";
Debug.ShouldStop(131072);
_result = main.mostCurrent.__c.runMethodAndSync(true,"Msgbox2",(Object)(BA.ObjectToCharSequence("آیا این گزارش حذف شود؟")),(Object)(BA.ObjectToCharSequence("حذف")),(Object)(BA.ObjectToString("بله")),(Object)(BA.ObjectToString("")),(Object)(BA.ObjectToString("خیر")),(Object)((main.mostCurrent.__c.getField(false,"Null"))),main.mostCurrent.activityBA);Debug.locals.put("result", _result);
 BA.debugLineNum = 3219;BA.debugLine="If result = DialogResponse.Positive Then";
Debug.ShouldStop(262144);
if (RemoteObject.solveBoolean("=",_result,BA.numberCast(double.class, main.mostCurrent.__c.getField(false,"DialogResponse").getField(true,"POSITIVE")))) { 
 BA.debugLineNum = 3221;BA.debugLine="If (dbCode.delete_gozaresh(b.tag))Then";
Debug.ShouldStop(1048576);
if ((main.mostCurrent._dbcode.runMethod(true,"_delete_gozaresh" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, _b.runMethod(false,"getTag"))))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 3222;BA.debugLine="ToastMessageShow(\"حذف شد.\",False)";
Debug.ShouldStop(2097152);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("حذف شد.")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 3223;BA.debugLine="fill_list_gozareshat(sp_year_gozaresh.SelectedI";
Debug.ShouldStop(4194304);
_fill_list_gozareshat(main.mostCurrent._sp_year_gozaresh.runMethod(true,"getSelectedItem"));
 };
 };
...
try {
		Debug.PushSubsStack("lbl_save_box_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1737);
if (RapidSub.canDelegate("lbl_save_box_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_save_box_click");}
 BA.debugLineNum = 1737;BA.debugLine="Private Sub lbl_save_box_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 1739;BA.debugLine="time_show";
Debug.ShouldStop(1024);
_time_show();
 BA.debugLineNum = 1740;BA.debugLine="add_end";
Debug.ShouldStop(2048);
_add_end();
...
try {
		Debug.PushSubsStack("lbl_save_picker_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2764);
...
RemoteObject _value2 = RemoteObject.createImmutable("");
 BA.debugLineNum = 2764;BA.debugLine="Private Sub lbl_save_picker_Click";
Debug.ShouldStop(2048);
 BA.debugLineNum = 2766;BA.debugLine="Dim value As String";
Debug.ShouldStop(8192);
_value = RemoteObject.createImmutable("");Debug.locals.put("value", _value);
 BA.debugLineNum = 2767;BA.debugLine="value=pik_hour1.Text";
Debug.ShouldStop(16384);
_value = main.mostCurrent._pik_hour1.runMethod(true,"getText");Debug.locals.put("value", _value);
 BA.debugLineNum = 2768;BA.debugLine="Select value";
Debug.ShouldStop(32768);
...
main.mostCurrent._lbl_tim1.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(main.mostCurrent._pik_hour1.runMethod(true,"getText"),RemoteObject.createImmutable(":"),main.mostCurrent._pik_min1.runMethod(true,"getText"))));
 BA.debugLineNum = 2866;BA.debugLine="lbl_date1.Text=pik_year1.Text&\"/\"&pik_moon1.Tag&";
Debug.ShouldStop(131072);
...
{ BA.debugLineNum = 2868;BA.debugLine="Else If (index_piker=2)Then  'date2";
Debug.ShouldStop(524288);
if ((RemoteObject.solveBoolean("=",main._index_piker,BA.numberCast(double.class, 2)))) { 
 BA.debugLineNum = 2870;BA.debugLine="lbl_tim2.Text=pik_hour1.Text&\":\"&pik_min1.Text";
Debug.ShouldStop(2097152);
main.mostCurrent._lbl_tim2.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(main.mostCurrent._pik_hour1.runMethod(true,"getText"),RemoteObject.createImmutable(":"),main.mostCurrent._pik_min1.runMethod(true,"getText"))));
 BA.debugLineNum = 2871;BA.debugLine="lbl_date2.Text=pik_year1.Text&\"/\"&pik_moon1.Tag&";
Debug.ShouldStop(4194304);
...
;
 BA.debugLineNum = 2876;BA.debugLine="pan_all2.Visible=False";
Debug.ShouldStop(134217728);
main.mostCurrent._pan_all2.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 2877;BA.debugLine="time_show";
Debug.ShouldStop(268435456);
_time_show();
...
try {
		Debug.PushSubsStack("lbl_share_app_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3604);
...
RemoteObject _i = RemoteObject.declareNull("anywheresoftware.b4a.objects.IntentWrapper");
 BA.debugLineNum = 3604;BA.debugLine="Private Sub lbl_share_app_Click";
Debug.ShouldStop(524288);
 BA.debugLineNum = 3605;BA.debugLine="Dim i As Intent";
Debug.ShouldStop(1048576);
_i = RemoteObject.createNew ("anywheresoftware.b4a.objects.IntentWrapper");Debug.locals.put("i", _i);
 BA.debugLineNum = 3606;BA.debugLine="i.Initialize(i.ACTION_SEND, \"\")";
Debug.ShouldStop(2097152);
_i.runVoidMethod ("Initialize",(Object)(_i.getField(true,"ACTION_SEND")),(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 3607;BA.debugLine="i.SetType(\"text/plain\")";
Debug.ShouldStop(4194304);
_i.runVoidMethod ("SetType",(Object)(RemoteObject.createImmutable("text/plain")));
 BA.debugLineNum = 3608;BA.debugLine="i.PutExtra(\"android.intent.extra.TEXT\", \"https://";
Debug.ShouldStop(8388608);
_i.runVoidMethod ("PutExtra",(Object)(BA.ObjectToString("android.intent.extra.TEXT")),(Object)((RemoteObject.createImmutable("https://cafebazaar.ir/app/ir.taravatgroup.ezafekari2"))));
 BA.debugLineNum = 3609;BA.debugLine="i.WrapAsIntentChooser(\"انتخاب کنید\")";
Debug.ShouldStop(16777216);
_i.runVoidMethod ("WrapAsIntentChooser",(Object)(RemoteObject.createImmutable("انتخاب کنید")));
 BA.debugLineNum = 3610;BA.debugLine="StartActivity(i)";
Debug.ShouldStop(33554432);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((_i.getObject())));
 BA.debugLineNum = 3611;BA.debugLine="pan_all_liteMenu_Click";
Debug.ShouldStop(67108864);
_pan_all_litemenu_click();
 BA.debugLineNum = 3612;BA.debugLine="End Sub";
Debug.ShouldStop(134217728);
return RemoteObject.createImmutable("");
}
catch (Exception e) {
...
try {
		Debug.PushSubsStack("lbl_tim1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2740);
if (RapidSub.canDelegate("lbl_tim1_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_tim1_click");}
 BA.debugLineNum = 2740;BA.debugLine="Private Sub lbl_tim1_Click";
Debug.ShouldStop(524288);
 BA.debugLineNum = 2741;BA.debugLine="index_piker=1";
Debug.ShouldStop(1048576);
main._index_piker = BA.numberCast(int.class, 1);
 BA.debugLineNum = 2743;BA.debugLine="pik_hour1.Text=strfun.Split(lbl_tim1.Text,\":\").Ge";
Debug.ShouldStop(4194304);
main.mostCurrent._pik_hour1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(main.mostCurrent._lbl_tim1.runMethod(true,"getText")),(Object)(RemoteObject.createImmutable(":"))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)))));
 BA.debugLineNum = 2744;BA.debugLine="pik_min1.Text=strfun.Split(lbl_tim1.Text,\":\").Get";
Debug.ShouldStop(8388608);
main.mostCurrent._pik_min1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(main.mostCurrent._lbl_tim1.runMethod(true,"getText")),(Object)(RemoteObject.createImmutable(":"))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1)))));
 BA.debugLineNum = 2746;BA.debugLine="pik_year1.Text=strfun.Split(lbl_date1.Text,\"/\").G";
Debug.ShouldStop(33554432);
main.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(main.mostCurrent._lbl_date1.runMethod(true,"getText")),(Object)(RemoteObject.createImmutable("/"))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)))));
 BA.debugLineNum = 2747;BA.debugLine="pik_moon1.Tag=strfun.Split(lbl_date1.Text,\"/\").Ge";
Debug.ShouldStop(67108864);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(main.mostCurrent._lbl_date1.runMethod(true,"getText")),(Object)(RemoteObject.createImmutable("/"))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1))));
 BA.debugLineNum = 2748;BA.debugLine="pik_moon1.Text=moon.Get(pik_moon1.Tag-1)";
Debug.ShouldStop(134217728);
main.mostCurrent._pik_moon1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._moon.runMethod(false,"Get",(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, main.mostCurrent._pik_moon1.runMethod(false,"getTag")),RemoteObject.createImmutable(1)}, "-",1, 0))))));
 BA.debugLineNum = 2749;BA.debugLine="pik_day1.Text=strfun.Split(lbl_date1.Text,\"/\").Ge";
Debug.ShouldStop(268435456);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(main.mostCurrent._lbl_date1.runMethod(true,"getText")),(Object)(RemoteObject.createImmutable("/"))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 2)))));
 BA.debugLineNum = 2753;BA.debugLine="pan_all2.Visible=True";
Debug.ShouldStop(1);
main.mostCurrent._pan_all2.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 2755;BA.debugLine="If (File.Exists(File.DirInternal,\"help_piktim\")=F";
Debug.ShouldStop(4);
if ((RemoteObject.solveBoolean("=",main.mostCurrent.__c.getField(false,"File").runMethod(true,"Exists",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("help_piktim"))),main.mostCurrent.__c.getField(true,"False")))) { 
 BA.debugLineNum = 2756;BA.debugLine="lbl_help_Click";
Debug.ShouldStop(8);
_lbl_help_click();
 BA.debugLineNum = 2757;BA.debugLine="index_curent_img=4";
Debug.ShouldStop(16);
main._index_curent_img = BA.numberCast(int.class, 4);
 BA.debugLineNum = 2758;BA.debugLine="img_slider(index_curent_img)";
Debug.ShouldStop(32);
_img_slider(main._index_curent_img);
 BA.debugLineNum = 2759;BA.debugLine="File.WriteString(File.DirInternal,\"help_piktim\",";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("lbl_tim2_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2709);
if (RapidSub.canDelegate("lbl_tim2_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_tim2_click");}
 BA.debugLineNum = 2709;BA.debugLine="Private Sub lbl_tim2_Click";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 2710;BA.debugLine="index_piker=2";
Debug.ShouldStop(2097152);
main._index_piker = BA.numberCast(int.class, 2);
 BA.debugLineNum = 2711;BA.debugLine="pik_hour1.Text=strfun.Split(lbl_tim2.Text,\":\").Ge";
Debug.ShouldStop(4194304);
main.mostCurrent._pik_hour1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(main.mostCurrent._lbl_tim2.runMethod(true,"getText")),(Object)(RemoteObject.createImmutable(":"))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)))));
 BA.debugLineNum = 2712;BA.debugLine="pik_min1.Text=strfun.Split(lbl_tim2.Text,\":\").Get";
Debug.ShouldStop(8388608);
main.mostCurrent._pik_min1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(main.mostCurrent._lbl_tim2.runMethod(true,"getText")),(Object)(RemoteObject.createImmutable(":"))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1)))));
 BA.debugLineNum = 2714;BA.debugLine="pik_year1.Text=strfun.Split(lbl_date2.Text,\"/\").G";
Debug.ShouldStop(33554432);
main.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(main.mostCurrent._lbl_date2.runMethod(true,"getText")),(Object)(RemoteObject.createImmutable("/"))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)))));
 BA.debugLineNum = 2715;BA.debugLine="pik_moon1.Tag=strfun.Split(lbl_date2.Text,\"/\").Ge";
Debug.ShouldStop(67108864);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(main.mostCurrent._lbl_date2.runMethod(true,"getText")),(Object)(RemoteObject.createImmutable("/"))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1))));
 BA.debugLineNum = 2716;BA.debugLine="pik_moon1.Text=moon.Get(pik_moon1.Tag-1)";
Debug.ShouldStop(134217728);
main.mostCurrent._pik_moon1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._moon.runMethod(false,"Get",(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, main.mostCurrent._pik_moon1.runMethod(false,"getTag")),RemoteObject.createImmutable(1)}, "-",1, 0))))));
 BA.debugLineNum = 2717;BA.debugLine="pik_day1.Text=strfun.Split(lbl_date2.Text,\"/\").Ge";
Debug.ShouldStop(268435456);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(main.mostCurrent._lbl_date2.runMethod(true,"getText")),(Object)(RemoteObject.createImmutable("/"))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 2)))));
 BA.debugLineNum = 2720;BA.debugLine="pan_all2.Visible=True";
Debug.ShouldStop(-2147483648);
main.mostCurrent._pan_all2.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 2723;BA.debugLine="If (File.Exists(File.DirInternal,\"help_piktim\")=F";
Debug.ShouldStop(4);
if ((RemoteObject.solveBoolean("=",main.mostCurrent.__c.getField(false,"File").runMethod(true,"Exists",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("help_piktim"))),main.mostCurrent.__c.getField(true,"False")))) { 
 BA.debugLineNum = 2724;BA.debugLine="lbl_help_Click";
Debug.ShouldStop(8);
_lbl_help_click();
 BA.debugLineNum = 2725;BA.debugLine="index_curent_img=4";
Debug.ShouldStop(16);
main._index_curent_img = BA.numberCast(int.class, 4);
 BA.debugLineNum = 2726;BA.debugLine="img_slider(index_curent_img)";
Debug.ShouldStop(32);
_img_slider(main._index_curent_img);
 BA.debugLineNum = 2727;BA.debugLine="File.WriteString(File.DirInternal,\"help_piktim\",";
Debug.ShouldStop(64);
main.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteString",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("help_piktim")),(Object)(RemoteObject.createImmutable("")));
 };
...
try {
		Debug.PushSubsStack("lbl_vip_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2957);
if (RapidSub.canDelegate("lbl_vip_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_vip_click");}
 BA.debugLineNum = 2957;BA.debugLine="Private Sub lbl_vip_Click";
Debug.ShouldStop(4096);
 BA.debugLineNum = 2959;BA.debugLine="pan_all_noskhe.Visible=True";
Debug.ShouldStop(16384);
main.mostCurrent._pan_all_noskhe.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 2960;BA.debugLine="scroll_v_noskhe.Panel.LoadLayout(\"noske_item\")";
Debug.ShouldStop(32768);
main.mostCurrent._scroll_v_noskhe.runMethod(false,"getPanel").runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("noske_item")),main.mostCurrent.activityBA);
 BA.debugLineNum = 2962;BA.debugLine="If(myfunc.check_karid)Then";
Debug.ShouldStop(131072);
if ((main.mostCurrent._myfunc.runMethod(true,"_check_karid" /*RemoteObject*/ ,main.mostCurrent.activityBA)).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 2963;BA.debugLine="lbl_show_vip.Text=\"نسخه کامل ( طلایی ) فعال می ب";
Debug.ShouldStop(262144);
main.mostCurrent._lbl_show_vip.runMethod(true,"setText",BA.ObjectToCharSequence("نسخه کامل ( طلایی ) فعال می باشد."));
 }else {
 BA.debugLineNum = 2965;BA.debugLine="lbl_show_vip.Text=\"نسخه معمولی ( هدیه ) فعال می";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("lbl_vip_later_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3253);
if (RapidSub.canDelegate("lbl_vip_later_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_vip_later_click");}
 BA.debugLineNum = 3253;BA.debugLine="Private Sub lbl_vip_later_Click";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 3254;BA.debugLine="pan_all_noskhe_Click";
Debug.ShouldStop(2097152);
_pan_all_noskhe_click();
...
try {
		Debug.PushSubsStack("lbl_vip_now_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3257);
...
RemoteObject _result = RemoteObject.createImmutable(0);
 BA.debugLineNum = 3257;BA.debugLine="Private Sub lbl_vip_now_Click";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 3258;BA.debugLine="If(myfunc.check_karid)Then";
Debug.ShouldStop(33554432);
if ((main.mostCurrent._myfunc.runMethod(true,"_check_karid" /*RemoteObject*/ ,main.mostCurrent.activityBA)).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 3260;BA.debugLine="Dim title , matn As String";
Debug.ShouldStop(134217728);
...
_matn = RemoteObject.createImmutable("");Debug.locals.put("matn", _matn);
 BA.debugLineNum = 3261;BA.debugLine="title=\" تبریک \"";
Debug.ShouldStop(268435456);
_title = BA.ObjectToString(" تبریک ");Debug.locals.put("title", _title);
 BA.debugLineNum = 3262;BA.debugLine="matn=\" شما صاحب نسخه طلایی و بدون محدودیت برنامه";
Debug.ShouldStop(536870912);
...
Debug.ShouldStop(-2147483648);
_result = RemoteObject.createImmutable(0);Debug.locals.put("result", _result);
 BA.debugLineNum = 3265;BA.debugLine="result = Msgbox2(matn, title, \"باشه\", \"\", \"\", Lo";
Debug.ShouldStop(1);
...
if (RemoteObject.solveBoolean("=",_result,BA.numberCast(double.class, main.mostCurrent.__c.getField(false,"DialogResponse").getField(true,"POSITIVE")))) { 
 ...
 BA.debugLineNum = 3271;BA.debugLine="kharid";
Debug.ShouldStop(64);
_kharid();
 };
...
try {
		Debug.PushSubsStack("lbl_vip2_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3237);
if (RapidSub.canDelegate("lbl_vip2_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_vip2_click");}
 BA.debugLineNum = 3237;BA.debugLine="Private Sub lbl_vip2_Click";
Debug.ShouldStop(16);
 BA.debugLineNum = 3238;BA.debugLine="lbl_vip_Click";
Debug.ShouldStop(32);
_lbl_vip_click();
...
try {
		Debug.PushSubsStack("lbl_vorod_FT_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3464);
if (RapidSub.canDelegate("lbl_vorod_ft_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_vorod_ft_click");}
 BA.debugLineNum = 3464;BA.debugLine="Private Sub lbl_vorod_FT_Click";
Debug.ShouldStop(128);
 BA.debugLineNum = 3465;BA.debugLine="ToastMessageShow(\"انگشت خود را 3 ثانیه نگه دارید\"";
Debug.ShouldStop(256);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("انگشت خود را 3 ثانیه نگه دارید")),(Object)(main.mostCurrent.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("lbl_vorod_FT_LongClick (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3472);
if (RapidSub.canDelegate("lbl_vorod_ft_longclick")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","lbl_vorod_ft_longclick");}
 BA.debugLineNum = 3472;BA.debugLine="Private Sub lbl_vorod_FT_LongClick";
Debug.ShouldStop(32768);
 BA.debugLineNum = 3474;BA.debugLine="If(code_fast_taradod=1)Then";
Debug.ShouldStop(131072);
if ((RemoteObject.solveBoolean("=",main._code_fast_taradod,BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 3475;BA.debugLine="index_box=4";
Debug.ShouldStop(262144);
main._index_box = BA.numberCast(int.class, 4);
 BA.debugLineNum = 3476;BA.debugLine="lbl_tim_vorod_FT.Text=DateTime.Time(DateTime.Now";
Debug.ShouldStop(524288);
main.mostCurrent._lbl_tim_vorod_ft.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"Time",(Object)(main.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"getNow")))));
 BA.debugLineNum = 3477;BA.debugLine="code_fast_taradod=10";
Debug.ShouldStop(1048576);
main._code_fast_taradod = BA.numberCast(int.class, 10);
 BA.debugLineNum = 3478;BA.debugLine="add_end";
Debug.ShouldStop(2097152);
_add_end();
 BA.debugLineNum = 3479;BA.debugLine="pan_add_taradod_fast_Click";
Debug.ShouldStop(4194304);
_pan_add_taradod_fast_click();
 }else 
{ BA.debugLineNum = 3480;BA.debugLine="Else If(code_fast_taradod=0)Then";
Debug.ShouldStop(8388608);
if ((RemoteObject.solveBoolean("=",main._code_fast_taradod,BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 3481;BA.debugLine="ToastMessageShow(\" تردد امروز دستی ثبت شده است\",";
Debug.ShouldStop(16777216);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence(" تردد امروز دستی ثبت شده است")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 }else {
 BA.debugLineNum = 3483;BA.debugLine="ToastMessageShow(\"زمان ورود ثبت شده است\",False)";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("pan_add_mamoriat_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1692);
if (RapidSub.canDelegate("pan_add_mamoriat_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_add_mamoriat_click");}
 BA.debugLineNum = 1692;BA.debugLine="Private Sub pan_add_mamoriat_Click";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 1693;BA.debugLine="is_for_edit=False";
Debug.ShouldStop(268435456);
main._is_for_edit = main.mostCurrent.__c.getField(true,"False");
 BA.debugLineNum = 1694;BA.debugLine="pan_ezaf_taradod.Visible=True";
Debug.ShouldStop(536870912);
main.mostCurrent._pan_ezaf_taradod.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 1695;BA.debugLine="pan_all.Visible=True";
Debug.ShouldStop(1073741824);
main.mostCurrent._pan_all.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 1696;BA.debugLine="lbl_box_title.Text=\"ثبت ماموریت\"";
Debug.ShouldStop(-2147483648);
main.mostCurrent._lbl_box_title.runMethod(true,"setText",BA.ObjectToCharSequence("ثبت ماموریت"));
 BA.debugLineNum = 1697;BA.debugLine="lbl_time_as.Text=\"از :\"";
Debug.ShouldStop(1);
main.mostCurrent._lbl_time_as.runMethod(true,"setText",BA.ObjectToCharSequence("از :"));
 BA.debugLineNum = 1698;BA.debugLine="lbl_time_ta.Text=\"تا :\"";
Debug.ShouldStop(2);
main.mostCurrent._lbl_time_ta.runMethod(true,"setText",BA.ObjectToCharSequence("تا :"));
 BA.debugLineNum = 1699;BA.debugLine="index_box=5";
Debug.ShouldStop(4);
main._index_box = BA.numberCast(int.class, 5);
 BA.debugLineNum = 1700;BA.debugLine="lbl_time_show.Text=\"\"";
Debug.ShouldStop(8);
main.mostCurrent._lbl_time_show.runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 1701;BA.debugLine="et_tozihat.Text=\"\"";
Debug.ShouldStop(16);
main.mostCurrent._et_tozihat.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 1702;BA.debugLine="lbl_ezaf_taradod.Visible=False";
Debug.ShouldStop(32);
main.mostCurrent._lbl_ezaf_taradod.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 1705;BA.debugLine="ckb_ezaf_taradod.Enabled=False";
Debug.ShouldStop(256);
main.mostCurrent._ckb_ezaf_taradod.runMethod(true,"setEnabled",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 1706;BA.debugLine="ckb_ezaf_taradod.Visible=False";
Debug.ShouldStop(512);
main.mostCurrent._ckb_ezaf_taradod.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 1707;BA.debugLine="ckb_ezaf_taradod.Checked=False";
Debug.ShouldStop(1024);
main.mostCurrent._ckb_ezaf_taradod.runMethodAndSync(true,"setChecked",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 1713;BA.debugLine="pik_year1.Text=myfunc.fa2en(persianDate.PersianYe";
Debug.ShouldStop(65536);
main.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.NumberToString(main._persiandate.runMethod(true,"getPersianYear"))))));
 BA.debugLineNum = 1714;BA.debugLine="pik_moon1.Tag=myfunc.fa2en(persianDate.PersianMon";
Debug.ShouldStop(131072);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.NumberToString(main._persiandate.runMethod(true,"getPersianMonth"))))));
 BA.debugLineNum = 1715;BA.debugLine="pik_moon1.Text=moon.Get(pik_moon1.Tag-1)";
Debug.ShouldStop(262144);
main.mostCurrent._pik_moon1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._moon.runMethod(false,"Get",(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, main.mostCurrent._pik_moon1.runMethod(false,"getTag")),RemoteObject.createImmutable(1)}, "-",1, 0))))));
 BA.debugLineNum = 1716;BA.debugLine="pik_day1.Text=myfunc.fa2en(persianDate.PersianDay";
Debug.ShouldStop(524288);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.NumberToString(main._persiandate.runMethod(true,"getPersianDay"))))));
 BA.debugLineNum = 1719;BA.debugLine="lbl_date1.Text=myfunc.fa2en(persianDate.PersianSh";
Debug.ShouldStop(4194304);
main.mostCurrent._lbl_date1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main._persiandate.runMethod(true,"getPersianShortDate")))));
 BA.debugLineNum = 1720;BA.debugLine="lbl_date2.Text=myfunc.fa2en(persianDate.PersianSh";
Debug.ShouldStop(8388608);
main.mostCurrent._lbl_date2.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main._persiandate.runMethod(true,"getPersianShortDate")))));
...
try {
		Debug.PushSubsStack("pan_add_taradod_fast_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3342);
if (RapidSub.canDelegate("pan_add_taradod_fast_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_add_taradod_fast_click");}
 BA.debugLineNum = 3342;BA.debugLine="Private Sub pan_add_taradod_fast_Click";
Debug.ShouldStop(8192);
 BA.debugLineNum = 3343;BA.debugLine="pan_all_FT.Visible=True";
Debug.ShouldStop(16384);
main.mostCurrent._pan_all_ft.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 3344;BA.debugLine="lbl_date_FT.Text=myfunc.fa2en(persianDate.Persian";
Debug.ShouldStop(32768);
main.mostCurrent._lbl_date_ft.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main._persiandate.runMethod(true,"getPersianShortDate")))));
 BA.debugLineNum = 3345;BA.debugLine="DateTime.TimeFormat = \"HH:mm\"";
Debug.ShouldStop(65536);
main.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"setTimeFormat",BA.ObjectToString("HH:mm"));
 BA.debugLineNum = 3347;BA.debugLine="If(dbCode.isexist_taradod_by_date(lbl_date_FT.Tex";
Debug.ShouldStop(262144);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._dbcode.runMethod(true,"_isexist_taradod_by_date" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._lbl_date_ft.runMethod(true,"getText"))),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 3348;BA.debugLine="dbCode.res=dbCode.sql.ExecQuery(\"SELECT * FROM t";
Debug.ShouldStop(524288);
main.mostCurrent._dbcode._res /*RemoteObject*/  = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.sql.SQL.ResultSetWrapper"), main.mostCurrent._dbcode._sql /*RemoteObject*/ .runMethod(false,"ExecQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("SELECT * FROM tb_taradod WHERE date_from LIKE '"),main.mostCurrent._lbl_date_ft.runMethod(true,"getText"),RemoteObject.createImmutable("';")))));
 BA.debugLineNum = 3349;BA.debugLine="dbCode.res.Position=0";
Debug.ShouldStop(1048576);
main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"setPosition",BA.numberCast(int.class, 0));
 BA.debugLineNum = 3351;BA.debugLine="lbl_tim_vorod_FT.Text=dbCode.res.GetString(\"time";
Debug.ShouldStop(4194304);
main.mostCurrent._lbl_tim_vorod_ft.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("time_from")))));
 BA.debugLineNum = 3352;BA.debugLine="lbl_tim_khoroj_FT.Text=dbCode.res.GetString(\"tim";
Debug.ShouldStop(8388608);
main.mostCurrent._lbl_tim_khoroj_ft.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("time_to")))));
 BA.debugLineNum = 3354;BA.debugLine="et_tozihat_FT.Text=dbCode.res.GetString(\"tozihat";
Debug.ShouldStop(33554432);
main.mostCurrent._et_tozihat_ft.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("tozihat")))));
 BA.debugLineNum = 3356;BA.debugLine="current_id_edit=dbCode.res.GetInt(\"id\")";
Debug.ShouldStop(134217728);
main._current_id_edit = main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("id")));
 BA.debugLineNum = 3357;BA.debugLine="Log(dbCode.res.GetInt(\"state\"))";
Debug.ShouldStop(268435456);
main.mostCurrent.__c.runVoidMethod ("LogImpl","17536655",BA.NumberToString(main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("state")))),0);
 BA.debugLineNum = 3359;BA.debugLine="lbl_vorod_FT.TextColor=Colors.Gray";
Debug.ShouldStop(1073741824);
main.mostCurrent._lbl_vorod_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Gray"));
 BA.debugLineNum = 3360;BA.debugLine="lbl_khoroj_FT.TextColor=Colors.Gray";
Debug.ShouldStop(-2147483648);
main.mostCurrent._lbl_khoroj_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Gray"));
 BA.debugLineNum = 3363;BA.debugLine="If(dbCode.res.GetInt(\"state\")=10)Then  ''vorod n";
Debug.ShouldStop(4);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("state"))),BA.numberCast(double.class, 10)))) { 
 BA.debugLineNum = 3364;BA.debugLine="lbl_vorod_FT.TextColor=Colors.Green";
Debug.ShouldStop(8);
main.mostCurrent._lbl_vorod_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"));
 BA.debugLineNum = 3365;BA.debugLine="lbl_khoroj_FT.TextColor=Colors.Gray";
Debug.ShouldStop(16);
main.mostCurrent._lbl_khoroj_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Gray"));
 BA.debugLineNum = 3366;BA.debugLine="ckb_ezaf_taradod_FT.Checked=False";
Debug.ShouldStop(32);
main.mostCurrent._ckb_ezaf_taradod_ft.runMethodAndSync(true,"setChecked",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 3367;BA.debugLine="ckb_ezaf_taradod_FT.Enabled=False";
Debug.ShouldStop(64);
main.mostCurrent._ckb_ezaf_taradod_ft.runMethod(true,"setEnabled",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 3369;BA.debugLine="code_fast_taradod=10";
Debug.ShouldStop(256);
main._code_fast_taradod = BA.numberCast(int.class, 10);
 }else 
{ BA.debugLineNum = 3370;BA.debugLine="Else If (dbCode.res.GetInt(\"state\")=20)Then  ''v";
Debug.ShouldStop(512);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("state"))),BA.numberCast(double.class, 20)))) { 
 BA.debugLineNum = 3371;BA.debugLine="lbl_vorod_FT.TextColor=Colors.Green";
Debug.ShouldStop(1024);
main.mostCurrent._lbl_vorod_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"));
 BA.debugLineNum = 3372;BA.debugLine="lbl_khoroj_FT.TextColor=Colors.Gray";
Debug.ShouldStop(2048);
main.mostCurrent._lbl_khoroj_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Gray"));
 BA.debugLineNum = 3373;BA.debugLine="ckb_ezaf_taradod_FT.Checked=True";
Debug.ShouldStop(4096);
main.mostCurrent._ckb_ezaf_taradod_ft.runMethodAndSync(true,"setChecked",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 3374;BA.debugLine="ckb_ezaf_taradod_FT.Enabled=False";
Debug.ShouldStop(8192);
main.mostCurrent._ckb_ezaf_taradod_ft.runMethod(true,"setEnabled",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 3376;BA.debugLine="code_fast_taradod=20";
Debug.ShouldStop(32768);
main._code_fast_taradod = BA.numberCast(int.class, 20);
 }else 
{ BA.debugLineNum = 3377;BA.debugLine="Else If (dbCode.res.GetInt(\"state\")=11)Then  ''k";
Debug.ShouldStop(65536);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("state"))),BA.numberCast(double.class, 11)))) { 
 BA.debugLineNum = 3378;BA.debugLine="lbl_vorod_FT.TextColor=Colors.Green";
Debug.ShouldStop(131072);
main.mostCurrent._lbl_vorod_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"));
 BA.debugLineNum = 3379;BA.debugLine="lbl_khoroj_FT.TextColor=Colors.Green";
Debug.ShouldStop(262144);
main.mostCurrent._lbl_khoroj_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"));
 BA.debugLineNum = 3380;BA.debugLine="ckb_ezaf_taradod_FT.Checked=False";
Debug.ShouldStop(524288);
main.mostCurrent._ckb_ezaf_taradod_ft.runMethodAndSync(true,"setChecked",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 3381;BA.debugLine="ckb_ezaf_taradod_FT.Enabled=False";
Debug.ShouldStop(1048576);
main.mostCurrent._ckb_ezaf_taradod_ft.runMethod(true,"setEnabled",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 3383;BA.debugLine="et_tozihat_FT.Enabled=False";
Debug.ShouldStop(4194304);
main.mostCurrent._et_tozihat_ft.runMethod(true,"setEnabled",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 3385;BA.debugLine="time_show2(lbl_date_FT.Text,lbl_date_FT.Text,lb";
Debug.ShouldStop(16777216);
_time_show2(main.mostCurrent._lbl_date_ft.runMethod(true,"getText"),main.mostCurrent._lbl_date_ft.runMethod(true,"getText"),main.mostCurrent._lbl_tim_vorod_ft.runMethod(true,"getText"),main.mostCurrent._lbl_tim_khoroj_ft.runMethod(true,"getText"));
 BA.debugLineNum = 3386;BA.debugLine="code_fast_taradod=11";
Debug.ShouldStop(33554432);
main._code_fast_taradod = BA.numberCast(int.class, 11);
 BA.debugLineNum = 3387;BA.debugLine="ToastMessageShow(\"تردد امروز ثبت شده است\",False";
Debug.ShouldStop(67108864);
...
{ BA.debugLineNum = 3390;BA.debugLine="Else If (dbCode.res.GetInt(\"state\")=21)Then  ''k";
Debug.ShouldStop(536870912);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("state"))),BA.numberCast(double.class, 21)))) { 
 BA.debugLineNum = 3391;BA.debugLine="lbl_vorod_FT.TextColor=Colors.Green";
Debug.ShouldStop(1073741824);
main.mostCurrent._lbl_vorod_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"));
 BA.debugLineNum = 3392;BA.debugLine="lbl_khoroj_FT.TextColor=Colors.Green";
Debug.ShouldStop(-2147483648);
main.mostCurrent._lbl_khoroj_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"));
 BA.debugLineNum = 3393;BA.debugLine="ckb_ezaf_taradod_FT.Checked=True";
Debug.ShouldStop(1);
main.mostCurrent._ckb_ezaf_taradod_ft.runMethodAndSync(true,"setChecked",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 3394;BA.debugLine="ckb_ezaf_taradod_FT.Enabled=False";
Debug.ShouldStop(2);
main.mostCurrent._ckb_ezaf_taradod_ft.runMethod(true,"setEnabled",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 3396;BA.debugLine="et_tozihat_FT.Enabled=False";
Debug.ShouldStop(8);
main.mostCurrent._et_tozihat_ft.runMethod(true,"setEnabled",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 3398;BA.debugLine="time_show2(lbl_date_FT.Text,lbl_date_FT.Text,lb";
Debug.ShouldStop(32);
_time_show2(main.mostCurrent._lbl_date_ft.runMethod(true,"getText"),main.mostCurrent._lbl_date_ft.runMethod(true,"getText"),main.mostCurrent._lbl_tim_vorod_ft.runMethod(true,"getText"),main.mostCurrent._lbl_tim_khoroj_ft.runMethod(true,"getText"));
 BA.debugLineNum = 3400;BA.debugLine="code_fast_taradod=21";
Debug.ShouldStop(128);
main._code_fast_taradod = BA.numberCast(int.class, 21);
 BA.debugLineNum = 3401;BA.debugLine="ToastMessageShow(\"تردد امروز ثبت شده است\",False";
Debug.ShouldStop(256);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("تردد امروز ثبت شده است")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 }else 
{ BA.debugLineNum = 3404;BA.debugLine="Else If (dbCode.res.GetInt(\"state\")=0)Then  ''da";
Debug.ShouldStop(2048);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("state"))),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 3405;BA.debugLine="lbl_vorod_FT.TextColor=Colors.Red";
Debug.ShouldStop(4096);
main.mostCurrent._lbl_vorod_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Red"));
 BA.debugLineNum = 3406;BA.debugLine="lbl_khoroj_FT.TextColor=Colors.Red";
Debug.ShouldStop(8192);
main.mostCurrent._lbl_khoroj_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Red"));
 BA.debugLineNum = 3407;BA.debugLine="ckb_ezaf_taradod_FT.Checked=False";
Debug.ShouldStop(16384);
main.mostCurrent._ckb_ezaf_taradod_ft.runMethodAndSync(true,"setChecked",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 3408;BA.debugLine="ckb_ezaf_taradod_FT.Enabled=False";
Debug.ShouldStop(32768);
main.mostCurrent._ckb_ezaf_taradod_ft.runMethod(true,"setEnabled",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 3410;BA.debugLine="et_tozihat_FT.Enabled=False";
Debug.ShouldStop(131072);
main.mostCurrent._et_tozihat_ft.runMethod(true,"setEnabled",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 3411;BA.debugLine="time_show2(lbl_date_FT.Text,lbl_date_FT.Text,lb";
Debug.ShouldStop(262144);
_time_show2(main.mostCurrent._lbl_date_ft.runMethod(true,"getText"),main.mostCurrent._lbl_date_ft.runMethod(true,"getText"),main.mostCurrent._lbl_tim_vorod_ft.runMethod(true,"getText"),main.mostCurrent._lbl_tim_khoroj_ft.runMethod(true,"getText"));
 BA.debugLineNum = 3413;BA.debugLine="ToastMessageShow(\"برای امروز تردد دستی ثبت شده";
Debug.ShouldStop(1048576);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("برای امروز تردد دستی ثبت شده است")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 3415;BA.debugLine="code_fast_taradod=0";
Debug.ShouldStop(4194304);
main._code_fast_taradod = BA.numberCast(int.class, 0);
 }}}}}
;
 }else {
 BA.debugLineNum = 3418;BA.debugLine="lbl_vorod_FT.TextColor=Colors.Gray";
Debug.ShouldStop(33554432);
main.mostCurrent._lbl_vorod_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Gray"));
 BA.debugLineNum = 3419;BA.debugLine="lbl_khoroj_FT.TextColor=Colors.Gray";
Debug.ShouldStop(67108864);
main.mostCurrent._lbl_khoroj_ft.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Gray"));
 BA.debugLineNum = 3421;BA.debugLine="ckb_ezaf_taradod_FT.Checked=True";
Debug.ShouldStop(268435456);
main.mostCurrent._ckb_ezaf_taradod_ft.runMethodAndSync(true,"setChecked",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 3422;BA.debugLine="ckb_ezaf_taradod_FT.Enabled=True";
Debug.ShouldStop(536870912);
main.mostCurrent._ckb_ezaf_taradod_ft.runMethod(true,"setEnabled",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 3423;BA.debugLine="code_fast_taradod=1";
Debug.ShouldStop(1073741824);
main._code_fast_taradod = BA.numberCast(int.class, 1);
 BA.debugLineNum = 3424;BA.debugLine="et_tozihat_FT.Enabled=True";
Debug.ShouldStop(-2147483648);
main.mostCurrent._et_tozihat_ft.runMethod(true,"setEnabled",main.mostCurrent.__c.getField(true,"True"));
 };
...
try {
		Debug.PushSubsStack("pan_all_chekUpdate_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3651);
if (RapidSub.canDelegate("pan_all_chekupdate_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_all_chekupdate_click");}
 BA.debugLineNum = 3651;BA.debugLine="Private Sub pan_all_chekUpdate_Click";
Debug.ShouldStop(4);
 BA.debugLineNum = 3652;BA.debugLine="pan_all_chekUpdate.Visible=False";
Debug.ShouldStop(8);
main.mostCurrent._pan_all_chekupdate.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("pan_all_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1729);
if (RapidSub.canDelegate("pan_all_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_all_click");}
 BA.debugLineNum = 1729;BA.debugLine="Private Sub pan_all_Click";
Debug.ShouldStop(1);
 BA.debugLineNum = 1730;BA.debugLine="pan_all.Visible=False";
Debug.ShouldStop(2);
main.mostCurrent._pan_all.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("pan_all_FT_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3460);
if (RapidSub.canDelegate("pan_all_ft_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_all_ft_click");}
 BA.debugLineNum = 3460;BA.debugLine="Private Sub pan_all_FT_Click";
Debug.ShouldStop(8);
 BA.debugLineNum = 3461;BA.debugLine="pan_all_FT.Visible=False";
Debug.ShouldStop(16);
main.mostCurrent._pan_all_ft.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("pan_all_liteMenu_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3327);
if (RapidSub.canDelegate("pan_all_litemenu_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_all_litemenu_click");}
 BA.debugLineNum = 3327;BA.debugLine="Private Sub pan_all_liteMenu_Click";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 3328;BA.debugLine="pan_all_liteMenu.Visible=False";
Debug.ShouldStop(-2147483648);
main.mostCurrent._pan_all_litemenu.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("pan_all_noskhe_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3275);
if (RapidSub.canDelegate("pan_all_noskhe_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_all_noskhe_click");}
 BA.debugLineNum = 3275;BA.debugLine="Private Sub pan_all_noskhe_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 3276;BA.debugLine="pan_all_noskhe.Visible=False";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("pan_all2_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2880);
if (RapidSub.canDelegate("pan_all2_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_all2_click");}
 BA.debugLineNum = 2880;BA.debugLine="Private Sub pan_all2_Click";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 2883;BA.debugLine="pan_all2.Visible=False";
Debug.ShouldStop(4);
main.mostCurrent._pan_all2.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("pan_bime_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3593);
if (RapidSub.canDelegate("pan_bime_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_bime_click");}
 BA.debugLineNum = 3593;BA.debugLine="Private Sub pan_bime_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 3594;BA.debugLine="StartActivity(bime_activity)";
Debug.ShouldStop(512);
...
try {
		Debug.PushSubsStack("pan_calc_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2949);
if (RapidSub.canDelegate("pan_calc_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_calc_click");}
 BA.debugLineNum = 2949;BA.debugLine="Private Sub pan_calc_Click";
Debug.ShouldStop(16);
 BA.debugLineNum = 2950;BA.debugLine="StartActivity(calc_activity)";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("pan_comment_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2891);
...
RemoteObject _url = RemoteObject.createImmutable("");
 BA.debugLineNum = 2891;BA.debugLine="Private Sub pan_comment_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 2893;BA.debugLine="Try";
Debug.ShouldStop(4096);
try { BA.debugLineNum = 2894;BA.debugLine="If (myfunc.check_internet=True)Then";
Debug.ShouldStop(8192);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._myfunc.runMethod(true,"_check_internet" /*RemoteObject*/ ,main.mostCurrent.activityBA),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 2896;BA.debugLine="Try";
Debug.ShouldStop(32768);
try { BA.debugLineNum = 2897;BA.debugLine="Dim market As Intent";
Debug.ShouldStop(65536);
_market = RemoteObject.createNew ("anywheresoftware.b4a.objects.IntentWrapper");Debug.locals.put("market", _market);
 BA.debugLineNum = 2898;BA.debugLine="Dim url As String";
Debug.ShouldStop(131072);
_url = RemoteObject.createImmutable("");Debug.locals.put("url", _url);
 BA.debugLineNum = 2900;BA.debugLine="url=\"bazaar://details?id=ir.taravatgroup.ezafek";
Debug.ShouldStop(524288);
_url = BA.ObjectToString("bazaar://details?id=ir.taravatgroup.ezafekari2");Debug.locals.put("url", _url);
 BA.debugLineNum = 2901;BA.debugLine="market.Initialize(market.ACTION_EDIT,url)";
Debug.ShouldStop(1048576);
_market.runVoidMethod ("Initialize",(Object)(_market.getField(true,"ACTION_EDIT")),(Object)(_url));
 BA.debugLineNum = 2902;BA.debugLine="market.SetPackage(\"com.farsitel.bazaar\")";
Debug.ShouldStop(2097152);
_market.runVoidMethod ("SetPackage",(Object)(RemoteObject.createImmutable("com.farsitel.bazaar")));
 BA.debugLineNum = 2903;BA.debugLine="StartActivity(market)";
Debug.ShouldStop(4194304);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((_market.getObject())));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e11) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e11.toString()); BA.debugLineNum = 2906;BA.debugLine="ToastMessageShow(\"برنامه بازار را نصب کنید\",Tru";
Debug.ShouldStop(33554432);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("برنامه بازار را نصب کنید")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 ...
 BA.debugLineNum = 2909;BA.debugLine="ToastMessageShow(\"ارتباط اینترنت را بررسی کنید\",";
Debug.ShouldStop(268435456);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("ارتباط اینترنت را بررسی کنید")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 ...
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e17.toString()); BA.debugLineNum = 2913;BA.debugLine="If (myfunc.check_internet=True)Then";
Debug.ShouldStop(1);
if ((RemoteObject.solveBoolean("=",main.mostCurrent._myfunc.runMethod(true,"_check_internet" /*RemoteObject*/ ,main.mostCurrent.activityBA),main.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 2915;BA.debugLine="Try";
Debug.ShouldStop(4);
try { BA.debugLineNum = 2916;BA.debugLine="Dim market As Intent";
Debug.ShouldStop(8);
_market = RemoteObject.createNew ("anywheresoftware.b4a.objects.IntentWrapper");Debug.locals.put("market", _market);
 BA.debugLineNum = 2917;BA.debugLine="Dim url As String";
Debug.ShouldStop(16);
_url = RemoteObject.createImmutable("");Debug.locals.put("url", _url);
 BA.debugLineNum = 2919;BA.debugLine="url=\"bazaar://details?id=ir.taravatgroup.ezafe";
Debug.ShouldStop(64);
_url = BA.ObjectToString("bazaar://details?id=ir.taravatgroup.ezafekari2");Debug.locals.put("url", _url);
 BA.debugLineNum = 2920;BA.debugLine="market.Initialize(market.ACTION_EDIT,url)";
Debug.ShouldStop(128);
_market.runVoidMethod ("Initialize",(Object)(_market.getField(true,"ACTION_EDIT")),(Object)(_url));
 BA.debugLineNum = 2921;BA.debugLine="StartActivity(market)";
Debug.ShouldStop(256);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((_market.getObject())));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e25) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e25.toString()); BA.debugLineNum = 2924;BA.debugLine="ToastMessageShow(\"برنامه بازار را نصب کنید\",Tr";
Debug.ShouldStop(2048);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("برنامه بازار را نصب کنید")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 };
 }else {
 BA.debugLineNum = 2927;BA.debugLine="ToastMessageShow(\"ارتباط اینترنت را بررسی کنید\"";
Debug.ShouldStop(16384);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("ارتباط اینترنت را بررسی کنید")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 };
 };
...
try {
		Debug.PushSubsStack("pan_darsad_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2886);
if (RapidSub.canDelegate("pan_darsad_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_darsad_click");}
 BA.debugLineNum = 2886;BA.debugLine="Private Sub pan_darsad_Click";
Debug.ShouldStop(32);
 BA.debugLineNum = 2887;BA.debugLine="StartActivity(darsad_activity)";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("pan_eidi_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2694);
if (RapidSub.canDelegate("pan_eidi_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_eidi_click");}
 BA.debugLineNum = 2694;BA.debugLine="Private Sub pan_eidi_Click";
Debug.ShouldStop(32);
 BA.debugLineNum = 2695;BA.debugLine="StartActivity(eidi_activity)";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("pan_ezafekari_mah_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3241);
if (RapidSub.canDelegate("pan_ezafekari_mah_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_ezafekari_mah_click");}
 BA.debugLineNum = 3241;BA.debugLine="Private Sub pan_ezafekari_mah_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 3242;BA.debugLine="btn_menu_list_Click";
Debug.ShouldStop(512);
_btn_menu_list_click();
 BA.debugLineNum = 3243;BA.debugLine="TabHost1.CurrentTab=0";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("pan_ganon_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3295);
if (RapidSub.canDelegate("pan_ganon_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_ganon_click");}
 BA.debugLineNum = 3295;BA.debugLine="Private Sub pan_ganon_Click";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 3296;BA.debugLine="StartActivity(ganon_activity)";
Debug.ShouldStop(-2147483648);
...
try {
		Debug.PushSubsStack("pan_help_Touch (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2990);
...
Debug.locals.put("Y", _y);
 BA.debugLineNum = 2990;BA.debugLine="Private Sub pan_help_Touch (Action As Int, X As Fl";
Debug.ShouldStop(8192);
 BA.debugLineNum = 2992;BA.debugLine="If (Action=0)Then";
Debug.ShouldStop(32768);
if ((RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 2993;BA.debugLine="index_x_start_swap=x";
Debug.ShouldStop(65536);
main._index_x_start_swap = BA.numberCast(int.class, _x);
 BA.debugLineNum = 2994;BA.debugLine="If (index_curent_img=4)Then";
Debug.ShouldStop(131072);
if ((RemoteObject.solveBoolean("=",main._index_curent_img,BA.numberCast(double.class, 4)))) { 
 BA.debugLineNum = 2995;BA.debugLine="pan_help.Visible=False";
Debug.ShouldStop(262144);
main.mostCurrent._pan_help.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 };
 };
 BA.debugLineNum = 2998;BA.debugLine="If(Action=1)Then";
Debug.ShouldStop(2097152);
if ((RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 2999;BA.debugLine="If(X<(index_x_start_swap-150))Then";
Debug.ShouldStop(4194304);
if ((RemoteObject.solveBoolean("<",_x,BA.numberCast(double.class, (RemoteObject.solve(new RemoteObject[] {main._index_x_start_swap,RemoteObject.createImmutable(150)}, "-",1, 1)))))) { 
 BA.debugLineNum = 3002;BA.debugLine="index_curent_img=index_curent_img+1";
Debug.ShouldStop(33554432);
main._index_curent_img = RemoteObject.solve(new RemoteObject[] {main._index_curent_img,RemoteObject.createImmutable(1)}, "+",1, 1);
 BA.debugLineNum = 3003;BA.debugLine="If(index_curent_img>4)Then";
Debug.ShouldStop(67108864);
if ((RemoteObject.solveBoolean(">",main._index_curent_img,BA.numberCast(double.class, 4)))) { 
 BA.debugLineNum = 3004;BA.debugLine="index_curent_img=4";
Debug.ShouldStop(134217728);
main._index_curent_img = BA.numberCast(int.class, 4);
 };
 }else 
{ BA.debugLineNum = 3008;BA.debugLine="Else If(X>(index_x_start_swap+150))Then";
Debug.ShouldStop(-2147483648);
if ((RemoteObject.solveBoolean(">",_x,BA.numberCast(double.class, (RemoteObject.solve(new RemoteObject[] {main._index_x_start_swap,RemoteObject.createImmutable(150)}, "+",1, 1)))))) { 
 BA.debugLineNum = 3011;BA.debugLine="index_curent_img=index_curent_img-1";
Debug.ShouldStop(4);
main._index_curent_img = RemoteObject.solve(new RemoteObject[] {main._index_curent_img,RemoteObject.createImmutable(1)}, "-",1, 1);
 BA.debugLineNum = 3012;BA.debugLine="If(index_curent_img<0)Then";
Debug.ShouldStop(8);
if ((RemoteObject.solveBoolean("<",main._index_curent_img,BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 3013;BA.debugLine="index_curent_img=0";
Debug.ShouldStop(16);
main._index_curent_img = BA.numberCast(int.class, 0);
 };
 }else 
{ BA.debugLineNum = 3017;BA.debugLine="Else If(index_x_start_swap<(pan_help.Width/2))Th";
Debug.ShouldStop(256);
if ((RemoteObject.solveBoolean("<",main._index_x_start_swap,(RemoteObject.solve(new RemoteObject[] {main.mostCurrent._pan_help.runMethod(true,"getWidth"),RemoteObject.createImmutable(2)}, "/",0, 0))))) { 
 BA.debugLineNum = 3019;BA.debugLine="index_curent_img=index_curent_img-1";
Debug.ShouldStop(1024);
main._index_curent_img = RemoteObject.solve(new RemoteObject[] {main._index_curent_img,RemoteObject.createImmutable(1)}, "-",1, 1);
 BA.debugLineNum = 3020;BA.debugLine="If(index_curent_img<0)Then";
Debug.ShouldStop(2048);
if ((RemoteObject.solveBoolean("<",main._index_curent_img,BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 3021;BA.debugLine="index_curent_img=0";
Debug.ShouldStop(4096);
main._index_curent_img = BA.numberCast(int.class, 0);
 };
 }else 
{ BA.debugLineNum = 3024;BA.debugLine="Else If(index_x_start_swap>(pan_help.Width/2))Th";
Debug.ShouldStop(32768);
if ((RemoteObject.solveBoolean(">",main._index_x_start_swap,(RemoteObject.solve(new RemoteObject[] {main.mostCurrent._pan_help.runMethod(true,"getWidth"),RemoteObject.createImmutable(2)}, "/",0, 0))))) { 
 BA.debugLineNum = 3026;BA.debugLine="index_curent_img=index_curent_img+1";
Debug.ShouldStop(131072);
main._index_curent_img = RemoteObject.solve(new RemoteObject[] {main._index_curent_img,RemoteObject.createImmutable(1)}, "+",1, 1);
 BA.debugLineNum = 3027;BA.debugLine="If(index_curent_img>4)Then";
Debug.ShouldStop(262144);
if ((RemoteObject.solveBoolean(">",main._index_curent_img,BA.numberCast(double.class, 4)))) { 
 BA.debugLineNum = 3028;BA.debugLine="index_curent_img=4";
Debug.ShouldStop(524288);
main._index_curent_img = BA.numberCast(int.class, 4);
 };
 }}}}
;
 BA.debugLineNum = 3033;BA.debugLine="img_slider(index_curent_img)";
Debug.ShouldStop(16777216);
_img_slider(main._index_curent_img);
 };
...
try {
		Debug.PushSubsStack("pan_info_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2704);
if (RapidSub.canDelegate("pan_info_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_info_click");}
 BA.debugLineNum = 2704;BA.debugLine="Private Sub pan_info_Click";
Debug.ShouldStop(32768);
 BA.debugLineNum = 2705;BA.debugLine="StartActivity(info_activity)";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("pan_item_gozaresh_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2938);
...
RemoteObject _ba = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
 BA.debugLineNum = 2938;BA.debugLine="Private Sub pan_item_gozaresh_Click";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 2939;BA.debugLine="Dim Ba As Panel = Sender";
Debug.ShouldStop(67108864);
...
_ba = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.PanelWrapper"), main.mostCurrent.__c.runMethod(false,"Sender",main.mostCurrent.activityBA));Debug.locals.put("Ba", _ba);Debug.locals.put("Ba", _ba);
 BA.debugLineNum = 2941;BA.debugLine="current_gozaresh_id=Ba.Tag";
Debug.ShouldStop(268435456);
main._current_gozaresh_id = BA.numberCast(int.class, _ba.runMethod(false,"getTag"));
 BA.debugLineNum = 2942;BA.debugLine="StartActivity(show_gozaresh_activity)";
Debug.ShouldStop(536870912);
...
try {
		Debug.PushSubsStack("pan_lelp_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3038);
if (RapidSub.canDelegate("pan_lelp_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_lelp_click");}
 BA.debugLineNum = 3038;BA.debugLine="Private Sub pan_lelp_Click";
Debug.ShouldStop(536870912);
...
try {
		Debug.PushSubsStack("pan_lock_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3598);
if (RapidSub.canDelegate("pan_lock_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_lock_click");}
 BA.debugLineNum = 3598;BA.debugLine="Private Sub pan_lock_Click";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("pan_morakhasi_mah_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3247);
if (RapidSub.canDelegate("pan_morakhasi_mah_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_morakhasi_mah_click");}
 BA.debugLineNum = 3247;BA.debugLine="Private Sub pan_morakhasi_mah_Click";
Debug.ShouldStop(16384);
 BA.debugLineNum = 3248;BA.debugLine="btn_menu_list_Click";
Debug.ShouldStop(32768);
_btn_menu_list_click();
 BA.debugLineNum = 3249;BA.debugLine="TabHost1.CurrentTab=1";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("pan_payankar_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2699);
if (RapidSub.canDelegate("pan_payankar_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_payankar_click");}
 BA.debugLineNum = 2699;BA.debugLine="Private Sub pan_payankar_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 2700;BA.debugLine="StartActivity(payankar_activity)";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("pan_setting_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3300);
if (RapidSub.canDelegate("pan_setting_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_setting_click");}
 BA.debugLineNum = 3300;BA.debugLine="Private Sub pan_setting_Click";
Debug.ShouldStop(8);
 BA.debugLineNum = 3301;BA.debugLine="StartActivity(setting_activity)";
Debug.ShouldStop(16);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((main.mostCurrent._setting_activity.getObject())));
 BA.debugLineNum = 3302;BA.debugLine="Activity.Finish";
Debug.ShouldStop(32);
main.mostCurrent._activity.runVoidMethod ("Finish");
...
try {
		Debug.PushSubsStack("pan_shift_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3313);
if (RapidSub.canDelegate("pan_shift_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_shift_click");}
 BA.debugLineNum = 3313;BA.debugLine="Private Sub pan_shift_Click";
Debug.ShouldStop(65536);
 BA.debugLineNum = 3314;BA.debugLine="StartActivity(shift_activity)";
Debug.ShouldStop(131072);
...
try {
		Debug.PushSubsStack("pan_taghvim_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3318);
if (RapidSub.canDelegate("pan_taghvim_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","pan_taghvim_click");}
 BA.debugLineNum = 3318;BA.debugLine="Private Sub pan_taghvim_Click";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 3319;BA.debugLine="pan_shift_Click";
Debug.ShouldStop(4194304);
_pan_shift_click();
...
try {
		Debug.PushSubsStack("Panel1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3331);
if (RapidSub.canDelegate("panel1_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","panel1_click");}
 BA.debugLineNum = 3331;BA.debugLine="Private Sub Panel1_Click";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("Panel10_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3655);
if (RapidSub.canDelegate("panel10_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","panel10_click");}
 BA.debugLineNum = 3655;BA.debugLine="Private Sub Panel10_Click";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("Panel4_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1733);
if (RapidSub.canDelegate("panel4_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","panel4_click");}
 BA.debugLineNum = 1733;BA.debugLine="Private Sub Panel4_Click";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("Panel5_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3279);
if (RapidSub.canDelegate("panel5_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","panel5_click");}
 BA.debugLineNum = 3279;BA.debugLine="Private Sub Panel5_Click";
Debug.ShouldStop(16384);
...
try {
		Debug.PushSubsStack("Panel6_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3573);
if (RapidSub.canDelegate("panel6_click")) { return ir.taravatgroup.ezafekari2.main.remoteMe.runUserSub(false, "main","panel6_click");}
 BA.debugLineNum = 3573;BA.debugLine="Private Sub Panel6_Click";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("pik_day_bala1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2574);
...
RemoteObject _int1 = RemoteObject.createImmutable(0);
 BA.debugLineNum = 2574;BA.debugLine="Private Sub pik_day_bala1_Click";
Debug.ShouldStop(8192);
 BA.debugLineNum = 2575;BA.debugLine="Dim int1 As Int=myfunc.fa2en(pik_day1.Text)";
Debug.ShouldStop(16384);
_int1 = BA.numberCast(int.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_day1.runMethod(true,"getText"))));Debug.locals.put("int1", _int1);Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2576;BA.debugLine="pik_day1.Text=int1+1";
Debug.ShouldStop(32768);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.solve(new RemoteObject[] {_int1,RemoteObject.createImmutable(1)}, "+",1, 1)));
 BA.debugLineNum = 2579;BA.debugLine="If(pik_moon1.Tag<7)Then";
Debug.ShouldStop(262144);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_moon1.runMethod(false,"getTag")),BA.numberCast(double.class, 7)))) { 
 BA.debugLineNum = 2580;BA.debugLine="If(pik_day1.Text>31)Then";
Debug.ShouldStop(524288);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_day1.runMethod(true,"getText")),BA.numberCast(double.class, 31)))) { 
 BA.debugLineNum = 2581;BA.debugLine="pik_day1.Text=1";
Debug.ShouldStop(1048576);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(1));
 };
 BA.debugLineNum = 2583;BA.debugLine="If(pik_day1.Text<1)Then";
Debug.ShouldStop(4194304);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_day1.runMethod(true,"getText")),BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 2584;BA.debugLine="pik_day1.Text=31";
Debug.ShouldStop(8388608);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(31));
 };
 }else {
 BA.debugLineNum = 2587;BA.debugLine="If(pik_day1.Text>30)Then";
Debug.ShouldStop(67108864);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_day1.runMethod(true,"getText")),BA.numberCast(double.class, 30)))) { 
 BA.debugLineNum = 2588;BA.debugLine="pik_day1.Text=1";
Debug.ShouldStop(134217728);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(1));
 };
 BA.debugLineNum = 2590;BA.debugLine="If(pik_day1.Text<1)Then";
Debug.ShouldStop(536870912);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_day1.runMethod(true,"getText")),BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 2591;BA.debugLine="pik_day1.Text=30";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("pik_day_paeen1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2597);
...
RemoteObject _int1 = RemoteObject.createImmutable(0);
 BA.debugLineNum = 2597;BA.debugLine="Private Sub pik_day_paeen1_Click";
Debug.ShouldStop(16);
 BA.debugLineNum = 2598;BA.debugLine="Dim int1 As Int=myfunc.fa2en(pik_day1.Text)";
Debug.ShouldStop(32);
_int1 = BA.numberCast(int.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_day1.runMethod(true,"getText"))));Debug.locals.put("int1", _int1);Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2599;BA.debugLine="pik_day1.Text=int1-1";
Debug.ShouldStop(64);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.solve(new RemoteObject[] {_int1,RemoteObject.createImmutable(1)}, "-",1, 1)));
 BA.debugLineNum = 2600;BA.debugLine="If(pik_moon1.Tag<7)Then";
Debug.ShouldStop(128);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_moon1.runMethod(false,"getTag")),BA.numberCast(double.class, 7)))) { 
 BA.debugLineNum = 2601;BA.debugLine="If(pik_day1.Text>31)Then";
Debug.ShouldStop(256);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_day1.runMethod(true,"getText")),BA.numberCast(double.class, 31)))) { 
 BA.debugLineNum = 2602;BA.debugLine="pik_day1.Text=1";
Debug.ShouldStop(512);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(1));
 };
 BA.debugLineNum = 2604;BA.debugLine="If(pik_day1.Text<1)Then";
Debug.ShouldStop(2048);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_day1.runMethod(true,"getText")),BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 2605;BA.debugLine="pik_day1.Text=31";
Debug.ShouldStop(4096);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(31));
 };
 }else {
 BA.debugLineNum = 2608;BA.debugLine="If(pik_day1.Text>30)Then";
Debug.ShouldStop(32768);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_day1.runMethod(true,"getText")),BA.numberCast(double.class, 30)))) { 
 BA.debugLineNum = 2609;BA.debugLine="pik_day1.Text=1";
Debug.ShouldStop(65536);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(1));
 };
 BA.debugLineNum = 2611;BA.debugLine="If(pik_day1.Text<1)Then";
Debug.ShouldStop(262144);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_day1.runMethod(true,"getText")),BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 2612;BA.debugLine="pik_day1.Text=30";
Debug.ShouldStop(524288);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(30));
 };
 };
...
try {
		Debug.PushSubsStack("pik_hour_bala1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2293);
...
RemoteObject _int1 = RemoteObject.createImmutable(0);
 BA.debugLineNum = 2293;BA.debugLine="Private Sub pik_hour_bala1_Click";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 2295;BA.debugLine="Dim int1 As Int=myfunc.fa2en(pik_hour1.Text)";
Debug.ShouldStop(4194304);
_int1 = BA.numberCast(int.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_hour1.runMethod(true,"getText"))));Debug.locals.put("int1", _int1);Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2296;BA.debugLine="pik_hour1.Text=int1+1";
Debug.ShouldStop(8388608);
main.mostCurrent._pik_hour1.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.solve(new RemoteObject[] {_int1,RemoteObject.createImmutable(1)}, "+",1, 1)));
 BA.debugLineNum = 2298;BA.debugLine="If(pik_hour1.Text>23)Then";
Debug.ShouldStop(33554432);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_hour1.runMethod(true,"getText")),BA.numberCast(double.class, 23)))) { 
 BA.debugLineNum = 2299;BA.debugLine="pik_hour1.Text=00";
Debug.ShouldStop(67108864);
main.mostCurrent._pik_hour1.runMethod(true,"setText",BA.ObjectToCharSequence(00));
 };
 BA.debugLineNum = 2301;BA.debugLine="If(pik_hour1.Text<0)Then";
Debug.ShouldStop(268435456);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_hour1.runMethod(true,"getText")),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 2302;BA.debugLine="pik_hour1.Text=23";
Debug.ShouldStop(536870912);
...
try {
		Debug.PushSubsStack("pik_hour_paeen1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2307);
...
RemoteObject _int1 = RemoteObject.createImmutable(0);
 BA.debugLineNum = 2307;BA.debugLine="Private Sub pik_hour_paeen1_Click";
Debug.ShouldStop(4);
 BA.debugLineNum = 2308;BA.debugLine="Dim int1 As Int=myfunc.fa2en(pik_hour1.Text)";
Debug.ShouldStop(8);
_int1 = BA.numberCast(int.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_hour1.runMethod(true,"getText"))));Debug.locals.put("int1", _int1);Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2309;BA.debugLine="pik_hour1.Text=int1-1";
Debug.ShouldStop(16);
main.mostCurrent._pik_hour1.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.solve(new RemoteObject[] {_int1,RemoteObject.createImmutable(1)}, "-",1, 1)));
 BA.debugLineNum = 2311;BA.debugLine="If(pik_hour1.Text>23)Then";
Debug.ShouldStop(64);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_hour1.runMethod(true,"getText")),BA.numberCast(double.class, 23)))) { 
 BA.debugLineNum = 2312;BA.debugLine="pik_hour1.Text=00";
Debug.ShouldStop(128);
main.mostCurrent._pik_hour1.runMethod(true,"setText",BA.ObjectToCharSequence(00));
 };
 BA.debugLineNum = 2314;BA.debugLine="If(pik_hour1.Text<0)Then";
Debug.ShouldStop(512);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_hour1.runMethod(true,"getText")),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 2315;BA.debugLine="pik_hour1.Text=23";
Debug.ShouldStop(1024);
main.mostCurrent._pik_hour1.runMethod(true,"setText",BA.ObjectToCharSequence(23));
 };
...
try {
		Debug.PushSubsStack("pik_min_bala1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2320);
...
RemoteObject _int1 = RemoteObject.createImmutable(0);
 BA.debugLineNum = 2320;BA.debugLine="Private Sub pik_min_bala1_Click";
Debug.ShouldStop(32768);
 BA.debugLineNum = 2321;BA.debugLine="Dim int1 As Int=myfunc.fa2en(pik_min1.Text)";
Debug.ShouldStop(65536);
_int1 = BA.numberCast(int.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_min1.runMethod(true,"getText"))));Debug.locals.put("int1", _int1);Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2322;BA.debugLine="pik_min1.Text=int1+1";
Debug.ShouldStop(131072);
main.mostCurrent._pik_min1.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.solve(new RemoteObject[] {_int1,RemoteObject.createImmutable(1)}, "+",1, 1)));
 BA.debugLineNum = 2324;BA.debugLine="If(pik_min1.Text>59)Then";
Debug.ShouldStop(524288);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_min1.runMethod(true,"getText")),BA.numberCast(double.class, 59)))) { 
 BA.debugLineNum = 2325;BA.debugLine="pik_min1.Text=00";
Debug.ShouldStop(1048576);
main.mostCurrent._pik_min1.runMethod(true,"setText",BA.ObjectToCharSequence(00));
 };
 BA.debugLineNum = 2327;BA.debugLine="If(pik_min1.Text<0)Then";
Debug.ShouldStop(4194304);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_min1.runMethod(true,"getText")),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 2328;BA.debugLine="pik_min1.Text=59";
Debug.ShouldStop(8388608);
...
try {
		Debug.PushSubsStack("pik_min_paeen1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2333);
...
RemoteObject _int1 = RemoteObject.createImmutable(0);
 BA.debugLineNum = 2333;BA.debugLine="Private Sub pik_min_paeen1_Click";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 2334;BA.debugLine="Dim int1 As Int=myfunc.fa2en(pik_min1.Text)";
Debug.ShouldStop(536870912);
_int1 = BA.numberCast(int.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_min1.runMethod(true,"getText"))));Debug.locals.put("int1", _int1);Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2335;BA.debugLine="pik_min1.Text=int1-1";
Debug.ShouldStop(1073741824);
main.mostCurrent._pik_min1.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.solve(new RemoteObject[] {_int1,RemoteObject.createImmutable(1)}, "-",1, 1)));
 BA.debugLineNum = 2337;BA.debugLine="If(pik_min1.Text>59)Then";
Debug.ShouldStop(1);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_min1.runMethod(true,"getText")),BA.numberCast(double.class, 59)))) { 
 BA.debugLineNum = 2338;BA.debugLine="pik_min1.Text=00";
Debug.ShouldStop(2);
main.mostCurrent._pik_min1.runMethod(true,"setText",BA.ObjectToCharSequence(00));
 };
 BA.debugLineNum = 2340;BA.debugLine="If(pik_min1.Text<0)Then";
Debug.ShouldStop(8);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_min1.runMethod(true,"getText")),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 2341;BA.debugLine="pik_min1.Text=59";
Debug.ShouldStop(16);
main.mostCurrent._pik_min1.runMethod(true,"setText",BA.ObjectToCharSequence(59));
 };
...
try {
		Debug.PushSubsStack("pik_moon_bala1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2520);
...
RemoteObject _int1 = RemoteObject.createImmutable(0);
 BA.debugLineNum = 2520;BA.debugLine="Private Sub pik_moon_bala1_Click";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 2521;BA.debugLine="Dim int1 As Int=myfunc.fa2en(pik_moon1.Tag)";
Debug.ShouldStop(16777216);
_int1 = BA.numberCast(int.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.ObjectToString(main.mostCurrent._pik_moon1.runMethod(false,"getTag")))));Debug.locals.put("int1", _int1);Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2522;BA.debugLine="pik_moon1.Tag=int1+1";
Debug.ShouldStop(33554432);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",(RemoteObject.solve(new RemoteObject[] {_int1,RemoteObject.createImmutable(1)}, "+",1, 1)));
 BA.debugLineNum = 2524;BA.debugLine="If(pik_moon1.Tag>12)Then";
Debug.ShouldStop(134217728);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_moon1.runMethod(false,"getTag")),BA.numberCast(double.class, 12)))) { 
 BA.debugLineNum = 2525;BA.debugLine="pik_moon1.Tag=1";
Debug.ShouldStop(268435456);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable((1)));
 };
 BA.debugLineNum = 2527;BA.debugLine="If(pik_moon1.Tag<1)Then";
Debug.ShouldStop(1073741824);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_moon1.runMethod(false,"getTag")),BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 2528;BA.debugLine="pik_moon1.Tag=12";
Debug.ShouldStop(-2147483648);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable((12)));
 };
 BA.debugLineNum = 2530;BA.debugLine="pik_moon1.Text=moon.Get(pik_moon1.Tag-1)";
Debug.ShouldStop(2);
main.mostCurrent._pik_moon1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._moon.runMethod(false,"Get",(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, main.mostCurrent._pik_moon1.runMethod(false,"getTag")),RemoteObject.createImmutable(1)}, "-",1, 0))))));
...
try {
		Debug.PushSubsStack("pik_moon_paeen1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2534);
...
RemoteObject _int1 = RemoteObject.createImmutable(0);
 BA.debugLineNum = 2534;BA.debugLine="Private Sub pik_moon_paeen1_Click";
Debug.ShouldStop(32);
 BA.debugLineNum = 2535;BA.debugLine="Dim int1 As Int=myfunc.fa2en(pik_moon1.Tag)";
Debug.ShouldStop(64);
_int1 = BA.numberCast(int.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.ObjectToString(main.mostCurrent._pik_moon1.runMethod(false,"getTag")))));Debug.locals.put("int1", _int1);Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2536;BA.debugLine="pik_moon1.Tag=int1-1";
Debug.ShouldStop(128);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",(RemoteObject.solve(new RemoteObject[] {_int1,RemoteObject.createImmutable(1)}, "-",1, 1)));
 BA.debugLineNum = 2538;BA.debugLine="If(pik_moon1.Tag>12)Then";
Debug.ShouldStop(512);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_moon1.runMethod(false,"getTag")),BA.numberCast(double.class, 12)))) { 
 BA.debugLineNum = 2539;BA.debugLine="pik_moon1.Tag=1";
Debug.ShouldStop(1024);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable((1)));
 };
 BA.debugLineNum = 2541;BA.debugLine="If(pik_moon1.Tag<1)Then";
Debug.ShouldStop(4096);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_moon1.runMethod(false,"getTag")),BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 2542;BA.debugLine="pik_moon1.Tag=12";
Debug.ShouldStop(8192);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable((12)));
 };
 BA.debugLineNum = 2544;BA.debugLine="pik_moon1.Text=moon.Get(myfunc.fa2en(pik_moon1.Ta";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("pik_pan_day1_Touch (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2480);
...
Debug.locals.put("X", _x);
Debug.locals.put("Y", _y);
 BA.debugLineNum = 2480;BA.debugLine="Private Sub pik_pan_day1_Touch (Action As Int, X A";
Debug.ShouldStop(32768);
 BA.debugLineNum = 2481;BA.debugLine="If(Action=1)Then";
Debug.ShouldStop(65536);
if ((RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 2482;BA.debugLine="Dim int1 As Int";
Debug.ShouldStop(131072);
_int1 = RemoteObject.createImmutable(0);Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2483;BA.debugLine="num=y";
Debug.ShouldStop(262144);
main._num = BA.numberCast(int.class, _y);
 };
 BA.debugLineNum = 2486;BA.debugLine="If(Action=2)Then";
Debug.ShouldStop(2097152);
if ((RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, 2)))) { 
 BA.debugLineNum = 2488;BA.debugLine="If(Y>num+20)Then";
Debug.ShouldStop(8388608);
if ((RemoteObject.solveBoolean(">",_y,BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {main._num,RemoteObject.createImmutable(20)}, "+",1, 1))))) { 
 BA.debugLineNum = 2489;BA.debugLine="int1=myfunc.fa2en(pik_day1.Text)-1";
Debug.ShouldStop(16777216);
_int1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_day1.runMethod(true,"getText")))),RemoteObject.createImmutable(1)}, "-",1, 0));Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2490;BA.debugLine="pik_day1.Text=int1";
Debug.ShouldStop(33554432);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(_int1));
 BA.debugLineNum = 2491;BA.debugLine="num=y";
Debug.ShouldStop(67108864);
main._num = BA.numberCast(int.class, _y);
 };
 BA.debugLineNum = 2493;BA.debugLine="If(Y<num-20)Then";
Debug.ShouldStop(268435456);
if ((RemoteObject.solveBoolean("<",_y,BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {main._num,RemoteObject.createImmutable(20)}, "-",1, 1))))) { 
 BA.debugLineNum = 2494;BA.debugLine="int1=myfunc.fa2en(pik_day1.Text)+1";
Debug.ShouldStop(536870912);
_int1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_day1.runMethod(true,"getText")))),RemoteObject.createImmutable(1)}, "+",1, 0));Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2495;BA.debugLine="pik_day1.Text=int1";
Debug.ShouldStop(1073741824);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(_int1));
 BA.debugLineNum = 2496;BA.debugLine="num=y";
Debug.ShouldStop(-2147483648);
main._num = BA.numberCast(int.class, _y);
 };
 BA.debugLineNum = 2499;BA.debugLine="If(pik_moon1.Tag<7)Then";
Debug.ShouldStop(4);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_moon1.runMethod(false,"getTag")),BA.numberCast(double.class, 7)))) { 
 BA.debugLineNum = 2500;BA.debugLine="If(pik_day1.Text>31)Then";
Debug.ShouldStop(8);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_day1.runMethod(true,"getText")),BA.numberCast(double.class, 31)))) { 
 BA.debugLineNum = 2501;BA.debugLine="pik_day1.Text=1";
Debug.ShouldStop(16);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(1));
 };
 BA.debugLineNum = 2503;BA.debugLine="If(pik_day1.Text<1)Then";
Debug.ShouldStop(64);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_day1.runMethod(true,"getText")),BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 2504;BA.debugLine="pik_day1.Text=31";
Debug.ShouldStop(128);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(31));
 };
 }else {
 BA.debugLineNum = 2507;BA.debugLine="If(pik_day1.Text>30)Then";
Debug.ShouldStop(1024);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_day1.runMethod(true,"getText")),BA.numberCast(double.class, 30)))) { 
 BA.debugLineNum = 2508;BA.debugLine="pik_day1.Text=1";
Debug.ShouldStop(2048);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(1));
 };
 BA.debugLineNum = 2510;BA.debugLine="If(pik_day1.Text<1)Then";
Debug.ShouldStop(8192);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_day1.runMethod(true,"getText")),BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 2511;BA.debugLine="pik_day1.Text=30";
Debug.ShouldStop(16384);
main.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(30));
 };
 };
...
try {
		Debug.PushSubsStack("pik_pan_hour1_Touch (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2346);
...
Debug.locals.put("X", _x);
Debug.locals.put("Y", _y);
 BA.debugLineNum = 2346;BA.debugLine="Private Sub pik_pan_hour1_Touch (Action As Int, X";
Debug.ShouldStop(512);
 BA.debugLineNum = 2347;BA.debugLine="If(Action=1)Then";
Debug.ShouldStop(1024);
if ((RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 2348;BA.debugLine="Dim int1 As Int";
Debug.ShouldStop(2048);
_int1 = RemoteObject.createImmutable(0);Debug.locals.put("int1", _int1);
...
main._num = BA.numberCast(int.class, _y);
 ...
 BA.debugLineNum = 2352;BA.debugLine="If(Action=2)Then";
Debug.ShouldStop(32768);
if ((RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, 2)))) { 
 BA.debugLineNum = 2354;BA.debugLine="If(Y>num+20)Then";
Debug.ShouldStop(131072);
if ((RemoteObject.solveBoolean(">",_y,BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {main._num,RemoteObject.createImmutable(20)}, "+",1, 1))))) { 
 BA.debugLineNum = 2355;BA.debugLine="int1=myfunc.fa2en(pik_hour1.Text)-1";
Debug.ShouldStop(262144);
_int1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_hour1.runMethod(true,"getText")))),RemoteObject.createImmutable(1)}, "-",1, 0));Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2356;BA.debugLine="pik_hour1.Text=int1";
Debug.ShouldStop(524288);
main.mostCurrent._pik_hour1.runMethod(true,"setText",BA.ObjectToCharSequence(_int1));
 BA.debugLineNum = 2357;BA.debugLine="num=y";
Debug.ShouldStop(1048576);
main._num = BA.numberCast(int.class, _y);
 };
 BA.debugLineNum = 2359;BA.debugLine="If(Y<num-20)Then";
Debug.ShouldStop(4194304);
if ((RemoteObject.solveBoolean("<",_y,BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {main._num,RemoteObject.createImmutable(20)}, "-",1, 1))))) { 
 BA.debugLineNum = 2360;BA.debugLine="int1=myfunc.fa2en(pik_hour1.Text)+1";
Debug.ShouldStop(8388608);
_int1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_hour1.runMethod(true,"getText")))),RemoteObject.createImmutable(1)}, "+",1, 0));Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2361;BA.debugLine="pik_hour1.Text=int1";
Debug.ShouldStop(16777216);
main.mostCurrent._pik_hour1.runMethod(true,"setText",BA.ObjectToCharSequence(_int1));
 BA.debugLineNum = 2362;BA.debugLine="num=y";
Debug.ShouldStop(33554432);
main._num = BA.numberCast(int.class, _y);
 };
 BA.debugLineNum = 2365;BA.debugLine="If(pik_hour1.Text>23)Then";
Debug.ShouldStop(268435456);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_hour1.runMethod(true,"getText")),BA.numberCast(double.class, 23)))) { 
 BA.debugLineNum = 2366;BA.debugLine="pik_hour1.Text=00";
Debug.ShouldStop(536870912);
main.mostCurrent._pik_hour1.runMethod(true,"setText",BA.ObjectToCharSequence(00));
 };
 BA.debugLineNum = 2368;BA.debugLine="If(pik_hour1.Text<0)Then";
Debug.ShouldStop(-2147483648);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_hour1.runMethod(true,"getText")),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 2369;BA.debugLine="pik_hour1.Text=23";
Debug.ShouldStop(1);
main.mostCurrent._pik_hour1.runMethod(true,"setText",BA.ObjectToCharSequence(23));
 };
 };
...
try {
		Debug.PushSubsStack("pik_pan_min1_Touch (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2376);
...
Debug.locals.put("X", _x);
Debug.locals.put("Y", _y);
 BA.debugLineNum = 2376;BA.debugLine="Private Sub pik_pan_min1_Touch (Action As Int, X A";
Debug.ShouldStop(128);
 BA.debugLineNum = 2377;BA.debugLine="If(Action=1)Then";
Debug.ShouldStop(256);
if ((RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 2378;BA.debugLine="Dim int1 As Int";
Debug.ShouldStop(512);
_int1 = RemoteObject.createImmutable(0);Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2379;BA.debugLine="num=y";
Debug.ShouldStop(1024);
main._num = BA.numberCast(int.class, _y);
 };
 BA.debugLineNum = 2382;BA.debugLine="If(Action=2)Then";
Debug.ShouldStop(8192);
if ((RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, 2)))) { 
 BA.debugLineNum = 2384;BA.debugLine="If(Y>num+20)Then";
Debug.ShouldStop(32768);
if ((RemoteObject.solveBoolean(">",_y,BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {main._num,RemoteObject.createImmutable(20)}, "+",1, 1))))) { 
 BA.debugLineNum = 2386;BA.debugLine="int1=myfunc.fa2en(pik_min1.Text)-1";
Debug.ShouldStop(131072);
_int1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_min1.runMethod(true,"getText")))),RemoteObject.createImmutable(1)}, "-",1, 0));Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2387;BA.debugLine="pik_min1.Text=int1";
Debug.ShouldStop(262144);
main.mostCurrent._pik_min1.runMethod(true,"setText",BA.ObjectToCharSequence(_int1));
 BA.debugLineNum = 2390;BA.debugLine="num=y";
Debug.ShouldStop(2097152);
main._num = BA.numberCast(int.class, _y);
 };
 BA.debugLineNum = 2392;BA.debugLine="If(Y<num-20)Then";
Debug.ShouldStop(8388608);
if ((RemoteObject.solveBoolean("<",_y,BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {main._num,RemoteObject.createImmutable(20)}, "-",1, 1))))) { 
 BA.debugLineNum = 2394;BA.debugLine="int1=myfunc.fa2en(pik_min1.Text)+1";
Debug.ShouldStop(33554432);
_int1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_min1.runMethod(true,"getText")))),RemoteObject.createImmutable(1)}, "+",1, 0));Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2395;BA.debugLine="pik_min1.Text=int1";
Debug.ShouldStop(67108864);
main.mostCurrent._pik_min1.runMethod(true,"setText",BA.ObjectToCharSequence(_int1));
...
main._num = BA.numberCast(int.class, _y);
 ...
 BA.debugLineNum = 2402;BA.debugLine="If(pik_min1.Text>59)Then";
Debug.ShouldStop(2);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_min1.runMethod(true,"getText")),BA.numberCast(double.class, 59)))) { 
 BA.debugLineNum = 2403;BA.debugLine="pik_min1.Text=00";
Debug.ShouldStop(4);
main.mostCurrent._pik_min1.runMethod(true,"setText",BA.ObjectToCharSequence(00));
 };
 BA.debugLineNum = 2406;BA.debugLine="If(pik_min1.Text<0)Then";
Debug.ShouldStop(32);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_min1.runMethod(true,"getText")),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 2407;BA.debugLine="pik_min1.Text=59";
Debug.ShouldStop(64);
main.mostCurrent._pik_min1.runMethod(true,"setText",BA.ObjectToCharSequence(59));
 };
 };
...
try {
		Debug.PushSubsStack("pik_pan_moon1_Touch (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2420);
...
Debug.locals.put("X", _x);
Debug.locals.put("Y", _y);
 BA.debugLineNum = 2420;BA.debugLine="Private Sub pik_pan_moon1_Touch (Action As Int, X";
Debug.ShouldStop(524288);
 BA.debugLineNum = 2421;BA.debugLine="If(Action=1)Then";
Debug.ShouldStop(1048576);
if ((RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 2422;BA.debugLine="Dim int1 As Int";
Debug.ShouldStop(2097152);
_int1 = RemoteObject.createImmutable(0);Debug.locals.put("int1", _int1);
...
main._num = BA.numberCast(int.class, _y);
 ...
 BA.debugLineNum = 2426;BA.debugLine="If(Action=2)Then";
Debug.ShouldStop(33554432);
if ((RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, 2)))) { 
 BA.debugLineNum = 2428;BA.debugLine="If(Y>num+20)Then";
Debug.ShouldStop(134217728);
if ((RemoteObject.solveBoolean(">",_y,BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {main._num,RemoteObject.createImmutable(20)}, "+",1, 1))))) { 
 BA.debugLineNum = 2429;BA.debugLine="int1=myfunc.fa2en(pik_moon1.Tag)-1";
Debug.ShouldStop(268435456);
_int1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.ObjectToString(main.mostCurrent._pik_moon1.runMethod(false,"getTag"))))),RemoteObject.createImmutable(1)}, "-",1, 0));Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2430;BA.debugLine="pik_moon1.Tag=int1";
Debug.ShouldStop(536870912);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",(_int1));
 BA.debugLineNum = 2431;BA.debugLine="num=y";
Debug.ShouldStop(1073741824);
main._num = BA.numberCast(int.class, _y);
 };
 BA.debugLineNum = 2433;BA.debugLine="If(Y<num-20)Then";
Debug.ShouldStop(1);
if ((RemoteObject.solveBoolean("<",_y,BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {main._num,RemoteObject.createImmutable(20)}, "-",1, 1))))) { 
 BA.debugLineNum = 2434;BA.debugLine="int1=myfunc.fa2en(pik_moon1.Tag)+1";
Debug.ShouldStop(2);
_int1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.ObjectToString(main.mostCurrent._pik_moon1.runMethod(false,"getTag"))))),RemoteObject.createImmutable(1)}, "+",1, 0));Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2435;BA.debugLine="pik_moon1.Tag=int1";
Debug.ShouldStop(4);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",(_int1));
 BA.debugLineNum = 2436;BA.debugLine="num=y";
Debug.ShouldStop(8);
main._num = BA.numberCast(int.class, _y);
 };
 BA.debugLineNum = 2439;BA.debugLine="If(pik_moon1.Tag>12)Then";
Debug.ShouldStop(64);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_moon1.runMethod(false,"getTag")),BA.numberCast(double.class, 12)))) { 
 BA.debugLineNum = 2440;BA.debugLine="pik_moon1.Tag=1";
Debug.ShouldStop(128);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable((1)));
 };
 BA.debugLineNum = 2442;BA.debugLine="If(pik_moon1.Tag<1)Then";
Debug.ShouldStop(512);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_moon1.runMethod(false,"getTag")),BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 2443;BA.debugLine="pik_moon1.Tag=12";
Debug.ShouldStop(1024);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable((12)));
 };
 BA.debugLineNum = 2445;BA.debugLine="pik_moon1.Text=moon.Get(pik_moon1.Tag-1)";
Debug.ShouldStop(4096);
main.mostCurrent._pik_moon1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._moon.runMethod(false,"Get",(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, main.mostCurrent._pik_moon1.runMethod(false,"getTag")),RemoteObject.createImmutable(1)}, "-",1, 0))))));
 };
...
try {
		Debug.PushSubsStack("pik_pan_year1_Touch (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2450);
...
Debug.locals.put("X", _x);
Debug.locals.put("Y", _y);
 BA.debugLineNum = 2450;BA.debugLine="Private Sub pik_pan_year1_Touch (Action As Int, X";
Debug.ShouldStop(131072);
 BA.debugLineNum = 2451;BA.debugLine="If(Action=1)Then";
Debug.ShouldStop(262144);
if ((RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 2452;BA.debugLine="Dim int1 As Int";
Debug.ShouldStop(524288);
_int1 = RemoteObject.createImmutable(0);Debug.locals.put("int1", _int1);
...
main._num = BA.numberCast(int.class, _y);
 ...
 BA.debugLineNum = 2456;BA.debugLine="If(Action=2)Then";
Debug.ShouldStop(8388608);
if ((RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, 2)))) { 
 BA.debugLineNum = 2458;BA.debugLine="If(Y>num+20)Then";
Debug.ShouldStop(33554432);
if ((RemoteObject.solveBoolean(">",_y,BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {main._num,RemoteObject.createImmutable(20)}, "+",1, 1))))) { 
 BA.debugLineNum = 2459;BA.debugLine="int1=myfunc.fa2en(pik_year1.Text)-1";
Debug.ShouldStop(67108864);
_int1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_year1.runMethod(true,"getText")))),RemoteObject.createImmutable(1)}, "-",1, 0));Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2460;BA.debugLine="pik_year1.Text=int1";
Debug.ShouldStop(134217728);
main.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(_int1));
 BA.debugLineNum = 2461;BA.debugLine="num=y";
Debug.ShouldStop(268435456);
main._num = BA.numberCast(int.class, _y);
 };
 BA.debugLineNum = 2463;BA.debugLine="If(Y<num-20)Then";
Debug.ShouldStop(1073741824);
if ((RemoteObject.solveBoolean("<",_y,BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {main._num,RemoteObject.createImmutable(20)}, "-",1, 1))))) { 
 BA.debugLineNum = 2464;BA.debugLine="int1=myfunc.fa2en(pik_year1.Text)+1";
Debug.ShouldStop(-2147483648);
_int1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_year1.runMethod(true,"getText")))),RemoteObject.createImmutable(1)}, "+",1, 0));Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2465;BA.debugLine="pik_year1.Text=int1";
Debug.ShouldStop(1);
main.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(_int1));
 BA.debugLineNum = 2466;BA.debugLine="num=y";
Debug.ShouldStop(2);
main._num = BA.numberCast(int.class, _y);
 };
 BA.debugLineNum = 2469;BA.debugLine="If(pik_year1.Text>1410)Then";
Debug.ShouldStop(16);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_year1.runMethod(true,"getText")),BA.numberCast(double.class, 1410)))) { 
 BA.debugLineNum = 2470;BA.debugLine="pik_year1.Text=1390";
Debug.ShouldStop(32);
main.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(1390));
 };
 BA.debugLineNum = 2472;BA.debugLine="If(pik_year1.Text<1390)Then";
Debug.ShouldStop(128);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_year1.runMethod(true,"getText")),BA.numberCast(double.class, 1390)))) { 
 BA.debugLineNum = 2473;BA.debugLine="pik_year1.Text=1410";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("pik_year_bala1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2548);
...
RemoteObject _int1 = RemoteObject.createImmutable(0);
 BA.debugLineNum = 2548;BA.debugLine="Private Sub pik_year_bala1_Click";
Debug.ShouldStop(524288);
 BA.debugLineNum = 2549;BA.debugLine="Dim int1 As Int=myfunc.fa2en(pik_year1.Text)";
Debug.ShouldStop(1048576);
_int1 = BA.numberCast(int.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_year1.runMethod(true,"getText"))));Debug.locals.put("int1", _int1);Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2550;BA.debugLine="pik_year1.Text=int1+1";
Debug.ShouldStop(2097152);
main.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.solve(new RemoteObject[] {_int1,RemoteObject.createImmutable(1)}, "+",1, 1)));
 BA.debugLineNum = 2552;BA.debugLine="If(pik_year1.Text>1410)Then";
Debug.ShouldStop(8388608);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_year1.runMethod(true,"getText")),BA.numberCast(double.class, 1410)))) { 
 BA.debugLineNum = 2553;BA.debugLine="pik_year1.Text=1390";
Debug.ShouldStop(16777216);
main.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(1390));
 };
 BA.debugLineNum = 2555;BA.debugLine="If(pik_year1.Text<1390)Then";
Debug.ShouldStop(67108864);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_year1.runMethod(true,"getText")),BA.numberCast(double.class, 1390)))) { 
 BA.debugLineNum = 2556;BA.debugLine="pik_year1.Text=1410";
Debug.ShouldStop(134217728);
main.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(1410));
 };
...
try {
		Debug.PushSubsStack("pik_year_paeen1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2561);
...
RemoteObject _int1 = RemoteObject.createImmutable(0);
 BA.debugLineNum = 2561;BA.debugLine="Private Sub pik_year_paeen1_Click";
Debug.ShouldStop(1);
 BA.debugLineNum = 2562;BA.debugLine="Dim int1 As Int=myfunc.fa2en(pik_year1.Text)";
Debug.ShouldStop(2);
_int1 = BA.numberCast(int.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._pik_year1.runMethod(true,"getText"))));Debug.locals.put("int1", _int1);Debug.locals.put("int1", _int1);
 BA.debugLineNum = 2563;BA.debugLine="pik_year1.Text=int1-1";
Debug.ShouldStop(4);
main.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.solve(new RemoteObject[] {_int1,RemoteObject.createImmutable(1)}, "-",1, 1)));
 BA.debugLineNum = 2565;BA.debugLine="If(pik_year1.Text>1410)Then";
Debug.ShouldStop(16);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, main.mostCurrent._pik_year1.runMethod(true,"getText")),BA.numberCast(double.class, 1410)))) { 
 BA.debugLineNum = 2566;BA.debugLine="pik_year1.Text=1390";
Debug.ShouldStop(32);
main.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(1390));
 };
 BA.debugLineNum = 2568;BA.debugLine="If(pik_year1.Text<1390)Then";
Debug.ShouldStop(128);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, main.mostCurrent._pik_year1.runMethod(true,"getText")),BA.numberCast(double.class, 1390)))) { 
 BA.debugLineNum = 2569;BA.debugLine="pik_year1.Text=1410";
Debug.ShouldStop(256);
main.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(1410));
 };
...
try {
		Debug.PushSubsStack("sp_moon_ItemClick (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2661);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 2661;BA.debugLine="Private Sub sp_moon_ItemClick (Position As Int, Va";
Debug.ShouldStop(16);
 BA.debugLineNum = 2662;BA.debugLine="Dim moon_num As String";
Debug.ShouldStop(32);
main._moon_num = RemoteObject.createImmutable("");
 BA.debugLineNum = 2663;BA.debugLine="Select sp_moon.SelectedIndex";
Debug.ShouldStop(64);
...
case 0: {
 BA.debugLineNum = 2665;BA.debugLine="moon_num=\"01\"";
Debug.ShouldStop(256);
main._moon_num = BA.ObjectToString("01");
 break; }
case 1: {
 BA.debugLineNum = 2667;BA.debugLine="moon_num=\"02\"";
Debug.ShouldStop(1024);
main._moon_num = BA.ObjectToString("02");
 break; }
case 2: {
 BA.debugLineNum = 2669;BA.debugLine="moon_num=\"03\"";
Debug.ShouldStop(4096);
main._moon_num = BA.ObjectToString("03");
 break; }
case 3: {
 BA.debugLineNum = 2671;BA.debugLine="moon_num=\"04\"";
Debug.ShouldStop(16384);
main._moon_num = BA.ObjectToString("04");
 break; }
case 4: {
 BA.debugLineNum = 2673;BA.debugLine="moon_num=\"05\"";
Debug.ShouldStop(65536);
main._moon_num = BA.ObjectToString("05");
 break; }
case 5: {
 BA.debugLineNum = 2675;BA.debugLine="moon_num=\"06\"";
Debug.ShouldStop(262144);
main._moon_num = BA.ObjectToString("06");
 break; }
case 6: {
 BA.debugLineNum = 2677;BA.debugLine="moon_num=\"07\"";
Debug.ShouldStop(1048576);
main._moon_num = BA.ObjectToString("07");
 break; }
case 7: {
 BA.debugLineNum = 2679;BA.debugLine="moon_num=\"08\"";
Debug.ShouldStop(4194304);
main._moon_num = BA.ObjectToString("08");
 break; }
case 8: {
 BA.debugLineNum = 2681;BA.debugLine="moon_num=\"09\"";
Debug.ShouldStop(16777216);
main._moon_num = BA.ObjectToString("09");
 break; }
case 9: {
 BA.debugLineNum = 2683;BA.debugLine="moon_num=\"10\"";
Debug.ShouldStop(67108864);
main._moon_num = BA.ObjectToString("10");
 break; }
case 10: {
 BA.debugLineNum = 2685;BA.debugLine="moon_num=\"11\"";
Debug.ShouldStop(268435456);
main._moon_num = BA.ObjectToString("11");
 break; }
case 11: {
 BA.debugLineNum = 2687;BA.debugLine="moon_num=\"12\"";
Debug.ShouldStop(1073741824);
main._moon_num = BA.ObjectToString("12");
 break; }
}
;
 BA.debugLineNum = 2690;BA.debugLine="fill_lists(sp_year.SelectedItem,moon_num)";
Debug.ShouldStop(2);
_fill_lists(main.mostCurrent._sp_year.runMethod(true,"getSelectedItem"),main._moon_num);
 BA.debugLineNum = 2691;BA.debugLine="TabHost1_TabChanged";
Debug.ShouldStop(4);
_tabhost1_tabchanged();
...
try {
		Debug.PushSubsStack("sp_year_gozaresh_ItemClick (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3335);
...
Debug.locals.put("Position", _position);
Debug.locals.put("Value", _value);
 BA.debugLineNum = 3335;BA.debugLine="Private Sub sp_year_gozaresh_ItemClick (Position A";
Debug.ShouldStop(64);
 BA.debugLineNum = 3336;BA.debugLine="fill_list_gozareshat(sp_year_gozaresh.SelectedIte";
Debug.ShouldStop(128);
_fill_list_gozareshat(main.mostCurrent._sp_year_gozaresh.runMethod(true,"getSelectedItem"));
...
try {
		Debug.PushSubsStack("sp_year_ItemClick (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2623);
...
Debug.locals.put("Position", _position);
Debug.locals.put("Value", _value);
 BA.debugLineNum = 2623;BA.debugLine="Private Sub sp_year_ItemClick (Position As Int, Va";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 2628;BA.debugLine="Dim moon_num As String";
Debug.ShouldStop(8);
main._moon_num = RemoteObject.createImmutable("");
 BA.debugLineNum = 2629;BA.debugLine="Select sp_moon.SelectedIndex";
Debug.ShouldStop(16);
switch (BA.switchObjectToInt(main.mostCurrent._sp_moon.runMethod(true,"getSelectedIndex"),BA.numberCast(int.class, 0),BA.numberCast(int.class, 1),BA.numberCast(int.class, 2),BA.numberCast(int.class, 3),BA.numberCast(int.class, 4),BA.numberCast(int.class, 5),BA.numberCast(int.class, 6),BA.numberCast(int.class, 7),BA.numberCast(int.class, 8),BA.numberCast(int.class, 9),BA.numberCast(int.class, 10),BA.numberCast(int.class, 11))) {
case 0: {
 BA.debugLineNum = 2631;BA.debugLine="moon_num=\"01\"";
Debug.ShouldStop(64);
main._moon_num = BA.ObjectToString("01");
 break; }
case 1: {
 BA.debugLineNum = 2633;BA.debugLine="moon_num=\"02\"";
Debug.ShouldStop(256);
main._moon_num = BA.ObjectToString("02");
 break; }
case 2: {
 BA.debugLineNum = 2635;BA.debugLine="moon_num=\"03\"";
Debug.ShouldStop(1024);
main._moon_num = BA.ObjectToString("03");
 break; }
case 3: {
 BA.debugLineNum = 2637;BA.debugLine="moon_num=\"04\"";
Debug.ShouldStop(4096);
main._moon_num = BA.ObjectToString("04");
 break; }
case 4: {
 BA.debugLineNum = 2639;BA.debugLine="moon_num=\"05\"";
Debug.ShouldStop(16384);
main._moon_num = BA.ObjectToString("05");
 break; }
case 5: {
 BA.debugLineNum = 2641;BA.debugLine="moon_num=\"06\"";
Debug.ShouldStop(65536);
main._moon_num = BA.ObjectToString("06");
 break; }
case 6: {
 BA.debugLineNum = 2643;BA.debugLine="moon_num=\"07\"";
Debug.ShouldStop(262144);
main._moon_num = BA.ObjectToString("07");
 break; }
case 7: {
 BA.debugLineNum = 2645;BA.debugLine="moon_num=\"08\"";
Debug.ShouldStop(1048576);
main._moon_num = BA.ObjectToString("08");
 break; }
case 8: {
 BA.debugLineNum = 2647;BA.debugLine="moon_num=\"09\"";
Debug.ShouldStop(4194304);
main._moon_num = BA.ObjectToString("09");
 break; }
case 9: {
 BA.debugLineNum = 2649;BA.debugLine="moon_num=\"10\"";
Debug.ShouldStop(16777216);
main._moon_num = BA.ObjectToString("10");
 break; }
case 10: {
 BA.debugLineNum = 2651;BA.debugLine="moon_num=\"11\"";
Debug.ShouldStop(67108864);
main._moon_num = BA.ObjectToString("11");
 break; }
case 11: {
 BA.debugLineNum = 2653;BA.debugLine="moon_num=\"12\"";
Debug.ShouldStop(268435456);
main._moon_num = BA.ObjectToString("12");
 break; }
}
;
 BA.debugLineNum = 2655;BA.debugLine="fill_lists(sp_year.SelectedItem,moon_num)";
Debug.ShouldStop(1073741824);
_fill_lists(main.mostCurrent._sp_year.runMethod(true,"getSelectedItem"),main._moon_num);
 BA.debugLineNum = 2657;BA.debugLine="TabHost1_TabChanged";
Debug.ShouldStop(1);
_tabhost1_tabchanged();
...
try {
		Debug.PushSubsStack("tim_vorod_conv_ezaf (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,3577);
...
Debug.locals.put("tim1", _tim1);
 BA.debugLineNum = 3577;BA.debugLine="Sub tim_vorod_conv_ezaf (tim1 As String) As Int";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 3579;BA.debugLine="Dim ste_tim() As String";
Debug.ShouldStop(67108864);
_ste_tim = RemoteObject.createNewArray ("String", new int[] {0}, new Object[]{});Debug.locals.put("ste_tim", _ste_tim);
 BA.debugLineNum = 3580;BA.debugLine="ste_tim=Regex.Split(\":\",tim1)";
Debug.ShouldStop(134217728);
_ste_tim = main.mostCurrent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(_tim1));Debug.locals.put("ste_tim", _ste_tim);
 BA.debugLineNum = 3583;BA.debugLine="Return (ste_tim(0)*60)+ste_tim(1) +saat_kar_min";
Debug.ShouldStop(1073741824);
if (true) return BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, _ste_tim.getArrayElement(true,BA.numberCast(int.class, 0))),RemoteObject.createImmutable(60)}, "*",0, 0)),BA.numberCast(double.class, _ste_tim.getArrayElement(true,BA.numberCast(int.class, 1))),main._saat_kar_min}, "++",2, 0));
 BA.debugLineNum = 3586;BA.debugLine="End Sub";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("time_show (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2041);
...
RemoteObject _str_show = RemoteObject.declareNull("anywheresoftware.b4a.keywords.StringBuilderWrapper");
 BA.debugLineNum = 2041;BA.debugLine="Sub time_show";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 2043;BA.debugLine="Try";
Debug.ShouldStop(67108864);
try { BA.debugLineNum = 2046;BA.debugLine="Dim list_date_per1 , list_date_per2 As List";
Debug.ShouldStop(536870912);
...
_list_date_per2 = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("list_date_per2", _list_date_per2);
 BA.debugLineNum = 2047;BA.debugLine="Dim list_date_miladi1 ,list_date_miladi2 As List";
Debug.ShouldStop(1073741824);
...
_list_date_miladi2 = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("list_date_miladi2", _list_date_miladi2);
 BA.debugLineNum = 2048;BA.debugLine="Dim dat_mil_2 As String";
Debug.ShouldStop(-2147483648);
_dat_mil_2 = RemoteObject.createImmutable("");Debug.locals.put("dat_mil_2", _dat_mil_2);
 BA.debugLineNum = 2049;BA.debugLine="Dim dat_mil_1 As String";
Debug.ShouldStop(1);
_dat_mil_1 = RemoteObject.createImmutable("");Debug.locals.put("dat_mil_1", _dat_mil_1);
 BA.debugLineNum = 2051;BA.debugLine="list_date_per1.Initialize";
Debug.ShouldStop(4);
_list_date_per1.runVoidMethod ("Initialize");
 BA.debugLineNum = 2052;BA.debugLine="list_date_per2.Initialize";
Debug.ShouldStop(8);
_list_date_per2.runVoidMethod ("Initialize");
 BA.debugLineNum = 2053;BA.debugLine="list_date_miladi1.Initialize";
Debug.ShouldStop(16);
_list_date_miladi1.runVoidMethod ("Initialize");
 BA.debugLineNum = 2054;BA.debugLine="list_date_miladi1.Initialize";
Debug.ShouldStop(32);
_list_date_miladi1.runVoidMethod ("Initialize");
 BA.debugLineNum = 2056;BA.debugLine="Select pik_moon1.Tag";
Debug.ShouldStop(128);
switch (BA.switchObjectToInt(main.mostCurrent._pik_moon1.runMethod(false,"getTag"),RemoteObject.createImmutable((1)),RemoteObject.createImmutable((2)),RemoteObject.createImmutable((3)),RemoteObject.createImmutable((4)),RemoteObject.createImmutable((5)),RemoteObject.createImmutable((6)),RemoteObject.createImmutable((7)),RemoteObject.createImmutable((8)),RemoteObject.createImmutable((9)),RemoteObject.createImmutable((10)),RemoteObject.createImmutable((11)),RemoteObject.createImmutable((12)))) {
case 0: {
 BA.debugLineNum = 2058;BA.debugLine="pik_moon1.Tag=\"01\"";
Debug.ShouldStop(512);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("01")));
 break; }
case 1: {
 BA.debugLineNum = 2060;BA.debugLine="pik_moon1.Tag=\"02\"";
Debug.ShouldStop(2048);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("02")));
 break; }
case 2: {
 BA.debugLineNum = 2062;BA.debugLine="pik_moon1.Tag=\"03\"";
Debug.ShouldStop(8192);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("03")));
 break; }
case 3: {
 BA.debugLineNum = 2064;BA.debugLine="pik_moon1.Tag=\"04\"";
Debug.ShouldStop(32768);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("04")));
 break; }
case 4: {
 BA.debugLineNum = 2066;BA.debugLine="pik_moon1.Tag=\"05\"";
Debug.ShouldStop(131072);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("05")));
 break; }
case 5: {
 BA.debugLineNum = 2068;BA.debugLine="pik_moon1.Tag=\"06\"";
Debug.ShouldStop(524288);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("06")));
 break; }
case 6: {
 BA.debugLineNum = 2070;BA.debugLine="pik_moon1.Tag=\"07\"";
Debug.ShouldStop(2097152);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("07")));
 break; }
case 7: {
 BA.debugLineNum = 2072;BA.debugLine="pik_moon1.Tag=\"08\"";
Debug.ShouldStop(8388608);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("08")));
 break; }
case 8: {
 BA.debugLineNum = 2074;BA.debugLine="pik_moon1.Tag=\"09\"";
Debug.ShouldStop(33554432);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("09")));
 break; }
case 9: {
 BA.debugLineNum = 2076;BA.debugLine="pik_moon1.Tag=\"10\"";
Debug.ShouldStop(134217728);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("10")));
 break; }
case 10: {
 BA.debugLineNum = 2078;BA.debugLine="pik_moon1.Tag=\"11\"";
Debug.ShouldStop(536870912);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("11")));
 break; }
case 11: {
...
;
 BA.debugLineNum = 2086;BA.debugLine="date1=lbl_date1.Text";
Debug.ShouldStop(32);
main.mostCurrent._date1 = main.mostCurrent._lbl_date1.runMethod(true,"getText");
 BA.debugLineNum = 2087;BA.debugLine="date2=lbl_date2.Text";
Debug.ShouldStop(64);
main.mostCurrent._date2 = main.mostCurrent._lbl_date2.runMethod(true,"getText");
 BA.debugLineNum = 2088;BA.debugLine="list_date_per1=strfun.Split(date1,\"/\")";
Debug.ShouldStop(128);
_list_date_per1 = main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(main.mostCurrent._date1),(Object)(RemoteObject.createImmutable("/")));Debug.locals.put("list_date_per1", _list_date_per1);
 BA.debugLineNum = 2089;BA.debugLine="list_date_per2=strfun.Split(date2,\"/\")";
Debug.ShouldStop(256);
_list_date_per2 = main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(main.mostCurrent._date2),(Object)(RemoteObject.createImmutable("/")));Debug.locals.put("list_date_per2", _list_date_per2);
 BA.debugLineNum = 2093;BA.debugLine="dat_mil_2=persianDate.PersianToGregorian(list_dat";
Debug.ShouldStop(4096);
_dat_mil_2 = main._persiandate.runMethod(true,"PersianToGregorian",(Object)(BA.numberCast(int.class, _list_date_per2.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))))),(Object)(BA.numberCast(int.class, _list_date_per2.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1))))),(Object)(BA.numberCast(int.class, _list_date_per2.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 2))))));Debug.locals.put("dat_mil_2", _dat_mil_2);
 BA.debugLineNum = 2094;BA.debugLine="dat_mil_1=persianDate.PersianToGregorian(list_dat";
Debug.ShouldStop(8192);
_dat_mil_1 = main._persiandate.runMethod(true,"PersianToGregorian",(Object)(BA.numberCast(int.class, _list_date_per1.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))))),(Object)(BA.numberCast(int.class, _list_date_per1.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1))))),(Object)(BA.numberCast(int.class, _list_date_per1.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 2))))));Debug.locals.put("dat_mil_1", _dat_mil_1);
 BA.debugLineNum = 2097;BA.debugLine="list_date_miladi1=strfun.Split(dat_mil_1,\"/\")";
Debug.ShouldStop(65536);
_list_date_miladi1 = main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(_dat_mil_1),(Object)(RemoteObject.createImmutable("/")));Debug.locals.put("list_date_miladi1", _list_date_miladi1);
 BA.debugLineNum = 2098;BA.debugLine="list_date_miladi2=strfun.Split(dat_mil_2,\"/\")";
Debug.ShouldStop(131072);
_list_date_miladi2 = main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(_dat_mil_2),(Object)(RemoteObject.createImmutable("/")));Debug.locals.put("list_date_miladi2", _list_date_miladi2);
 BA.debugLineNum = 2101;BA.debugLine="Dim date_end1 ,date_end2 As String";
Debug.ShouldStop(1048576);
...
_date_end2 = RemoteObject.createImmutable("");Debug.locals.put("date_end2", _date_end2);
 BA.debugLineNum = 2102;BA.debugLine="Dim time_end1 ,time_end2 As String";
Debug.ShouldStop(2097152);
...
_time_end2 = RemoteObject.createImmutable("");Debug.locals.put("time_end2", _time_end2);
 BA.debugLineNum = 2104;BA.debugLine="date_end2=list_date_miladi2.Get(1)&\"/\"&list_date_";
Debug.ShouldStop(8388608);
_date_end2 = RemoteObject.concat(_list_date_miladi2.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1))),RemoteObject.createImmutable("/"),_list_date_miladi2.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 2))),RemoteObject.createImmutable("/"),_list_date_miladi2.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("date_end2", _date_end2);
 BA.debugLineNum = 2105;BA.debugLine="date_end1=list_date_miladi1.Get(1)&\"/\"&list_date_";
Debug.ShouldStop(16777216);
_date_end1 = RemoteObject.concat(_list_date_miladi1.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1))),RemoteObject.createImmutable("/"),_list_date_miladi1.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 2))),RemoteObject.createImmutable("/"),_list_date_miladi1.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("date_end1", _date_end1);
 BA.debugLineNum = 2107;BA.debugLine="time_end2=lbl_tim2.Text&\":00\"";
Debug.ShouldStop(67108864);
_time_end2 = RemoteObject.concat(main.mostCurrent._lbl_tim2.runMethod(true,"getText"),RemoteObject.createImmutable(":00"));Debug.locals.put("time_end2", _time_end2);
 BA.debugLineNum = 2108;BA.debugLine="time_end1=lbl_tim1.Text&\":00\"";
Debug.ShouldStop(134217728);
_time_end1 = RemoteObject.concat(main.mostCurrent._lbl_tim1.runMethod(true,"getText"),RemoteObject.createImmutable(":00"));Debug.locals.put("time_end1", _time_end1);
 BA.debugLineNum = 2110;BA.debugLine="Dim tim1_long As Long";
Debug.ShouldStop(536870912);
_tim1_long = RemoteObject.createImmutable(0L);Debug.locals.put("tim1_long", _tim1_long);
 BA.debugLineNum = 2111;BA.debugLine="Dim tim2_long As Long";
Debug.ShouldStop(1073741824);
_tim2_long = RemoteObject.createImmutable(0L);Debug.locals.put("tim2_long", _tim2_long);
 BA.debugLineNum = 2112;BA.debugLine="tim1_long=DateTime.DateTimeParse(myfunc.fa2en(da";
Debug.ShouldStop(-2147483648);
_tim1_long = main.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"DateTimeParse",(Object)(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(_date_end1))),(Object)(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(_time_end1))));Debug.locals.put("tim1_long", _tim1_long);
 BA.debugLineNum = 2113;BA.debugLine="tim2_long=DateTime.DateTimeParse(myfunc.fa2en(da";
Debug.ShouldStop(1);
_tim2_long = main.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"DateTimeParse",(Object)(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(_date_end2))),(Object)(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(_time_end2))));Debug.locals.put("tim2_long", _tim2_long);
 BA.debugLineNum = 2117;BA.debugLine="Dim period_between As Period";
Debug.ShouldStop(16);
_period_between = RemoteObject.createNew ("b4a.example.dateutils._period");Debug.locals.put("period_between", _period_between);
 BA.debugLineNum = 2118;BA.debugLine="period_between=DateUtils.PeriodBetween(myfunc.fa";
Debug.ShouldStop(32);
_period_between = main.mostCurrent._dateutils.runMethod(false,"_periodbetween",main.mostCurrent.activityBA,(Object)(BA.numberCast(long.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.NumberToString(_tim1_long))))),(Object)(BA.numberCast(long.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.NumberToString(_tim2_long))))));Debug.locals.put("period_between", _period_between);
 BA.debugLineNum = 2121;BA.debugLine="Dim str_show As StringBuilder";
Debug.ShouldStop(256);
_str_show = RemoteObject.createNew ("anywheresoftware.b4a.keywords.StringBuilderWrapper");Debug.locals.put("str_show", _str_show);
 BA.debugLineNum = 2122;BA.debugLine="str_show.Initialize";
Debug.ShouldStop(512);
_str_show.runVoidMethod ("Initialize");
 BA.debugLineNum = 2124;BA.debugLine="If (period_between.Years<>0)Then";
Debug.ShouldStop(2048);
if ((RemoteObject.solveBoolean("!",_period_between.getField(true,"Years"),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 2125;BA.debugLine="str_show.Append(period_between.Years&\" سال \").A";
Debug.ShouldStop(4096);
_str_show.runMethod(false,"Append",(Object)(RemoteObject.concat(_period_between.getField(true,"Years"),RemoteObject.createImmutable(" سال ")))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable(" و ")));
 ...
 BA.debugLineNum = 2127;BA.debugLine="If (period_between.Months<>0)Then";
Debug.ShouldStop(16384);
if ((RemoteObject.solveBoolean("!",_period_between.getField(true,"Months"),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 2128;BA.debugLine="str_show.Append(period_between.Months&\" ماه \").";
Debug.ShouldStop(32768);
_str_show.runMethod(false,"Append",(Object)(RemoteObject.concat(_period_between.getField(true,"Months"),RemoteObject.createImmutable(" ماه ")))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable(" و ")));
 ...
 BA.debugLineNum = 2130;BA.debugLine="If (period_between.Days<>0)Then";
Debug.ShouldStop(131072);
if ((RemoteObject.solveBoolean("!",_period_between.getField(true,"Days"),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 2131;BA.debugLine="str_show.Append(period_between.Days&\" روز \").Ap";
Debug.ShouldStop(262144);
_str_show.runMethod(false,"Append",(Object)(RemoteObject.concat(_period_between.getField(true,"Days"),RemoteObject.createImmutable(" روز ")))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable(" و ")));
 ...
 BA.debugLineNum = 2134;BA.debugLine="str_show.Append(period_between.Hours&\" ساعت \").A";
Debug.ShouldStop(2097152);
_str_show.runMethod(false,"Append",(Object)(RemoteObject.concat(_period_between.getField(true,"Hours"),RemoteObject.createImmutable(" ساعت ")))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable(" و ")));
 BA.debugLineNum = 2135;BA.debugLine="str_show.Append(period_between.Minutes&\" دقیقه \"";
Debug.ShouldStop(4194304);
_str_show.runVoidMethod ("Append",(Object)(RemoteObject.concat(_period_between.getField(true,"Minutes"),RemoteObject.createImmutable(" دقیقه "))));
 BA.debugLineNum = 2138;BA.debugLine="year_bt=period_between.Years";
Debug.ShouldStop(33554432);
main._year_bt = _period_between.getField(true,"Years");
 BA.debugLineNum = 2139;BA.debugLine="moon_bt=period_between.Months";
Debug.ShouldStop(67108864);
main._moon_bt = _period_between.getField(true,"Months");
 BA.debugLineNum = 2140;BA.debugLine="day_bt=period_between.Days";
Debug.ShouldStop(134217728);
main._day_bt = _period_between.getField(true,"Days");
 BA.debugLineNum = 2141;BA.debugLine="hour_bt=period_between.Hours";
Debug.ShouldStop(268435456);
main._hour_bt = _period_between.getField(true,"Hours");
 BA.debugLineNum = 2142;BA.debugLine="min_bt=period_between.Minutes";
Debug.ShouldStop(536870912);
main._min_bt = _period_between.getField(true,"Minutes");
 BA.debugLineNum = 2145;BA.debugLine="lbl_time_show.Text=str_show";
Debug.ShouldStop(1);
main.mostCurrent._lbl_time_show.runMethod(true,"setText",BA.ObjectToCharSequence(_str_show.getObject()));
 BA.debugLineNum = 2146;BA.debugLine="If(index_box=3)Then";
Debug.ShouldStop(2);
if ((RemoteObject.solveBoolean("=",main._index_box,BA.numberCast(double.class, 3)))) { 
 BA.debugLineNum = 2148;BA.debugLine="tim_min=(hour_bt*60)+min_bt";
Debug.ShouldStop(8);
main._tim_min = RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {main._hour_bt,RemoteObject.createImmutable(60)}, "*",0, 1)),main._min_bt}, "+",1, 1);
 BA.debugLineNum = 2152;BA.debugLine="If(tim_min>saat_kar_min) Then";
Debug.ShouldStop(128);
if ((RemoteObject.solveBoolean(">",main._tim_min,BA.numberCast(double.class, main._saat_kar_min)))) { 
 BA.debugLineNum = 2153;BA.debugLine="ckb_ezaf_taradod.Enabled=True";
Debug.ShouldStop(256);
main.mostCurrent._ckb_ezaf_taradod.runMethod(true,"setEnabled",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 2157;BA.debugLine="lbl_ezaf_taradod.Text=\"افزودن به اضافه کاری \"&";
Debug.ShouldStop(4096);
main.mostCurrent._lbl_ezaf_taradod.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("افزودن به اضافه کاری "),(main.mostCurrent._myfunc.runMethod(false,"_min_to_saatminroz" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(RemoteObject.solve(new RemoteObject[] {main._tim_min,main._saat_kar_min}, "-",1, 1))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)))),RemoteObject.createImmutable(" ساعت و "),main.mostCurrent._myfunc.runMethod(false,"_min_to_saatminroz" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(RemoteObject.solve(new RemoteObject[] {main._tim_min,main._saat_kar_min}, "-",1, 1))).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1))),RemoteObject.createImmutable(" دقیقه "))));
 ...
 BA.debugLineNum = 2161;BA.debugLine="lbl_ezaf_taradod.Text=\"\"";
Debug.ShouldStop(65536);
main.mostCurrent._lbl_ezaf_taradod.runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 2162;BA.debugLine="ckb_ezaf_taradod.Enabled=False";
Debug.ShouldStop(131072);
main.mostCurrent._ckb_ezaf_taradod.runMethod(true,"setEnabled",main.mostCurrent.__c.getField(true,"False"));
 };
 };
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e86.toString()); BA.debugLineNum = 2170;BA.debugLine="ToastMessageShow(\"خطا\",False)";
Debug.ShouldStop(33554432);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("خطا")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 };
...
try {
		Debug.PushSubsStack("time_show2 (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2176);
...
Debug.locals.put("tim2", _tim2);
 BA.debugLineNum = 2176;BA.debugLine="Sub time_show2 (dat1 As String,dat2 As String, tim";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 2178;BA.debugLine="Try";
Debug.ShouldStop(2);
try { BA.debugLineNum = 2181;BA.debugLine="Dim list_date_per1 , list_date_per2 As List";
Debug.ShouldStop(16);
_list_date_per1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("list_date_per1", _list_date_per1);
_list_date_per2 = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("list_date_per2", _list_date_per2);
 BA.debugLineNum = 2182;BA.debugLine="Dim list_date_miladi1 ,list_date_miladi2 As List";
Debug.ShouldStop(32);
_list_date_miladi1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("list_date_miladi1", _list_date_miladi1);
_list_date_miladi2 = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("list_date_miladi2", _list_date_miladi2);
 BA.debugLineNum = 2183;BA.debugLine="Dim dat_mil_2 As String";
Debug.ShouldStop(64);
_dat_mil_2 = RemoteObject.createImmutable("");Debug.locals.put("dat_mil_2", _dat_mil_2);
 BA.debugLineNum = 2184;BA.debugLine="Dim dat_mil_1 As String";
Debug.ShouldStop(128);
_dat_mil_1 = RemoteObject.createImmutable("");Debug.locals.put("dat_mil_1", _dat_mil_1);
 BA.debugLineNum = 2186;BA.debugLine="list_date_per1.Initialize";
Debug.ShouldStop(512);
_list_date_per1.runVoidMethod ("Initialize");
 BA.debugLineNum = 2187;BA.debugLine="list_date_per2.Initialize";
Debug.ShouldStop(1024);
_list_date_per2.runVoidMethod ("Initialize");
 BA.debugLineNum = 2188;BA.debugLine="list_date_miladi1.Initialize";
Debug.ShouldStop(2048);
_list_date_miladi1.runVoidMethod ("Initialize");
 BA.debugLineNum = 2189;BA.debugLine="list_date_miladi1.Initialize";
Debug.ShouldStop(4096);
_list_date_miladi1.runVoidMethod ("Initialize");
 BA.debugLineNum = 2191;BA.debugLine="Select pik_moon1.Tag";
Debug.ShouldStop(16384);
switch (BA.switchObjectToInt(main.mostCurrent._pik_moon1.runMethod(false,"getTag"),RemoteObject.createImmutable((1)),RemoteObject.createImmutable((2)),RemoteObject.createImmutable((3)),RemoteObject.createImmutable((4)),RemoteObject.createImmutable((5)),RemoteObject.createImmutable((6)),RemoteObject.createImmutable((7)),RemoteObject.createImmutable((8)),RemoteObject.createImmutable((9)),RemoteObject.createImmutable((10)),RemoteObject.createImmutable((11)),RemoteObject.createImmutable((12)))) {
case 0: {
 BA.debugLineNum = 2193;BA.debugLine="pik_moon1.Tag=\"01\"";
Debug.ShouldStop(65536);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("01")));
 break; }
case 1: {
 BA.debugLineNum = 2195;BA.debugLine="pik_moon1.Tag=\"02\"";
Debug.ShouldStop(262144);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("02")));
 break; }
case 2: {
 BA.debugLineNum = 2197;BA.debugLine="pik_moon1.Tag=\"03\"";
Debug.ShouldStop(1048576);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("03")));
 break; }
case 3: {
 BA.debugLineNum = 2199;BA.debugLine="pik_moon1.Tag=\"04\"";
Debug.ShouldStop(4194304);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("04")));
 break; }
case 4: {
 BA.debugLineNum = 2201;BA.debugLine="pik_moon1.Tag=\"05\"";
Debug.ShouldStop(16777216);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("05")));
 break; }
case 5: {
 BA.debugLineNum = 2203;BA.debugLine="pik_moon1.Tag=\"06\"";
Debug.ShouldStop(67108864);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("06")));
 break; }
case 6: {
 BA.debugLineNum = 2205;BA.debugLine="pik_moon1.Tag=\"07\"";
Debug.ShouldStop(268435456);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("07")));
 break; }
case 7: {
 BA.debugLineNum = 2207;BA.debugLine="pik_moon1.Tag=\"08\"";
Debug.ShouldStop(1073741824);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("08")));
 break; }
case 8: {
 BA.debugLineNum = 2209;BA.debugLine="pik_moon1.Tag=\"09\"";
Debug.ShouldStop(1);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("09")));
 break; }
case 9: {
 BA.debugLineNum = 2211;BA.debugLine="pik_moon1.Tag=\"10\"";
Debug.ShouldStop(4);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("10")));
 break; }
case 10: {
 BA.debugLineNum = 2213;BA.debugLine="pik_moon1.Tag=\"11\"";
Debug.ShouldStop(16);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("11")));
 break; }
case 11: {
 BA.debugLineNum = 2215;BA.debugLine="pik_moon1.Tag=\"12\"";
Debug.ShouldStop(64);
main.mostCurrent._pik_moon1.runMethod(false,"setTag",RemoteObject.createImmutable(("12")));
 break; }
}
;
 BA.debugLineNum = 2221;BA.debugLine="date1=dat1";
Debug.ShouldStop(4096);
main.mostCurrent._date1 = _dat1;
 BA.debugLineNum = 2222;BA.debugLine="date2=dat2";
Debug.ShouldStop(8192);
main.mostCurrent._date2 = _dat2;
 BA.debugLineNum = 2223;BA.debugLine="list_date_per1=strfun.Split(date1,\"/\")";
Debug.ShouldStop(16384);
_list_date_per1 = main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(main.mostCurrent._date1),(Object)(RemoteObject.createImmutable("/")));Debug.locals.put("list_date_per1", _list_date_per1);
 BA.debugLineNum = 2224;BA.debugLine="list_date_per2=strfun.Split(date2,\"/\")";
Debug.ShouldStop(32768);
_list_date_per2 = main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(main.mostCurrent._date2),(Object)(RemoteObject.createImmutable("/")));Debug.locals.put("list_date_per2", _list_date_per2);
 BA.debugLineNum = 2228;BA.debugLine="dat_mil_2=persianDate.PersianToGregorian(list_dat";
Debug.ShouldStop(524288);
_dat_mil_2 = main._persiandate.runMethod(true,"PersianToGregorian",(Object)(BA.numberCast(int.class, _list_date_per2.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))))),(Object)(BA.numberCast(int.class, _list_date_per2.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1))))),(Object)(BA.numberCast(int.class, _list_date_per2.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 2))))));Debug.locals.put("dat_mil_2", _dat_mil_2);
 BA.debugLineNum = 2229;BA.debugLine="dat_mil_1=persianDate.PersianToGregorian(list_dat";
Debug.ShouldStop(1048576);
_dat_mil_1 = main._persiandate.runMethod(true,"PersianToGregorian",(Object)(BA.numberCast(int.class, _list_date_per1.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))))),(Object)(BA.numberCast(int.class, _list_date_per1.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1))))),(Object)(BA.numberCast(int.class, _list_date_per1.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 2))))));Debug.locals.put("dat_mil_1", _dat_mil_1);
 BA.debugLineNum = 2232;BA.debugLine="list_date_miladi1=strfun.Split(dat_mil_1,\"/\")";
Debug.ShouldStop(8388608);
_list_date_miladi1 = main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(_dat_mil_1),(Object)(RemoteObject.createImmutable("/")));Debug.locals.put("list_date_miladi1", _list_date_miladi1);
 BA.debugLineNum = 2233;BA.debugLine="list_date_miladi2=strfun.Split(dat_mil_2,\"/\")";
Debug.ShouldStop(16777216);
_list_date_miladi2 = main.mostCurrent._strfun.runMethod(false,"_vvvvvv5",(Object)(_dat_mil_2),(Object)(RemoteObject.createImmutable("/")));Debug.locals.put("list_date_miladi2", _list_date_miladi2);
 BA.debugLineNum = 2236;BA.debugLine="Dim date_end1 ,date_end2 As String";
Debug.ShouldStop(134217728);
_date_end1 = RemoteObject.createImmutable("");Debug.locals.put("date_end1", _date_end1);
_date_end2 = RemoteObject.createImmutable("");Debug.locals.put("date_end2", _date_end2);
 BA.debugLineNum = 2237;BA.debugLine="Dim time_end1 ,time_end2 As String";
Debug.ShouldStop(268435456);
_time_end1 = RemoteObject.createImmutable("");Debug.locals.put("time_end1", _time_end1);
_time_end2 = RemoteObject.createImmutable("");Debug.locals.put("time_end2", _time_end2);
 BA.debugLineNum = 2239;BA.debugLine="date_end2=list_date_miladi2.Get(1)&\"/\"&list_date_";
Debug.ShouldStop(1073741824);
_date_end2 = RemoteObject.concat(_list_date_miladi2.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1))),RemoteObject.createImmutable("/"),_list_date_miladi2.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 2))),RemoteObject.createImmutable("/"),_list_date_miladi2.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("date_end2", _date_end2);
 BA.debugLineNum = 2240;BA.debugLine="date_end1=list_date_miladi1.Get(1)&\"/\"&list_date_";
Debug.ShouldStop(-2147483648);
_date_end1 = RemoteObject.concat(_list_date_miladi1.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 1))),RemoteObject.createImmutable("/"),_list_date_miladi1.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 2))),RemoteObject.createImmutable("/"),_list_date_miladi1.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("date_end1", _date_end1);
 BA.debugLineNum = 2242;BA.debugLine="time_end2=tim2&\":00\"";
Debug.ShouldStop(2);
_time_end2 = RemoteObject.concat(_tim2,RemoteObject.createImmutable(":00"));Debug.locals.put("time_end2", _time_end2);
 BA.debugLineNum = 2243;BA.debugLine="time_end1=tim1&\":00\"";
Debug.ShouldStop(4);
_time_end1 = RemoteObject.concat(_tim1,RemoteObject.createImmutable(":00"));Debug.locals.put("time_end1", _time_end1);
 BA.debugLineNum = 2245;BA.debugLine="Dim tim1_long As Long";
Debug.ShouldStop(16);
_tim1_long = RemoteObject.createImmutable(0L);Debug.locals.put("tim1_long", _tim1_long);
 BA.debugLineNum = 2246;BA.debugLine="Dim tim2_long As Long";
Debug.ShouldStop(32);
_tim2_long = RemoteObject.createImmutable(0L);Debug.locals.put("tim2_long", _tim2_long);
 BA.debugLineNum = 2247;BA.debugLine="tim1_long=DateTime.DateTimeParse(myfunc.fa2en(da";
Debug.ShouldStop(64);
_tim1_long = main.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"DateTimeParse",(Object)(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(_date_end1))),(Object)(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(_time_end1))));Debug.locals.put("tim1_long", _tim1_long);
 BA.debugLineNum = 2248;BA.debugLine="tim2_long=DateTime.DateTimeParse(myfunc.fa2en(da";
Debug.ShouldStop(128);
_tim2_long = main.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"DateTimeParse",(Object)(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(_date_end2))),(Object)(main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(_time_end2))));Debug.locals.put("tim2_long", _tim2_long);
 BA.debugLineNum = 2252;BA.debugLine="Dim period_between As Period";
Debug.ShouldStop(2048);
_period_between = RemoteObject.createNew ("b4a.example.dateutils._period");Debug.locals.put("period_between", _period_between);
 BA.debugLineNum = 2253;BA.debugLine="period_between=DateUtils.PeriodBetween(myfunc.fa";
Debug.ShouldStop(4096);
_period_between = main.mostCurrent._dateutils.runMethod(false,"_periodbetween",main.mostCurrent.activityBA,(Object)(BA.numberCast(long.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.NumberToString(_tim1_long))))),(Object)(BA.numberCast(long.class, main.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(BA.NumberToString(_tim2_long))))));Debug.locals.put("period_between", _period_between);
 BA.debugLineNum = 2256;BA.debugLine="Dim str_show As StringBuilder";
Debug.ShouldStop(32768);
_str_show = RemoteObject.createNew ("anywheresoftware.b4a.keywords.StringBuilderWrapper");Debug.locals.put("str_show", _str_show);
 BA.debugLineNum = 2257;BA.debugLine="str_show.Initialize";
Debug.ShouldStop(65536);
_str_show.runVoidMethod ("Initialize");
 BA.debugLineNum = 2259;BA.debugLine="If (period_between.Years<>0)Then";
Debug.ShouldStop(262144);
if ((RemoteObject.solveBoolean("!",_period_between.getField(true,"Years"),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 2260;BA.debugLine="str_show.Append(period_between.Years&\" سال \").A";
Debug.ShouldStop(524288);
_str_show.runMethod(false,"Append",(Object)(RemoteObject.concat(_period_between.getField(true,"Years"),RemoteObject.createImmutable(" سال ")))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable(" و ")));
 };
 BA.debugLineNum = 2262;BA.debugLine="If (period_between.Months<>0)Then";
Debug.ShouldStop(2097152);
if ((RemoteObject.solveBoolean("!",_period_between.getField(true,"Months"),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 2263;BA.debugLine="str_show.Append(period_between.Months&\" ماه \").";
Debug.ShouldStop(4194304);
_str_show.runMethod(false,"Append",(Object)(RemoteObject.concat(_period_between.getField(true,"Months"),RemoteObject.createImmutable(" ماه ")))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable(" و ")));
 };
 BA.debugLineNum = 2265;BA.debugLine="If (period_between.Days<>0)Then";
Debug.ShouldStop(16777216);
if ((RemoteObject.solveBoolean("!",_period_between.getField(true,"Days"),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 2266;BA.debugLine="str_show.Append(period_between.Days&\" روز \").Ap";
Debug.ShouldStop(33554432);
_str_show.runMethod(false,"Append",(Object)(RemoteObject.concat(_period_between.getField(true,"Days"),RemoteObject.createImmutable(" روز ")))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable(" و ")));
 };
 BA.debugLineNum = 2269;BA.debugLine="str_show.Append(period_between.Hours&\" ساعت \").A";
Debug.ShouldStop(268435456);
_str_show.runMethod(false,"Append",(Object)(RemoteObject.concat(_period_between.getField(true,"Hours"),RemoteObject.createImmutable(" ساعت ")))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable(" و ")));
 BA.debugLineNum = 2270;BA.debugLine="str_show.Append(period_between.Minutes&\" دقیقه \"";
Debug.ShouldStop(536870912);
_str_show.runVoidMethod ("Append",(Object)(RemoteObject.concat(_period_between.getField(true,"Minutes"),RemoteObject.createImmutable(" دقیقه "))));
 BA.debugLineNum = 2273;BA.debugLine="year_bt=period_between.Years";
Debug.ShouldStop(1);
main._year_bt = _period_between.getField(true,"Years");
 BA.debugLineNum = 2274;BA.debugLine="moon_bt=period_between.Months";
Debug.ShouldStop(2);
main._moon_bt = _period_between.getField(true,"Months");
 BA.debugLineNum = 2275;BA.debugLine="day_bt=period_between.Days";
Debug.ShouldStop(4);
main._day_bt = _period_between.getField(true,"Days");
 BA.debugLineNum = 2276;BA.debugLine="hour_bt=period_between.Hours";
Debug.ShouldStop(8);
main._hour_bt = _period_between.getField(true,"Hours");
 BA.debugLineNum = 2277;BA.debugLine="min_bt=period_between.Minutes";
Debug.ShouldStop(16);
main._min_bt = _period_between.getField(true,"Minutes");
 BA.debugLineNum = 2280;BA.debugLine="lbl_time_show_FT.Text=str_show";
Debug.ShouldStop(128);
main.mostCurrent._lbl_time_show_ft.runMethod(true,"setText",BA.ObjectToCharSequence(_str_show.getObject()));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e76) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e76.toString()); BA.debugLineNum = 2283;BA.debugLine="ToastMessageShow(\"خطا\",False)";
Debug.ShouldStop(1024);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("خطا")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 };
...
Debug.ShouldStop(256);
main.mostCurrent.__c.runVoidMethod ("LogImpl","1852009",BA.ObjectToString(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA)),0);
 };
 };
 };
 }else {
