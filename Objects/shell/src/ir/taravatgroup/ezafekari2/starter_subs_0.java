...
try {
		Debug.PushSubsStack("Application_Error (starter) ","starter",23,starter.processBA,starter.mostCurrent,43);
...
try {
		Debug.PushSubsStack("Service_Create (starter) ","starter",23,starter.processBA,starter.mostCurrent,12);
...
try {
		Debug.PushSubsStack("Service_Destroy (starter) ","starter",23,starter.processBA,starter.mostCurrent,47);
...
try {
		Debug.PushSubsStack("Service_Start (starter) ","starter",23,starter.processBA,starter.mostCurrent,18);
...
try {
		Debug.PushSubsStack("Service_TaskRemoved (starter) ","starter",23,starter.processBA,starter.mostCurrent,38);
