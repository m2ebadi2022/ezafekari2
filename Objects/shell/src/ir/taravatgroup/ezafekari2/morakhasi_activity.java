...
public static RemoteObject _lbl_mande_ta_inendmah = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static ir.taravatgroup.ezafekari2.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",morakhasi_activity.mostCurrent._activity,"bime_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.bime_activity.class),"calc_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.calc_activity.class),"chk_manfi",morakhasi_activity.mostCurrent._chk_manfi,"comment_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.comment_activity.class),"darsad_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.darsad_activity.class),"DateUtils",morakhasi_activity.mostCurrent._dateutils,"dbCode",Debug.moduleToString(ir.taravatgroup.ezafekari2.dbcode.class),"eidi_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.eidi_activity.class),"et_mande_d",morakhasi_activity.mostCurrent._et_mande_d,"et_mande_h",morakhasi_activity.mostCurrent._et_mande_h,"et_mande_m",morakhasi_activity.mostCurrent._et_mande_m,"fast_run_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.fast_run_activity.class),"ganon_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.ganon_activity.class),"hogog_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.hogog_activity.class),"HttpUtils2Service",Debug.moduleToString(ir.taravatgroup.ezafekari2.httputils2service.class),"index_box_edit",morakhasi_activity._index_box_edit,"info_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.info_activity.class),"lbl_box_edit",morakhasi_activity.mostCurrent._lbl_box_edit,"lbl_estehgag_darMah",morakhasi_activity.mostCurrent._lbl_estehgag_darmah,"lbl_help_mandeh",morakhasi_activity.mostCurrent._lbl_help_mandeh,"lbl_mah",morakhasi_activity.mostCurrent._lbl_mah,"lbl_mande_show",morakhasi_activity.mostCurrent._lbl_mande_show,"lbl_mande_ta_emroz",morakhasi_activity.mostCurrent._lbl_mande_ta_emroz,"lbl_mande_ta_inEndMah",morakhasi_activity.mostCurrent._lbl_mande_ta_inendmah,"lbl_morakhasi_baHogog",morakhasi_activity.mostCurrent._lbl_morakhasi_bahogog,"lbl_morakhasi_BiHogog",morakhasi_activity.mostCurrent._lbl_morakhasi_bihogog,"lbl_morakhasi_estehgag",morakhasi_activity.mostCurrent._lbl_morakhasi_estehgag,"lbl_morakhasi_estelaj",morakhasi_activity.mostCurrent._lbl_morakhasi_estelaj,"Main",Debug.moduleToString(ir.taravatgroup.ezafekari2.main.class),"mande_d",morakhasi_activity._mande_d,"mande_h",morakhasi_activity._mande_h,"mande_m",morakhasi_activity._mande_m,"morakhasi_estefade_esteh",morakhasi_activity._morakhasi_estefade_esteh,"morkasiDarMah_d",morakhasi_activity._morkasidarmah_d,"morkasiDarMah_h",morakhasi_activity._morkasidarmah_h,"morkasiDarMah_m",morakhasi_activity._morkasidarmah_m,"myfunc",Debug.moduleToString(ir.taravatgroup.ezafekari2.myfunc.class),"pan_all_morakhasi",morakhasi_activity.mostCurrent._pan_all_morakhasi,"pan_hed_mandeMorakh",morakhasi_activity.mostCurrent._pan_hed_mandemorakh,"payankar_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.payankar_activity.class),"ScrollView1",morakhasi_activity.mostCurrent._scrollview1,"setting_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.setting_activity.class),"setting_hogog_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.setting_hogog_activity.class),"shift_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.shift_activity.class),"show_gozaresh_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.show_gozaresh_activity.class),"Starter",Debug.moduleToString(ir.taravatgroup.ezafekari2.starter.class)};
}
}