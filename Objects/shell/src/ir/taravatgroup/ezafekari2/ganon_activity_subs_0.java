...
try {
		Debug.PushSubsStack("Activity_Create (ganon_activity) ","ganon_activity",13,ganon_activity.mostCurrent.activityBA,ganon_activity.mostCurrent,20);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (ganon_activity) ","ganon_activity",13,ganon_activity.mostCurrent.activityBA,ganon_activity.mostCurrent,50);
...
try {
		Debug.PushSubsStack("Activity_Pause (ganon_activity) ","ganon_activity",13,ganon_activity.mostCurrent.activityBA,ganon_activity.mostCurrent,40);
...
try {
		Debug.PushSubsStack("Activity_Resume (ganon_activity) ","ganon_activity",13,ganon_activity.mostCurrent.activityBA,ganon_activity.mostCurrent,36);
...
try {
		Debug.PushSubsStack("lbl_back_Click (ganon_activity) ","ganon_activity",13,ganon_activity.mostCurrent.activityBA,ganon_activity.mostCurrent,45);
