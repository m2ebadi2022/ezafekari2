...
try {
		Debug.PushSubsStack("Activity_Create (bime_activity) ","bime_activity",7,bime_activity.mostCurrent.activityBA,bime_activity.mostCurrent,21);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (bime_activity) ","bime_activity",7,bime_activity.mostCurrent.activityBA,bime_activity.mostCurrent,56);
...
try {
		Debug.PushSubsStack("Activity_Pause (bime_activity) ","bime_activity",7,bime_activity.mostCurrent.activityBA,bime_activity.mostCurrent,40);
...
try {
		Debug.PushSubsStack("Activity_Resume (bime_activity) ","bime_activity",7,bime_activity.mostCurrent.activityBA,bime_activity.mostCurrent,36);
...
try {
		Debug.PushSubsStack("lbl_back_Click (bime_activity) ","bime_activity",7,bime_activity.mostCurrent.activityBA,bime_activity.mostCurrent,45);
...
try {
		Debug.PushSubsStack("web_view1_PageFinished (bime_activity) ","bime_activity",7,bime_activity.mostCurrent.activityBA,bime_activity.mostCurrent,50);
