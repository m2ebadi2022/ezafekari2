...
try {
		Debug.PushSubsStack("Auth_Complete (fingerprintmanager) ","fingerprintmanager",12,__ref.getField(false, "ba"),__ref,72);
...
try {
		Debug.PushSubsStack("Authenticate (fingerprintmanager) ","fingerprintmanager",12,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("Cancel (fingerprintmanager) ","fingerprintmanager",12,__ref.getField(false, "ba"),__ref,32);
...
try {
		Debug.PushSubsStack("getHardwareDetected (fingerprintmanager) ","fingerprintmanager",12,__ref.getField(false, "ba"),__ref,16);
...
try {
		Debug.PushSubsStack("getHasEnrolledFingerprints (fingerprintmanager) ","fingerprintmanager",12,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("Initialize (fingerprintmanager) ","fingerprintmanager",12,__ref.getField(false, "ba"),__ref,9);
