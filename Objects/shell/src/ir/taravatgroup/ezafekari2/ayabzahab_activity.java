...
public class ayabzahab_activity implements IRemote{
	public static ayabzahab_activity mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public ayabzahab_activity() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("ayabzahab_activity"), "ir.taravatgroup.ezafekari2.ayabzahab_activity");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, ayabzahab_activity.class);
...
public static RemoteObject _cust_lv_ayabzahab = RemoteObject.declareNull("b4a.example3.customlistview");
...
public static ir.taravatgroup.ezafekari2.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",ayabzahab_activity.mostCurrent._activity,"addEdit_id",ayabzahab_activity._addedit_id,"bime_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.bime_activity.class),"calc_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.calc_activity.class),"comment_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.comment_activity.class),"current_itemId_edit",ayabzahab_activity._current_itemid_edit,"cust_LV_ayabzahab",ayabzahab_activity.mostCurrent._cust_lv_ayabzahab,"darsad_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.darsad_activity.class),"DateUtils",ayabzahab_activity.mostCurrent._dateutils,"dbCode",Debug.moduleToString(ir.taravatgroup.ezafekari2.dbcode.class),"eidi_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.eidi_activity.class),"et_mablagh_edit1",ayabzahab_activity.mostCurrent._et_mablagh_edit1,"et_onvan_edit1",ayabzahab_activity.mostCurrent._et_onvan_edit1,"et_tozih_edit1",ayabzahab_activity.mostCurrent._et_tozih_edit1,"fast_run_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.fast_run_activity.class),"food_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.food_activity.class),"ganon_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.ganon_activity.class),"gestha_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.gestha_activity.class),"help_kharid_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.help_kharid_activity.class),"hogog_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.hogog_activity.class),"HttpUtils2Service",Debug.moduleToString(ir.taravatgroup.ezafekari2.httputils2service.class),"index_current_pan",ayabzahab_activity._index_current_pan,"info_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.info_activity.class),"lbl_date",ayabzahab_activity.mostCurrent._lbl_date,"lbl_date_edit1",ayabzahab_activity.mostCurrent._lbl_date_edit1,"lbl_edit_from_list",ayabzahab_activity.mostCurrent._lbl_edit_from_list,"lbl_icon",ayabzahab_activity.mostCurrent._lbl_icon,"lbl_mablagh",ayabzahab_activity.mostCurrent._lbl_mablagh,"lbl_onvan",ayabzahab_activity.mostCurrent._lbl_onvan,"lbl_remove_from_list",ayabzahab_activity.mostCurrent._lbl_remove_from_list,"lbl_sp_type",ayabzahab_activity.mostCurrent._lbl_sp_type,"lbl_title_edit1",ayabzahab_activity.mostCurrent._lbl_title_edit1,"lbl_tozih",ayabzahab_activity.mostCurrent._lbl_tozih,"Main",Debug.moduleToString(ir.taravatgroup.ezafekari2.main.class),"moon_dataPik",ayabzahab_activity.mostCurrent._moon_datapik,"morakhasi_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.morakhasi_activity.class),"mosaedeh_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.mosaedeh_activity.class),"myfunc",Debug.moduleToString(ir.taravatgroup.ezafekari2.myfunc.class),"num_dataPik",ayabzahab_activity._num_datapik,"p",ayabzahab_activity.mostCurrent._p,"padash_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.padash_activity.class),"pan_all_edit1",ayabzahab_activity.mostCurrent._pan_all_edit1,"pan_all_set_date",ayabzahab_activity.mostCurrent._pan_all_set_date,"pan_hed_list2",ayabzahab_activity.mostCurrent._pan_hed_list2,"Panel1",ayabzahab_activity.mostCurrent._panel1,"payankar_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.payankar_activity.class),"pik_day1",ayabzahab_activity.mostCurrent._pik_day1,"pik_moon1",ayabzahab_activity.mostCurrent._pik_moon1,"pik_year1",ayabzahab_activity.mostCurrent._pik_year1,"sabt2_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.sabt2_activity.class),"savabeg_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.savabeg_activity.class),"sayer_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.sayer_activity.class),"setting_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.setting_activity.class),"setting_hogog_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.setting_hogog_activity.class),"shift_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.shift_activity.class),"show_gozaresh_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.show_gozaresh_activity.class),"sp_moon",ayabzahab_activity.mostCurrent._sp_moon,"sp_type_state",ayabzahab_activity.mostCurrent._sp_type_state,"sp_year",ayabzahab_activity.mostCurrent._sp_year,"Starter",Debug.moduleToString(ir.taravatgroup.ezafekari2.starter.class),"step0_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step0_activity.class),"step1_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step1_activity.class),"step2_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step2_activity.class),"vam_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.vam_activity.class),"xui2",ayabzahab_activity.mostCurrent._xui2};
}
}