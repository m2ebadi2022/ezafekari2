...
try {
		Debug.PushSubsStack("Activity_Create (gestha_activity) ","gestha_activity",14,gestha_activity.mostCurrent.activityBA,gestha_activity.mostCurrent,37);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (gestha_activity) ","gestha_activity",14,gestha_activity.mostCurrent.activityBA,gestha_activity.mostCurrent,162);
...
try {
		Debug.PushSubsStack("Activity_Pause (gestha_activity) ","gestha_activity",14,gestha_activity.mostCurrent.activityBA,gestha_activity.mostCurrent,59);
...
try {
		Debug.PushSubsStack("Activity_Resume (gestha_activity) ","gestha_activity",14,gestha_activity.mostCurrent.activityBA,gestha_activity.mostCurrent,55);
...
try {
		Debug.PushSubsStack("fill_list_gestha (gestha_activity) ","gestha_activity",14,gestha_activity.mostCurrent.activityBA,gestha_activity.mostCurrent,65);
...
try {
		Debug.PushSubsStack("lbl_back_Click (gestha_activity) ","gestha_activity",14,gestha_activity.mostCurrent.activityBA,gestha_activity.mostCurrent,158);
