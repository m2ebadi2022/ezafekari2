...
public static RemoteObject _tim_lock_lbl = RemoteObject.declareNull("anywheresoftware.b4a.objects.Timer");
...
public static RemoteObject _user_namefamili = RemoteObject.createImmutable("");
...
public static RemoteObject _list_mamoriat_id = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
...
public static RemoteObject _et_tozihat_ft = RemoteObject.declareNull("anywheresoftware.b4a.objects.EditTextWrapper");
public static RemoteObject _btneight = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _btnfive = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _btnfour = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _btnnine = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _btnone = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _btnseven = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _btnsix = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _btnthree = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _btntwo = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _btnzero = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _key1 = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _key2 = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _key3 = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _key4 = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _click_count = RemoteObject.createImmutable(0);
public static RemoteObject _master_password = RemoteObject.createImmutable("");
public static RemoteObject _entered_password = RemoteObject.createImmutable("");
public static RemoteObject _fingerprint = RemoteObject.declareNull("ir.taravatgroup.ezafekari2.fingerprintmanager");
public static RemoteObject _lbl_finger = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _stat_finger = RemoteObject.createImmutable(0);
public static RemoteObject _pan_lock = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _lbl_hint_lock = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _pan_all_chekupdate = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _webveiw_chk_update = RemoteObject.declareNull("anywheresoftware.b4a.objects.WebViewWrapper");
public static RemoteObject _lbl_chk_update_ok = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbl_day_clv = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _cust_lv_mamoriat = RemoteObject.declareNull("b4a.example3.customlistview");
...
public static ir.taravatgroup.ezafekari2.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"app_vesion",main._app_vesion,"bime_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.bime_activity.class),"bit_img0",main.mostCurrent._bit_img0,"bit_img1",main.mostCurrent._bit_img1,"bit_img2",main.mostCurrent._bit_img2,"bit_img3",main.mostCurrent._bit_img3,"bit_img4",main.mostCurrent._bit_img4,"btnEight",main.mostCurrent._btneight,"btnFive",main.mostCurrent._btnfive,"btnFour",main.mostCurrent._btnfour,"btnNine",main.mostCurrent._btnnine,"btnOne",main.mostCurrent._btnone,"btnSeven",main.mostCurrent._btnseven,"btnSix",main.mostCurrent._btnsix,"btnThree",main.mostCurrent._btnthree,"btnTwo",main.mostCurrent._btntwo,"btnZero",main.mostCurrent._btnzero,"buy_index",main._buy_index,"calc_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.calc_activity.class),"ckb_ezaf_taradod",main.mostCurrent._ckb_ezaf_taradod,"ckb_ezaf_taradod_FT",main.mostCurrent._ckb_ezaf_taradod_ft,"Click_Count",main._click_count,"CLV_gozaresh",main.mostCurrent._clv_gozaresh,"code_fast_taradod",main._code_fast_taradod,"color_index",main._color_index,"color1",main._color1,"color2",main._color2,"color3",main._color3,"color4",main._color4,"color5",main._color5,"comment_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.comment_activity.class),"curent_tab_list",main._curent_tab_list,"current_gozaresh_id",main._current_gozaresh_id,"current_id_edit",main._current_id_edit,"cust_LV_ezafekari",main.mostCurrent._cust_lv_ezafekari,"cust_LV_mamoriat",main.mostCurrent._cust_lv_mamoriat,"cust_LV_morakhasi",main.mostCurrent._cust_lv_morakhasi,"cust_LV_taradod",main.mostCurrent._cust_lv_taradod,"cv_loader",main.mostCurrent._cv_loader,"darsad_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.darsad_activity.class),"date1",main.mostCurrent._date1,"date2",main.mostCurrent._date2,"DateUtils",main.mostCurrent._dateutils,"day_bt",main._day_bt,"dbCode",Debug.moduleToString(ir.taravatgroup.ezafekari2.dbcode.class),"eidi_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.eidi_activity.class),"entered_Password",main.mostCurrent._entered_password,"et_tozihat",main.mostCurrent._et_tozihat,"et_tozihat_FT",main.mostCurrent._et_tozihat_ft,"fast_run_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.fast_run_activity.class),"fingerprint",main.mostCurrent._fingerprint,"ganon_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.ganon_activity.class),"hogog_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.hogog_activity.class),"hour_bt",main._hour_bt,"ht",main.mostCurrent._ht,"HttpUtils2Service",Debug.moduleToString(ir.taravatgroup.ezafekari2.httputils2service.class),"img_help",main.mostCurrent._img_help,"img1",main.mostCurrent._img1,"img2",main.mostCurrent._img2,"img3",main.mostCurrent._img3,"inapp",main.mostCurrent._inapp,"index_box",main._index_box,"index_curent_img",main._index_curent_img,"index_noe_morakhasi",main._index_noe_morakhasi,"index_page",main._index_page,"index_piker",main._index_piker,"index_x_start_swap",main._index_x_start_swap,"info_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.info_activity.class),"is_for_edit",main._is_for_edit,"is_now_instal",main._is_now_instal,"key",main.mostCurrent._key,"key1",main.mostCurrent._key1,"key2",main.mostCurrent._key2,"key3",main.mostCurrent._key3,"key4",main.mostCurrent._key4,"last_notif",main.mostCurrent._last_notif,"lbl_box_title",main.mostCurrent._lbl_box_title,"lbl_chk_update_ok",main.mostCurrent._lbl_chk_update_ok,"lbl_close_help",main.mostCurrent._lbl_close_help,"lbl_date_CLV",main.mostCurrent._lbl_date_clv,"lbl_date_FT",main.mostCurrent._lbl_date_ft,"lbl_date_home",main.mostCurrent._lbl_date_home,"lbl_date1",main.mostCurrent._lbl_date1,"lbl_date2",main.mostCurrent._lbl_date2,"lbl_dateGozaresh_CLV",main.mostCurrent._lbl_dategozaresh_clv,"lbl_day_CLV",main.mostCurrent._lbl_day_clv,"lbl_edit_from_list",main.mostCurrent._lbl_edit_from_list,"lbl_ezaf_taradod",main.mostCurrent._lbl_ezaf_taradod,"lbl_ezafekari_mah_h",main.mostCurrent._lbl_ezafekari_mah_h,"lbl_ezafekari_mah_m",main.mostCurrent._lbl_ezafekari_mah_m,"lbl_finger",main.mostCurrent._lbl_finger,"lbl_hint_lock",main.mostCurrent._lbl_hint_lock,"lbl_hour_CLV",main.mostCurrent._lbl_hour_clv,"lbl_khoroj_FT",main.mostCurrent._lbl_khoroj_ft,"lbl_majmoe_saat",main.mostCurrent._lbl_majmoe_saat,"lbl_morakhasi_mah_d",main.mostCurrent._lbl_morakhasi_mah_d,"lbl_morakhasi_mah_h",main.mostCurrent._lbl_morakhasi_mah_h,"lbl_morakhasi_mah_m",main.mostCurrent._lbl_morakhasi_mah_m,"lbl_nameGozaresh_CLV",main.mostCurrent._lbl_namegozaresh_clv,"lbl_remove_from_list",main.mostCurrent._lbl_remove_from_list,"lbl_remove_from_list2",main.mostCurrent._lbl_remove_from_list2,"lbl_shift_home",main.mostCurrent._lbl_shift_home,"lbl_show_vip",main.mostCurrent._lbl_show_vip,"lbl_tim_khoroj_FT",main.mostCurrent._lbl_tim_khoroj_ft,"lbl_tim_vorod_FT",main.mostCurrent._lbl_tim_vorod_ft,"lbl_tim1",main.mostCurrent._lbl_tim1,"lbl_tim2",main.mostCurrent._lbl_tim2,"lbl_time_as",main.mostCurrent._lbl_time_as,"lbl_time_CLV",main.mostCurrent._lbl_time_clv,"lbl_time_show",main.mostCurrent._lbl_time_show,"lbl_time_show_FT",main.mostCurrent._lbl_time_show_ft,"lbl_time_ta",main.mostCurrent._lbl_time_ta,"lbl_title_msgPan",main.mostCurrent._lbl_title_msgpan,"lbl_tozih_CLV",main.mostCurrent._lbl_tozih_clv,"lbl_tozihGozaresh_CLV",main.mostCurrent._lbl_tozihgozaresh_clv,"lbl_vesion_app",main.mostCurrent._lbl_vesion_app,"lbl_vip",main.mostCurrent._lbl_vip,"lbl_vip_now",main.mostCurrent._lbl_vip_now,"lbl_vip2",main.mostCurrent._lbl_vip2,"lbl_vorod_FT",main.mostCurrent._lbl_vorod_ft,"list_ezafekari_id",main.mostCurrent._list_ezafekari_id,"list_gozareshat_id",main.mostCurrent._list_gozareshat_id,"list_mamoriat_id",main.mostCurrent._list_mamoriat_id,"list_morakhasi_id",main.mostCurrent._list_morakhasi_id,"list_taradod_id",main.mostCurrent._list_taradod_id,"ls1",main.mostCurrent._ls1,"ls2",main.mostCurrent._ls2,"ls3",main.mostCurrent._ls3,"main_font",main._main_font,"Master_Password",main.mostCurrent._master_password,"min_bt",main._min_bt,"moon",main.mostCurrent._moon,"moon_bt",main._moon_bt,"moon_num",main._moon_num,"morakhasi_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.morakhasi_activity.class),"msg",main.mostCurrent._msg,"myfunc",Debug.moduleToString(ir.taravatgroup.ezafekari2.myfunc.class),"num",main._num,"p",main.mostCurrent._p,"pan_all",main.mostCurrent._pan_all,"pan_all_chekUpdate",main.mostCurrent._pan_all_chekupdate,"pan_all_FT",main.mostCurrent._pan_all_ft,"pan_all_liteMenu",main.mostCurrent._pan_all_litemenu,"pan_all_msgNewYear",main.mostCurrent._pan_all_msgnewyear,"pan_all_noskhe",main.mostCurrent._pan_all_noskhe,"pan_all2",main.mostCurrent._pan_all2,"pan_ezaf_taradod",main.mostCurrent._pan_ezaf_taradod,"pan_hed_gozaresh",main.mostCurrent._pan_hed_gozaresh,"pan_hed_list",main.mostCurrent._pan_hed_list,"pan_help",main.mostCurrent._pan_help,"pan_imag",main.mostCurrent._pan_imag,"pan_item_gozaresh",main.mostCurrent._pan_item_gozaresh,"pan_lock",main.mostCurrent._pan_lock,"pan_main",main.mostCurrent._pan_main,"pan_notif",main.mostCurrent._pan_notif,"pan_notifi_all",main.mostCurrent._pan_notifi_all,"pan_picker",main.mostCurrent._pan_picker,"Panel1",main.mostCurrent._panel1,"payankar_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.payankar_activity.class),"persianDate",main._persiandate,"phon",main._phon,"phon_num",main._phon_num,"pik_day1",main.mostCurrent._pik_day1,"pik_hour_bala1",main.mostCurrent._pik_hour_bala1,"pik_hour_paeen1",main.mostCurrent._pik_hour_paeen1,"pik_hour1",main.mostCurrent._pik_hour1,"pik_min_bala1",main.mostCurrent._pik_min_bala1,"pik_min_paeen1",main.mostCurrent._pik_min_paeen1,"pik_min1",main.mostCurrent._pik_min1,"pik_moon1",main.mostCurrent._pik_moon1,"pik_year1",main.mostCurrent._pik_year1,"rsPOP_noe",main.mostCurrent._rspop_noe,"saat_kar_min",main._saat_kar_min,"scroll_v_noskhe",main.mostCurrent._scroll_v_noskhe,"scv_home_item",main.mostCurrent._scv_home_item,"setting_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.setting_activity.class),"setting_hogog_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.setting_hogog_activity.class),"shift_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.shift_activity.class),"show_gozaresh_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.show_gozaresh_activity.class),"size_f1",main._size_f1,"size_f2",main._size_f2,"size_f3",main._size_f3,"sp_moon",main.mostCurrent._sp_moon,"sp_year",main.mostCurrent._sp_year,"sp_year_gozaresh",main.mostCurrent._sp_year_gozaresh,"Starter",Debug.moduleToString(ir.taravatgroup.ezafekari2.starter.class),"stat_finger",main._stat_finger,"step0_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step0_activity.class),"step1_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step1_activity.class),"step2_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step2_activity.class),"str_noe",main.mostCurrent._str_noe,"strfun",main.mostCurrent._strfun,"TabHost1",main.mostCurrent._tabhost1,"tim_lock_lbl",main._tim_lock_lbl,"tim_min",main._tim_min,"tim_msg",main._tim_msg,"time_page_load",main._time_page_load,"timer1",main._timer1,"user_nameFamili",main._user_namefamili,"web_msg_show",main.mostCurrent._web_msg_show,"webVeiw_chk_update",main.mostCurrent._webveiw_chk_update,"xui",main._xui,"year_bt",main._year_bt,"year_num",main._year_num};
}
}