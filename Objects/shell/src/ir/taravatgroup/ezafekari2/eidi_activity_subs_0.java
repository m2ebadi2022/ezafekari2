...
try {
		Debug.PushSubsStack("Activity_Create (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,34);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,92);
...
try {
		Debug.PushSubsStack("Activity_Pause (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,82);
...
try {
		Debug.PushSubsStack("Activity_Resume (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,78);
...
try {
		Debug.PushSubsStack("btn_mohasebe_eidi_Click (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,101);
...
_eidi_nakhales = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, eidi_activity.mostCurrent._et_payeh.runMethod(false,"getTag")),RemoteObject.createImmutable(2)}, "*",0, 0));Debug.locals.put("eidi_nakhales", _eidi_nakhales);
 ...
 BA.debugLineNum = 122;BA.debugLine="If(eidi_nakhales>(3*7166184) )Then";
Debug.ShouldStop(33554432);
if ((RemoteObject.solveBoolean(">",_eidi_nakhales,BA.numberCast(double.class, (RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(3),RemoteObject.createImmutable(7166184)}, "*",0, 1)))))) { 
 BA.debugLineNum = 123;BA.debugLine="eidi_nakhales= (3*7166184)";
Debug.ShouldStop(67108864);
_eidi_nakhales = (RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(3),RemoteObject.createImmutable(7166184)}, "*",0, 1));Debug.locals.put("eidi_nakhales", _eidi_nakhales);
 };
...
try {
		Debug.PushSubsStack("change_formater (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,137);
...
try {
		Debug.PushSubsStack("et_payeh_TextChanged (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,152);
...
try {
		Debug.PushSubsStack("lbl_back_Click (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,87);
...
try {
		Debug.PushSubsStack("lbl_date1_Click (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,336);
if (RapidSub.canDelegate("lbl_date1_click")) { return ir.taravatgroup.ezafekari2.eidi_activity.remoteMe.runUserSub(false, "eidi_activity","lbl_date1_click");}
 BA.debugLineNum = 336;BA.debugLine="Private Sub lbl_date1_Click";
Debug.ShouldStop(32768);
 BA.debugLineNum = 337;BA.debugLine="pan_all_set_date.Visible=True";
Debug.ShouldStop(65536);
eidi_activity.mostCurrent._pan_all_set_date.runMethod(true,"setVisible",eidi_activity.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 338;BA.debugLine="index_datePik=1";
Debug.ShouldStop(131072);
eidi_activity._index_datepik = BA.numberCast(int.class, 1);
 BA.debugLineNum = 340;BA.debugLine="pik_year1.Text=myfunc.fa2en(lbl_date1.Text.SubStr";
Debug.ShouldStop(524288);
eidi_activity.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(eidi_activity.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,eidi_activity.mostCurrent.activityBA,(Object)(eidi_activity.mostCurrent._lbl_date1.runMethod(true,"getText").runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 4)))))));
 BA.debugLineNum = 341;BA.debugLine="pik_moon1.Tag=myfunc.fa2en(lbl_date1.Text.SubStri";
Debug.ShouldStop(1048576);
eidi_activity.mostCurrent._pik_moon1.runMethod(false,"setTag",(eidi_activity.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,eidi_activity.mostCurrent.activityBA,(Object)(eidi_activity.mostCurrent._lbl_date1.runMethod(true,"getText").runMethod(true,"substring",(Object)(BA.numberCast(int.class, 5)),(Object)(BA.numberCast(int.class, 7)))))));
 BA.debugLineNum = 342;BA.debugLine="pik_moon1.Text=moon_dataPik.Get(pik_moon1.Tag-1)";
Debug.ShouldStop(2097152);
eidi_activity.mostCurrent._pik_moon1.runMethod(true,"setText",BA.ObjectToCharSequence(eidi_activity.mostCurrent._moon_datapik.runMethod(false,"Get",(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, eidi_activity.mostCurrent._pik_moon1.runMethod(false,"getTag")),RemoteObject.createImmutable(1)}, "-",1, 0))))));
 BA.debugLineNum = 343;BA.debugLine="pik_day1.Text=myfunc.fa2en(lbl_date1.Text.SubStri";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("lbl_date2_Click (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,346);
if (RapidSub.canDelegate("lbl_date2_click")) { return ir.taravatgroup.ezafekari2.eidi_activity.remoteMe.runUserSub(false, "eidi_activity","lbl_date2_click");}
 BA.debugLineNum = 346;BA.debugLine="Private Sub lbl_date2_Click";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 347;BA.debugLine="pan_all_set_date.Visible=True";
Debug.ShouldStop(67108864);
eidi_activity.mostCurrent._pan_all_set_date.runMethod(true,"setVisible",eidi_activity.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 348;BA.debugLine="index_datePik=2";
Debug.ShouldStop(134217728);
eidi_activity._index_datepik = BA.numberCast(int.class, 2);
 BA.debugLineNum = 350;BA.debugLine="pik_year1.Text=myfunc.fa2en(lbl_date2.Text.SubStr";
Debug.ShouldStop(536870912);
eidi_activity.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(eidi_activity.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,eidi_activity.mostCurrent.activityBA,(Object)(eidi_activity.mostCurrent._lbl_date2.runMethod(true,"getText").runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 4)))))));
 BA.debugLineNum = 351;BA.debugLine="pik_moon1.Tag=myfunc.fa2en(lbl_date2.Text.SubStri";
Debug.ShouldStop(1073741824);
eidi_activity.mostCurrent._pik_moon1.runMethod(false,"setTag",(eidi_activity.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,eidi_activity.mostCurrent.activityBA,(Object)(eidi_activity.mostCurrent._lbl_date2.runMethod(true,"getText").runMethod(true,"substring",(Object)(BA.numberCast(int.class, 5)),(Object)(BA.numberCast(int.class, 7)))))));
 BA.debugLineNum = 352;BA.debugLine="pik_moon1.Text=moon_dataPik.Get(pik_moon1.Tag-1)";
Debug.ShouldStop(-2147483648);
eidi_activity.mostCurrent._pik_moon1.runMethod(true,"setText",BA.ObjectToCharSequence(eidi_activity.mostCurrent._moon_datapik.runMethod(false,"Get",(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, eidi_activity.mostCurrent._pik_moon1.runMethod(false,"getTag")),RemoteObject.createImmutable(1)}, "-",1, 0))))));
 BA.debugLineNum = 353;BA.debugLine="pik_day1.Text=myfunc.fa2en(lbl_date2.Text.SubStri";
Debug.ShouldStop(1);
eidi_activity.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(eidi_activity.mostCurrent._myfunc.runMethod(true,"_fa2en" /*RemoteObject*/ ,eidi_activity.mostCurrent.activityBA,(Object)(eidi_activity.mostCurrent._lbl_date2.runMethod(true,"getText").runMethod(true,"substring",(Object)(BA.numberCast(int.class, 8)),(Object)(BA.numberCast(int.class, 10)))))));
...
try {
		Debug.PushSubsStack("lbl_save_picker_Click (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,356);
if (RapidSub.canDelegate("lbl_save_picker_click")) { return ir.taravatgroup.ezafekari2.eidi_activity.remoteMe.runUserSub(false, "eidi_activity","lbl_save_picker_click");}
 BA.debugLineNum = 356;BA.debugLine="Private Sub lbl_save_picker_Click";
Debug.ShouldStop(8);
 BA.debugLineNum = 357;BA.debugLine="If(index_datePik=1) Then";
Debug.ShouldStop(16);
if ((RemoteObject.solveBoolean("=",eidi_activity._index_datepik,BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 358;BA.debugLine="lbl_date1.Text=pik_year1.Text&\"/\"&myfunc.convert";
Debug.ShouldStop(32);
...
{ BA.debugLineNum = 360;BA.debugLine="Else If(index_datePik=2) Then";
Debug.ShouldStop(128);
if ((RemoteObject.solveBoolean("=",eidi_activity._index_datepik,BA.numberCast(double.class, 2)))) { 
 BA.debugLineNum = 361;BA.debugLine="lbl_date2.Text=pik_year1.Text&\"/\"&myfunc.convert";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("mohasebe_maliat (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,159);
...
_state4 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_hogog,RemoteObject.createImmutable(29160000)}, "-",1, 1)),RemoteObject.createImmutable(0.3)}, "*",0, 0));Debug.locals.put("state4", _state4);
 ...
 BA.debugLineNum = 250;BA.debugLine="If (year=1402)Then";
Debug.ShouldStop(33554432);
if ((RemoteObject.solveBoolean("=",_year,BA.numberCast(double.class, 1402)))) { 
 BA.debugLineNum = 251;BA.debugLine="If(hogog>10000001 And hogog<14000001)Then	  ''--";
Debug.ShouldStop(67108864);
if ((RemoteObject.solveBoolean(">",_hogog,BA.numberCast(double.class, 10000001)) && RemoteObject.solveBoolean("<",_hogog,BA.numberCast(double.class, 14000001)))) { 
 BA.debugLineNum = 252;BA.debugLine="state1=(hogog-10000000)*0.1";
Debug.ShouldStop(134217728);
_state1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_hogog,RemoteObject.createImmutable(10000000)}, "-",1, 1)),RemoteObject.createImmutable(0.1)}, "*",0, 0));Debug.locals.put("state1", _state1);
 ...
 BA.debugLineNum = 254;BA.debugLine="If(hogog>14000001 And hogog<23000001)Then	  ''--";
Debug.ShouldStop(536870912);
if ((RemoteObject.solveBoolean(">",_hogog,BA.numberCast(double.class, 14000001)) && RemoteObject.solveBoolean("<",_hogog,BA.numberCast(double.class, 23000001)))) { 
 BA.debugLineNum = 255;BA.debugLine="state1=(4000000)*0.1";
Debug.ShouldStop(1073741824);
_state1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((4000000)),RemoteObject.createImmutable(0.1)}, "*",0, 0));Debug.locals.put("state1", _state1);
 BA.debugLineNum = 256;BA.debugLine="state2=(hogog-14000000)*0.15";
Debug.ShouldStop(-2147483648);
_state2 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_hogog,RemoteObject.createImmutable(14000000)}, "-",1, 1)),RemoteObject.createImmutable(0.15)}, "*",0, 0));Debug.locals.put("state2", _state2);
 ...
 BA.debugLineNum = 258;BA.debugLine="If(hogog>23000001 And hogog<34000001)Then	  ''--";
Debug.ShouldStop(2);
if ((RemoteObject.solveBoolean(">",_hogog,BA.numberCast(double.class, 23000001)) && RemoteObject.solveBoolean("<",_hogog,BA.numberCast(double.class, 34000001)))) { 
 BA.debugLineNum = 259;BA.debugLine="state1=(4000000)*0.1";
Debug.ShouldStop(4);
_state1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((4000000)),RemoteObject.createImmutable(0.1)}, "*",0, 0));Debug.locals.put("state1", _state1);
 BA.debugLineNum = 260;BA.debugLine="state2=(9000000)*0.15";
Debug.ShouldStop(8);
_state2 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((9000000)),RemoteObject.createImmutable(0.15)}, "*",0, 0));Debug.locals.put("state2", _state2);
 BA.debugLineNum = 261;BA.debugLine="state3=(hogog-23000000)*0.2";
Debug.ShouldStop(16);
_state3 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_hogog,RemoteObject.createImmutable(23000000)}, "-",1, 1)),RemoteObject.createImmutable(0.2)}, "*",0, 0));Debug.locals.put("state3", _state3);
 ...
 BA.debugLineNum = 264;BA.debugLine="If(hogog>34000001)Then	  ''-----stat4";
Debug.ShouldStop(128);
...
Debug.ShouldStop(256);
_state1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((4000000)),RemoteObject.createImmutable(0.1)}, "*",0, 0));Debug.locals.put("state1", _state1);
 BA.debugLineNum = 266;BA.debugLine="state2=(9000000)*0.15";
Debug.ShouldStop(512);
_state2 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((9000000)),RemoteObject.createImmutable(0.15)}, "*",0, 0));Debug.locals.put("state2", _state2);
 BA.debugLineNum = 267;BA.debugLine="state3=(11000000)*0.2";
Debug.ShouldStop(1024);
_state3 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((11000000)),RemoteObject.createImmutable(0.2)}, "*",0, 0));Debug.locals.put("state3", _state3);
 BA.debugLineNum = 269;BA.debugLine="state4=(hogog-34000001)*0.3";
Debug.ShouldStop(4096);
_state4 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_hogog,RemoteObject.createImmutable(34000001)}, "-",1, 1)),RemoteObject.createImmutable(0.3)}, "*",0, 0));Debug.locals.put("state4", _state4);
 ...
 BA.debugLineNum = 275;BA.debugLine="If (year=1403)Then";
Debug.ShouldStop(262144);
if ((RemoteObject.solveBoolean("=",_year,BA.numberCast(double.class, 1403)))) { 
 BA.debugLineNum = 276;BA.debugLine="If(hogog>12000001 And hogog<16500001)Then	  ''--";
Debug.ShouldStop(524288);
if ((RemoteObject.solveBoolean(">",_hogog,BA.numberCast(double.class, 12000001)) && RemoteObject.solveBoolean("<",_hogog,BA.numberCast(double.class, 16500001)))) { 
 BA.debugLineNum = 277;BA.debugLine="state1=(hogog-12000000)*0.1";
Debug.ShouldStop(1048576);
_state1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_hogog,RemoteObject.createImmutable(12000000)}, "-",1, 1)),RemoteObject.createImmutable(0.1)}, "*",0, 0));Debug.locals.put("state1", _state1);
 ...
 BA.debugLineNum = 279;BA.debugLine="If(hogog>16500001 And hogog<27000001)Then	  ''--";
Debug.ShouldStop(4194304);
if ((RemoteObject.solveBoolean(">",_hogog,BA.numberCast(double.class, 16500001)) && RemoteObject.solveBoolean("<",_hogog,BA.numberCast(double.class, 27000001)))) { 
 BA.debugLineNum = 280;BA.debugLine="state1=(4500000)*0.1";
Debug.ShouldStop(8388608);
_state1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((4500000)),RemoteObject.createImmutable(0.1)}, "*",0, 0));Debug.locals.put("state1", _state1);
 BA.debugLineNum = 281;BA.debugLine="state2=(hogog-16500000)*0.15";
Debug.ShouldStop(16777216);
_state2 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_hogog,RemoteObject.createImmutable(16500000)}, "-",1, 1)),RemoteObject.createImmutable(0.15)}, "*",0, 0));Debug.locals.put("state2", _state2);
 ...
 BA.debugLineNum = 283;BA.debugLine="If(hogog>27000001 And hogog<40000001)Then	  ''--";
Debug.ShouldStop(67108864);
if ((RemoteObject.solveBoolean(">",_hogog,BA.numberCast(double.class, 27000001)) && RemoteObject.solveBoolean("<",_hogog,BA.numberCast(double.class, 40000001)))) { 
 BA.debugLineNum = 284;BA.debugLine="state1=(4500000)*0.1";
Debug.ShouldStop(134217728);
_state1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((4500000)),RemoteObject.createImmutable(0.1)}, "*",0, 0));Debug.locals.put("state1", _state1);
 BA.debugLineNum = 285;BA.debugLine="state2=(10500000)*0.15";
Debug.ShouldStop(268435456);
_state2 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((10500000)),RemoteObject.createImmutable(0.15)}, "*",0, 0));Debug.locals.put("state2", _state2);
 BA.debugLineNum = 286;BA.debugLine="state3=(hogog-27000000)*0.2";
Debug.ShouldStop(536870912);
_state3 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_hogog,RemoteObject.createImmutable(27000000)}, "-",1, 1)),RemoteObject.createImmutable(0.2)}, "*",0, 0));Debug.locals.put("state3", _state3);
 ...
 BA.debugLineNum = 289;BA.debugLine="If(hogog>40000001)Then	  ''-----stat4";
Debug.ShouldStop(1);
if ((RemoteObject.solveBoolean(">",_hogog,BA.numberCast(double.class, 40000001)))) { 
 BA.debugLineNum = 290;BA.debugLine="state1=(4500000)*0.1";
Debug.ShouldStop(2);
_state1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((4500000)),RemoteObject.createImmutable(0.1)}, "*",0, 0));Debug.locals.put("state1", _state1);
 BA.debugLineNum = 291;BA.debugLine="state2=(10500000)*0.15";
Debug.ShouldStop(4);
_state2 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((10500000)),RemoteObject.createImmutable(0.15)}, "*",0, 0));Debug.locals.put("state2", _state2);
 BA.debugLineNum = 292;BA.debugLine="state3=(13000000)*0.2";
Debug.ShouldStop(8);
_state3 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((13000000)),RemoteObject.createImmutable(0.2)}, "*",0, 0));Debug.locals.put("state3", _state3);
 BA.debugLineNum = 294;BA.debugLine="state4=(hogog-40000001)*0.3";
Debug.ShouldStop(32);
_state4 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_hogog,RemoteObject.createImmutable(40000001)}, "-",1, 1)),RemoteObject.createImmutable(0.3)}, "*",0, 0));Debug.locals.put("state4", _state4);
 ...
 BA.debugLineNum = 301;BA.debugLine="If (year=1404)Then";
Debug.ShouldStop(4096);
if ((RemoteObject.solveBoolean("=",_year,BA.numberCast(double.class, 1404)))) { 
 BA.debugLineNum = 302;BA.debugLine="If(hogog>24000001 And hogog<30000001)Then	  ''--";
Debug.ShouldStop(8192);
if ((RemoteObject.solveBoolean(">",_hogog,BA.numberCast(double.class, 24000001)) && RemoteObject.solveBoolean("<",_hogog,BA.numberCast(double.class, 30000001)))) { 
 BA.debugLineNum = 303;BA.debugLine="state1=(hogog-24000000)*0.1";
Debug.ShouldStop(16384);
_state1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_hogog,RemoteObject.createImmutable(24000000)}, "-",1, 1)),RemoteObject.createImmutable(0.1)}, "*",0, 0));Debug.locals.put("state1", _state1);
 ...
 BA.debugLineNum = 305;BA.debugLine="If(hogog>30000001 And hogog<38000001)Then	  ''--";
Debug.ShouldStop(65536);
if ((RemoteObject.solveBoolean(">",_hogog,BA.numberCast(double.class, 30000001)) && RemoteObject.solveBoolean("<",_hogog,BA.numberCast(double.class, 38000001)))) { 
 BA.debugLineNum = 306;BA.debugLine="state1=(6000000)*0.1";
Debug.ShouldStop(131072);
_state1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((6000000)),RemoteObject.createImmutable(0.1)}, "*",0, 0));Debug.locals.put("state1", _state1);
 BA.debugLineNum = 307;BA.debugLine="state2=(hogog-30000000)*0.15";
Debug.ShouldStop(262144);
_state2 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_hogog,RemoteObject.createImmutable(30000000)}, "-",1, 1)),RemoteObject.createImmutable(0.15)}, "*",0, 0));Debug.locals.put("state2", _state2);
 ...
 BA.debugLineNum = 309;BA.debugLine="If(hogog>38000001 And hogog<50000001)Then	  ''--";
Debug.ShouldStop(1048576);
if ((RemoteObject.solveBoolean(">",_hogog,BA.numberCast(double.class, 38000001)) && RemoteObject.solveBoolean("<",_hogog,BA.numberCast(double.class, 50000001)))) { 
 BA.debugLineNum = 310;BA.debugLine="state1=(6000000)*0.1";
Debug.ShouldStop(2097152);
_state1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((6000000)),RemoteObject.createImmutable(0.1)}, "*",0, 0));Debug.locals.put("state1", _state1);
 BA.debugLineNum = 311;BA.debugLine="state2=(8000000)*0.15";
Debug.ShouldStop(4194304);
_state2 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((8000000)),RemoteObject.createImmutable(0.15)}, "*",0, 0));Debug.locals.put("state2", _state2);
 BA.debugLineNum = 312;BA.debugLine="state3=(hogog-38000000)*0.2";
Debug.ShouldStop(8388608);
_state3 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_hogog,RemoteObject.createImmutable(38000000)}, "-",1, 1)),RemoteObject.createImmutable(0.2)}, "*",0, 0));Debug.locals.put("state3", _state3);
 ...
 BA.debugLineNum = 315;BA.debugLine="If(hogog>50000001 And hogog<66700001)Then	  ''--";
Debug.ShouldStop(67108864);
if ((RemoteObject.solveBoolean(">",_hogog,BA.numberCast(double.class, 50000001)) && RemoteObject.solveBoolean("<",_hogog,BA.numberCast(double.class, 66700001)))) { 
 BA.debugLineNum = 316;BA.debugLine="state1=(6000000)*0.1";
Debug.ShouldStop(134217728);
_state1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((6000000)),RemoteObject.createImmutable(0.1)}, "*",0, 0));Debug.locals.put("state1", _state1);
 BA.debugLineNum = 317;BA.debugLine="state2=(8000000)*0.15";
Debug.ShouldStop(268435456);
_state2 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((8000000)),RemoteObject.createImmutable(0.15)}, "*",0, 0));Debug.locals.put("state2", _state2);
 BA.debugLineNum = 318;BA.debugLine="state3=(12000000)*0.2";
Debug.ShouldStop(536870912);
_state3 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((12000000)),RemoteObject.createImmutable(0.2)}, "*",0, 0));Debug.locals.put("state3", _state3);
 BA.debugLineNum = 319;BA.debugLine="state4=(hogog-50000001)*0.25";
Debug.ShouldStop(1073741824);
_state4 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_hogog,RemoteObject.createImmutable(50000001)}, "-",1, 1)),RemoteObject.createImmutable(0.25)}, "*",0, 0));Debug.locals.put("state4", _state4);
 ...
 BA.debugLineNum = 321;BA.debugLine="If(hogog>66700001)Then	  ''-----stat5";
Debug.ShouldStop(1);
if ((RemoteObject.solveBoolean(">",_hogog,BA.numberCast(double.class, 66700001)))) { 
 BA.debugLineNum = 322;BA.debugLine="state1=(6000000)*0.1";
Debug.ShouldStop(2);
_state1 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((6000000)),RemoteObject.createImmutable(0.1)}, "*",0, 0));Debug.locals.put("state1", _state1);
 BA.debugLineNum = 323;BA.debugLine="state2=(8000000)*0.15";
Debug.ShouldStop(4);
_state2 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((8000000)),RemoteObject.createImmutable(0.15)}, "*",0, 0));Debug.locals.put("state2", _state2);
 BA.debugLineNum = 324;BA.debugLine="state3=(12000000)*0.2";
Debug.ShouldStop(8);
_state3 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((12000000)),RemoteObject.createImmutable(0.2)}, "*",0, 0));Debug.locals.put("state3", _state3);
 BA.debugLineNum = 325;BA.debugLine="state4=(16700000)*0.25";
Debug.ShouldStop(16);
_state4 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((16700000)),RemoteObject.createImmutable(0.25)}, "*",0, 0));Debug.locals.put("state4", _state4);
 BA.debugLineNum = 326;BA.debugLine="state5=(hogog-66700001)*0.3";
Debug.ShouldStop(32);
_state5 = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_hogog,RemoteObject.createImmutable(66700001)}, "-",1, 1)),RemoteObject.createImmutable(0.3)}, "*",0, 0));Debug.locals.put("state5", _state5);
 ...
 BA.debugLineNum = 330;BA.debugLine="all_maliat=state1+state2+state3+state4+state5+sta";
Debug.ShouldStop(512);
_all_maliat = RemoteObject.solve(new RemoteObject[] {_state1,_state2,_state3,_state4,_state5,_state6}, "+++++",5, 1);Debug.locals.put("all_maliat", _all_maliat);
 BA.debugLineNum = 331;BA.debugLine="Return all_maliat";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("pan_all_set_date_Click (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,567);
if (RapidSub.canDelegate("pan_all_set_date_click")) { return ir.taravatgroup.ezafekari2.eidi_activity.remoteMe.runUserSub(false, "eidi_activity","pan_all_set_date_click");}
 BA.debugLineNum = 567;BA.debugLine="Private Sub pan_all_set_date_Click";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 568;BA.debugLine="pan_all_set_date.Visible=False";
Debug.ShouldStop(8388608);
eidi_activity.mostCurrent._pan_all_set_date.runMethod(true,"setVisible",eidi_activity.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("pik_day_bala1_Click (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,522);
...
Debug.ShouldStop(536870912);
eidi_activity.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(eidi_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,eidi_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, eidi_activity.mostCurrent._pik_day1.runMethod(true,"getText"))))));
...
try {
		Debug.PushSubsStack("pik_day_paeen1_Click (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,545);
...
try {
		Debug.PushSubsStack("pik_moon_bala1_Click (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,468);
...
try {
		Debug.PushSubsStack("pik_moon_paeen1_Click (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,482);
...
try {
		Debug.PushSubsStack("pik_pan_day1_Touch (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,428);
...
try {
		Debug.PushSubsStack("pik_pan_moon1_Touch (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,368);
...
try {
		Debug.PushSubsStack("pik_pan_year1_Touch (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,398);
...
try {
		Debug.PushSubsStack("pik_year_bala1_Click (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,496);
...
try {
		Debug.PushSubsStack("pik_year_paeen1_Click (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,509);
...
try {
		Debug.PushSubsStack("show_num_pool (eidi_activity) ","eidi_activity",9,eidi_activity.mostCurrent.activityBA,eidi_activity.mostCurrent,134);
...
Debug.ShouldStop(64);
if (true) return eidi_activity.mostCurrent.__c.runMethod(true,"NumberFormat",(Object)(BA.numberCast(double.class, _num)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)));
