...
try {
		Debug.PushSubsStack("Activity_Create (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,58);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,153);
...
try {
		Debug.PushSubsStack("Activity_Pause (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,142);
...
try {
		Debug.PushSubsStack("Activity_Resume (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,138);
...
try {
		Debug.PushSubsStack("all_morakhasiha_mah (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,271);
...
try {
		Debug.PushSubsStack("get_mande_db (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,76);
...
try {
		Debug.PushSubsStack("lbl_back_Click (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,147);
...
try {
		Debug.PushSubsStack("lbl_edit_estehgag_Click (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,383);
...
try {
		Debug.PushSubsStack("lbl_edit_mande_Click (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,398);
...
try {
		Debug.PushSubsStack("lbl_help_mandeh_Click (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,410);
...
try {
		Debug.PushSubsStack("lbl_run_mohasebe_Click (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,164);
...
Debug.ShouldStop(16777216);
morakhasi_activity.mostCurrent.__c.runVoidMethod ("LogImpl","630408725",BA.NumberToString(morakhasi_activity._morakhasi_estefade_esteh),0);
...
try {
		Debug.PushSubsStack("lbl_save_mande_Click (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,336);
...
try {
		Debug.PushSubsStack("min_to_str (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,200);
...
try {
		Debug.PushSubsStack("modify_str_showTime (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,115);
...
try {
		Debug.PushSubsStack("pan_all_morakhasi_Click (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,328);
...
try {
		Debug.PushSubsStack("Panel4_Click (morakhasi_activity) ","morakhasi_activity",18,morakhasi_activity.mostCurrent.activityBA,morakhasi_activity.mostCurrent,332);
