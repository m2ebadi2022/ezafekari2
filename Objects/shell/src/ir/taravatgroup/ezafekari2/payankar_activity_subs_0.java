...
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, payankar_activity.mostCurrent._pik_year1.runMethod(true,"getText")),BA.numberCast(double.class, 1410)))) { 
 BA.debugLineNum = 228;BA.debugLine="pik_year1.Text=1380";
Debug.ShouldStop(8);
payankar_activity.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(1380));
 };
 BA.debugLineNum = 230;BA.debugLine="If(pik_year1.Text<1380)Then";
Debug.ShouldStop(32);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, payankar_activity.mostCurrent._pik_year1.runMethod(true,"getText")),BA.numberCast(double.class, 1380)))) { 
...
Debug.ShouldStop(2097152);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, payankar_activity.mostCurrent._pik_year1.runMethod(true,"getText")),BA.numberCast(double.class, 1410)))) { 
 BA.debugLineNum = 311;BA.debugLine="pik_year1.Text=1380";
Debug.ShouldStop(4194304);
payankar_activity.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(1380));
 };
 BA.debugLineNum = 313;BA.debugLine="If(pik_year1.Text<1380)Then";
Debug.ShouldStop(16777216);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, payankar_activity.mostCurrent._pik_year1.runMethod(true,"getText")),BA.numberCast(double.class, 1380)))) { 
...
Debug.ShouldStop(4);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, payankar_activity.mostCurrent._pik_year1.runMethod(true,"getText")),BA.numberCast(double.class, 1410)))) { 
 BA.debugLineNum = 324;BA.debugLine="pik_year1.Text=1380";
Debug.ShouldStop(8);
payankar_activity.mostCurrent._pik_year1.runMethod(true,"setText",BA.ObjectToCharSequence(1380));
 };
 BA.debugLineNum = 326;BA.debugLine="If(pik_year1.Text<1380)Then";
Debug.ShouldStop(32);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, payankar_activity.mostCurrent._pik_year1.runMethod(true,"getText")),BA.numberCast(double.class, 1380)))) { 
...
Debug.ShouldStop(8388608);
 BA.debugLineNum = 121;BA.debugLine="Return NumberFormat(num,0,0)";
Debug.ShouldStop(16777216);
if (true) return payankar_activity.mostCurrent.__c.runMethod(true,"NumberFormat",(Object)(BA.numberCast(double.class, _num)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)));
