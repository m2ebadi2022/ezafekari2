...
public class sayer_activity implements IRemote{
	public static sayer_activity mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public sayer_activity() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("sayer_activity"), "ir.taravatgroup.ezafekari2.sayer_activity");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, sayer_activity.class);
...
public static ir.taravatgroup.ezafekari2.savabeg_activity _savabeg_activity = null;
...
public static ir.taravatgroup.ezafekari2.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",sayer_activity.mostCurrent._activity,"addEdit_id",sayer_activity._addedit_id,"ayabzahab_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.ayabzahab_activity.class),"bime_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.bime_activity.class),"calc_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.calc_activity.class),"comment_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.comment_activity.class),"current_itemId_edit",sayer_activity._current_itemid_edit,"cust_LV_sayer",sayer_activity.mostCurrent._cust_lv_sayer,"darsad_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.darsad_activity.class),"DateUtils",sayer_activity.mostCurrent._dateutils,"dbCode",Debug.moduleToString(ir.taravatgroup.ezafekari2.dbcode.class),"eidi_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.eidi_activity.class),"et_mablagh_edit1",sayer_activity.mostCurrent._et_mablagh_edit1,"et_onvan_edit1",sayer_activity.mostCurrent._et_onvan_edit1,"et_tozih_edit1",sayer_activity.mostCurrent._et_tozih_edit1,"fast_run_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.fast_run_activity.class),"food_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.food_activity.class),"ganon_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.ganon_activity.class),"gestha_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.gestha_activity.class),"help_kharid_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.help_kharid_activity.class),"hogog_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.hogog_activity.class),"HttpUtils2Service",Debug.moduleToString(ir.taravatgroup.ezafekari2.httputils2service.class),"index_current_pan",sayer_activity._index_current_pan,"info_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.info_activity.class),"lbl_date",sayer_activity.mostCurrent._lbl_date,"lbl_date_edit1",sayer_activity.mostCurrent._lbl_date_edit1,"lbl_edit_from_list",sayer_activity.mostCurrent._lbl_edit_from_list,"lbl_icon",sayer_activity.mostCurrent._lbl_icon,"lbl_mablagh",sayer_activity.mostCurrent._lbl_mablagh,"lbl_onvan",sayer_activity.mostCurrent._lbl_onvan,"lbl_remove_from_list",sayer_activity.mostCurrent._lbl_remove_from_list,"lbl_sp_type",sayer_activity.mostCurrent._lbl_sp_type,"lbl_title_edit1",sayer_activity.mostCurrent._lbl_title_edit1,"lbl_tozih",sayer_activity.mostCurrent._lbl_tozih,"Main",Debug.moduleToString(ir.taravatgroup.ezafekari2.main.class),"moon_dataPik",sayer_activity.mostCurrent._moon_datapik,"morakhasi_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.morakhasi_activity.class),"mosaedeh_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.mosaedeh_activity.class),"myfunc",Debug.moduleToString(ir.taravatgroup.ezafekari2.myfunc.class),"num_dataPik",sayer_activity._num_datapik,"p",sayer_activity.mostCurrent._p,"padash_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.padash_activity.class),"pan_all_edit1",sayer_activity.mostCurrent._pan_all_edit1,"pan_all_set_date",sayer_activity.mostCurrent._pan_all_set_date,"pan_hed_list2",sayer_activity.mostCurrent._pan_hed_list2,"Panel1",sayer_activity.mostCurrent._panel1,"payankar_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.payankar_activity.class),"pik_day1",sayer_activity.mostCurrent._pik_day1,"pik_moon1",sayer_activity.mostCurrent._pik_moon1,"pik_year1",sayer_activity.mostCurrent._pik_year1,"sabt2_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.sabt2_activity.class),"savabeg_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.savabeg_activity.class),"setting_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.setting_activity.class),"setting_hogog_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.setting_hogog_activity.class),"shift_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.shift_activity.class),"show_gozaresh_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.show_gozaresh_activity.class),"sp_moon",sayer_activity.mostCurrent._sp_moon,"sp_type_state",sayer_activity.mostCurrent._sp_type_state,"sp_year",sayer_activity.mostCurrent._sp_year,"Starter",Debug.moduleToString(ir.taravatgroup.ezafekari2.starter.class),"step0_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step0_activity.class),"step1_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step1_activity.class),"step2_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step2_activity.class),"vam_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.vam_activity.class),"xui2",sayer_activity.mostCurrent._xui2};
}
}