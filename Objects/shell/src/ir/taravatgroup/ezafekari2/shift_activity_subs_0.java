...
try {
		Debug.PushSubsStack("Activity_Create (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,330);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,732);
...
try {
		Debug.PushSubsStack("Activity_Pause (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,721);
...
try {
		Debug.PushSubsStack("Activity_Resume (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,717);
...
try {
		Debug.PushSubsStack("generat_taghvim (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,908);
...
Debug.ShouldStop(8192);
shift_activity.mostCurrent.__c.runVoidMethod ("LogImpl","617891426",RemoteObject.createImmutable("nooop data"),0);
 };
...
Debug.ShouldStop(1073741824);
shift_activity.mostCurrent.__c.runVoidMethod ("LogImpl","617891507",BA.ObjectToString(shift_activity.mostCurrent.__c.runMethod(false,"LastException",shift_activity.mostCurrent.activityBA)),0);
 };
...
try {
		Debug.PushSubsStack("get_ezafekari (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,845);
...
try {
		Debug.PushSubsStack("get_monasebat (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,756);
...
try {
		Debug.PushSubsStack("get_morakhasi (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,874);
...
try {
		Debug.PushSubsStack("get_note (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,800);
...
try {
		Debug.PushSubsStack("get_taradod (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,816);
...
try {
		Debug.PushSubsStack("lbl_back_2_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1333);
...
try {
		Debug.PushSubsStack("lbl_back_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,727);
...
try {
		Debug.PushSubsStack("lbl_del_shiftha_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1344);
...
try {
		Debug.PushSubsStack("lbl_delete_lis_olgo_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1338);
...
try {
		Debug.PushSubsStack("lbl_edit_note_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1365);
...
try {
		Debug.PushSubsStack("lbl_go_today_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,510);
...
try {
		Debug.PushSubsStack("lbl_mah_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,639);
...
try {
		Debug.PushSubsStack("lbl_mah_end_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,702);
...
try {
		Debug.PushSubsStack("lbl_moon_name_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,545);
...
try {
		Debug.PushSubsStack("lbl_new_line_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1197);
...
try {
		Debug.PushSubsStack("lbl_next_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1147);
...
try {
		Debug.PushSubsStack("lbl_prev_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1168);
...
try {
		Debug.PushSubsStack("lbl_roz_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,643);
...
try {
		Debug.PushSubsStack("lbl_roz_end_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,706);
...
try {
		Debug.PushSubsStack("lbl_save_note_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1398);
...
try {
		Debug.PushSubsStack("lbl_save_shift_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1225);
...
try {
		Debug.PushSubsStack("lbl_show_panShift_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1260);
...
try {
		Debug.PushSubsStack("lbl_year_tagvim_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,541);
...
try {
		Debug.PushSubsStack("lbl_years_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,635);
...
try {
		Debug.PushSubsStack("lbl_years_end_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,698);
...
try {
		Debug.PushSubsStack("PA_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1097);
...
try {
		Debug.PushSubsStack("PA_LongClick (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1379);
...
try {
		Debug.PushSubsStack("pan_all_note_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1390);
...
try {
		Debug.PushSubsStack("pan_all_setSift_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1193);
...
try {
		Debug.PushSubsStack("Panel12_Click (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1394);
...
try {
		Debug.PushSubsStack("rsPOP_mah_end_MenuItemClick (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,654);
...
try {
		Debug.PushSubsStack("rsPOP_mah_MenuItemClick (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,594);
...
try {
		Debug.PushSubsStack("rsPOP_moon_tagvim_MenuItemClick (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,551);
...
try {
		Debug.PushSubsStack("rsPOP_roz_end_MenuItemClick (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,691);
...
try {
		Debug.PushSubsStack("rsPOP_roz_MenuItemClick (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,629);
...
try {
		Debug.PushSubsStack("rsPOP_year_end_MenuItemClick (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,650);
...
try {
		Debug.PushSubsStack("rsPOP_year_MenuItemClick (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,590);
...
try {
		Debug.PushSubsStack("rsPOP_year_tagvim_MenuItemClick (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,535);
...
try {
		Debug.PushSubsStack("set_note (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1407);
...
try {
		Debug.PushSubsStack("set_shift (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1283);
...
Debug.ShouldStop(32);
shift_activity.mostCurrent.__c.runVoidMethod ("LogImpl","618415651",BA.ObjectToString(shift_activity.mostCurrent.__c.runMethod(false,"LastException",shift_activity.mostCurrent.activityBA)),0);
...
try {
		Debug.PushSubsStack("shift_rest (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1348);
...
try {
		Debug.PushSubsStack("sql_NonQueryComplete (shift_activity) ","shift_activity",6,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1327);
