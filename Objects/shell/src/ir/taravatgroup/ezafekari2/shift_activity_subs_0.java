...
try {
		Debug.PushSubsStack("Activity_Create (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,335);
...
{
final int step101 = 1;
final int limit101 = 31;
_i = 1 ;
for (;(step101 > 0 && _i <= limit101) || (step101 < 0 && _i >= limit101) ;_i = ((int)(0 + _i + step101))  ) {
Debug.locals.put("i", _i);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,740);
...
{ BA.debugLineNum = 746;BA.debugLine="Else If (pan_all_note.Visible=True)Then";
Debug.ShouldStop(512);
...
try {
		Debug.PushSubsStack("Activity_Pause (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,729);
...
try {
		Debug.PushSubsStack("Activity_Resume (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,725);
...
try {
		Debug.PushSubsStack("CheckBox_tatil_garardadi_CheckedChange (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1514);
...
Debug.locals.put("Checked", _checked);
 BA.debugLineNum = 1514;BA.debugLine="Private Sub CheckBox_tatil_garardadi_CheckedChange";
Debug.ShouldStop(512);
...
shift_activity.mostCurrent._dbcode.runVoidMethod ("_connect_db" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA);
 BA.debugLineNum = 1516;BA.debugLine="If(Checked=True)Then";
Debug.ShouldStop(2048);
if ((RemoteObject.solveBoolean("=",_checked,shift_activity.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 1518;BA.debugLine="dbCode.sql.ExecNonQuery(\"UPDATE 'my_calander' se";
Debug.ShouldStop(8192);
shift_activity.mostCurrent._dbcode._sql /*RemoteObject*/ .runVoidMethod ("ExecNonQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("UPDATE 'my_calander' set state='tatil1' WHERE id="),shift_activity._selectedday_id)));
 ...
 BA.debugLineNum = 1522;BA.debugLine="dbCode.sql.ExecNonQuery(\"UPDATE 'my_calander' se";
Debug.ShouldStop(131072);
shift_activity.mostCurrent._dbcode._sql /*RemoteObject*/ .runVoidMethod ("ExecNonQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("UPDATE 'my_calander' set state='' WHERE id="),shift_activity._selectedday_id)));
 ...
 BA.debugLineNum = 1525;BA.debugLine="generat_taghvim(lbl_year_tagvim.Text,lbl_moon_nam";
Debug.ShouldStop(1048576);
_generat_taghvim(BA.numberCast(int.class, shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"getText")),BA.numberCast(int.class, shift_activity.mostCurrent._lbl_moon_name.runMethod(false,"getTag")));
 BA.debugLineNum = 1527;BA.debugLine="pan_all_menu_day_Click";
Debug.ShouldStop(4194304);
_pan_all_menu_day_click();
 BA.debugLineNum = 1528;BA.debugLine="ToastMessageShow(\" ذخیره شد\",True)";
Debug.ShouldStop(8388608);
...
try {
		Debug.PushSubsStack("generat_taghvim (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,920);
...
Debug.locals.put("moon", _moon);
 BA.debugLineNum = 920;BA.debugLine="Sub generat_taghvim(year As Int , moon As Int)";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 921;BA.debugLine="Try";
Debug.ShouldStop(16777216);
try { BA.debugLineNum = 924;BA.debugLine="dbCode.connect_db";
Debug.ShouldStop(134217728);
shift_activity.mostCurrent._dbcode.runVoidMethod ("_connect_db" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA);
 BA.debugLineNum = 928;BA.debugLine="For d=0 To PA.Length-1";
Debug.ShouldStop(-2147483648);
{
final int step3 = 1;
...
Debug.locals.put("d", _d);
 BA.debugLineNum = 929;BA.debugLine="PA(d).Visible=True";
Debug.ShouldStop(1);
shift_activity.mostCurrent._pa.getArrayElement(false,BA.numberCast(int.class, _d)).runMethod(true,"setVisible",shift_activity.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 930;BA.debugLine="PA(d).Color=0xFFEFEFEF";
Debug.ShouldStop(2);
shift_activity.mostCurrent._pa.getArrayElement(false,BA.numberCast(int.class, _d)).runVoidMethod ("setColor",BA.numberCast(int.class, ((int)0xffefefef)));
 BA.debugLineNum = 933;BA.debugLine="EZ(d).Text=\"\"";
Debug.ShouldStop(16);
shift_activity.mostCurrent._ez.getArrayElement(false,BA.numberCast(int.class, _d)).runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 934;BA.debugLine="NO(d).Text=\"\"";
Debug.ShouldStop(32);
...
shift_activity.mostCurrent._dbcode._res /*RemoteObject*/  = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.sql.SQL.ResultSetWrapper"), shift_activity.mostCurrent._dbcode._sql /*RemoteObject*/ .runMethod(false,"ExecQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("SELECT * FROM 'my_calander' WHERE year="),_year,RemoteObject.createImmutable(" AND moon="),_moon,RemoteObject.createImmutable(" ;")))));
 BA.debugLineNum = 983;BA.debugLine="If (dbCode.res.RowCount>0)Then";
Debug.ShouldStop(4194304);
if ((RemoteObject.solveBoolean(">",shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"getRowCount"),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 985;BA.debugLine="count_day_moon=dbCode.res.RowCount";
Debug.ShouldStop(16777216);
_count_day_moon = shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"getRowCount");Debug.locals.put("count_day_moon", _count_day_moon);
 BA.debugLineNum = 986;BA.debugLine="dbCode.res.Position =0";
Debug.ShouldStop(33554432);
shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"setPosition",BA.numberCast(int.class, 0));
 BA.debugLineNum = 987;BA.debugLine="start_day=dbCode.res.Getint(\"day_h\")";
Debug.ShouldStop(67108864);
shift_activity._start_day = shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("day_h")));
 BA.debugLineNum = 990;BA.debugLine="For i=0 To dbCode.res.RowCount-1";
Debug.ShouldStop(536870912);
{
final int step48 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 991;BA.debugLine="dbCode.res.Position =i";
Debug.ShouldStop(1073741824);
shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"setPosition",BA.numberCast(int.class, _i));
 BA.debugLineNum = 993;BA.debugLine="If (dbCode.res.GetString(\"shift\") = Null)Then";
Debug.ShouldStop(1);
if ((RemoteObject.solveBoolean("n",shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("shift")))))) { 
 BA.debugLineNum = 994;BA.debugLine="ls_shift_moon.Add(\"\")";
Debug.ShouldStop(2);
shift_activity.mostCurrent._ls_shift_moon.runVoidMethod ("Add",(Object)((RemoteObject.createImmutable(""))));
 }else {
 BA.debugLineNum = 996;BA.debugLine="ls_shift_moon.Add(dbCode.res.GetString(\"shift";
Debug.ShouldStop(8);
shift_activity.mostCurrent._ls_shift_moon.runVoidMethod ("Add",(Object)((shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("shift"))))));
 ...
 BA.debugLineNum = 1000;BA.debugLine="If (dbCode.res.GetString(\"state\") = \"tatil\")Th";
Debug.ShouldStop(128);
...
if ((RemoteObject.solveBoolean("=",shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("state"))),RemoteObject.createImmutable("tatil1")))) { 
 BA.debugLineNum = 1008;BA.debugLine="ls_tatili_custom_moon.Add(True)";
Debug.ShouldStop(32768);
shift_activity.mostCurrent._ls_tatili_custom_moon.runVoidMethod ("Add",(Object)((shift_activity.mostCurrent.__c.getField(true,"True"))));
 ...
 BA.debugLineNum = 1010;BA.debugLine="ls_tatili_custom_moon.Add(False)";
Debug.ShouldStop(131072);
shift_activity.mostCurrent._ls_tatili_custom_moon.runVoidMethod ("Add",(Object)((shift_activity.mostCurrent.__c.getField(true,"False"))));
 ...
 BA.debugLineNum = 1014;BA.debugLine="If (dbCode.res.GetString(\"note\") = \"\")Then";
Debug.ShouldStop(2097152);
...
Debug.ShouldStop(2);
shift_activity.mostCurrent.__c.runVoidMethod ("LogImpl","241287786",RemoteObject.createImmutable("nooop data"),0);
 };
...
Debug.locals.put("j", _j);
 BA.debugLineNum = 1032;BA.debugLine="PA(j).Visible=False";
Debug.ShouldStop(128);
...
;
 BA.debugLineNum = 1037;BA.debugLine="Dim counter As Int=1";
Debug.ShouldStop(4096);
_counter = BA.numberCast(int.class, 1);Debug.locals.put("counter", _counter);Debug.locals.put("counter", _counter);
 BA.debugLineNum = 1039;BA.debugLine="For i = start_day To count_day_moon+start_day";
Debug.ShouldStop(16384);
{
final int step78 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 1045;BA.debugLine="Lb(i).Text=counter";
Debug.ShouldStop(1048576);
shift_activity.mostCurrent._lb.getArrayElement(false,BA.numberCast(int.class, _i)).runMethod(true,"setText",BA.ObjectToCharSequence(_counter));
 BA.debugLineNum = 1046;BA.debugLine="PA(i).Tag=counter";
Debug.ShouldStop(2097152);
shift_activity.mostCurrent._pa.getArrayElement(false,BA.numberCast(int.class, _i)).runMethod(false,"setTag",(_counter));
 BA.debugLineNum = 1051;BA.debugLine="If(counter-1 < count_day_moon)Then";
Debug.ShouldStop(67108864);
if ((RemoteObject.solveBoolean("<",RemoteObject.solve(new RemoteObject[] {_counter,RemoteObject.createImmutable(1)}, "-",1, 1),BA.numberCast(double.class, _count_day_moon)))) { 
 BA.debugLineNum = 1052;BA.debugLine="SH(i).Text=ls_shift_moon.Get(counter-1)  ''---s";
Debug.ShouldStop(134217728);
shift_activity.mostCurrent._sh.getArrayElement(false,BA.numberCast(int.class, _i)).runMethod(true,"setText",BA.ObjectToCharSequence(shift_activity.mostCurrent._ls_shift_moon.runMethod(false,"Get",(Object)(RemoteObject.solve(new RemoteObject[] {_counter,RemoteObject.createImmutable(1)}, "-",1, 1)))));
 BA.debugLineNum = 1053;BA.debugLine="If(SH(i).Text=\"ر\")Then";
Debug.ShouldStop(268435456);
if ((RemoteObject.solveBoolean("=",shift_activity.mostCurrent._sh.getArrayElement(false,BA.numberCast(int.class, _i)).runMethod(true,"getText"),RemoteObject.createImmutable("ر")))) { 
 BA.debugLineNum = 1054;BA.debugLine="SH(i).Color=0x96FFFA00";
Debug.ShouldStop(536870912);
...
{ BA.debugLineNum = 1055;BA.debugLine="Else If (SH(i).Text=\"ع\")Then";
Debug.ShouldStop(1073741824);
if ((RemoteObject.solveBoolean("=",shift_activity.mostCurrent._sh.getArrayElement(false,BA.numberCast(int.class, _i)).runMethod(true,"getText"),RemoteObject.createImmutable("ع")))) { 
 BA.debugLineNum = 1056;BA.debugLine="SH(i).Color=0x960066FF";
Debug.ShouldStop(-2147483648);
shift_activity.mostCurrent._sh.getArrayElement(false,BA.numberCast(int.class, _i)).runVoidMethod ("setColor",BA.numberCast(int.class, ((int)0x960066ff)));
 }else 
{ BA.debugLineNum = 1057;BA.debugLine="Else If (SH(i).Text=\"ش\")Then";
Debug.ShouldStop(1);
if ((RemoteObject.solveBoolean("=",shift_activity.mostCurrent._sh.getArrayElement(false,BA.numberCast(int.class, _i)).runMethod(true,"getText"),RemoteObject.createImmutable("ش")))) { 
 BA.debugLineNum = 1058;BA.debugLine="SH(i).Color=0x96414141";
Debug.ShouldStop(2);
...
{ BA.debugLineNum = 1059;BA.debugLine="Else If (SH(i).Text=\"ا\")Then";
Debug.ShouldStop(4);
if ((RemoteObject.solveBoolean("=",shift_activity.mostCurrent._sh.getArrayElement(false,BA.numberCast(int.class, _i)).runMethod(true,"getText"),RemoteObject.createImmutable("ا")))) { 
 BA.debugLineNum = 1060;BA.debugLine="SH(i).Color=0x9600FF24";
Debug.ShouldStop(8);
shift_activity.mostCurrent._sh.getArrayElement(false,BA.numberCast(int.class, _i)).runVoidMethod ("setColor",BA.numberCast(int.class, ((int)0x9600ff24)));
 ...
 BA.debugLineNum = 1062;BA.debugLine="SH(i).Color=Colors.Transparent";
Debug.ShouldStop(32);
...
;
 BA.debugLineNum = 1068;BA.debugLine="If(ls_tatili_moon.Get(counter-1)=True)Then";
Debug.ShouldStop(2048);
if ((RemoteObject.solveBoolean("=",shift_activity.mostCurrent._ls_tatili_moon.runMethod(false,"Get",(Object)(RemoteObject.solve(new RemoteObject[] {_counter,RemoteObject.createImmutable(1)}, "-",1, 1))),(shift_activity.mostCurrent.__c.getField(true,"True"))))) { 
 BA.debugLineNum = 1069;BA.debugLine="PA(i).Color=0xFFFF5252";
Debug.ShouldStop(4096);
shift_activity.mostCurrent._pa.getArrayElement(false,BA.numberCast(int.class, _i)).runVoidMethod ("setColor",BA.numberCast(int.class, ((int)0xffff5252)));
 ...
 BA.debugLineNum = 1073;BA.debugLine="If(ls_tatili_custom_moon.Get(counter-1)=True)T";
Debug.ShouldStop(65536);
if ((RemoteObject.solveBoolean("=",shift_activity.mostCurrent._ls_tatili_custom_moon.runMethod(false,"Get",(Object)(RemoteObject.solve(new RemoteObject[] {_counter,RemoteObject.createImmutable(1)}, "-",1, 1))),(shift_activity.mostCurrent.__c.getField(true,"True"))))) { 
 BA.debugLineNum = 1074;BA.debugLine="PA(i).Color=0xFF00BB8B";
Debug.ShouldStop(131072);
shift_activity.mostCurrent._pa.getArrayElement(false,BA.numberCast(int.class, _i)).runVoidMethod ("setColor",BA.numberCast(int.class, ((int)0xff00bb8b)));
 ...
 BA.debugLineNum = 1078;BA.debugLine="If(ls_note_moon.Get(counter-1)=True)Then";
Debug.ShouldStop(2097152);
if ((RemoteObject.solveBoolean("=",shift_activity.mostCurrent._ls_note_moon.runMethod(false,"Get",(Object)(RemoteObject.solve(new RemoteObject[] {_counter,RemoteObject.createImmutable(1)}, "-",1, 1))),(shift_activity.mostCurrent.__c.getField(true,"True"))))) { 
 BA.debugLineNum = 1079;BA.debugLine="NO(i).Text=\"•\"";
Debug.ShouldStop(4194304);
shift_activity.mostCurrent._no.getArrayElement(false,BA.numberCast(int.class, _i)).runMethod(true,"setText",BA.ObjectToCharSequence("•"));
 BA.debugLineNum = 1080;BA.debugLine="NO(i).textColor=Colors.Blue";
Debug.ShouldStop(8388608);
shift_activity.mostCurrent._no.getArrayElement(false,BA.numberCast(int.class, _i)).runMethod(true,"setTextColor",shift_activity.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue"));
 ...
 BA.debugLineNum = 1085;BA.debugLine="If(dbCode.isexist_ezafekari_by_date(year&\"/\"&my";
Debug.ShouldStop(268435456);
if ((RemoteObject.solveBoolean("=",shift_activity.mostCurrent._dbcode.runMethod(true,"_isexist_ezafekari_by_date" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(RemoteObject.concat(_year,RemoteObject.createImmutable("/"),shift_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(_moon)),RemoteObject.createImmutable("/"),shift_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(_counter))))),shift_activity.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 1086;BA.debugLine="EZ(i).Text=\"*\"";
Debug.ShouldStop(536870912);
shift_activity.mostCurrent._ez.getArrayElement(false,BA.numberCast(int.class, _i)).runMethod(true,"setText",BA.ObjectToCharSequence("*"));
 BA.debugLineNum = 1087;BA.debugLine="EZ(i).TextColor=0xFF00941C";
Debug.ShouldStop(1073741824);
...
{ BA.debugLineNum = 1088;BA.debugLine="Else if (dbCode.isexist_morakhasi_by_date(year&";
Debug.ShouldStop(-2147483648);
if ((RemoteObject.solveBoolean("=",shift_activity.mostCurrent._dbcode.runMethod(true,"_isexist_morakhasi_by_date" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(RemoteObject.concat(_year,RemoteObject.createImmutable("/"),shift_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(_moon)),RemoteObject.createImmutable("/"),shift_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(_counter))))),shift_activity.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 1089;BA.debugLine="EZ(i).Text=\"*\"";
Debug.ShouldStop(1);
shift_activity.mostCurrent._ez.getArrayElement(false,BA.numberCast(int.class, _i)).runMethod(true,"setText",BA.ObjectToCharSequence("*"));
 BA.debugLineNum = 1090;BA.debugLine="EZ(i).TextColor=0xFFFF5200";
Debug.ShouldStop(2);
...
{ BA.debugLineNum = 1091;BA.debugLine="Else if (dbCode.isexist_taradod_by_date(year&\"/";
Debug.ShouldStop(4);
if ((RemoteObject.solveBoolean("=",shift_activity.mostCurrent._dbcode.runMethod(true,"_isexist_taradod_by_date" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(RemoteObject.concat(_year,RemoteObject.createImmutable("/"),shift_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(_moon)),RemoteObject.createImmutable("/"),shift_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(_counter))))),shift_activity.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 1092;BA.debugLine="EZ(i).Text=\"*\"";
Debug.ShouldStop(8);
shift_activity.mostCurrent._ez.getArrayElement(false,BA.numberCast(int.class, _i)).runMethod(true,"setText",BA.ObjectToCharSequence("*"));
 BA.debugLineNum = 1093;BA.debugLine="EZ(i).TextColor=0xFFFF5200";
Debug.ShouldStop(16);
shift_activity.mostCurrent._ez.getArrayElement(false,BA.numberCast(int.class, _i)).runMethod(true,"setTextColor",BA.numberCast(int.class, ((int)0xffff5200)));
 }}}
;
 };
 BA.debugLineNum = 1102;BA.debugLine="If(counter=this_day And moon=date.PersianMonth A";
Debug.ShouldStop(8192);
if ((RemoteObject.solveBoolean("=",_counter,BA.numberCast(double.class, shift_activity._this_day)) && RemoteObject.solveBoolean("=",_moon,BA.numberCast(double.class, shift_activity.mostCurrent._date.runMethod(true,"getPersianMonth"))) && RemoteObject.solveBoolean("=",_year,BA.numberCast(double.class, shift_activity._this_year)))) { 
 BA.debugLineNum = 1105;BA.debugLine="Lb(i).TextColor=0xFFFF9000";
Debug.ShouldStop(65536);
shift_activity.mostCurrent._lb.getArrayElement(false,BA.numberCast(int.class, _i)).runMethod(true,"setTextColor",BA.numberCast(int.class, ((int)0xffff9000)));
 BA.debugLineNum = 1106;BA.debugLine="index_i_today=i";
Debug.ShouldStop(131072);
shift_activity._index_i_today = BA.numberCast(int.class, _i);
 };
 BA.debugLineNum = 1109;BA.debugLine="If(counter>=count_day_moon)Then";
Debug.ShouldStop(1048576);
if ((RemoteObject.solveBoolean("g",_counter,BA.numberCast(double.class, _count_day_moon)))) { 
 BA.debugLineNum = 1111;BA.debugLine="For f=i+1 To Lb.Length-1";
Debug.ShouldStop(4194304);
{
final int step120 = 1;
final int limit120 = RemoteObject.solve(new RemoteObject[] {shift_activity.mostCurrent._lb.getField(true,"length"),RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
...
for (;(step120 > 0 && _f <= limit120) || (step120 < 0 && _f >= limit120) ;_f = ((int)(0 + _f + step120))  ) {
Debug.locals.put("f", _f);
 BA.debugLineNum = 1112;BA.debugLine="PA(f).Visible=False";
Debug.ShouldStop(8388608);
...
;
 ...
 BA.debugLineNum = 1118;BA.debugLine="counter=counter+1";
Debug.ShouldStop(536870912);
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",shift_activity.processBA, e127.toString()); BA.debugLineNum = 1122;BA.debugLine="Log(LastException)";
Debug.ShouldStop(2);
shift_activity.mostCurrent.__c.runVoidMethod ("LogImpl","241287882",BA.ObjectToString(shift_activity.mostCurrent.__c.runMethod(false,"LastException",shift_activity.mostCurrent.activityBA)),0);
 };
...
try {
		Debug.PushSubsStack("get_ezafekari (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,857);
...
shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"setPosition",BA.numberCast(int.class, _k));
 BA.debugLineNum = 870;BA.debugLine="ezList.Add(newLine&\"از \"&dbCode.res.GetString(\"";
Debug.ShouldStop(32);
_ezlist.runVoidMethod ("Add",(Object)((RemoteObject.concat(_newline,RemoteObject.createImmutable("از "),shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("time_from"))),RemoteObject.createImmutable(" تا "),shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("time_to"))),RemoteObject.createImmutable("  ( "),shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("end_tim_h"))),RemoteObject.createImmutable(":"),shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("end_tim_m"))),RemoteObject.createImmutable(")")))));
 BA.debugLineNum = 871;BA.debugLine="newLine=CRLF";
Debug.ShouldStop(64);
...
;
 ...
 BA.debugLineNum = 877;BA.debugLine="ezList.Add(\"-\")";
Debug.ShouldStop(4096);
_ezlist.runVoidMethod ("Add",(Object)((RemoteObject.createImmutable("-"))));
 };
 BA.debugLineNum = 880;BA.debugLine="For i=0 To ezList.Size-1";
Debug.ShouldStop(32768);
{
final int step16 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 881;BA.debugLine="lbl_ezafekari_day.Text=lbl_ezafekari_day.Text &";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("get_monasebat (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,764);
...
try {
		Debug.PushSubsStack("get_morakhasi (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,886);
...
int _i = 0;
Debug.locals.put("date1", _date1);
 BA.debugLineNum = 886;BA.debugLine="Sub get_morakhasi(date1 As String)";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 887;BA.debugLine="lbl_morakhasi_day.Text=\"\"";
Debug.ShouldStop(4194304);
shift_activity.mostCurrent._lbl_morakhasi_day.runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 888;BA.debugLine="dbCode.connect_db";
Debug.ShouldStop(8388608);
shift_activity.mostCurrent._dbcode.runVoidMethod ("_connect_db" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA);
 BA.debugLineNum = 889;BA.debugLine="Dim ezList As List";
Debug.ShouldStop(16777216);
_ezlist = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("ezList", _ezlist);
 BA.debugLineNum = 890;BA.debugLine="ezList.Initialize";
Debug.ShouldStop(33554432);
_ezlist.runVoidMethod ("Initialize");
 BA.debugLineNum = 891;BA.debugLine="Dim newLine As String=\"\"";
Debug.ShouldStop(67108864);
_newline = BA.ObjectToString("");Debug.locals.put("newLine", _newline);Debug.locals.put("newLine", _newline);
 BA.debugLineNum = 893;BA.debugLine="dbCode.res =  dbCode.sql.ExecQuery(\"SELECT * FROM";
Debug.ShouldStop(268435456);
shift_activity.mostCurrent._dbcode._res /*RemoteObject*/  = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.sql.SQL.ResultSetWrapper"), shift_activity.mostCurrent._dbcode._sql /*RemoteObject*/ .runMethod(false,"ExecQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("SELECT * FROM tb_morakhasi WHERE date_from LIKE '"),_date1,RemoteObject.createImmutable("';")))));
 BA.debugLineNum = 895;BA.debugLine="If (dbCode.res.RowCount>0)Then";
Debug.ShouldStop(1073741824);
if ((RemoteObject.solveBoolean(">",shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"getRowCount"),BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 896;BA.debugLine="For K=0 To dbCode.res.RowCount-1";
Debug.ShouldStop(-2147483648);
{
final int step8 = 1;
final int limit8 = RemoteObject.solve(new RemoteObject[] {shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"getRowCount"),RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
...
for (;(step8 > 0 && _k <= limit8) || (step8 < 0 && _k >= limit8) ;_k = ((int)(0 + _k + step8))  ) {
Debug.locals.put("K", _k);
 BA.debugLineNum = 897;BA.debugLine="dbCode.res.Position=K";
Debug.ShouldStop(1);
shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"setPosition",BA.numberCast(int.class, _k));
 BA.debugLineNum = 899;BA.debugLine="ezList.Add(newLine&\"از \"&dbCode.res.GetString(\"";
Debug.ShouldStop(4);
_ezlist.runVoidMethod ("Add",(Object)((RemoteObject.concat(_newline,RemoteObject.createImmutable("از "),shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("time_from"))),RemoteObject.createImmutable(" تا "),shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("time_to"))),RemoteObject.createImmutable("  ( "),shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("end_tim_d"))),RemoteObject.createImmutable(":"),shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("end_tim_h"))),RemoteObject.createImmutable(":"),shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("end_tim_m"))),RemoteObject.createImmutable(")")))));
 BA.debugLineNum = 900;BA.debugLine="newLine=CRLF";
Debug.ShouldStop(8);
_newline = shift_activity.mostCurrent.__c.getField(true,"CRLF");Debug.locals.put("newLine", _newline);
 }
}Debug.locals.put("K", _k);
;
 ...
 BA.debugLineNum = 906;BA.debugLine="ezList.Add(\"-\")";
Debug.ShouldStop(512);
_ezlist.runVoidMethod ("Add",(Object)((RemoteObject.createImmutable("-"))));
 };
 BA.debugLineNum = 909;BA.debugLine="For i=0 To ezList.Size-1";
Debug.ShouldStop(4096);
{
final int step16 = 1;
final int limit16 = RemoteObject.solve(new RemoteObject[] {_ezlist.runMethod(true,"getSize"),RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
...
for (;(step16 > 0 && _i <= limit16) || (step16 < 0 && _i >= limit16) ;_i = ((int)(0 + _i + step16))  ) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 910;BA.debugLine="lbl_morakhasi_day.Text=lbl_morakhasi_day.Text &";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("get_note (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,812);
...
try {
		Debug.PushSubsStack("get_taradod (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,828);
...
try {
		Debug.PushSubsStack("lbl_back_2_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1374);
if (RapidSub.canDelegate("lbl_back_2_click")) { return ir.taravatgroup.ezafekari2.shift_activity.remoteMe.runUserSub(false, "shift_activity","lbl_back_2_click");}
 BA.debugLineNum = 1374;BA.debugLine="Private Sub lbl_back_2_Click";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 1375;BA.debugLine="pan_all_setSift.Visible=False";
Debug.ShouldStop(1073741824);
shift_activity.mostCurrent._pan_all_setsift.runMethod(true,"setVisible",shift_activity.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 1376;BA.debugLine="lbl_delete_lis_olgo_Click";
Debug.ShouldStop(-2147483648);
_lbl_delete_lis_olgo_click();
...
try {
		Debug.PushSubsStack("lbl_back_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,735);
...
try {
		Debug.PushSubsStack("lbl_CheckBox_tatil_garardadi_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1504);
if (RapidSub.canDelegate("lbl_checkbox_tatil_garardadi_click")) { return ir.taravatgroup.ezafekari2.shift_activity.remoteMe.runUserSub(false, "shift_activity","lbl_checkbox_tatil_garardadi_click");}
 BA.debugLineNum = 1504;BA.debugLine="Private Sub lbl_CheckBox_tatil_garardadi_Click";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 1506;BA.debugLine="If(CheckBox_tatil_garardadi.Checked=True)Then";
Debug.ShouldStop(2);
if ((RemoteObject.solveBoolean("=",shift_activity.mostCurrent._checkbox_tatil_garardadi.runMethod(true,"getChecked"),shift_activity.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 1507;BA.debugLine="CheckBox_tatil_garardadi.Checked=False";
Debug.ShouldStop(4);
shift_activity.mostCurrent._checkbox_tatil_garardadi.runMethodAndSync(true,"setChecked",shift_activity.mostCurrent.__c.getField(true,"False"));
 ...
 BA.debugLineNum = 1509;BA.debugLine="CheckBox_tatil_garardadi.Checked=True";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("lbl_del_shiftha_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1385);
if (RapidSub.canDelegate("lbl_del_shiftha_click")) { return ir.taravatgroup.ezafekari2.shift_activity.remoteMe.runUserSub(false, "shift_activity","lbl_del_shiftha_click");}
 BA.debugLineNum = 1385;BA.debugLine="Private Sub lbl_del_shiftha_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 1386;BA.debugLine="shift_rest";
Debug.ShouldStop(512);
_shift_rest();
...
try {
		Debug.PushSubsStack("lbl_delete_lis_olgo_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1379);
if (RapidSub.canDelegate("lbl_delete_lis_olgo_click")) { return ir.taravatgroup.ezafekari2.shift_activity.remoteMe.runUserSub(false, "shift_activity","lbl_delete_lis_olgo_click");}
 BA.debugLineNum = 1379;BA.debugLine="Private Sub lbl_delete_lis_olgo_Click";
Debug.ShouldStop(4);
 BA.debugLineNum = 1380;BA.debugLine="ls_set_shift.Clear";
Debug.ShouldStop(8);
shift_activity.mostCurrent._ls_set_shift.runVoidMethod ("Clear");
 BA.debugLineNum = 1381;BA.debugLine="list_sift_olgo.Clear";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("lbl_edit_note_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1406);
if (RapidSub.canDelegate("lbl_edit_note_click")) { return ir.taravatgroup.ezafekari2.shift_activity.remoteMe.runUserSub(false, "shift_activity","lbl_edit_note_click");}
 BA.debugLineNum = 1406;BA.debugLine="Private Sub lbl_edit_note_Click";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 1407;BA.debugLine="dbCode.connect_db";
Debug.ShouldStop(1073741824);
shift_activity.mostCurrent._dbcode.runVoidMethod ("_connect_db" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA);
 BA.debugLineNum = 1408;BA.debugLine="dbCode.res =  dbCode.sql.ExecQuery(\"SELECT * FROM";
Debug.ShouldStop(-2147483648);
shift_activity.mostCurrent._dbcode._res /*RemoteObject*/  = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.sql.SQL.ResultSetWrapper"), shift_activity.mostCurrent._dbcode._sql /*RemoteObject*/ .runMethod(false,"ExecQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("SELECT * FROM 'my_calander' WHERE id="),shift_activity._selectedday_id))));
 BA.debugLineNum = 1409;BA.debugLine="dbCode.res.Position=0";
Debug.ShouldStop(1);
shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"setPosition",BA.numberCast(int.class, 0));
 BA.debugLineNum = 1412;BA.debugLine="et_note.Text=dbCode.res.GetString(\"note\")";
Debug.ShouldStop(8);
shift_activity.mostCurrent._et_note.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("note")))));
 BA.debugLineNum = 1414;BA.debugLine="lbl_date_in_note.Text=lbl_year_tagvim.Text&\"/\"&db";
Debug.ShouldStop(32);
shift_activity.mostCurrent._lbl_date_in_note.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"getText"),RemoteObject.createImmutable("/"),shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("moon"))),RemoteObject.createImmutable("/"),shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetInt",(Object)(RemoteObject.createImmutable("day_c"))))));
 BA.debugLineNum = 1417;BA.debugLine="pan_all_note.Visible=True";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("lbl_go_today_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,518);
...
try {
		Debug.PushSubsStack("lbl_help_shift_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1531);
if (RapidSub.canDelegate("lbl_help_shift_click")) { return ir.taravatgroup.ezafekari2.shift_activity.remoteMe.runUserSub(false, "shift_activity","lbl_help_shift_click");}
 BA.debugLineNum = 1531;BA.debugLine="Private Sub lbl_help_shift_Click";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 1532;BA.debugLine="myfunc.help_man(\"راهنما\",\"1- با نگهداشتن انگشت رو";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("lbl_mah_end_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,710);
...
try {
		Debug.PushSubsStack("lbl_moon_name_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,553);
...
try {
		Debug.PushSubsStack("lbl_new_line_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1238);
...
int _i = 0;
 BA.debugLineNum = 1238;BA.debugLine="Private Sub lbl_new_line_Click";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 1241;BA.debugLine="ls_set_shift.AddSingleLine(et_num_roz.Text&\" \"&sp";
Debug.ShouldStop(16777216);
shift_activity.mostCurrent._ls_set_shift.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(shift_activity.mostCurrent._et_num_roz.runMethod(true,"getText"),RemoteObject.createImmutable(" "),shift_activity.mostCurrent._sp_noe_shift.runMethod(true,"getSelectedItem")))));
 BA.debugLineNum = 1242;BA.debugLine="For i=1 To et_num_roz.Text";
Debug.ShouldStop(33554432);
{
final int step2 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 1244;BA.debugLine="Select sp_noe_shift.SelectedIndex";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("lbl_next_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1188);
...
RemoteObject _adad = RemoteObject.createImmutable(0);
 BA.debugLineNum = 1188;BA.debugLine="Private Sub lbl_next_Click";
Debug.ShouldStop(8);
 BA.debugLineNum = 1190;BA.debugLine="If (current_moon>=12)Then";
Debug.ShouldStop(32);
if ((RemoteObject.solveBoolean("g",shift_activity._current_moon,BA.numberCast(double.class, 12)))) { 
 BA.debugLineNum = 1192;BA.debugLine="If(lbl_year_tagvim.Text<1403)Then";
Debug.ShouldStop(128);
if ((RemoteObject.solveBoolean("<",BA.numberCast(double.class, shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"getText")),BA.numberCast(double.class, 1403)))) { 
 BA.debugLineNum = 1193;BA.debugLine="Dim adad As Int=lbl_year_tagvim.Text";
Debug.ShouldStop(256);
_adad = BA.numberCast(int.class, shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"getText"));Debug.locals.put("adad", _adad);Debug.locals.put("adad", _adad);
 BA.debugLineNum = 1194;BA.debugLine="lbl_year_tagvim.Text=adad+1";
Debug.ShouldStop(512);
shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.solve(new RemoteObject[] {_adad,RemoteObject.createImmutable(1)}, "+",1, 1)));
 BA.debugLineNum = 1195;BA.debugLine="current_moon=1";
Debug.ShouldStop(1024);
shift_activity._current_moon = BA.numberCast(int.class, 1);
 }else {
 BA.debugLineNum = 1197;BA.debugLine="current_moon=12";
Debug.ShouldStop(4096);
shift_activity._current_moon = BA.numberCast(int.class, 12);
 };
 }else {
 BA.debugLineNum = 1203;BA.debugLine="current_moon=current_moon+1";
Debug.ShouldStop(262144);
shift_activity._current_moon = RemoteObject.solve(new RemoteObject[] {shift_activity._current_moon,RemoteObject.createImmutable(1)}, "+",1, 1);
 ...
 BA.debugLineNum = 1205;BA.debugLine="generat_taghvim(lbl_year_tagvim.Text,current_moon";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("lbl_note_day_menu_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1499);
if (RapidSub.canDelegate("lbl_note_day_menu_click")) { return ir.taravatgroup.ezafekari2.shift_activity.remoteMe.runUserSub(false, "shift_activity","lbl_note_day_menu_click");}
 BA.debugLineNum = 1499;BA.debugLine="Private Sub lbl_note_day_menu_Click";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 1500;BA.debugLine="lbl_edit_note_Click";
Debug.ShouldStop(134217728);
_lbl_edit_note_click();
 BA.debugLineNum = 1501;BA.debugLine="pan_all_menu_day_Click";
Debug.ShouldStop(268435456);
_pan_all_menu_day_click();
...
try {
		Debug.PushSubsStack("lbl_prev_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1209);
...
RemoteObject _adad = RemoteObject.createImmutable(0);
 BA.debugLineNum = 1209;BA.debugLine="Private Sub lbl_prev_Click";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 1211;BA.debugLine="If (current_moon<=1)Then";
Debug.ShouldStop(67108864);
if ((RemoteObject.solveBoolean("k",shift_activity._current_moon,BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 1214;BA.debugLine="If(lbl_year_tagvim.Text>1398)Then";
Debug.ShouldStop(536870912);
if ((RemoteObject.solveBoolean(">",BA.numberCast(double.class, shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"getText")),BA.numberCast(double.class, 1398)))) { 
 BA.debugLineNum = 1215;BA.debugLine="Dim adad As Int=lbl_year_tagvim.Text";
Debug.ShouldStop(1073741824);
_adad = BA.numberCast(int.class, shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"getText"));Debug.locals.put("adad", _adad);Debug.locals.put("adad", _adad);
 BA.debugLineNum = 1216;BA.debugLine="lbl_year_tagvim.Text=adad-1";
Debug.ShouldStop(-2147483648);
shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.solve(new RemoteObject[] {_adad,RemoteObject.createImmutable(1)}, "-",1, 1)));
 BA.debugLineNum = 1217;BA.debugLine="current_moon=12";
Debug.ShouldStop(1);
shift_activity._current_moon = BA.numberCast(int.class, 12);
 }else {
...
shift_activity._current_moon = BA.numberCast(int.class, 1);
 ...
 BA.debugLineNum = 1224;BA.debugLine="current_moon=current_moon-1";
Debug.ShouldStop(128);
shift_activity._current_moon = RemoteObject.solve(new RemoteObject[] {shift_activity._current_moon,RemoteObject.createImmutable(1)}, "-",1, 1);
 };
 BA.debugLineNum = 1226;BA.debugLine="generat_taghvim(lbl_year_tagvim.Text,current_moon";
Debug.ShouldStop(512);
_generat_taghvim(BA.numberCast(int.class, shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"getText")),shift_activity._current_moon);
...
try {
		Debug.PushSubsStack("lbl_roz_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,651);
...
try {
		Debug.PushSubsStack("lbl_roz_end_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,714);
...
try {
		Debug.PushSubsStack("lbl_save_note_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1471);
if (RapidSub.canDelegate("lbl_save_note_click")) { return ir.taravatgroup.ezafekari2.shift_activity.remoteMe.runUserSub(false, "shift_activity","lbl_save_note_click");}
 BA.debugLineNum = 1471;BA.debugLine="Private Sub lbl_save_note_Click";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 1473;BA.debugLine="set_note(selectedDay_id,et_note.Text)";
Debug.ShouldStop(1);
_set_note(shift_activity._selectedday_id,shift_activity.mostCurrent._et_note.runMethod(true,"getText"));
 BA.debugLineNum = 1474;BA.debugLine="generat_taghvim(lbl_year_tagvim.Text,lbl_moon_nam";
Debug.ShouldStop(2);
_generat_taghvim(BA.numberCast(int.class, shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"getText")),BA.numberCast(int.class, shift_activity.mostCurrent._lbl_moon_name.runMethod(false,"getTag")));
...
try {
		Debug.PushSubsStack("lbl_save_shift_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1266);
...
int _p = 0;
 BA.debugLineNum = 1266;BA.debugLine="Private Sub lbl_save_shift_Click";
Debug.ShouldStop(131072);
 BA.debugLineNum = 1269;BA.debugLine="If(ls_set_shift.Size<1)Then";
Debug.ShouldStop(1048576);
if ((RemoteObject.solveBoolean("<",shift_activity.mostCurrent._ls_set_shift.runMethod(true,"getSize"),BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 1270;BA.debugLine="ToastMessageShow(\"الگو باید حداقل یک مورد باشد\",";
Debug.ShouldStop(2097152);
shift_activity.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("الگو باید حداقل یک مورد باشد")),(Object)(shift_activity.mostCurrent.__c.getField(true,"False")));
 ...
 BA.debugLineNum = 1275;BA.debugLine="set_shift(list_sift_olgo)";
Debug.ShouldStop(67108864);
_set_shift(shift_activity.mostCurrent._list_sift_olgo);
 BA.debugLineNum = 1278;BA.debugLine="Dim ls_toSave As List";
Debug.ShouldStop(536870912);
_ls_tosave = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("ls_toSave", _ls_tosave);
 BA.debugLineNum = 1279;BA.debugLine="ls_toSave.Initialize";
Debug.ShouldStop(1073741824);
_ls_tosave.runVoidMethod ("Initialize");
 BA.debugLineNum = 1281;BA.debugLine="For p=0 To ls_set_shift.Size-1";
Debug.ShouldStop(1);
{
final int step7 = 1;
...
Debug.locals.put("p", _p);
 BA.debugLineNum = 1282;BA.debugLine="ls_toSave.Add(ls_set_shift.GetItem(p))";
Debug.ShouldStop(2);
...
;
 BA.debugLineNum = 1285;BA.debugLine="File.WriteList(File.DirInternal,\"shift_olgo\",ls_";
Debug.ShouldStop(16);
shift_activity.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteList",(Object)(shift_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("shift_olgo")),(Object)(_ls_tosave));
 BA.debugLineNum = 1286;BA.debugLine="File.WriteList(File.DirInternal,\"shift_olgo_cod\"";
Debug.ShouldStop(32);
shift_activity.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteList",(Object)(shift_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("shift_olgo_cod")),(Object)(shift_activity.mostCurrent._list_sift_olgo));
 BA.debugLineNum = 1289;BA.debugLine="pan_all_setSift.Visible=False";
Debug.ShouldStop(256);
shift_activity.mostCurrent._pan_all_setsift.runMethod(true,"setVisible",shift_activity.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 1293;BA.debugLine="lbl_delete_lis_olgo_Click";
Debug.ShouldStop(4096);
_lbl_delete_lis_olgo_click();
 BA.debugLineNum = 1294;BA.debugLine="generat_taghvim(this_year,this_moon)";
Debug.ShouldStop(8192);
_generat_taghvim(shift_activity._this_year,shift_activity._this_moon);
 };
...
try {
		Debug.PushSubsStack("lbl_show_panShift_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1301);
...
int _i = 0;
 BA.debugLineNum = 1301;BA.debugLine="Private Sub lbl_show_panShift_Click";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 1303;BA.debugLine="If(File.Exists(File.DirInternal,\"shift_olgo\")=Tru";
Debug.ShouldStop(4194304);
if ((RemoteObject.solveBoolean("=",shift_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"Exists",(Object)(shift_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("shift_olgo"))),shift_activity.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 1305;BA.debugLine="Dim ls_toLoad As List";
Debug.ShouldStop(16777216);
_ls_toload = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("ls_toLoad", _ls_toload);
 BA.debugLineNum = 1306;BA.debugLine="ls_toLoad.Initialize";
Debug.ShouldStop(33554432);
_ls_toload.runVoidMethod ("Initialize");
 BA.debugLineNum = 1308;BA.debugLine="ls_toLoad=File.ReadList(File.DirInternal,\"shift_";
Debug.ShouldStop(134217728);
_ls_toload = shift_activity.mostCurrent.__c.getField(false,"File").runMethod(false,"ReadList",(Object)(shift_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("shift_olgo")));Debug.locals.put("ls_toLoad", _ls_toload);
 BA.debugLineNum = 1310;BA.debugLine="For i=0 To ls_toLoad.Size-1";
Debug.ShouldStop(536870912);
{
final int step5 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 1311;BA.debugLine="ls_set_shift.AddSingleLine(ls_toLoad.Get(i))";
Debug.ShouldStop(1073741824);
...
;
 BA.debugLineNum = 1314;BA.debugLine="list_sift_olgo=File.ReadList(File.DirInternal,\"s";
Debug.ShouldStop(2);
shift_activity.mostCurrent._list_sift_olgo = shift_activity.mostCurrent.__c.getField(false,"File").runMethod(false,"ReadList",(Object)(shift_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("shift_olgo_cod")));
 ...
 BA.debugLineNum = 1318;BA.debugLine="pan_all_setSift.Visible=True";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("lbl_year_tagvim_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,549);
...
try {
		Debug.PushSubsStack("lbl_years_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,643);
...
try {
		Debug.PushSubsStack("lbl_years_end_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,706);
...
try {
		Debug.PushSubsStack("mod_tatil_garardadi (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1436);
...
Debug.locals.put("id", _id);
 BA.debugLineNum = 1436;BA.debugLine="Sub mod_tatil_garardadi (id As Int)";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 1437;BA.debugLine="dbCode.connect_db";
Debug.ShouldStop(268435456);
shift_activity.mostCurrent._dbcode.runVoidMethod ("_connect_db" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA);
 BA.debugLineNum = 1438;BA.debugLine="dbCode.res =  dbCode.sql.ExecQuery(\"SELECT * FROM";
Debug.ShouldStop(536870912);
shift_activity.mostCurrent._dbcode._res /*RemoteObject*/  = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.sql.SQL.ResultSetWrapper"), shift_activity.mostCurrent._dbcode._sql /*RemoteObject*/ .runMethod(false,"ExecQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("SELECT * FROM 'my_calander' WHERE id="),_id))));
 BA.debugLineNum = 1439;BA.debugLine="dbCode.res.Position=0";
Debug.ShouldStop(1073741824);
shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"setPosition",BA.numberCast(int.class, 0));
 BA.debugLineNum = 1442;BA.debugLine="If(dbCode.res.GetString(\"state\")=\"tatil\") Then";
Debug.ShouldStop(2);
if ((RemoteObject.solveBoolean("=",shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("state"))),RemoteObject.createImmutable("tatil")))) { 
 BA.debugLineNum = 1443;BA.debugLine="CheckBox_tatil_garardadi.Enabled=False";
Debug.ShouldStop(4);
shift_activity.mostCurrent._checkbox_tatil_garardadi.runMethod(true,"setEnabled",shift_activity.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 1444;BA.debugLine="lbl_CheckBox_tatil_garardadi.Enabled=False";
Debug.ShouldStop(8);
shift_activity.mostCurrent._lbl_checkbox_tatil_garardadi.runMethod(true,"setEnabled",shift_activity.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 1445;BA.debugLine="CheckBox_tatil_garardadi.Checked=False";
Debug.ShouldStop(16);
shift_activity.mostCurrent._checkbox_tatil_garardadi.runMethodAndSync(true,"setChecked",shift_activity.mostCurrent.__c.getField(true,"False"));
 }else 
{ BA.debugLineNum = 1447;BA.debugLine="Else If(dbCode.res.GetString(\"state\")=\"tatil1\") T";
Debug.ShouldStop(64);
if ((RemoteObject.solveBoolean("=",shift_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("state"))),RemoteObject.createImmutable("tatil1")))) { 
 BA.debugLineNum = 1448;BA.debugLine="CheckBox_tatil_garardadi.Enabled=True";
Debug.ShouldStop(128);
shift_activity.mostCurrent._checkbox_tatil_garardadi.runMethod(true,"setEnabled",shift_activity.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 1449;BA.debugLine="lbl_CheckBox_tatil_garardadi.Enabled=True";
Debug.ShouldStop(256);
shift_activity.mostCurrent._lbl_checkbox_tatil_garardadi.runMethod(true,"setEnabled",shift_activity.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 1450;BA.debugLine="CheckBox_tatil_garardadi.Checked=True";
Debug.ShouldStop(512);
shift_activity.mostCurrent._checkbox_tatil_garardadi.runMethodAndSync(true,"setChecked",shift_activity.mostCurrent.__c.getField(true,"True"));
 }else {
 BA.debugLineNum = 1452;BA.debugLine="CheckBox_tatil_garardadi.Enabled=True";
Debug.ShouldStop(2048);
shift_activity.mostCurrent._checkbox_tatil_garardadi.runMethod(true,"setEnabled",shift_activity.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 1453;BA.debugLine="lbl_CheckBox_tatil_garardadi.Enabled=True";
Debug.ShouldStop(4096);
shift_activity.mostCurrent._lbl_checkbox_tatil_garardadi.runMethod(true,"setEnabled",shift_activity.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 1454;BA.debugLine="CheckBox_tatil_garardadi.Checked=False";
Debug.ShouldStop(8192);
shift_activity.mostCurrent._checkbox_tatil_garardadi.runMethodAndSync(true,"setChecked",shift_activity.mostCurrent.__c.getField(true,"False"));
 }}
;
...
try {
		Debug.PushSubsStack("PA_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1132);
...
RemoteObject _moon_tag = RemoteObject.createImmutable(0);
 BA.debugLineNum = 1132;BA.debugLine="Private Sub PA_Click";
Debug.ShouldStop(2048);
 BA.debugLineNum = 1133;BA.debugLine="Dim str_t As String";
Debug.ShouldStop(4096);
_str_t = RemoteObject.createImmutable("");Debug.locals.put("str_t", _str_t);
 BA.debugLineNum = 1134;BA.debugLine="Dim B As Panel = Sender";
Debug.ShouldStop(8192);
...
_b = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.PanelWrapper"), shift_activity.mostCurrent.__c.runMethod(false,"Sender",shift_activity.mostCurrent.activityBA));Debug.locals.put("B", _b);Debug.locals.put("B", _b);
 BA.debugLineNum = 1135;BA.debugLine="selectedDay_id=dbCode.get_day_id(lbl_year_tagvim.";
Debug.ShouldStop(16384);
shift_activity._selectedday_id = shift_activity.mostCurrent._dbcode.runMethod(true,"_get_day_id" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"getText"))),(Object)(BA.numberCast(int.class, shift_activity.mostCurrent._lbl_moon_name.runMethod(false,"getTag"))),(Object)(BA.numberCast(int.class, _b.runMethod(false,"getTag"))));
 BA.debugLineNum = 1137;BA.debugLine="For d=0 To PA.Length-1";
Debug.ShouldStop(65536);
{
final int step4 = 1;
...
Debug.locals.put("d", _d);
 BA.debugLineNum = 1138;BA.debugLine="str_t=PA(d).Tag";
Debug.ShouldStop(131072);
_str_t = BA.ObjectToString(shift_activity.mostCurrent._pa.getArrayElement(false,BA.numberCast(int.class, _d)).runMethod(false,"getTag"));Debug.locals.put("str_t", _str_t);
 BA.debugLineNum = 1139;BA.debugLine="If ( str_t = last_selected_itemTag )Then";
Debug.ShouldStop(262144);
if ((RemoteObject.solveBoolean("=",_str_t,BA.NumberToString(shift_activity._last_selected_itemtag)))) { 
 BA.debugLineNum = 1143;BA.debugLine="If(last_selected_itemTag<>0)Then";
Debug.ShouldStop(4194304);
if ((RemoteObject.solveBoolean("!",shift_activity._last_selected_itemtag,BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 1145;BA.debugLine="If(ls_tatili_moon.Get(last_selected_itemTag-1)";
Debug.ShouldStop(16777216);
...
{ BA.debugLineNum = 1148;BA.debugLine="Else If(ls_tatili_custom_moon.Get(last_selecte";
Debug.ShouldStop(134217728);
...
;
 BA.debugLineNum = 1165;BA.debugLine="Dim moon_tag As Int=lbl_moon_name.Tag";
Debug.ShouldStop(4096);
_moon_tag = BA.numberCast(int.class, shift_activity.mostCurrent._lbl_moon_name.runMethod(false,"getTag"));Debug.locals.put("moon_tag", _moon_tag);Debug.locals.put("moon_tag", _moon_tag);
 BA.debugLineNum = 1166;BA.debugLine="If( moon_tag=this_moon)Then";
Debug.ShouldStop(8192);
if ((RemoteObject.solveBoolean("=",_moon_tag,BA.numberCast(double.class, shift_activity._this_moon)))) { 
 BA.debugLineNum = 1168;BA.debugLine="Lb(index_i_today).TextColor=0xFFFF9000";
Debug.ShouldStop(32768);
shift_activity.mostCurrent._lb.getArrayElement(false,shift_activity._index_i_today).runMethod(true,"setTextColor",BA.numberCast(int.class, ((int)0xffff9000)));
 ...
 BA.debugLineNum = 1173;BA.debugLine="B.Color=Colors.Gray";
Debug.ShouldStop(1048576);
_b.runVoidMethod ("setColor",shift_activity.mostCurrent.__c.getField(false,"Colors").getField(true,"Gray"));
 BA.debugLineNum = 1174;BA.debugLine="get_monasebat(selectedDay_id)";
Debug.ShouldStop(2097152);
_get_monasebat(shift_activity._selectedday_id);
 BA.debugLineNum = 1175;BA.debugLine="get_note(selectedDay_id)";
Debug.ShouldStop(4194304);
_get_note(shift_activity._selectedday_id);
 BA.debugLineNum = 1177;BA.debugLine="get_ezafekari(lbl_year_tagvim.Text&\"/\"&myfunc.con";
Debug.ShouldStop(16777216);
_get_ezafekari(RemoteObject.concat(shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"getText"),RemoteObject.createImmutable("/"),shift_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, shift_activity.mostCurrent._lbl_moon_name.runMethod(false,"getTag")))),RemoteObject.createImmutable("/"),shift_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, _b.runMethod(false,"getTag"))))));
 BA.debugLineNum = 1178;BA.debugLine="get_morakhasi(lbl_year_tagvim.Text&\"/\"&myfunc.con";
Debug.ShouldStop(33554432);
_get_morakhasi(RemoteObject.concat(shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"getText"),RemoteObject.createImmutable("/"),shift_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, shift_activity.mostCurrent._lbl_moon_name.runMethod(false,"getTag")))),RemoteObject.createImmutable("/"),shift_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, _b.runMethod(false,"getTag"))))));
 BA.debugLineNum = 1179;BA.debugLine="get_taradod(lbl_year_tagvim.Text&\"/\"&myfunc.conve";
Debug.ShouldStop(67108864);
_get_taradod(RemoteObject.concat(shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"getText"),RemoteObject.createImmutable("/"),shift_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, shift_activity.mostCurrent._lbl_moon_name.runMethod(false,"getTag")))),RemoteObject.createImmutable("/"),shift_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, _b.runMethod(false,"getTag"))))));
 BA.debugLineNum = 1181;BA.debugLine="last_selected_itemTag=B.Tag";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("PA_LongClick (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1420);
...
RemoteObject _b = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
 BA.debugLineNum = 1420;BA.debugLine="Private Sub PA_LongClick";
Debug.ShouldStop(2048);
 BA.debugLineNum = 1421;BA.debugLine="Dim B As Panel = Sender";
Debug.ShouldStop(4096);
_b = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");
_b = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.PanelWrapper"), shift_activity.mostCurrent.__c.runMethod(false,"Sender",shift_activity.mostCurrent.activityBA));Debug.locals.put("B", _b);Debug.locals.put("B", _b);
 BA.debugLineNum = 1424;BA.debugLine="selectedDay_id=dbCode.get_day_id(lbl_year_tagvim.";
Debug.ShouldStop(32768);
shift_activity._selectedday_id = shift_activity.mostCurrent._dbcode.runMethod(true,"_get_day_id" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"getText"))),(Object)(BA.numberCast(int.class, shift_activity.mostCurrent._lbl_moon_name.runMethod(false,"getTag"))),(Object)(BA.numberCast(int.class, _b.runMethod(false,"getTag"))));
 BA.debugLineNum = 1431;BA.debugLine="lbl_title_day_menu.Text=lbl_year_tagvim.Text&\"/\"&";
Debug.ShouldStop(4194304);
shift_activity.mostCurrent._lbl_title_day_menu.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(shift_activity.mostCurrent._lbl_year_tagvim.runMethod(true,"getText"),RemoteObject.createImmutable("/"),shift_activity.mostCurrent._lbl_moon_name.runMethod(false,"getTag"),RemoteObject.createImmutable("/"),_b.runMethod(false,"getTag"))));
 BA.debugLineNum = 1432;BA.debugLine="mod_tatil_garardadi(selectedDay_id)";
Debug.ShouldStop(8388608);
_mod_tatil_garardadi(shift_activity._selectedday_id);
 BA.debugLineNum = 1433;BA.debugLine="pan_all_menu_day.Visible=True";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("pan_all_menu_day_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1491);
if (RapidSub.canDelegate("pan_all_menu_day_click")) { return ir.taravatgroup.ezafekari2.shift_activity.remoteMe.runUserSub(false, "shift_activity","pan_all_menu_day_click");}
 BA.debugLineNum = 1491;BA.debugLine="Private Sub pan_all_menu_day_Click";
Debug.ShouldStop(262144);
 BA.debugLineNum = 1492;BA.debugLine="pan_all_menu_day.Visible=False";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("pan_all_note_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1463);
if (RapidSub.canDelegate("pan_all_note_click")) { return ir.taravatgroup.ezafekari2.shift_activity.remoteMe.runUserSub(false, "shift_activity","pan_all_note_click");}
 BA.debugLineNum = 1463;BA.debugLine="Private Sub pan_all_note_Click";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 1464;BA.debugLine="pan_all_note.Visible=False";
Debug.ShouldStop(8388608);
shift_activity.mostCurrent._pan_all_note.runMethod(true,"setVisible",shift_activity.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("pan_all_setSift_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1234);
if (RapidSub.canDelegate("pan_all_setsift_click")) { return ir.taravatgroup.ezafekari2.shift_activity.remoteMe.runUserSub(false, "shift_activity","pan_all_setsift_click");}
 BA.debugLineNum = 1234;BA.debugLine="Private Sub pan_all_setSift_Click";
Debug.ShouldStop(131072);
...
try {
		Debug.PushSubsStack("Panel12_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1467);
if (RapidSub.canDelegate("panel12_click")) { return ir.taravatgroup.ezafekari2.shift_activity.remoteMe.runUserSub(false, "shift_activity","panel12_click");}
 BA.debugLineNum = 1467;BA.debugLine="Private Sub Panel12_Click";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("Panel8_Click (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1495);
if (RapidSub.canDelegate("panel8_click")) { return ir.taravatgroup.ezafekari2.shift_activity.remoteMe.runUserSub(false, "shift_activity","panel8_click");}
 BA.debugLineNum = 1495;BA.debugLine="Private Sub Panel8_Click";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("rsPOP_mah_end_MenuItemClick (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,662);
...
try {
		Debug.PushSubsStack("rsPOP_mah_MenuItemClick (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,602);
...
try {
		Debug.PushSubsStack("rsPOP_moon_tagvim_MenuItemClick (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,559);
...
try {
		Debug.PushSubsStack("rsPOP_roz_end_MenuItemClick (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,699);
...
try {
		Debug.PushSubsStack("rsPOP_roz_MenuItemClick (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,637);
...
try {
		Debug.PushSubsStack("rsPOP_year_end_MenuItemClick (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,658);
...
try {
		Debug.PushSubsStack("rsPOP_year_MenuItemClick (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,598);
...
try {
		Debug.PushSubsStack("rsPOP_year_tagvim_MenuItemClick (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,543);
...
try {
		Debug.PushSubsStack("set_note (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1480);
...
Debug.locals.put("matn", _matn);
 BA.debugLineNum = 1480;BA.debugLine="Sub set_note(id As Int , matn As String)";
Debug.ShouldStop(128);
 BA.debugLineNum = 1481;BA.debugLine="dbCode.connect_db";
Debug.ShouldStop(256);
shift_activity.mostCurrent._dbcode.runVoidMethod ("_connect_db" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA);
 BA.debugLineNum = 1482;BA.debugLine="dbCode.sql.ExecNonQuery(\"UPDATE 'my_calander' set";
Debug.ShouldStop(512);
shift_activity.mostCurrent._dbcode._sql /*RemoteObject*/ .runVoidMethod ("ExecNonQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("UPDATE 'my_calander' set note='"),_matn,RemoteObject.createImmutable("' WHERE id="),_id)));
 BA.debugLineNum = 1484;BA.debugLine="ToastMessageShow(\"یادداشت ذخیره شد\",True)";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("set_shift (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1324);
...
Debug.locals.put("ol", _ol);
 BA.debugLineNum = 1324;BA.debugLine="Sub set_shift(ol As List )";
Debug.ShouldStop(2048);
 BA.debugLineNum = 1326;BA.debugLine="Try";
Debug.ShouldStop(8192);
try { BA.debugLineNum = 1327;BA.debugLine="ProgressDialogShow(\"در حال تنظیم شیفت ها\")";
Debug.ShouldStop(16384);
shift_activity.mostCurrent.__c.runVoidMethod ("ProgressDialogShow",shift_activity.mostCurrent.activityBA,(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("در حال تنظیم شیفت ها"))));
 BA.debugLineNum = 1329;BA.debugLine="Dim start_shift As Int";
Debug.ShouldStop(65536);
_start_shift = RemoteObject.createImmutable(0);Debug.locals.put("start_shift", _start_shift);
 BA.debugLineNum = 1330;BA.debugLine="Dim end_shift As Int";
Debug.ShouldStop(131072);
_end_shift = RemoteObject.createImmutable(0);Debug.locals.put("end_shift", _end_shift);
 BA.debugLineNum = 1332;BA.debugLine="Dim index_curent_shift As Int=0";
Debug.ShouldStop(524288);
...
Debug.ShouldStop(1048576);
shift_activity.mostCurrent._dbcode.runVoidMethod ("_connect_db" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA);
 BA.debugLineNum = 1335;BA.debugLine="dbCode.sql.ExecNonQuery(\"UPDATE 'my_calander' se";
Debug.ShouldStop(4194304);
shift_activity.mostCurrent._dbcode._sql /*RemoteObject*/ .runVoidMethod ("ExecNonQuery",(Object)(RemoteObject.createImmutable("UPDATE 'my_calander' set shift=''")));
 BA.debugLineNum = 1338;BA.debugLine="start_shift=dbCode.get_day_id(lbl_years.Text,lbl";
Debug.ShouldStop(33554432);
_start_shift = shift_activity.mostCurrent._dbcode.runMethod(true,"_get_day_id" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, shift_activity.mostCurrent._lbl_years.runMethod(true,"getText"))),(Object)(shift_activity._lbl_mah_tagid),(Object)(BA.numberCast(int.class, shift_activity.mostCurrent._lbl_roz.runMethod(true,"getText"))));Debug.locals.put("start_shift", _start_shift);
 BA.debugLineNum = 1339;BA.debugLine="end_shift=dbCode.get_day_id(lbl_years_end.Text,l";
Debug.ShouldStop(67108864);
_end_shift = shift_activity.mostCurrent._dbcode.runMethod(true,"_get_day_id" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, shift_activity.mostCurrent._lbl_years_end.runMethod(true,"getText"))),(Object)(shift_activity._lbl_mah_end_tagid),(Object)(BA.numberCast(int.class, shift_activity.mostCurrent._lbl_roz_end.runMethod(true,"getText"))));Debug.locals.put("end_shift", _end_shift);
 BA.debugLineNum = 1342;BA.debugLine="For i=start_shift To end_shift";
Debug.ShouldStop(536870912);
{
final int step10 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 1344;BA.debugLine="dbCode.sql.ExecNonQuery2(\"UPDATE 'my_calander'";
Debug.ShouldStop(-2147483648);
shift_activity.mostCurrent._dbcode._sql /*RemoteObject*/ .runVoidMethod ("ExecNonQuery2",(Object)(BA.ObjectToString("UPDATE 'my_calander' set shift=? WHERE id=?")),(Object)(shift_activity.mostCurrent.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {shift_activity.mostCurrent._list_sift_olgo.runMethod(false,"Get",(Object)(_index_curent_shift)),RemoteObject.createImmutable((_i))})))));
 BA.debugLineNum = 1347;BA.debugLine="If(index_curent_shift=list_sift_olgo.Size-1)The";
Debug.ShouldStop(4);
if ((RemoteObject.solveBoolean("=",_index_curent_shift,BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {shift_activity.mostCurrent._list_sift_olgo.runMethod(true,"getSize"),RemoteObject.createImmutable(1)}, "-",1, 1))))) { 
 BA.debugLineNum = 1348;BA.debugLine="index_curent_shift=0";
Debug.ShouldStop(8);
_index_curent_shift = BA.numberCast(int.class, 0);Debug.locals.put("index_curent_shift", _index_curent_shift);
 }else {
 BA.debugLineNum = 1350;BA.debugLine="index_curent_shift=index_curent_shift+1";
Debug.ShouldStop(32);
...
shift_activity.mostCurrent._dbcode._sql /*RemoteObject*/ .runVoidMethod ("Close");
 BA.debugLineNum = 1356;BA.debugLine="ProgressDialogHide";
Debug.ShouldStop(2048);
shift_activity.mostCurrent.__c.runVoidMethod ("ProgressDialogHide");
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e21) {
			BA.rdebugUtils.runVoidMethod("setLastException",shift_activity.processBA, e21.toString()); BA.debugLineNum = 1359;BA.debugLine="Log(LastException)";
Debug.ShouldStop(16384);
shift_activity.mostCurrent.__c.runVoidMethod ("LogImpl","241812003",BA.ObjectToString(shift_activity.mostCurrent.__c.runMethod(false,"LastException",shift_activity.mostCurrent.activityBA)),0);
...
try {
		Debug.PushSubsStack("shift_rest (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1389);
if (RapidSub.canDelegate("shift_rest")) { return ir.taravatgroup.ezafekari2.shift_activity.remoteMe.runUserSub(false, "shift_activity","shift_rest");}
 BA.debugLineNum = 1389;BA.debugLine="Sub shift_rest";
Debug.ShouldStop(4096);
 BA.debugLineNum = 1390;BA.debugLine="dbCode.connect_db";
Debug.ShouldStop(8192);
shift_activity.mostCurrent._dbcode.runVoidMethod ("_connect_db" /*RemoteObject*/ ,shift_activity.mostCurrent.activityBA);
 BA.debugLineNum = 1391;BA.debugLine="dbCode.sql.ExecNonQuery(\"UPDATE 'my_calander' set";
Debug.ShouldStop(16384);
shift_activity.mostCurrent._dbcode._sql /*RemoteObject*/ .runVoidMethod ("ExecNonQuery",(Object)(RemoteObject.createImmutable("UPDATE 'my_calander' set shift='' ")));
 BA.debugLineNum = 1392;BA.debugLine="If(File.Exists(File.DirInternal,\"shift_olgo\"))The";
Debug.ShouldStop(32768);
if ((shift_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"Exists",(Object)(shift_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("shift_olgo")))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 1393;BA.debugLine="File.Delete(File.DirInternal,\"shift_olgo\")";
Debug.ShouldStop(65536);
shift_activity.mostCurrent.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(shift_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("shift_olgo")));
 BA.debugLineNum = 1394;BA.debugLine="File.Delete(File.DirInternal,\"shift_olgo_cod\")";
Debug.ShouldStop(131072);
shift_activity.mostCurrent.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(shift_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("shift_olgo_cod")));
 ...
 BA.debugLineNum = 1398;BA.debugLine="pan_all_setSift.Visible=False";
Debug.ShouldStop(2097152);
shift_activity.mostCurrent._pan_all_setsift.runMethod(true,"setVisible",shift_activity.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 1399;BA.debugLine="lbl_delete_lis_olgo_Click";
Debug.ShouldStop(4194304);
_lbl_delete_lis_olgo_click();
 BA.debugLineNum = 1400;BA.debugLine="generat_taghvim(this_year,this_moon)";
Debug.ShouldStop(8388608);
_generat_taghvim(shift_activity._this_year,shift_activity._this_moon);
 BA.debugLineNum = 1401;BA.debugLine="ToastMessageShow(\"همه شیفت ها حذف شدند\",True)";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("sql_NonQueryComplete (shift_activity) ","shift_activity",26,shift_activity.mostCurrent.activityBA,shift_activity.mostCurrent,1368);
...
Debug.locals.put("Success", _success);
 BA.debugLineNum = 1368;BA.debugLine="Sub sql_NonQueryComplete (Success As Boolean)";
Debug.ShouldStop(8388608);
