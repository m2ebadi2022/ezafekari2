...
Debug.ShouldStop(16384);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","321561351",_dir,0);
 BA.debugLineNum = 144;BA.debugLine="Log(FileName)";
Debug.ShouldStop(32768);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","321561352",_filename,0);
 BA.debugLineNum = 145;BA.debugLine="Log(File.Exists(Starter.Provider.SharedFolder,\"d";
Debug.ShouldStop(65536);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","321561353",BA.ObjectToString(parent.mostCurrent.__c.getField(false,"File").runMethod(true,"Exists",(Object)(parent.mostCurrent._starter._provider /*RemoteObject*/ .getField(true,"_sharedfolder" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("db2.db")))),0);
