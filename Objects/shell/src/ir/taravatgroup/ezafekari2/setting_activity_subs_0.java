...
Debug.ShouldStop(8388608);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","632309255",_dir,0);
 BA.debugLineNum = 153;BA.debugLine="Log(FileName)";
Debug.ShouldStop(16777216);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","632309256",_filename,0);
 BA.debugLineNum = 154;BA.debugLine="Log(File.Exists(Starter.Provider.SharedFolder,\"d";
Debug.ShouldStop(33554432);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","632309257",BA.ObjectToString(parent.mostCurrent.__c.getField(false,"File").runMethod(true,"Exists",(Object)(parent.mostCurrent._starter._provider /*RemoteObject*/ .getField(true,"_sharedfolder" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("db2.db")))),0);
...
Debug.ShouldStop(8388608);
setting_activity.mostCurrent.__c.runVoidMethod ("LogImpl","634209806",BA.ObjectToString(setting_activity.mostCurrent.__c.runMethod(false,"LastException",setting_activity.mostCurrent.activityBA)),0);
 };
...
Debug.ShouldStop(33554432);
setting_activity.mostCurrent.__c.runVoidMethod ("LogImpl","634013197",BA.ObjectToString(setting_activity.mostCurrent.__c.runMethod(false,"LastException",setting_activity.mostCurrent.activityBA)),0);
 };
