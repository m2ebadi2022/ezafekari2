...
Debug.ShouldStop(524288);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","350397191",_dir,0);
 BA.debugLineNum = 245;BA.debugLine="Log(FileName)";
Debug.ShouldStop(1048576);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","350397192",_filename,0);
 BA.debugLineNum = 246;BA.debugLine="Log(File.Exists(Starter.Provider.SharedFolder,\"d";
Debug.ShouldStop(2097152);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","350397193",BA.ObjectToString(parent.mostCurrent.__c.getField(false,"File").runMethod(true,"Exists",(Object)(parent.mostCurrent._starter._provider /*RemoteObject*/ .getField(true,"_sharedfolder" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("db2.db")))),0);
...
Debug.ShouldStop(524288);
setting_activity.mostCurrent.__c.runVoidMethod ("LogImpl","352297742",BA.ObjectToString(setting_activity.mostCurrent.__c.runMethod(false,"LastException",setting_activity.mostCurrent.activityBA)),0);
 };
...
Debug.ShouldStop(2097152);
setting_activity.mostCurrent.__c.runVoidMethod ("LogImpl","352101133",BA.ObjectToString(setting_activity.mostCurrent.__c.runMethod(false,"LastException",setting_activity.mostCurrent.activityBA)),0);
 };
