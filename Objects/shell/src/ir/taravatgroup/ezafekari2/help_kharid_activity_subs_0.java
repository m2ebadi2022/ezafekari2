...
try {
		Debug.PushSubsStack("Activity_Create (help_kharid_activity) ","help_kharid_activity",15,help_kharid_activity.mostCurrent.activityBA,help_kharid_activity.mostCurrent,20);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (help_kharid_activity) ","help_kharid_activity",15,help_kharid_activity.mostCurrent.activityBA,help_kharid_activity.mostCurrent,48);
...
try {
		Debug.PushSubsStack("Activity_Pause (help_kharid_activity) ","help_kharid_activity",15,help_kharid_activity.mostCurrent.activityBA,help_kharid_activity.mostCurrent,38);
...
try {
		Debug.PushSubsStack("Activity_Resume (help_kharid_activity) ","help_kharid_activity",15,help_kharid_activity.mostCurrent.activityBA,help_kharid_activity.mostCurrent,34);
...
try {
		Debug.PushSubsStack("lbl_back_Click (help_kharid_activity) ","help_kharid_activity",15,help_kharid_activity.mostCurrent.activityBA,help_kharid_activity.mostCurrent,44);
