...
try {
		Debug.PushSubsStack("GetFileUri (fileprovider) ","fileprovider",33,__ref.getField(false, "ba"),__ref,22);
...
try {
		Debug.PushSubsStack("Initialize (fileprovider) ","fileprovider",33,__ref.getField(false, "ba"),__ref,8);
...
Debug.JustUpdateDeviceLine();
fileprovider.__c.runVoidMethod ("LogImpl","943122698",(RemoteObject.concat(RemoteObject.createImmutable("Using FileProvider? "),fileprovider.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(true,"_usefileprovider" /*RemoteObject*/ )))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("SetFileUriAsIntentData (fileprovider) ","fileprovider",33,__ref.getField(false, "ba"),__ref,40);
