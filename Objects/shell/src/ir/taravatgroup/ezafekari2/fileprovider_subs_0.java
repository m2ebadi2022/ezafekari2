...
try {
		Debug.PushSubsStack("GetFileUri (fileprovider) ","fileprovider",24,__ref.getField(false, "ba"),__ref,22);
...
try {
		Debug.PushSubsStack("Initialize (fileprovider) ","fileprovider",24,__ref.getField(false, "ba"),__ref,8);
...
Debug.JustUpdateDeviceLine();
fileprovider.__c.runVoidMethod ("LogImpl","937421066",(RemoteObject.concat(RemoteObject.createImmutable("Using FileProvider? "),fileprovider.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(true,"_usefileprovider" /*RemoteObject*/ )))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("SetFileUriAsIntentData (fileprovider) ","fileprovider",24,__ref.getField(false, "ba"),__ref,40);
...
Debug.JustUpdateDeviceLine();
_jo.runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setData")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.runClassMethod (ir.taravatgroup.ezafekari2.fileprovider.class, "_getfileuri" /*RemoteObject*/ ,(Object)(_filename))})));
