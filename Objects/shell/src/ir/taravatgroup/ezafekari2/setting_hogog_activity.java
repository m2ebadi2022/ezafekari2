...
public static RemoteObject _et_hamsar = RemoteObject.declareNull("anywheresoftware.b4a.objects.EditTextWrapper");
public static RemoteObject _lbl_onv16 = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _chek_hamsar = RemoteObject.declareNull("anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper");
public static RemoteObject _hamsar_int = RemoteObject.createImmutable(0);
...
public static ir.taravatgroup.ezafekari2.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",setting_hogog_activity.mostCurrent._activity,"ayabzahab_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.ayabzahab_activity.class),"bime_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.bime_activity.class),"calc_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.calc_activity.class),"chek_hamsar",setting_hogog_activity.mostCurrent._chek_hamsar,"comment_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.comment_activity.class),"current_index_onvan",setting_hogog_activity._current_index_onvan,"darsad_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.darsad_activity.class),"DateUtils",setting_hogog_activity.mostCurrent._dateutils,"dbCode",Debug.moduleToString(ir.taravatgroup.ezafekari2.dbcode.class),"eidi_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.eidi_activity.class),"et_bime_takmil",setting_hogog_activity.mostCurrent._et_bime_takmil,"et_bime_tamin",setting_hogog_activity.mostCurrent._et_bime_tamin,"et_bon",setting_hogog_activity.mostCurrent._et_bon,"et_fani",setting_hogog_activity.mostCurrent._et_fani,"et_hamsar",setting_hogog_activity.mostCurrent._et_hamsar,"et_ksorat",setting_hogog_activity.mostCurrent._et_ksorat,"et_maliat",setting_hogog_activity.mostCurrent._et_maliat,"et_maskan",setting_hogog_activity.mostCurrent._et_maskan,"et_masoliat",setting_hogog_activity.mostCurrent._et_masoliat,"et_mazaya",setting_hogog_activity.mostCurrent._et_mazaya,"et_min_kari",setting_hogog_activity.mostCurrent._et_min_kari,"et_olad",setting_hogog_activity.mostCurrent._et_olad,"et_onv_new",setting_hogog_activity.mostCurrent._et_onv_new,"et_paye",setting_hogog_activity.mostCurrent._et_paye,"et_saat_kari",setting_hogog_activity.mostCurrent._et_saat_kari,"et_sanavat",setting_hogog_activity.mostCurrent._et_sanavat,"et_sarparast",setting_hogog_activity.mostCurrent._et_sarparast,"et_shift",setting_hogog_activity.mostCurrent._et_shift,"fast_run_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.fast_run_activity.class),"food_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.food_activity.class),"ganon_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.ganon_activity.class),"gestha_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.gestha_activity.class),"hamsar_int",setting_hogog_activity._hamsar_int,"help_kharid_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.help_kharid_activity.class),"hogog_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.hogog_activity.class),"HttpUtils2Service",Debug.moduleToString(ir.taravatgroup.ezafekari2.httputils2service.class),"info_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.info_activity.class),"lbl_onv_def",setting_hogog_activity.mostCurrent._lbl_onv_def,"lbl_onv1",setting_hogog_activity.mostCurrent._lbl_onv1,"lbl_onv10",setting_hogog_activity.mostCurrent._lbl_onv10,"lbl_onv11",setting_hogog_activity.mostCurrent._lbl_onv11,"lbl_onv12",setting_hogog_activity.mostCurrent._lbl_onv12,"lbl_onv13",setting_hogog_activity.mostCurrent._lbl_onv13,"lbl_onv14",setting_hogog_activity.mostCurrent._lbl_onv14,"lbl_onv15",setting_hogog_activity.mostCurrent._lbl_onv15,"lbl_onv16",setting_hogog_activity.mostCurrent._lbl_onv16,"lbl_onv2",setting_hogog_activity.mostCurrent._lbl_onv2,"lbl_onv3",setting_hogog_activity.mostCurrent._lbl_onv3,"lbl_onv4",setting_hogog_activity.mostCurrent._lbl_onv4,"lbl_onv5",setting_hogog_activity.mostCurrent._lbl_onv5,"lbl_onv6",setting_hogog_activity.mostCurrent._lbl_onv6,"lbl_onv7",setting_hogog_activity.mostCurrent._lbl_onv7,"lbl_onv8",setting_hogog_activity.mostCurrent._lbl_onv8,"lbl_onv9",setting_hogog_activity.mostCurrent._lbl_onv9,"lbl_vahed",setting_hogog_activity.mostCurrent._lbl_vahed,"Main",Debug.moduleToString(ir.taravatgroup.ezafekari2.main.class),"min_saat_kari",setting_hogog_activity._min_saat_kari,"morakhasi_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.morakhasi_activity.class),"mosaedeh_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.mosaedeh_activity.class),"myfunc",Debug.moduleToString(ir.taravatgroup.ezafekari2.myfunc.class),"olad_vahed",setting_hogog_activity._olad_vahed,"padash_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.padash_activity.class),"pan_all_onvanHa",setting_hogog_activity.mostCurrent._pan_all_onvanha,"pan_hed_sethogog",setting_hogog_activity.mostCurrent._pan_hed_sethogog,"payankar_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.payankar_activity.class),"sabt2_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.sabt2_activity.class),"savabeg_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.savabeg_activity.class),"sayer_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.sayer_activity.class),"scv_sett_hogog",setting_hogog_activity.mostCurrent._scv_sett_hogog,"setting_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.setting_activity.class),"shift_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.shift_activity.class),"show_gozaresh_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.show_gozaresh_activity.class),"sp_ganon_kar",setting_hogog_activity.mostCurrent._sp_ganon_kar,"sp_olad",setting_hogog_activity.mostCurrent._sp_olad,"Starter",Debug.moduleToString(ir.taravatgroup.ezafekari2.starter.class),"step0_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step0_activity.class),"step1_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step1_activity.class),"step2_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step2_activity.class),"vam_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.vam_activity.class)};
}
}