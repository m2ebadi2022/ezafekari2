...
padash_activity.mostCurrent._sp_year.runVoidMethod ("Add",(Object)(RemoteObject.createImmutable("1404")));
 BA.debugLineNum = 62;BA.debugLine="sp_year.Add(\"1403\")";
Debug.ShouldStop(536870912);
padash_activity.mostCurrent._sp_year.runVoidMethod ("Add",(Object)(RemoteObject.createImmutable("1403")));
...
_moon_num = padash_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,padash_activity.mostCurrent.activityBA,(Object)(RemoteObject.solve(new RemoteObject[] {padash_activity.mostCurrent._sp_moon.runMethod(true,"getSelectedIndex"),RemoteObject.createImmutable(1)}, "+",1, 1)));Debug.locals.put("moon_num", _moon_num);Debug.locals.put("moon_num", _moon_num);
 BA.debugLineNum = 77;BA.debugLine="fill_list_padash(sp_year.SelectedItem,moon_num)";
...
try {
		Debug.PushSubsStack("Activity_KeyPress (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,176);
...
try {
		Debug.PushSubsStack("Activity_Pause (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,99);
...
try {
		Debug.PushSubsStack("Activity_Resume (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,95);
...
try {
		Debug.PushSubsStack("et_mablagh_edit1_TextChanged (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,307);
...
try {
		Debug.PushSubsStack("fill_list_padash (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,105);
...
Debug.locals.put("moon", _moon);
 BA.debugLineNum = 105;BA.debugLine="Sub fill_list_padash(year As String , moon As Stri";
Debug.ShouldStop(256);
 BA.debugLineNum = 108;BA.debugLine="cust_LV_padash.Clear";
...
padash_activity.mostCurrent._p.runVoidMethodAndSync ("LoadLayout",(Object)(RemoteObject.createImmutable("item_list_list2")),padash_activity.mostCurrent.activityBA);
 BA.debugLineNum = 124;BA.debugLine="cust_LV_padash.Add(p,dbCode.res.GetString(\"id\"))";
...
padash_activity.mostCurrent._dbcode._sql /*RemoteObject*/ .runVoidMethod ("Close");
 BA.debugLineNum = 148;BA.debugLine="If(cust_LV_padash.LastVisibleIndex<5)Then";
Debug.ShouldStop(524288);
...
Debug.ShouldStop(1048576);
padash_activity.mostCurrent._p = padash_activity.mostCurrent._xui2.runMethod(false,"CreatePanel",padash_activity.processBA,(Object)(RemoteObject.createImmutable("p")));
 BA.debugLineNum = 150;BA.debugLine="Select cust_LV_padash.LastVisibleIndex";
Debug.ShouldStop(2097152);
...
;
 BA.debugLineNum = 164;BA.debugLine="cust_LV_padash.Add(p,\"\")";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("item_edit_box_mod (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,233);
...
try {
		Debug.PushSubsStack("lbl_add_padash_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,536);
if (RapidSub.canDelegate("lbl_add_padash_click")) { return ir.taravatgroup.ezafekari2.padash_activity.remoteMe.runUserSub(false, "padash_activity","lbl_add_padash_click");}
 BA.debugLineNum = 536;BA.debugLine="Private Sub lbl_add_padash_Click";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 538;BA.debugLine="addEdit_id=0";
Debug.ShouldStop(33554432);
padash_activity._addedit_id = BA.numberCast(int.class, 0);
 BA.debugLineNum = 539;BA.debugLine="item_edit_box_mod(\"ثبت پاداش\",\"\",myfunc.fa2en(Mai";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("lbl_back_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,172);
...
try {
		Debug.PushSubsStack("lbl_date_edit1_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,301);
...
try {
		Debug.PushSubsStack("lbl_edit_from_list_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,211);
...
padash_activity._current_itemid_edit = BA.numberCast(int.class, _b.runMethod(false,"getTag"));
 BA.debugLineNum = 223;BA.debugLine="dbCode.res= dbCode.sql.ExecQuery(\"SELECT * FROM t";
Debug.ShouldStop(1073741824);
...
padash_activity.mostCurrent._dbcode._res /*RemoteObject*/ .runMethod(true,"setPosition",BA.numberCast(int.class, 0));
 BA.debugLineNum = 226;BA.debugLine="item_edit_box_mod(\"ویرایش\",dbCode.res.GetString(\"";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("lbl_remove_from_list_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,185);
...
if (RemoteObject.solveBoolean("=",_result,BA.numberCast(double.class, padash_activity.mostCurrent.__c.getField(false,"DialogResponse").getField(true,"POSITIVE")))) { 
 BA.debugLineNum = 195;BA.debugLine="If (dbCode.delete_padash(b.Tag))Then";
Debug.ShouldStop(4);
...
padash_activity.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("حذف شد.")),(Object)(padash_activity.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 199;BA.debugLine="fill_list_padash(sp_year.SelectedItem,myfunc.co";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("lbl_save_edit1_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,277);
...
if ((RemoteObject.solveBoolean("=",padash_activity._addedit_id,BA.numberCast(double.class, 0)))) { 
 BA.debugLineNum = 286;BA.debugLine="dbCode.add_padash(et_onvan_edit1.Text ,lbl_date";
Debug.ShouldStop(536870912);
...
if ((RemoteObject.solveBoolean("=",padash_activity._addedit_id,BA.numberCast(double.class, 1)))) { 
 BA.debugLineNum = 289;BA.debugLine="dbCode.edit_padash(current_itemId_edit,et_onvan";
Debug.ShouldStop(1);
...
;
 BA.debugLineNum = 296;BA.debugLine="fill_list_padash(sp_year.SelectedItem,myfunc.con";
Debug.ShouldStop(128);
_fill_list_padash(padash_activity.mostCurrent._sp_year.runMethod(true,"getSelectedItem"),padash_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,padash_activity.mostCurrent.activityBA,(Object)(RemoteObject.solve(new RemoteObject[] {padash_activity.mostCurrent._sp_moon.runMethod(true,"getSelectedIndex"),RemoteObject.createImmutable(1)}, "+",1, 1))));
...
try {
		Debug.PushSubsStack("lbl_save_picker_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,314);
...
try {
		Debug.PushSubsStack("pan_all_edit1_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,264);
...
try {
		Debug.PushSubsStack("pan_all_set_date_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,272);
...
try {
		Debug.PushSubsStack("Panel4_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,268);
...
try {
		Debug.PushSubsStack("pik_day_bala1_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,475);
...
Debug.ShouldStop(16384);
padash_activity.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(padash_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,padash_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, padash_activity.mostCurrent._pik_day1.runMethod(true,"getText"))))));
...
try {
		Debug.PushSubsStack("pik_day_paeen1_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,498);
...
padash_activity.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(30));
 ...
 BA.debugLineNum = 516;BA.debugLine="pik_day1.Text=myfunc.convert_adad(pik_day1.Text)";
Debug.ShouldStop(8);
padash_activity.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(padash_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,padash_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, padash_activity.mostCurrent._pik_day1.runMethod(true,"getText"))))));
...
try {
		Debug.PushSubsStack("pik_moon_bala1_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,421);
...
try {
		Debug.PushSubsStack("pik_moon_paeen1_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,435);
...
try {
		Debug.PushSubsStack("pik_pan_day1_Touch (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,381);
...
padash_activity.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(30));
 ...
 BA.debugLineNum = 415;BA.debugLine="pik_day1.Text=myfunc.convert_adad(pik_day1.Text)";
Debug.ShouldStop(1073741824);
padash_activity.mostCurrent._pik_day1.runMethod(true,"setText",BA.ObjectToCharSequence(padash_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,padash_activity.mostCurrent.activityBA,(Object)(BA.numberCast(int.class, padash_activity.mostCurrent._pik_day1.runMethod(true,"getText"))))));
 };
...
try {
		Debug.PushSubsStack("pik_pan_moon1_Touch (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,321);
...
try {
		Debug.PushSubsStack("pik_pan_year1_Touch (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,351);
...
try {
		Debug.PushSubsStack("pik_year_bala1_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,449);
...
try {
		Debug.PushSubsStack("pik_year_paeen1_Click (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,462);
...
try {
		Debug.PushSubsStack("sp_moon_ItemClick (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,530);
...
Debug.ShouldStop(131072);
 BA.debugLineNum = 532;BA.debugLine="fill_list_padash(sp_year.SelectedItem,myfunc.conv";
Debug.ShouldStop(524288);
_fill_list_padash(padash_activity.mostCurrent._sp_year.runMethod(true,"getSelectedItem"),padash_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,padash_activity.mostCurrent.activityBA,(Object)(RemoteObject.solve(new RemoteObject[] {padash_activity.mostCurrent._sp_moon.runMethod(true,"getSelectedIndex"),RemoteObject.createImmutable(1)}, "+",1, 1))));
...
try {
		Debug.PushSubsStack("sp_year_ItemClick (padash_activity) ","padash_activity",20,padash_activity.mostCurrent.activityBA,padash_activity.mostCurrent,522);
...
Debug.ShouldStop(512);
 BA.debugLineNum = 524;BA.debugLine="fill_list_padash(sp_year.SelectedItem,myfunc.conv";
Debug.ShouldStop(2048);
_fill_list_padash(padash_activity.mostCurrent._sp_year.runMethod(true,"getSelectedItem"),padash_activity.mostCurrent._myfunc.runMethod(true,"_convert_adad" /*RemoteObject*/ ,padash_activity.mostCurrent.activityBA,(Object)(RemoteObject.solve(new RemoteObject[] {padash_activity.mostCurrent._sp_moon.runMethod(true,"getSelectedIndex"),RemoteObject.createImmutable(1)}, "+",1, 1))));
