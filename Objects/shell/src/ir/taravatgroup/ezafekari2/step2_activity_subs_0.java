...
try {
		Debug.PushSubsStack("Activity_Create (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,58);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,435);
...
{ BA.debugLineNum = 439;BA.debugLine="Else If(pan_all_msg.Visible=True)Then";
Debug.ShouldStop(4194304);
...
{ BA.debugLineNum = 441;BA.debugLine="Else If(pan_all_show_myMsg.Visible=True)Then";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("Activity_Pause (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,126);
...
try {
		Debug.PushSubsStack("Activity_Resume (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,122);
...
try {
		Debug.PushSubsStack("http_initial_1 (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,173);
...
{ BA.debugLineNum = 187;BA.debugLine="Else If(type1=2)Then ' to edit";
...
{ BA.debugLineNum = 200;BA.debugLine="Else If(type1=3)Then '  req transfer noskhe";
Debug.ShouldStop(128);
...
{ BA.debugLineNum = 205;BA.debugLine="Else If(type1=4)Then '  req chek noskhe";
Debug.ShouldStop(4096);
...
{ BA.debugLineNum = 210;BA.debugLine="Else If(type1=5)Then '  send msg";
...
{ BA.debugLineNum = 230;BA.debugLine="Else If (type1=6) Then  ' recive pic";
Debug.ShouldStop(32);
...
{ BA.debugLineNum = 233;BA.debugLine="Else If(type1=7)Then";
Debug.ShouldStop(256);
...
{ BA.debugLineNum = 241;BA.debugLine="Else If(type1=8)Then";
...
try {
		Debug.PushSubsStack("Jobdone (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,256);
...
{ BA.debugLineNum = 308;BA.debugLine="else If job.JobName=\"ht2\" Then";
Debug.ShouldStop(524288);
...
{ BA.debugLineNum = 315;BA.debugLine="else If job.JobName=\"ht3\" Then  '  req transfer";
Debug.ShouldStop(67108864);
...
{ BA.debugLineNum = 323;BA.debugLine="else If job.JobName=\"ht4\" Then '  req chek nosk";
Debug.ShouldStop(4);
...
{ BA.debugLineNum = 331;BA.debugLine="else If job.JobName=\"ht5\" Then  '  send msg";
Debug.ShouldStop(1024);
...
{ BA.debugLineNum = 340;BA.debugLine="else If job.JobName=\"ht6\" Then  '  recive db";
Debug.ShouldStop(524288);
...
{ BA.debugLineNum = 353;BA.debugLine="else If job.JobName=\"ht7\" Then  '  recive pic";
Debug.ShouldStop(1);
...
{ BA.debugLineNum = 368;BA.debugLine="else If job.JobName=\"ht8\" Then  '  recive my ms";
Debug.ShouldStop(32768);
...
{ BA.debugLineNum = 374;BA.debugLine="else If job.JobName=\"ht9\" Then  '  i see";
Debug.ShouldStop(2097152);
...
Debug.ShouldStop(4194304);
step2_activity.mostCurrent.__c.runVoidMethod ("LogImpl","258130551",_job.runClassMethod (ir.taravatgroup.ezafekari2.httpjob.class, "_getstring" /*RemoteObject*/ ),0);
 }}}}}}}}}
;
...
step2_activity.mostCurrent._img_p_edit.runMethod(false,"setBitmap",(step2_activity.mostCurrent._myfunc.runMethod(false,"_circleimage" /*RemoteObject*/ ,step2_activity.mostCurrent.activityBA,(Object)(step2_activity.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(step2_activity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(step2_activity.mostCurrent._picname)))).getObject()));
 ...
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",step2_activity.processBA, e92.toString()); BA.debugLineNum = 410;BA.debugLine="Log(LastException)";
Debug.ShouldStop(33554432);
step2_activity.mostCurrent.__c.runVoidMethod ("LogImpl","258130586",BA.ObjectToString(step2_activity.mostCurrent.__c.runMethod(false,"LastException",step2_activity.mostCurrent.activityBA)),0);
...
try {
		Debug.PushSubsStack("lbl_all_msg_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,635);
...
try {
		Debug.PushSubsStack("lbl_back_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,152);
...
try {
		Debug.PushSubsStack("lbl_back_home_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,454);
...
try {
		Debug.PushSubsStack("lbl_back_Shmsg_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,643);
...
try {
		Debug.PushSubsStack("lbl_chek_noskhe_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,539);
...
try {
		Debug.PushSubsStack("lbl_edit_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,418);
...
try {
		Debug.PushSubsStack("lbl_icon_noUp_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,654);
...
try {
		Debug.PushSubsStack("lbl_image_up_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,459);
...
Debug.ShouldStop(67108864);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","258392592",BA.ObjectToString(parent.mostCurrent.__c.runMethod(false,"LastException",step2_activity.mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
Debug.ShouldStop(32);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","258392603",BA.ObjectToString(parent.mostCurrent.__c.runMethod(false,"LastException",step2_activity.mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
try {
		Debug.PushSubsStack("lbl_logOff_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,156);
...
try {
		Debug.PushSubsStack("lbl_reseve_db_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,547);
...
try {
		Debug.PushSubsStack("lbl_save_edit_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,134);
...
{ BA.debugLineNum = 137;BA.debugLine="else If(et_nameFamili.Text=\"\")Then";
Debug.ShouldStop(256);
...
{ BA.debugLineNum = 139;BA.debugLine="Else If(et_email.Text=\"\")Then";
Debug.ShouldStop(1024);
...
{ BA.debugLineNum = 142;BA.debugLine="Else If(myfunc.Validate_Email(et_email.Text)=Fals";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("lbl_send_db_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,558);
...
try {
		Debug.PushSubsStack("lbl_send_msg_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,533);
...
try {
		Debug.PushSubsStack("lbl_send_msg_end_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,620);
...
try {
		Debug.PushSubsStack("lbl_send_msg2_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,649);
...
try {
		Debug.PushSubsStack("lbl_send_up_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,575);
...
Debug.ShouldStop(16777216);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","259113498",BA.ObjectToString(parent.mostCurrent.__c.runMethod(false,"LastException",step2_activity.mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
Debug.ShouldStop(16);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","259113510",BA.ObjectToString(parent.mostCurrent.__c.runMethod(false,"LastException",step2_activity.mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
try {
		Debug.PushSubsStack("lbl_send_up_icon_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,631);
...
try {
		Debug.PushSubsStack("lbl_transfer_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,525);
...
try {
		Debug.PushSubsStack("pan_all_edit_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,130);
...
try {
		Debug.PushSubsStack("pan_all_msg_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,571);
...
try {
		Debug.PushSubsStack("Panel9_Click (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,627);
...
try {
		Debug.PushSubsStack("Up_sendFile (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,509);
...
Debug.ShouldStop(536870912);
step2_activity.mostCurrent.__c.runVoidMethod ("LogImpl","258589185",_value,0);
...
try {
		Debug.PushSubsStack("Up_statusUpload (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,513);
...
try {
		Debug.PushSubsStack("upload_file (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,504);
...
Debug.ShouldStop(16777216);
step2_activity.mostCurrent.__c.runVoidMethod ("ProgressDialogShow",step2_activity.mostCurrent.activityBA,(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("بارگیری..."))));
...
try {
		Debug.PushSubsStack("upload_img (step2_activity) ","step2_activity",31,step2_activity.mostCurrent.activityBA,step2_activity.mostCurrent,493);
