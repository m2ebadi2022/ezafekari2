...
public static RemoteObject _tim_send_backup = RemoteObject.declareNull("anywheresoftware.b4a.objects.Timer");
...
public static RemoteObject _pan_all_sendbackup = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _progressbar1 = RemoteObject.declareNull("anywheresoftware.b4a.objects.ProgressBarWrapper");
public static RemoteObject _pan_progressbar = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _lbl_progressbar1 = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static ir.taravatgroup.ezafekari2.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",step2_activity.mostCurrent._activity,"ayabzahab_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.ayabzahab_activity.class),"bime_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.bime_activity.class),"bmp",step2_activity.mostCurrent._bmp,"calc_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.calc_activity.class),"CC",step2_activity._cc,"comment_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.comment_activity.class),"comp",step2_activity._comp,"darsad_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.darsad_activity.class),"DateUtils",step2_activity.mostCurrent._dateutils,"dbCode",Debug.moduleToString(ir.taravatgroup.ezafekari2.dbcode.class),"eidi_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.eidi_activity.class),"et_email",step2_activity.mostCurrent._et_email,"et_msg",step2_activity.mostCurrent._et_msg,"et_nameFamili",step2_activity.mostCurrent._et_namefamili,"fast_run_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.fast_run_activity.class),"food_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.food_activity.class),"ganon_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.ganon_activity.class),"gestha_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.gestha_activity.class),"help_kharid_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.help_kharid_activity.class),"hogog_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.hogog_activity.class),"http3",step2_activity.mostCurrent._http3,"HttpUtils2Service",Debug.moduleToString(ir.taravatgroup.ezafekari2.httputils2service.class),"img_p_edit",step2_activity.mostCurrent._img_p_edit,"img_pofil",step2_activity.mostCurrent._img_pofil,"info_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.info_activity.class),"Label12",step2_activity.mostCurrent._label12,"lbl_email",step2_activity.mostCurrent._lbl_email,"lbl_icon_noUp",step2_activity.mostCurrent._lbl_icon_noup,"lbl_icon_up",step2_activity.mostCurrent._lbl_icon_up,"lbl_image_up",step2_activity.mostCurrent._lbl_image_up,"lbl_nameFamili",step2_activity.mostCurrent._lbl_namefamili,"lbl_noske",step2_activity.mostCurrent._lbl_noske,"lbl_phoneNum",step2_activity.mostCurrent._lbl_phonenum,"lbl_progressBar1",step2_activity.mostCurrent._lbl_progressbar1,"Main",Debug.moduleToString(ir.taravatgroup.ezafekari2.main.class),"morakhasi_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.morakhasi_activity.class),"mosaedeh_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.mosaedeh_activity.class),"myfunc",Debug.moduleToString(ir.taravatgroup.ezafekari2.myfunc.class),"padash_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.padash_activity.class),"pan_all_edit",step2_activity.mostCurrent._pan_all_edit,"pan_all_msg",step2_activity.mostCurrent._pan_all_msg,"pan_all_sendBackup",step2_activity.mostCurrent._pan_all_sendbackup,"pan_all_show_myMsg",step2_activity.mostCurrent._pan_all_show_mymsg,"pan_progressBar",step2_activity.mostCurrent._pan_progressbar,"Panel12",step2_activity.mostCurrent._panel12,"Path_Phone_Image",step2_activity.mostCurrent._path_phone_image,"payankar_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.payankar_activity.class),"picName",step2_activity.mostCurrent._picname,"pp",step2_activity.mostCurrent._pp,"ProgressBar1",step2_activity.mostCurrent._progressbar1,"sabt2_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.sabt2_activity.class),"savabeg_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.savabeg_activity.class),"sayer_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.sayer_activity.class),"setting_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.setting_activity.class),"setting_hogog_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.setting_hogog_activity.class),"shift_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.shift_activity.class),"show_gozaresh_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.show_gozaresh_activity.class),"Starter",Debug.moduleToString(ir.taravatgroup.ezafekari2.starter.class),"step0_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step0_activity.class),"step1_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step1_activity.class),"tempFile",step2_activity.mostCurrent._tempfile,"tim_send_backup",step2_activity._tim_send_backup,"type_app",step2_activity._type_app,"Up",step2_activity.mostCurrent._up,"Url_Php_Page",step2_activity.mostCurrent._url_php_page,"user_key",step2_activity.mostCurrent._user_key,"vam_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.vam_activity.class),"wb_show_myMsg",step2_activity.mostCurrent._wb_show_mymsg};
}
}