...
public static ir.taravatgroup.ezafekari2.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",fast_run_activity.mostCurrent._activity,"bime_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.bime_activity.class),"bime_takmil",fast_run_activity._bime_takmil,"bime_tamin",fast_run_activity._bime_tamin,"bime_tamin_end",fast_run_activity._bime_tamin_end,"bon",fast_run_activity._bon,"calc_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.calc_activity.class),"comment_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.comment_activity.class),"darsad_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.darsad_activity.class),"DateUtils",fast_run_activity.mostCurrent._dateutils,"dbCode",Debug.moduleToString(ir.taravatgroup.ezafekari2.dbcode.class),"eidi_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.eidi_activity.class),"et_bon",fast_run_activity.mostCurrent._et_bon,"et_kosorat",fast_run_activity.mostCurrent._et_kosorat,"et_maskan",fast_run_activity.mostCurrent._et_maskan,"et_mazaya",fast_run_activity.mostCurrent._et_mazaya,"et_olad",fast_run_activity.mostCurrent._et_olad,"et_paye",fast_run_activity.mostCurrent._et_paye,"et_rozeKari",fast_run_activity.mostCurrent._et_rozekari,"et_sanavat",fast_run_activity.mostCurrent._et_sanavat,"et_time_h",fast_run_activity.mostCurrent._et_time_h,"et_time_m",fast_run_activity.mostCurrent._et_time_m,"et_vahed_ezafekari",fast_run_activity.mostCurrent._et_vahed_ezafekari,"ezafekari_end",fast_run_activity._ezafekari_end,"fani",fast_run_activity._fani,"ganon_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.ganon_activity.class),"hogog_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.hogog_activity.class),"hogog_khales",fast_run_activity._hogog_khales,"hogog_nakhales",fast_run_activity._hogog_nakhales,"HttpUtils2Service",Debug.moduleToString(ir.taravatgroup.ezafekari2.httputils2service.class),"imm",fast_run_activity.mostCurrent._imm,"imm2",fast_run_activity.mostCurrent._imm2,"info_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.info_activity.class),"jame_kosorat",fast_run_activity._jame_kosorat,"ksorat",fast_run_activity._ksorat,"ksorat_end",fast_run_activity._ksorat_end,"Main",Debug.moduleToString(ir.taravatgroup.ezafekari2.main.class),"maliat_end",fast_run_activity._maliat_end,"maskan",fast_run_activity._maskan,"masoliat",fast_run_activity._masoliat,"mazaya",fast_run_activity._mazaya,"mazaya_end",fast_run_activity._mazaya_end,"morakhasi_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.morakhasi_activity.class),"myfunc",Debug.moduleToString(ir.taravatgroup.ezafekari2.myfunc.class),"olad",fast_run_activity._olad,"olad_end",fast_run_activity._olad_end,"pan_all",fast_run_activity.mostCurrent._pan_all,"pan_hed_fast_run",fast_run_activity.mostCurrent._pan_hed_fast_run,"payankar_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.payankar_activity.class),"paye",fast_run_activity._paye,"paye_end",fast_run_activity._paye_end,"sanavat",fast_run_activity._sanavat,"sanavat_end",fast_run_activity._sanavat_end,"sarparasti",fast_run_activity._sarparasti,"sc_view1",fast_run_activity.mostCurrent._sc_view1,"setting_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.setting_activity.class),"setting_hogog_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.setting_hogog_activity.class),"shift",fast_run_activity._shift,"shift_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.shift_activity.class),"shift_end",fast_run_activity._shift_end,"show_gozaresh_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.show_gozaresh_activity.class),"sp_olad",fast_run_activity.mostCurrent._sp_olad,"Starter",Debug.moduleToString(ir.taravatgroup.ezafekari2.starter.class),"step0_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step0_activity.class),"step1_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step1_activity.class),"step2_activity",Debug.moduleToString(ir.taravatgroup.ezafekari2.step2_activity.class),"vahed_ezafekari",fast_run_activity._vahed_ezafekari,"wb_show_result",fast_run_activity.mostCurrent._wb_show_result};
}
}