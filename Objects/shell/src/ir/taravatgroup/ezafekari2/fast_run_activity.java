...
public static RemoteObject _hamsar = RemoteObject.createImmutable(0);
...
public static RemoteObject _str_show = RemoteObject.declareNull("anywheresoftware.b4a.keywords.StringBuilderWrapper");
public static RemoteObject _pan_all_savabeg = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _et_title_savabeg = RemoteObject.declareNull("anywheresoftware.b4a.objects.EditTextWrapper");
