...
try {
		Debug.PushSubsStack("Activity_Create (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,79);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,144);
...
try {
		Debug.PushSubsStack("Activity_Pause (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,132);
...
try {
		Debug.PushSubsStack("Activity_Resume (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,128);
...
try {
		Debug.PushSubsStack("box_control (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,433);
...
try {
		Debug.PushSubsStack("btn_run_Click (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,169);
...
try {
		Debug.PushSubsStack("calc_vahed_ezafekari (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,484);
...
try {
		Debug.PushSubsStack("et_kosorat_TextChanged (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,553);
...
try {
		Debug.PushSubsStack("et_mazaya_TextChanged (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,548);
...
try {
		Debug.PushSubsStack("et_olad_TextChanged (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,543);
...
try {
		Debug.PushSubsStack("et_paye_TextChanged (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,510);
...
try {
		Debug.PushSubsStack("et_rozeKari_TextChanged (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,534);
...
try {
		Debug.PushSubsStack("et_sanavat_TextChanged (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,522);
...
try {
		Debug.PushSubsStack("et_vahed_ezafekari_TextChanged (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,558);
...
try {
		Debug.PushSubsStack("get_data_hogogi (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,223);
...
try {
		Debug.PushSubsStack("lbl_back_Click (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,136);
...
try {
		Debug.PushSubsStack("lbl_close_Click (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,165);
...
try {
		Debug.PushSubsStack("lbl_help_1_Click (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,573);
...
Debug.ShouldStop(536870912);
fast_run_activity.mostCurrent._myfunc.runVoidMethod ("_help_man" /*RemoteObject*/ ,fast_run_activity.mostCurrent.activityBA,(Object)(BA.ObjectToString("راهنما")),(Object)(RemoteObject.createImmutable("اطلاعات حقوق خود را برای 30 روز وارد کنید. توجه داشته باشید محاسبات بر اساس قانون کار سال 1401 می باشد. ")));
...
try {
		Debug.PushSubsStack("lbl_help_2_Click (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,568);
...
try {
		Debug.PushSubsStack("lbl_help_3_Click (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,563);
...
try {
		Debug.PushSubsStack("lbl_refresh_vahed_Click (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,479);
...
try {
		Debug.PushSubsStack("mohasebe (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,340);
...
try {
		Debug.PushSubsStack("mohasebe_maliat (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,393);
...
try {
		Debug.PushSubsStack("pan_all_Click (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,218);
...
try {
		Debug.PushSubsStack("Panel4_Click (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,161);
...
try {
		Debug.PushSubsStack("show_num_pool (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,335);
...
try {
		Debug.PushSubsStack("sp_olad_ItemClick (fast_run_activity) ","fast_run_activity",13,fast_run_activity.mostCurrent.activityBA,fast_run_activity.mostCurrent,504);
