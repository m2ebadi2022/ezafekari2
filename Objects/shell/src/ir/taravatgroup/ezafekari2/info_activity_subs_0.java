...
try {
		Debug.PushSubsStack("Activity_Create (info_activity) ","info_activity",17,info_activity.mostCurrent.activityBA,info_activity.mostCurrent,22);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (info_activity) ","info_activity",17,info_activity.mostCurrent.activityBA,info_activity.mostCurrent,44);
...
try {
		Debug.PushSubsStack("Activity_Pause (info_activity) ","info_activity",17,info_activity.mostCurrent.activityBA,info_activity.mostCurrent,35);
...
try {
		Debug.PushSubsStack("Activity_Resume (info_activity) ","info_activity",17,info_activity.mostCurrent.activityBA,info_activity.mostCurrent,31);
...
try {
		Debug.PushSubsStack("lbl_back_Click (info_activity) ","info_activity",17,info_activity.mostCurrent.activityBA,info_activity.mostCurrent,39);
...
try {
		Debug.PushSubsStack("lbl_email_Click (info_activity) ","info_activity",17,info_activity.mostCurrent.activityBA,info_activity.mostCurrent,88);
...
Debug.ShouldStop(32);
info_activity.mostCurrent.__c.runVoidMethod ("LogImpl","629753358",BA.ObjectToString(info_activity.mostCurrent.__c.runMethod(false,"LastException",info_activity.mostCurrent.activityBA)),0);
...
try {
		Debug.PushSubsStack("lbl_insta_Click (info_activity) ","info_activity",17,info_activity.mostCurrent.activityBA,info_activity.mostCurrent,71);
...
info_activity.mostCurrent.__c.runVoidMethod ("LogImpl","629687819",BA.ObjectToString(info_activity.mostCurrent.__c.runMethod(false,"LastException",info_activity.mostCurrent.activityBA)),0);
...
try {
		Debug.PushSubsStack("lbl_whatsapp_Click (info_activity) ","info_activity",17,info_activity.mostCurrent.activityBA,info_activity.mostCurrent,53);
...
Debug.ShouldStop(1073741824);
info_activity.mostCurrent.__c.runVoidMethod ("LogImpl","629622282",BA.ObjectToString(info_activity.mostCurrent.__c.runMethod(false,"LastException",info_activity.mostCurrent.activityBA)),0);
