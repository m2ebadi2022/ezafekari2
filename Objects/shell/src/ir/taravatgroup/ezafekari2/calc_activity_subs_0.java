...
try {
		Debug.PushSubsStack("Activity_Create (calc_activity) ","calc_activity",8,calc_activity.mostCurrent.activityBA,calc_activity.mostCurrent,43);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (calc_activity) ","calc_activity",8,calc_activity.mostCurrent.activityBA,calc_activity.mostCurrent,224);
...
try {
		Debug.PushSubsStack("Activity_Pause (calc_activity) ","calc_activity",8,calc_activity.mostCurrent.activityBA,calc_activity.mostCurrent,105);
...
try {
		Debug.PushSubsStack("Activity_Resume (calc_activity) ","calc_activity",8,calc_activity.mostCurrent.activityBA,calc_activity.mostCurrent,101);
...
try {
		Debug.PushSubsStack("calcpnl_Click (calc_activity) ","calc_activity",8,calc_activity.mostCurrent.activityBA,calc_activity.mostCurrent,110);
...
try {
		Debug.PushSubsStack("docalc (calc_activity) ","calc_activity",8,calc_activity.mostCurrent.activityBA,calc_activity.mostCurrent,179);
...
Debug.ShouldStop(8192);
calc_activity.mostCurrent.__c.runVoidMethod ("LogImpl","718612251",BA.ObjectToString(calc_activity.mostCurrent.__c.runMethod(false,"LastException",calc_activity.mostCurrent.activityBA)),0);
 };
...
try {
		Debug.PushSubsStack("font_setting (calc_activity) ","calc_activity",8,calc_activity.mostCurrent.activityBA,calc_activity.mostCurrent,58);
...
try {
		Debug.PushSubsStack("lbl_back_Click (calc_activity) ","calc_activity",8,calc_activity.mostCurrent.activityBA,calc_activity.mostCurrent,216);
...
try {
		Debug.PushSubsStack("nrbtn_Click (calc_activity) ","calc_activity",8,calc_activity.mostCurrent.activityBA,calc_activity.mostCurrent,114);
